...
name|merge
argument_list|(
literal|"1-1453387901516-5d1e2450"
argument_list|,
name|ImmutableList
operator|.
name|of
...
argument_list|()
decl_stmt|;
comment|// The initial empty update creates a commit which is needed to track the
comment|// creation time of the change.
name|ChangeUpdate
name|update
init|=
name|newUpdate
...
argument_list|()
expr_stmt|;
comment|// Any further empty update doesn't create a new commit.
name|update
operator|=
name|newUpdate
argument_list|(
...
annotation|@
name|Test
DECL|method|subjectChangeNotes ()
specifier|public
name|void
name|subjectChangeNotes
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// An unrelated update doesn't affect the subject
name|ChangeUpdate
name|update
init|=
name|newUpdate
...
argument_list|)
expr_stmt|;
comment|// An update of the subject doesn't affect the original subject
name|update
operator|=
name|newUpdate
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// An update creates a new lastUpdatedOn timestamp.
name|ChangeUpdate
name|update
init|=
name|newUpdate
...
name|expectMessage
argument_list|(
literal|"Multiple revisions parsed for patch set"
argument_list|)
expr_stmt|;
name|notes
operator|=
...
annotation|@
name|Test
DECL|method|commitChangeNotes ()
specifier|public
name|void
name|commitChangeNotes
parameter_list|()
throws|throws
name|Exception
block|{
