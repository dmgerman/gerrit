...
expr_stmt|;
block|}
DECL|method|execute (final Branch.NameKey superProjectBranch, final Map<String, SubmoduleSection> sectionsToReturn, final Map<String, String> reposToBeFound, final Set<SubmoduleSubscription> expectedSubscriptions)
specifier|private
name|void
name|execute
parameter_list|(
