...
annotation|@
name|Test
DECL|method|diffPatchSetsIgnoresGreaterThanCurrentFromReviewDb ()
specifier|public
name|void
name|diffPatchSetsIgnoresGreaterThanCurrentFromReviewDb
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Both ReviewDb, exact match is required.
name|ChangeBundle
name|b1
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Both NoteDb, exact match is required.
name|b1
operator|=
operator|new
name|ChangeBundle
...
argument_list|)
expr_stmt|;
comment|// PS2 is in ReviewDb but not NoteDb, ok.
name|b1
operator|=
operator|new
name|ChangeBundle
