...
annotation|@
name|Test
DECL|method|diffChangesIgnoresLeadingWhitespaceInReviewDbTopics ()
specifier|public
name|void
name|diffChangesIgnoresLeadingWhitespaceInReviewDbTopics
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Must match except for the leading whitespace.
name|Change
name|c3
init|=
name|clone
...
literal|" in NoteDb vs. ReviewDb:"
operator|+
literal|" {2009-09-30 17:00:06.0} != {2009-09-30 17:00:12.0}"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
annotation|@
name|Test
DECL|method|diffChangeMessagesIgnoresMessagesOnPatchSetGreaterThanCurrent ()
specifier|public
name|void
name|diffChangeMessagesIgnoresMessagesOnPatchSetGreaterThanCurrent
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|diffIgnoresPatchSetsGreaterThanCurrent ()
specifier|public
name|void
name|diffIgnoresPatchSetsGreaterThanCurrent
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|diffReviewerKeySets ()
specifier|public
name|void
name|diffReviewerKeySets
parameter_list|()
throws|throws
name|Exception
block|{
...
name|b2
argument_list|,
literal|"ReviewerKey sets differ:"
operator|+
literal|" [REVIEWER,1] only in A;"
operator|+
literal|" [REVIEWER,2] only in B"
argument_list|)
expr_stmt|;
block|}
annotation|@
name|Test
DECL|method|diffReviewerTimestamps ()
specifier|public
name|void
name|diffReviewerTimestamps
parameter_list|()
throws|throws
name|Exception
block|{
...
name|b2
argument_list|,
literal|"timestamp differs for ReviewerKey REVIEWER,1:"
operator|+
literal|" {2009-09-30 17:00:06.0} != {2009-09-30 17:00:12.0}"
argument_list|)
expr_stmt|;
...
name|b2
argument_list|,
literal|"timestamp differs for ReviewerKey REVIEWER,1 in NoteDb vs. ReviewDb:"
operator|+
literal|" {2009-09-30 17:00:12.0} != {2009-09-30 17:00:06.0}"
argument_list|)
expr_stmt|;
block|}
annotation|@
name|Test
DECL|method|diffReviewerTimestampsAllowsSlop ()
specifier|public
name|void
name|diffReviewerTimestampsAllowsSlop
parameter_list|()
throws|throws
name|Exception
block|{
