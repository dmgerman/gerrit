...
return|;
block|}
DECL|method|newChangeForUser (TestRepository<Repo> repo, Account.Id owner)
specifier|protected
name|ChangeInserter
name|newChangeForUser
parameter_list|(
...
return|;
block|}
DECL|method|newChange (TestRepository<Repo> repo, @Nullable RevCommit commit, @Nullable Account.Id owner, @Nullable String branch, @Nullable Change.Status status, @Nullable String topic)
specifier|protected
name|ChangeInserter
name|newChange
parameter_list|(
