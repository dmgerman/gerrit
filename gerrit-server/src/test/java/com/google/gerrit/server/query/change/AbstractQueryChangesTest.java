...
argument_list|()
decl_stmt|;
comment|// TODO(dborowitz): Limit is broken in SQL (returns N+1 results) with some
comment|// kinds of predicates but not others.
comment|//assertResultEquals(change2, queryOne("status:new limit:1"));
name|List
argument_list|<
name|ChangeInfo
argument_list|>
