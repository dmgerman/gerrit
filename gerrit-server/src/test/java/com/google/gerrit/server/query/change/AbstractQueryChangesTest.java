...
expr_stmt|;
block|}
comment|//assertResultEquals(change, queryOne("status:new ownerin:Administrators"));
name|assertResultEquals
argument_list|(
name|change
argument_list|,
...
annotation|@
name|Test
DECL|method|byBeforeAbsolute ()
specifier|public
name|void
name|byBeforeAbsolute
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|0
expr_stmt|;
comment|// GitDateParser drops unparsed portions of the string, so be very careful
comment|// with formats.
name|assertTrue
argument_list|(
name|query
argument_list|(
...
name|queryOne
argument_list|(
literal|"before:\"2009-09-30 21:02:00 -0400\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertResultEquals
...
annotation|@
name|Test
DECL|method|byBeforeRelative ()
specifier|public
name|void
name|byBeforeRelative
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|byAfterAbsolute ()
specifier|public
name|void
name|byAfterAbsolute
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|byAfterRelative ()
specifier|public
name|void
name|byAfterRelative
parameter_list|()
throws|throws
name|Exception
block|{
