...
name|assertTrue
argument_list|(
literal|"push is blocked to refs/drafts/master"
argument_list|,
name|u
operator|.
name|controlForRef
...
name|assertTrue
argument_list|(
literal|"push is blocked for anonymous to refs/drafts/master"
argument_list|,
name|util
operator|.
name|user
...
name|assertFalse
argument_list|(
literal|"push is blocked for admin refs/drafts/master"
argument_list|,
name|util
operator|.
name|user
...
name|assertFalse
argument_list|(
literal|"not blocked from submitting"
argument_list|,
name|u
operator|.
name|controlForRef
