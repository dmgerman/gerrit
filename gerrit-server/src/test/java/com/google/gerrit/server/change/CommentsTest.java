...
name|RevId
argument_list|(
literal|"1234123412341234123412341234123412341234"
argument_list|)
argument_list|)
expr_stmt|;
name|List
...
annotation|@
name|Test
DECL|method|testGetCommentExisting ()
specifier|public
name|void
name|testGetCommentExisting
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testGetCommentNotExisting ()
specifier|public
name|void
name|testGetCommentNotExisting
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testPatchLineCommentsUtilDraftByChangeAuthor ()
specifier|public
name|void
name|testPatchLineCommentsUtilDraftByChangeAuthor
parameter_list|()
throws|throws
name|Exception
block|{
...
return|;
block|}
DECL|method|assertListComments (RevisionResource res, Map<String, ? extends List<PatchLineComment>> expected)
specifier|private
name|void
name|assertListComments
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|assertListDrafts (RevisionResource res, Map<String, ? extends List<PatchLineComment>> expected)
specifier|private
name|void
name|assertListDrafts
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|assertCommentMap (Map<String, List<CommentInfo>> actual, Map<String, ? extends List<PatchLineComment>> expected, boolean isPublished)
specifier|private
name|void
name|assertCommentMap
parameter_list|(
