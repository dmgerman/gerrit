...
return|;
block|}
DECL|method|createInjector (LifecycleManager lifecycle, Config cfg)
specifier|public
specifier|static
name|Injector
name|createInjector
...
parameter_list|()
block|{
comment|// These bindings must be in a child injector, because
comment|// ChangeMergeQueue creates its own child injector with conflicting
comment|// bindings.
name|InetSocketAddress
name|addr
init|=
