...
annotation|@
name|Inject
DECL|method|EventBroker ( DynamicSet<UserScopedEventListener> listeners, DynamicSet<EventListener> unrestrictedListeners, PermissionBackend permissionBackend, ProjectCache projectCache, ChangeNotes.Factory notesFactory, Provider<ReviewDb> dbProvider)
specifier|public
name|EventBroker
parameter_list|(
name|DynamicSet
...
name|debug
argument_list|(
literal|"Change {} cannot be found, falling back on ref visibility check"
argument_list|,
name|cid
operator|.
name|id
