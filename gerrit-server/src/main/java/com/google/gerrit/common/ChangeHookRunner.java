...
decl_stmt|;
comment|/** Path of the reviewer deleted hook. */
DECL|field|reviewerDeletedHook
specifier|private
specifier|final
name|Optional
argument_list|<
...
decl_stmt|;
comment|/** Path of the project created hook. */
DECL|field|projectCreatedHook
specifier|private
specifier|final
name|Optional
argument_list|<
...
annotation|@
name|Override
DECL|method|doCommentAddedHook (final Change change, Account account, PatchSet patchSet, String comment, final Map<String, Short> approvals, final Map<String, Short> oldApprovals, ReviewDb db)
specifier|public
name|void
...
annotation|@
name|Override
DECL|method|doRefUpdatedHook (final Branch.NameKey refName, final ObjectId oldId, final ObjectId newId, Account account)
specifier|public
name|void
name|doRefUpdatedHook
parameter_list|(
...
annotation|@
name|Override
DECL|method|doReviewerDeletedHook (final Change change, Account account, PatchSet patchSet, String comment, final Map<String, Short> approvals, final Map<String, Short> oldApprovals, ReviewDb db)
specifier|public
name|void
...
argument_list|()
decl_stmt|;
comment|// append votes that were removed
for|for
control|(
name|Map
operator|.
...
block|}
block|}
DECL|method|getAccountSupplier ( final Account.Id account)
specifier|private
name|Supplier
argument_list|<
name|AccountState
...
return|;
block|}
DECL|method|accountAttributeSupplier ( final Supplier<AccountState> s)
specifier|private
name|Supplier
argument_list|<
name|AccountAttribute
...
return|;
block|}
DECL|method|accountAttributeSupplier ( final Account account)
specifier|private
name|Supplier
argument_list|<
name|AccountAttribute
...
return|;
block|}
comment|/**      * Create an ApprovalAttribute for the given approval suitable for serialization to JSON.      * @param labelTypes      * @param approval      * @param oldApprovals      * @return object suitable for serialization to JSON      */
...
DECL|method|runHook (Project.NameKey project, Optional<Path> hook, List<String> args)
specifier|private
...
block|}
block|}
DECL|method|runHook (Optional<Path> hook, List<String> args)
specifier|private
specifier|synchronized
name|void
name|runHook
...
block|}
block|}
DECL|method|runSyncHook (Project.NameKey project, Optional<Path> hook, List<String> args)
specifier|private
name|HookResult
name|runSyncHook
parameter_list|(
...
annotation|@
name|Override
DECL|method|onNewProjectCreated (NewProjectCreatedListener.Event event)
specifier|public
name|void
