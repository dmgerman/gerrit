...
decl_stmt|;
comment|/** Filename of the draft published hook. */
...
decl_stmt|;
comment|/** Filename of the merge failed hook. */
...
name|refUpdatedHook
decl_stmt|;
comment|/** Filename of the reviewer added hook. */
...
decl_stmt|;
comment|/** Filename of the topic changed hook. */
...
name|claSignedHook
decl_stmt|;
comment|/** Filename of the update hook. */
...
name|refUpdateHook
decl_stmt|;
comment|/** Filename of the hashtags changed hook */
...
block|}
block|}
DECL|method|runSyncHook (Project.NameKey project, File hook, List<String> args)
specifier|private
name|HookResult
name|runSyncHook
parameter_list|(
...
argument_list|>
block|{
DECL|method|SyncHookTask (Project.NameKey project, File hook, List<String> args)
specifier|private
name|SyncHookTask
parameter_list|(
name|Project
...
name|Runnable
block|{
DECL|method|AsyncHookTask (Project.NameKey project, File hook, List<String> args)
specifier|private
name|AsyncHookTask
parameter_list|(
name|Project
