...
annotation|@
name|Override
DECL|method|doCommentAddedHook (final Change change, Account account, PatchSet patchSet, String comment, final Map<String, Short> approvals, ReviewDb db)
specifier|public
name|void
...
return|;
block|}
DECL|method|fireEventForUnrestrictedListeners (com.google.gerrit.server.events.Event event)
specifier|private
name|void
...
expr_stmt|;
block|}
DECL|method|fireEvent (com.google.gerrit.server.events.Event event, ReviewDb db)
specifier|private
name|void
name|fireEvent
parameter_list|(
...
return|;
block|}
DECL|method|isVisibleTo (com.google.gerrit.server.events.Event event, CurrentUser user, ReviewDb db)
specifier|private
name|boolean
name|isVisibleTo
parameter_list|(
