...
annotation|@
name|Inject
DECL|method|ChangeHookRunner (WorkQueue queue, GitRepositoryManager repoManager, @GerritServerConfig Config config, @AnonymousCowardName String anonymousCowardName, SitePaths sitePath, ProjectCache projectCache, AccountCache accountCache, EventFactory eventFactory)
specifier|public
name|ChangeHookRunner
parameter_list|(
name|WorkQueue
...
block|}
block|}
DECL|method|patchSetAttribute (Change change, PatchSet patchSet)
specifier|private
name|PatchSetAttribute
name|patchSetAttribute
parameter_list|(
