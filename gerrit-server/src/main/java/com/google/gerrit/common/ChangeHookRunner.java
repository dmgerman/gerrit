...
annotation|@
name|Inject
DECL|method|ChangeHookRunner (final WorkQueue queue, final GitRepositoryManager repoManager, @GerritServerConfig final Config config, final SitePaths sitePath, final ProjectCache projectCache, final AccountCache accountCache, final ApprovalTypes approvalTypes, @CanonicalWebUrl @Nullable final Provider<String> cwu)
specifier|public
name|ChangeHookRunner
parameter_list|(
specifier|final
...
DECL|method|getAccountAttribute (final Account account)
specifier|private
name|AuthorAttribute
name|getAccountAttribute
parameter_list|(
...
DECL|method|getChangeAttribute (final Change change)
specifier|private
name|ChangeAttribute
name|getChangeAttribute
parameter_list|(
...
return|;
block|}
comment|/**      * Create an PatchSetAttribute for the given patchset suitable for serialization to JSON.      *      * @param patchSet      * @return object suitable for serialization to JSON      */
DECL|method|getPatchSetAttribute (final PatchSet patchSet)
specifier|private
name|PatchSetAttribute
name|getPatchSetAttribute
parameter_list|(
