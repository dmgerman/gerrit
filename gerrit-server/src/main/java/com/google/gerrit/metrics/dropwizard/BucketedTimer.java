...
begin_comment
comment|/** Abstract timer broken down into buckets by {@link Field} values. */
end_comment

begin_class
DECL|class|BucketedTimer
specifier|abstract
class|class
name|BucketedTimer
...
argument_list|()
decl_stmt|;
DECL|method|BucketedTimer (DropWizardMetricMaker metrics, String name, Description desc, Field<?>... fields)
name|BucketedTimer
parameter_list|(
name|DropWizardMetricMaker
name|metrics
