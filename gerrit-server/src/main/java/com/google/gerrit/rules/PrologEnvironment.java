...
name|reductionLimit
decl_stmt|;
DECL|field|reductionsRemaining
specifier|private
name|int
name|reductionsRemaining
decl_stmt|;
DECL|field|cleanup
specifier|private
name|List
...
annotation|@
name|Override
DECL|method|isEngineStopped ()
specifier|public
name|boolean
name|isEngineStopped
parameter_list|()
block|{
if|if
condition|(
...
expr_stmt|;
block|}
comment|/** @return number of reductions during execution. */
DECL|method|getReductions ()
specifier|public
name|int
name|getReductions
parameter_list|()
...
if|if
condition|(
literal|"com.googlecode.prolog_cafe.builtin.PRED_consult_stream_2"
operator|.
name|equals
argument_list|(
name|goal
