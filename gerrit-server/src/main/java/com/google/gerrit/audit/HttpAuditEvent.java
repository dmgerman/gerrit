...
DECL|method|HttpAuditEvent (String sessionId, CurrentUser who, String what, long when, Multimap<String, ?> params, String httpMethod, Object input, int status, Object result)
specifier|public
name|HttpAuditEvent
parameter_list|(
name|String
