...
annotation|@
name|Inject
DECL|method|ProjectControlHandler ( ProjectControl.GenericFactory projectControlFactory, PermissionBackend permissionBackend, Provider<CurrentUser> user, @Assisted final CmdLineParser parser, @Assisted final OptionDef option, @Assisted final Setter<ProjectControl> setter)
specifier|public
name|ProjectControlHandler
parameter_list|(
name|ProjectControl
