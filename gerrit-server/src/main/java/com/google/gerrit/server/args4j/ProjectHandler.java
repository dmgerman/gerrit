...
annotation|@
name|Inject
DECL|method|ProjectHandler ( ProjectCache projectCache, PermissionBackend permissionBackend, Provider<CurrentUser> user, @Assisted final CmdLineParser parser, @Assisted final OptionDef option, @Assisted final Setter<ProjectState> setter)
specifier|public
name|ProjectHandler
parameter_list|(
name|ProjectCache
