...
annotation|@
name|Inject
DECL|method|SubmitStrategyFactory ( final IdentifiedUser.GenericFactory identifiedUserFactory, @GerritPersonIdent final PersonIdent myIdent, final ChangeNotes.Factory notesFactory, final ChangeUpdate.Factory updateFactory, final PatchSetInfoFactory patchSetInfoFactory, final GitReferenceUpdated gitRefUpdated, final RebaseChange rebaseChange, final ProjectCache projectCache, final ApprovalsUtil approvalsUtil, final MergeUtil.Factory mergeUtilFactory, final ChangeIndexer indexer)
name|SubmitStrategyFactory
parameter_list|(
specifier|final
name|IdentifiedUser
