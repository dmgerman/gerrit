...
annotation|@
name|Inject
DECL|method|CreateEmail (Provider<CurrentUser> self, AuthConfig authConfig, AccountManager accountManager, RegisterNewEmailSender.Factory registerNewEmailFactory, @Assisted String email)
name|CreateEmail
parameter_list|(
name|Provider
argument_list|<
