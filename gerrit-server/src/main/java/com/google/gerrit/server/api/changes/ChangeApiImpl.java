...
annotation|@
name|Inject
DECL|method|ChangeApiImpl (Changes changeApi, Revisions revisions, RevisionApiImpl.Factory revisionApi, Abandon abandon, Revert revert, Restore restore, Provider<PostReviewers> postReviewers, Provider<ChangeJson> changeJson, @Assisted ChangeResource change)
name|ChangeApiImpl
parameter_list|(
name|Changes
name|changeApi
