...
annotation|@
name|Inject
DECL|method|ChangeApiImpl (Changes changeApi, Revisions revisions, RevisionApiImpl.Factory revisionApi, Provider<Abandon> abandon, Provider<Revert> revert, Provider<Restore> restore, Provider<PostReviewers> postReviewers, ChangeJson changeJson, @Assisted ChangeResource change)
name|ChangeApiImpl
parameter_list|(
name|Changes
name|changeApi
