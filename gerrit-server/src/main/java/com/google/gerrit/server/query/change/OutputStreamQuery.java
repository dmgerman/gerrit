...
annotation|@
name|Inject
DECL|method|OutputStreamQuery ( Provider<ReviewDb> db, ChangeQueryBuilder queryBuilder, QueryProcessor queryProcessor, EventFactory eventFactory, TrackingFooters trackingFooters, CurrentUser user)
name|OutputStreamQuery
parameter_list|(
name|Provider
argument_list|<
