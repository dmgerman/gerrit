...
name|OperatorFactory
block|{
DECL|method|create (String value)
name|Predicate
name|create
parameter_list|(
name|String
...
annotation|@
name|Override
DECL|method|create (final String value)
specifier|public
name|Predicate
name|create
parameter_list|(
