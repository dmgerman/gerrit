...
annotation|@
name|Inject
DECL|method|PushReplication (final Injector i, final WorkQueue wq, final SitePaths site, final ReplicationUser.Factory ruf, final SchemaFactory<ReviewDb> db, final GitRepositoryManager grm)
name|PushReplication
parameter_list|(
specifier|final
name|Injector
...
decl_stmt|;
DECL|method|ReplicationConfig (final Injector injector, final WorkQueue workQueue, final RemoteConfig rc, final Config cfg, SchemaFactory<ReviewDb> db, final ReplicationUser.Factory replicationUserFactory, final GitRepositoryManager gitRepositoryManager)
name|ReplicationConfig
parameter_list|(
specifier|final
name|Injector
