...
annotation|@
name|Inject
DECL|method|PushReplication (final Injector i, final WorkQueue wq, final SitePaths site, final ReplicationUser.Factory ruf, final SchemaFactory<ReviewDb> db, final GitRepositoryManager grm, GroupCache gc)
name|PushReplication
parameter_list|(
specifier|final
name|Injector
...
name|warn
argument_list|(
literal|"Cannot create new project on remote site since neither the "
operator|+
literal|"connection method is SSH nor the replication target is local: "
operator|+
name|replicateURI
operator|.
name|toString
...
block|}
block|}
DECL|method|replicateProjectLocally (final URIish replicateURI, final String head)
specifier|private
name|void
name|replicateProjectLocally
parameter_list|(
...
name|error
argument_list|(
literal|"Failed to replicate project locally: "
operator|+
name|replicateURI
operator|.
name|getPath
...
block|}
block|}
DECL|method|replicateProjectOverSsh (final URIish replicateURI, final String head)
specifier|private
name|void
name|replicateProjectOverSsh
parameter_list|(
...
name|mgr
decl_stmt|;
DECL|field|replicatePermissions
specifier|private
specifier|final
name|boolean
name|replicatePermissions
decl_stmt|;
DECL|method|ReplicationConfig (final Injector injector, final WorkQueue workQueue, final RemoteConfig rc, final Config cfg, SchemaFactory<ReviewDb> db, final ReplicationUser.Factory replicationUserFactory, final GitRepositoryManager gitRepositoryManager, GroupCache groupCache)
name|ReplicationConfig
parameter_list|(
specifier|final
name|Injector
...
name|error
argument_list|(
literal|"Internal error: cannot check type of project "
operator|+
name|project
operator|+
...
return|;
block|}
DECL|method|isReplicatePermissions ()
name|boolean
