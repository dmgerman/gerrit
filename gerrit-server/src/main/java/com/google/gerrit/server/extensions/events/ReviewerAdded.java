...
expr_stmt|;
block|}
DECL|method|fire (ChangeInfo change, RevisionInfo revision, List<AccountInfo> reviewers, AccountInfo adder, Timestamp when)
specifier|public
name|void
name|fire
parameter_list|(
...
block|}
block|}
DECL|method|fire (Change change, PatchSet patchSet, List<Account.Id> reviewers, Account adder, Timestamp when)
specifier|public
name|void
name|fire
parameter_list|(
