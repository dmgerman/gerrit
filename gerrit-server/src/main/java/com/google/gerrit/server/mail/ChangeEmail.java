...
block|}
block|}
comment|/** BCC users and groups that want notification of events. */
DECL|method|bccWatches (NotifyType type)
specifier|protected
name|void
name|bccWatches
parameter_list|(
...
DECL|method|getWatches (NotifyType type)
specifier|protected
specifier|final
name|Watchers
name|getWatches
...
name|format
argument_list|(
literal|"Project %s has invalid group %s in notify section %s"
argument_list|,
name|project
operator|.
name|get
...
name|format
argument_list|(
literal|"Project %s cannot use group %s of type %s in notify section %s"
argument_list|,
name|project
operator|.
name|get
...
condition|)
block|{
name|recursivelyAddAllAccounts
argument_list|(
name|matching
argument_list|,
name|group
...
block|}
block|}
DECL|method|recursivelyAddAllAccounts (Watchers matching, AccountGroup group)
specifier|private
name|void
name|recursivelyAddAllAccounts
parameter_list|(
