...
annotation|@
name|AssistedInject
DECL|method|SetAssigneeOp (AccountsCollection accounts, NotesMigration notesMigration, ChangeMessagesUtil cmUtil, AccountInfoCacheFactory.Factory accountInfosFactory, @AnonymousCowardName String anonymousCowardName, @Assisted AssigneeInput input, DynamicSet<AssigneeValidationListener> validationListeners)
name|SetAssigneeOp
parameter_list|(
name|AccountsCollection
name|accounts
