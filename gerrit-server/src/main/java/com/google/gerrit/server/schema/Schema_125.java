...
annotation|@
name|Inject
DECL|method|Schema_125 (Provider<Schema_124> prior, GitRepositoryManager repoManager, AllUsersName allUsersName, AllProjectsName allProjectsName, @GerritPersonIdent PersonIdent serverUser)
name|Schema_125
parameter_list|(
name|Provider
argument_list|<
