...
annotation|@
name|Inject
DECL|method|CreateMergePatchSet ( Provider<ReviewDb> db, GitRepositoryManager gitManager, @GerritPersonIdent PersonIdent myIdent, Provider<CurrentUser> user, ChangeJson.Factory json, PatchSetUtil psUtil, MergeUtil.Factory mergeUtilFactory, RetryHelper retryHelper, PatchSetInserter.Factory patchSetInserterFactory)
name|CreateMergePatchSet
parameter_list|(
name|Provider
argument_list|<
...
annotation|@
name|Override
DECL|method|applyImpl ( BatchUpdate.Factory updateFactory, ChangeResource req, MergePatchSetInput in)
specifier|protected
name|Response
argument_list|<
name|ChangeInfo
