...
annotation|@
name|Inject
DECL|method|GetContent ( Provider<ReviewDb> db, GitRepositoryManager gitManager, PatchSetUtil psUtil, FileContentUtil fileContentUtil, ProjectCache projectCache)
name|GetContent
parameter_list|(
name|Provider
argument_list|<
