...
block|}
block|}
DECL|method|parseAddApproval (PatchSet.Id psId, Account.Id accountId, RevCommit commit, String line)
specifier|private
name|void
name|parseAddApproval
parameter_list|(
...
return|;
block|}
DECL|method|parseRemoveApproval (PatchSet.Id psId, Account.Id accountId, String line)
specifier|private
name|void
name|parseRemoveApproval
parameter_list|(
...
block|}
block|}
DECL|method|isApprovalRemoved (PatchSet.Id psId, Account.Id accountId, String label)
specifier|private
name|boolean
name|isApprovalRemoved
parameter_list|(
