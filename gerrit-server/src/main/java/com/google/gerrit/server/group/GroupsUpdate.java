...
annotation|@
name|Inject
DECL|method|GroupsUpdate ( Groups groups, GroupCache groupCache, AuditService auditService, AccountCache accountCache, @Assisted @Nullable IdentifiedUser currentUser)
name|GroupsUpdate
parameter_list|(
name|Groups
name|groups
