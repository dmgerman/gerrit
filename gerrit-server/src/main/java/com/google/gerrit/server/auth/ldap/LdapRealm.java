...
annotation|@
name|Inject
DECL|method|LdapRealm ( final Helper helper, final AuthConfig authConfig, final EmailExpander emailExpander, @Named(LdapModule.GROUP_CACHE) final LoadingCache<String, Set<AccountGroup.UUID>> membershipCache, @Named(LdapModule.USERNAME_CACHE) final LoadingCache<String, Optional<Account.Id>> usernameCache, @GerritServerConfig final Config config, final MaterializedGroupMembership.Factory groupMembershipFactory)
name|LdapRealm
parameter_list|(
specifier|final
name|Helper
...
name|format
argument_list|(
literal|"Cannot lookup groups for %s in LDAP"
argument_list|,
name|id
argument_list|)
argument_list|,
