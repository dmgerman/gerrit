...
literal|"accepted"
decl_stmt|;
DECL|field|KEY_REQUIRE_CONTACT_INFORMATION
specifier|private
specifier|static
specifier|final
name|String
name|KEY_REQUIRE_CONTACT_INFORMATION
init|=
literal|"requireContactInformation"
decl_stmt|;
...
name|format
argument_list|(
literal|"Invalid label ID \"%s\" for label \"%s\": "
operator|+
literal|"Label ID may have at most 4 characters"
argument_list|,
name|id
argument_list|,
name|name
