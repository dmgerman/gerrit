...
annotation|@
name|Inject
DECL|method|Sequences ( @erritServerConfig Config cfg, Provider<ReviewDb> db, NotesMigration migration, GitRepositoryManager repoManager, AllProjectsName allProjects, MetricMaker metrics)
name|Sequences
parameter_list|(
annotation|@
name|GerritServerConfig
