...
comment|//is wrapped into a ListenableFutureTask.
if|if
condition|(
name|runnable
operator|instanceof
...
name|errorMessage
operator|=
literal|"Cannot find wrapped Callable field"
expr_stmt|;
block|}
catch|catch
parameter_list|(
...
name|errorMessage
operator|=
literal|"Cannot call toString on Callable field"
expr_stmt|;
block|}
name|log
operator|.
name|debug
argument_list|(
literal|"Cannot get a proper name for ListenableFutureTask: {}"
argument_list|,
name|errorMessage
argument_list|)
expr_stmt|;
