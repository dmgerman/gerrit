...
annotation|@
name|Inject
DECL|method|Emails (ExternalIds externalIds, InternalAccountQuery accountQuery)
specifier|public
name|Emails
parameter_list|(
name|ExternalIds
...
name|stream
argument_list|()
comment|// the index query also matches prefixes and emails with other case,
comment|// filter those out
operator|.
name|filter
argument_list|(
name|a
