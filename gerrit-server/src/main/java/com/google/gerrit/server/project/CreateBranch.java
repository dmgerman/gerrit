...
annotation|@
name|Inject
DECL|method|CreateBranch (Provider<IdentifiedUser> identifiedUser, GitRepositoryManager repoManager, Provider<ReviewDb> db, GitReferenceUpdated referenceUpdated, @Assisted String ref)
name|CreateBranch
parameter_list|(
name|Provider
argument_list|<
