...
annotation|@
name|Inject
DECL|method|GuiceRequestScopePropagator ( @anonicalWebUrl @ullable Provider<String> urlProvider, @RemotePeer Provider<SocketAddress> remotePeerProvider, Provider<CurrentUser> currentUserProvider)
name|GuiceRequestScopePropagator
parameter_list|(
annotation|@
name|CanonicalWebUrl
