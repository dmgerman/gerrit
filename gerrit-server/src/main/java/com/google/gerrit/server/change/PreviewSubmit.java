...
annotation|@
name|Inject
DECL|method|PreviewSubmit ( Provider<ReviewDb> dbProvider, RetryHelper retryHelper, MergeOp.Factory mergeOpFactory, AllowedFormats allowedFormats, @GerritServerConfig Config cfg)
name|PreviewSubmit
parameter_list|(
name|Provider
argument_list|<
...
name|RestApiException
block|{
comment|// Shouldn't ever need to retry, since we are doing a dry-run BatchUpdate, but this is required
comment|// to get access to a BatchUpdate.Factory.
return|return
name|retryHelper
operator|.
name|execute
...
return|;
block|}
DECL|method|getBundles ( BatchUpdate.Factory updateFactory, RevisionResource rsrc, ArchiveFormat f)
specifier|private
name|BinaryResult
name|getBundles
parameter_list|(
