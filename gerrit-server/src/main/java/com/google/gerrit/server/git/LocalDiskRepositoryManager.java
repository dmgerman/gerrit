...
return|;
block|}
DECL|method|openRepository (File path, Project.NameKey name)
specifier|private
name|Repository
name|openRepository
parameter_list|(
...
return|;
block|}
DECL|method|createRepository (File path, Project.NameKey name)
specifier|private
name|Repository
name|createRepository
parameter_list|(
...
block|}
block|}
DECL|method|getProjectName (final String prefix, final String fileName)
specifier|private
name|Project
operator|.
name|NameKey
