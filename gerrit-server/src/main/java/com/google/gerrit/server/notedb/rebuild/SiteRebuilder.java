...
annotation|@
name|Inject
DECL|method|Builder ( SchemaFactory<ReviewDb> schemaFactory, NoteDbUpdateManager.Factory updateManagerFactory, ChangeRebuilder rebuilder, ChangeBundleReader bundleReader, WorkQueue workQueue)
name|Builder
parameter_list|(
name|SchemaFactory
argument_list|<
...
name|progressOut
decl_stmt|;
DECL|method|SiteRebuilder ( SchemaFactory<ReviewDb> schemaFactory, NoteDbUpdateManager.Factory updateManagerFactory, ChangeRebuilder rebuilder, ChangeBundleReader bundleReader, ListeningExecutorService executor, ImmutableList<Project.NameKey> projects, ImmutableList<Change.Id> changes, OutputStream progressOut)
specifier|private
name|SiteRebuilder
parameter_list|(
name|SchemaFactory
