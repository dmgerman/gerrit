...
block|}
block|}
DECL|method|commentsOnFile ( Collection<PatchLineComment> allComments, String file)
specifier|private
specifier|static
name|List
argument_list|<
...
return|;
block|}
DECL|method|commentsOnPatchSet ( Collection<PatchLineComment> allComments, PatchSet.Id psId)
specifier|private
specifier|static
name|List
argument_list|<
...
try|try
block|{
comment|// TODO(dborowitz): Bypass cache if side is REVISION.
name|PatchList
name|patchList
init|=
name|cache
...
block|}
block|}
DECL|method|getDraftRefs (Repository repo, final Change.Id changeId)
specifier|private
name|Map
argument_list|<
name|String
