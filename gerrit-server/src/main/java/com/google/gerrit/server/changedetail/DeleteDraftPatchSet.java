...
annotation|@
name|Inject
DECL|method|DeleteDraftPatchSet (ChangeControl.Factory changeControlFactory, ReviewDb db, PatchSetInfoFactory patchSetInfoFactory, ChangeIndexer indexer, ChangeUtil changeUtil, @Assisted PatchSet.Id patchSetId)
name|DeleteDraftPatchSet
parameter_list|(
name|ChangeControl
operator|.
