...
block|}
block|}
DECL|method|addRef (Repository db, List<Ref> refs, String name)
specifier|private
specifier|static
name|void
name|addRef
...
block|}
block|}
DECL|method|filterBranches ( FluentIterable<BranchInfo> branches)
specifier|private
name|FluentIterable
argument_list|<
name|BranchInfo
...
annotation|@
name|Override
DECL|method|apply (BranchInfo in)
specifier|public
name|boolean
name|apply
parameter_list|(
