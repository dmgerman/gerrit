...
annotation|@
name|Inject
DECL|method|DeletePrivate (Provider<ReviewDb> dbProvider, RetryHelper retryHelper, ChangeMessagesUtil cmUtil)
name|DeletePrivate
parameter_list|(
name|Provider
argument_list|<
...
annotation|@
name|Inject
DECL|method|DeletePrivateByPost ( Provider<ReviewDb> dbProvider, RetryHelper retryHelper, ChangeMessagesUtil cmUtil)
name|DeletePrivateByPost
parameter_list|(
name|Provider
argument_list|<
