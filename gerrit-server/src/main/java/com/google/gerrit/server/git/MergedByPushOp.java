...
annotation|@
name|AssistedInject
DECL|method|MergedByPushOp ( PatchSetInfoFactory patchSetInfoFactory, ChangeHooks hooks, ChangeMessagesUtil cmUtil, MergedSender.Factory mergedSenderFactory, PatchSetUtil psUtil, @SendEmailExecutor ExecutorService sendEmailExecutor, @Assisted RequestScopePropagator requestScopePropagator, @Assisted PatchSet.Id psId, @Assisted String refName)
name|MergedByPushOp
parameter_list|(
name|PatchSetInfoFactory
name|patchSetInfoFactory
