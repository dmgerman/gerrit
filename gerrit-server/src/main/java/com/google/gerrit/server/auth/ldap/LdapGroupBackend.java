...
annotation|@
name|Inject
DECL|method|LdapGroupBackend ( Helper helper, @Named(GROUP_CACHE) LoadingCache<String, Set<AccountGroup.UUID>> membershipCache, @Named(GROUP_EXIST_CACHE) LoadingCache<String, Boolean> existsCache, Provider<CurrentUser> userProvider)
name|LdapGroupBackend
parameter_list|(
name|Helper
name|helper
...
return|;
block|}
DECL|method|groupReference (LdapQuery.Result res)
specifier|private
specifier|static
name|GroupReference
name|groupReference
