...
name|Factory
block|{
DECL|method|create ( NotifyHandling notify, Multimap<RecipientType, Account.Id> accountsToNotify, ChangeNotes notes, PatchSet patchSet, IdentifiedUser user, ChangeMessage message, List<Comment> comments)
name|EmailReviewComments
name|create
parameter_list|(
name|NotifyHandling
