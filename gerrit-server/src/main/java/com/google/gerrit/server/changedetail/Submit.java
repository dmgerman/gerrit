...
annotation|@
name|Inject
DECL|method|Submit (final ChangeControl.Factory changeControlFactory, final MergeOp.Factory opFactory, final MergeQueue merger, final ReviewDb db, final IdentifiedUser currentUser, @Assisted final PatchSet.Id patchSetId)
name|Submit
parameter_list|(
specifier|final
name|ChangeControl
