...
return|;
block|}
comment|// Avoid auto-rebuilding when reindexing if reading is disabled. This just
comment|// increases contention on the meta ref from a background indexing thread
comment|// with little benefit. The next actual write to the entity may still incur a
comment|// less-contentious rebuild.
DECL|method|newChangeData (ReviewDb db, Change change)
specifier|private
name|ChangeData
name|newChangeData
parameter_list|(
...
return|;
block|}
DECL|method|newChangeData (ReviewDb db, Project.NameKey project, Change.Id changeId)
specifier|private
name|ChangeData
name|newChangeData
parameter_list|(
