...
expr_stmt|;
block|}
DECL|method|addReviewers (ReviewDb db, LabelTypes labelTypes, Change change, PatchSet ps, PatchSetInfo info, Iterable<Account.Id> wantReviewers, Collection<Account.Id> existingReviewers)
specifier|public
name|List
argument_list|<
name|PatchSetApproval
...
return|;
block|}
DECL|method|addReviewers (ReviewDb db, LabelTypes labelTypes, Change change, PatchSet.Id psId, boolean isDraft, Account.Id authorId, Account.Id committerId, Iterable<Account.Id> wantReviewers, Collection<Account.Id> existingReviewers)
specifier|private
name|List
argument_list|<
name|PatchSetApproval
...
return|;
block|}
DECL|method|byPatchSet (ReviewDb db, PatchSet.Id psId)
specifier|public
name|List
argument_list|<
name|PatchSetApproval
...
return|;
block|}
DECL|method|getSubmitter (ReviewDb db, PatchSet.Id c)
specifier|public
name|PatchSetApproval
name|getSubmitter
parameter_list|(
