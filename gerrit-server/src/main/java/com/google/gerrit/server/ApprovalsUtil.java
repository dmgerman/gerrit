...
expr_stmt|;
block|}
comment|/**    * Moves the PatchSetApprovals to the specified PatchSet on the change from    * the prior PatchSet, while keeping the vetos.    *    * @throws OrmException    * @return List<PatchSetApproval> The previous approvals    */
