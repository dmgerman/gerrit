...
decl_stmt|;
DECL|method|QueryProcessor (Metrics metrics, SchemaDefinitions<T> schemaDef, IndexConfig indexConfig, IndexCollection<?, T, ? extends Index<?, T>> indexes, IndexRewriter<T> rewriter, String limitField)
specifier|protected
name|QueryProcessor
parameter_list|(
name|Metrics
...
return|;
block|}
comment|/**    * Invoked after the query was rewritten. Subclasses may overwrite this method    * to add additional predicates to the query before it is executed.    *    * @param pred the query    * @return the modified query    */
DECL|method|postRewrite (Predicate<T> pred)
specifier|protected
name|Predicate
argument_list|<
name|T
