...
block|{
DECL|method|newMessage (BatchUpdate.ChangeContext ctx, String body)
specifier|public
specifier|static
name|ChangeMessage
name|newMessage
...
return|;
block|}
DECL|method|newMessage ( ReviewDb db, PatchSet.Id psId, CurrentUser user, Timestamp when, String body)
specifier|public
specifier|static
name|ChangeMessage
name|newMessage
