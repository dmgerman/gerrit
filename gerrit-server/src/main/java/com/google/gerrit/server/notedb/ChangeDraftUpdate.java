...
annotation|@
name|AssistedInject
DECL|method|ChangeDraftUpdate ( @erritPersonIdent PersonIdent serverIdent, @AnonymousCowardName String anonymousCowardName, GitRepositoryManager repoManager, NotesMigration migration, DraftCommentNotes.Factory draftNotesFactory, AllUsersName allUsers, CommentsInNotesUtil commentsUtil, @Assisted ChangeControl ctl, @Assisted Date when)
specifier|private
name|ChangeDraftUpdate
parameter_list|(
annotation|@
...
DECL|method|storeCommentsInNotes (ObjectInserter inserter, AtomicBoolean removedAllComments)
specifier|private
name|ObjectId
