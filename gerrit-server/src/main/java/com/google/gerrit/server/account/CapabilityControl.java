...
annotation|@
name|Inject
DECL|method|Factory (@ildProjectName Project.NameKey wp, ProjectCache pc, Provider<CurrentUser> cu)
name|Factory
parameter_list|(
annotation|@
name|WildProjectName
...
name|permissions
decl_stmt|;
DECL|method|CapabilityControl (ProjectState p, CurrentUser currentUser)
specifier|private
name|CapabilityControl
parameter_list|(
name|ProjectState
