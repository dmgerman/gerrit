...
argument_list|()
decl_stmt|;
DECL|class|SubmitLabelProtoField
specifier|public
specifier|static
class|class
name|SubmitLabelProtoField
extends|extends
name|FieldDef
operator|.
name|Repeatable
...
argument_list|)
decl_stmt|;
DECL|method|SubmitLabelProtoField ()
specifier|private
name|SubmitLabelProtoField
parameter_list|()
block|{
...
name|OrmException
block|{
comment|// Flatten the highest-valued labels to mimic the results from ChangeJson
comment|// with standard labels.
name|Map
argument_list|<
name|String
argument_list|,
...
return|;
block|}
DECL|method|getSubmitRecords (ChangeData input, FillArgs args)
specifier|private
name|List
argument_list|<
name|SubmitRecord
...
try|try
block|{
comment|// Use the ChangeControl for InternalUser. This will give bogus
comment|// results for whether or not the change is submittable, but does
comment|// not affect label calculation.
name|ctl
operator|=
name|args
operator|.
...
block|}
block|}
comment|/**    * Serialized labels from the submit rule evaluator, used for pre-populating    * results.    */
DECL|field|SUBMIT_RECORD_LABEL
specifier|public
specifier|static
specifier|final
name|SubmitLabelProtoField
