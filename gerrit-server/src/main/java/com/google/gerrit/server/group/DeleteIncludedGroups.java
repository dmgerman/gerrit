...
annotation|@
name|Inject
DECL|method|DeleteIncludedGroups ( GroupsCollection groupsCollection, Provider<ReviewDb> db, @UserInitiated Provider<GroupsUpdate> groupsUpdateProvider)
name|DeleteIncludedGroups
parameter_list|(
name|GroupsCollection
name|groupsCollection
