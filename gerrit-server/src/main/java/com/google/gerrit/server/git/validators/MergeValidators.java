...
annotation|@
name|Inject
DECL|method|MergeValidators ( DynamicSet<MergeValidationListener> mergeValidationListeners, ProjectConfigValidator.Factory projectConfigValidatorFactory, AccountValidator.Factory accountValidatorFactory)
name|MergeValidators
parameter_list|(
name|DynamicSet
argument_list|<
...
annotation|@
name|Inject
DECL|method|ProjectConfigValidator ( AllProjectsName allProjectsName, ProjectCache projectCache, PermissionBackend permissionBackend, DynamicMap<ProjectConfigEntry> pluginConfigEntries)
specifier|public
name|ProjectConfigValidator
parameter_list|(
name|AllProjectsName
...
annotation|@
name|Inject
DECL|method|AccountValidator ( Provider<ReviewDb> dbProvider, AllUsersName allUsersName, ChangeData.Factory changeDataFactory)
specifier|public
name|AccountValidator
parameter_list|(
name|Provider
...
condition|)
block|{
comment|// for merge commits we cannot ensure that the 'account.config' file is not modified, since
comment|// for merge commits file modifications that come in through the merge don't appear in the
comment|// file list that is returned by ChangeData#currentFilePaths()
throw|throw
operator|new
name|MergeValidationException
argument_list|(
literal|"cannot submit merge commit to user branch"
argument_list|)
throw|;
block|}
name|ChangeData
...
name|format
argument_list|(
literal|"update of %s not allowed"
argument_list|,
name|AccountConfig
operator|.
name|ACCOUNT_CONFIG
