...
annotation|@
name|VisibleForTesting
DECL|method|isStale (GitRepositoryManager repoManager, Change.Id id, SetMultimap<Project.NameKey, RefState> states, Multimap<Project.NameKey, RefStatePattern> patterns)
specifier|static
name|boolean
name|isStale
parameter_list|(
...
return|;
block|}
DECL|method|isStale (GitRepositoryManager repoManager, Change.Id id, Project.NameKey project, SetMultimap<Project.NameKey, RefState> allStates, Multimap<Project.NameKey, RefStatePattern> allPatterns)
specifier|private
specifier|static
name|boolean
name|isStale
