...
annotation|@
name|Inject
DECL|method|IncludedGroupsCollection ( DynamicMap<RestView<IncludedGroupResource>> views, ListIncludedGroups list, GroupsCollection groupsCollection, Provider<ReviewDb> dbProvider, Groups groups, AddIncludedGroups put)
name|IncludedGroupsCollection
parameter_list|(
name|DynamicMap
argument_list|<
...
throw|;
block|}
DECL|method|isMember (GroupDescription.Internal parent, GroupDescription.Basic member)
specifier|private
name|boolean
name|isMember
parameter_list|(
