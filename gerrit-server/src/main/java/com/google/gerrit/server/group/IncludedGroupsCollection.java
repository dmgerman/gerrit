...
annotation|@
name|Inject
DECL|method|IncludedGroupsCollection (DynamicMap<RestView<IncludedGroupResource>> views, Provider<ListIncludedGroups> list, GroupCache groupCache, GroupControl.Factory groupControlFactory, Provider<ReviewDb> dbProvider)
name|IncludedGroupsCollection
parameter_list|(
name|DynamicMap
argument_list|<
