...
annotation|@
name|Inject
DECL|method|IncludedGroupsCollection (DynamicMap<RestView<IncludedGroupResource>> views, Provider<ListIncludedGroups> list, Provider<GroupsCollection> groupsCollection, Provider<ReviewDb> dbProvider)
name|IncludedGroupsCollection
parameter_list|(
name|DynamicMap
argument_list|<
