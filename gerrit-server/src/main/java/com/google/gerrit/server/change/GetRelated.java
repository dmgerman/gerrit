...
annotation|@
name|Inject
DECL|method|GetRelated (Provider<ReviewDb> db, @GerritServerConfig Config cfg, GetRelatedByAncestors byAncestors, Provider<InternalChangeQuery> queryProvider, PatchSetAncestorSorter sorter, IndexCollection indexes)
name|GetRelated
parameter_list|(
name|Provider
argument_list|<
