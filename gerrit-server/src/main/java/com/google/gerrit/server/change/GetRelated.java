...
annotation|@
name|Inject
DECL|method|GetRelated (GitRepositoryManager gitMgr, Provider<ReviewDb> db, Provider<InternalChangeQuery> queryProvider)
name|GetRelated
parameter_list|(
name|GitRepositoryManager
name|gitMgr
...
block|{
comment|// check if there is a merged or abandoned change for this commit
name|ReviewDb
name|db
init|=
name|dbProvider
