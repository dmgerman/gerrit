...
block|}
decl_stmt|;
DECL|field|TO_JAVA_QUALIFIED_CLASS_NAME
specifier|private
specifier|static
specifier|final
name|Function
...
name|String
argument_list|>
name|TO_JAVA_QUALIFIED_CLASS_NAME
init|=
operator|new
name|Function
argument_list|<
...
name|interfaces
decl_stmt|;
DECL|method|ExtensionMetaData (String className, String annotationValue, Iterable<String> interfaces)
specifier|private
name|ExtensionMetaData
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|getAnnotationValue ()
specifier|public
name|String
...
block|}
block|}
DECL|method|scan (File file, String pluginName, Class<? extends Annotation> annotation)
specifier|public
specifier|static
name|Iterable
argument_list|<
...
return|;
block|}
DECL|method|scan ( JarFile jarFile, String pluginName, Iterable<Class<? extends Annotation>> annotations)
specifier|public
specifier|static
name|Map
argument_list|<
