...
annotation|@
name|Inject
DECL|method|Revisions ( DynamicMap<RestView<RevisionResource>> views, Provider<ReviewDb> dbProvider, ChangeEditUtil editUtil, PatchSetUtil psUtil, ChangeControl.GenericFactory changeControlFactory)
name|Revisions
parameter_list|(
name|DynamicMap
argument_list|<
