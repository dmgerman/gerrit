...
annotation|@
name|Inject
DECL|method|PutDescription (ProjectCache cache, MetaDataUpdate.Server updateFactory, ChangeHooks hooks, GitReferenceUpdated gitRefUpdated, GitRepositoryManager gitMgr)
name|PutDescription
parameter_list|(
name|ProjectCache
name|cache
