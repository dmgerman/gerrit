...
name|Id
argument_list|>
name|approversThatVotedInCategory
init|=
operator|new
name|HashSet
argument_list|<
...
name|Id
argument_list|>
name|approversThatDidNotVoteInCategory
init|=
operator|new
name|HashSet
argument_list|<
...
return|;
block|}
DECL|method|match (final Change change, final int value, final Account.Id approver, final LabelType type)
specifier|private
name|boolean
name|match
parameter_list|(
