...
annotation|@
name|Inject
DECL|method|Check ( PermissionBackend permissionBackend, Provider<CurrentUser> user, ChangeJson.Factory json, ProjectControl.GenericFactory projectControlFactory)
name|Check
parameter_list|(
name|PermissionBackend
name|permissionBackend
