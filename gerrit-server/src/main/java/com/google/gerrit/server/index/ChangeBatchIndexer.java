...
annotation|@
name|Inject
DECL|method|ChangeBatchIndexer (SchemaFactory<ReviewDb> schemaFactory, ChangeData.Factory changeDataFactory, GitRepositoryManager repoManager, @IndexExecutor ListeningExecutorService executor, ChangeIndexer.Factory indexerFactory, MergeabilityChecker mergeabilityChecker)
name|ChangeBatchIndexer
parameter_list|(
name|SchemaFactory
argument_list|<
