...
decl_stmt|;
DECL|method|JarPlugin (String name, PluginUser pluginUser, File srcJar, FileSnapshot snapshot, JarFile jarFile, Manifest manifest, File dataDir, ApiType apiType, ClassLoader classLoader, @Nullable Class<? extends Module> sysModule, @Nullable Class<? extends Module> sshModule, @Nullable Class<? extends Module> httpModule)
specifier|public
name|JarPlugin
parameter_list|(
name|String
