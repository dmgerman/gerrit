...
annotation|@
name|Inject
DECL|method|MembersCollection (DynamicMap<RestView<MemberResource>> views, Provider<ListMembers> list, IdentifiedUser.GenericFactory userGenericFactory, AccountResolver accountResolver, Provider<ReviewDb> db, Provider<AddMembers> put)
name|MembersCollection
parameter_list|(
name|DynamicMap
argument_list|<
...
return|;
block|}
DECL|method|parse (Account account)
specifier|public
specifier|static
name|MemberInfo
name|parse
