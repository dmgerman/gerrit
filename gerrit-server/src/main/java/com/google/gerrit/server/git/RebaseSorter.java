...
name|repo
decl_stmt|;
DECL|method|RebaseSorter (CodeReviewRevWalk rw, RevCommit initialTip, Set<RevCommit> alreadyAccepted, RevFlag canMergeFlag, InternalChangeQuery internalChangeQuery, ChangeKindCache changeKindCache, Repository repo)
specifier|public
name|RebaseSorter
parameter_list|(
name|CodeReviewRevWalk
...
block|}
block|}
DECL|method|isRework (Project.NameKey project, RevCommit oldCommit, ChangeData change)
specifier|private
name|boolean
name|isRework
parameter_list|(
