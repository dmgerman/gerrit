...
expr_stmt|;
block|}
DECL|method|completeChangeSet (ReviewDb db, ChangeSet changes)
specifier|public
name|ChangeSet
...
argument_list|)
expr_stmt|;
comment|// A new empty branch doesn't have additional changes
continue|continue;
block|}
name|rw
operator|.
...
control|)
block|{
comment|// TODO(sbeller): Cache the change data here and in completeChangeSet
comment|// There is no need to reread it a few times.
name|ChangeData
name|cd
init|=
name|changeDataFactory
