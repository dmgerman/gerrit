...
annotation|@
name|Inject
DECL|method|PostWatchedProjects (Provider<ReviewDb> dbProvider, Provider<IdentifiedUser> self, GetWatchedProjects getWatchedProjects, ProjectsCollection projectsCollection, AccountCache accountCache)
specifier|public
name|PostWatchedProjects
parameter_list|(
name|Provider
