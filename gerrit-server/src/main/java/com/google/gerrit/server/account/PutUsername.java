...
annotation|@
name|Inject
DECL|method|PutUsername ( Provider<CurrentUser> self, ChangeUserName.Factory changeUserNameFactory, PermissionBackend permissionBackend, Realm realm, Provider<ReviewDb> db)
name|PutUsername
parameter_list|(
name|Provider
argument_list|<
