...
annotation|@
name|Inject
DECL|method|RebaseUtil (Provider<ReviewDb> db, GitRepositoryManager gitManager)
name|RebaseUtil
parameter_list|(
name|Provider
argument_list|<
...
block|}
block|}
DECL|method|canRebase (PatchSet patchSet, Branch.NameKey dest, Repository git, RevWalk rw, ReviewDb db)
specifier|public
specifier|static
name|boolean
name|canRebase
...
DECL|method|findBaseRevision (PatchSet patchSet, Branch.NameKey destBranch, Repository git, RevWalk rw, ReviewDb db)
specifier|static
name|ObjectId
name|findBaseRevision
parameter_list|(
