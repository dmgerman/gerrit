...
annotation|@
name|Inject
DECL|method|EventFactory (AccountCache accountCache, @CanonicalWebUrl @Nullable Provider<String> urlProvider, ApprovalTypes approvalTypes, PatchListCache patchListCache)
name|EventFactory
parameter_list|(
name|AccountCache
name|accountCache
