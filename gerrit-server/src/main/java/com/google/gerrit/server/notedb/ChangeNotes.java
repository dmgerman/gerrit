...
return|;
block|}
DECL|method|scanReviewDb (Repository repo, ReviewDb db)
specifier|private
name|Stream
argument_list|<
name|ChangeNotesResult
...
parameter_list|)
block|{
comment|// Return this error for each Id in the input batch.
return|return
name|batch
operator|.
name|stream
...
return|;
block|}
DECL|method|scanOneNoteDbChange ( ReviewDb db, Project.NameKey project, ScanResult sr, PrimaryStorage defaultStorage, Change.Id id)
specifier|private
name|ChangeNotesResult
name|scanOneNoteDbChange
parameter_list|(
...
return|;
block|}
comment|/** Result of {@link #scan(Repository, ReviewDb, Project.NameKey)}. */
annotation|@
name|AutoValue
