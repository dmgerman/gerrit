...
annotation|@
name|Inject
DECL|method|Factory (GitRepositoryManager repoManager, NotesMigration migration, AllUsersNameProvider allUsersProvider, Provider<InternalChangeQuery> queryProvider)
specifier|public
name|Factory
parameter_list|(
name|GitRepositoryManager
