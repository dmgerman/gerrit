...
name|Factory
block|{
DECL|method|create ( ProjectControl projectControl, ReceivePack receivePack, AllRefsWatcher allRefsWatcher)
name|ReceiveCommits
name|create
parameter_list|(
name|ProjectControl
...
name|cmd
argument_list|,
literal|"cannot be draft& merged"
argument_list|)
expr_stmt|;
return|return;
block|}
...
block|}
block|}
DECL|method|validCommit ( RevWalk rw, PermissionBackend.ForRef perm, RefControl ctl, ReceiveCommand cmd, ObjectId id)
specifier|private
name|boolean
name|validCommit
parameter_list|(
