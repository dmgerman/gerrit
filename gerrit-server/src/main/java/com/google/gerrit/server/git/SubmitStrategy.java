...
name|mergeSorter
decl_stmt|;
DECL|method|Arguments (final IdentifiedUser.GenericFactory identifiedUserFactory, final PersonIdent myIdent, final ReviewDb db, final ChangeNotes.Factory notesFactory, final ChangeUpdate.Factory updateFactory, final Repository repo, final RevWalk rw, final ObjectInserter inserter, final RevFlag canMergeFlag, final Set<RevCommit> alreadyAccepted, final Branch.NameKey destBranch, final ApprovalsUtil approvalsUtil, final MergeUtil mergeUtil, final ChangeIndexer indexer)
name|Arguments
parameter_list|(
specifier|final
name|IdentifiedUser
