...
annotation|@
name|Inject
DECL|method|ChangeQueryProcessor (Metrics metrics, IndexConfig indexConfig, ChangeIndexCollection indexes, ChangeIndexRewriter rewriter, Provider<ReviewDb> db, Provider<CurrentUser> userProvider, ChangeControl.GenericFactory changeControlFactory, ChangeNotes.Factory notesFactory)
name|ChangeQueryProcessor
parameter_list|(
name|Metrics
name|metrics
...
annotation|@
name|Override
DECL|method|postRewrite (Predicate<ChangeData> pred)
specifier|protected
name|Predicate
argument_list|<
name|ChangeData
