...
annotation|@
name|Inject
DECL|method|AbandonChange (final AbandonedSender.Factory abandonedSenderFactory, final ChangeControl.Factory changeControlFactory, final ReviewDb db, final IdentifiedUser currentUser, final ChangeHooks hooks)
name|AbandonChange
parameter_list|(
specifier|final
name|AbandonedSender
