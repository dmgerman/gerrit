...
annotation|@
name|Inject
DECL|method|AbandonChange (final AbandonedSender.Factory abandonedSenderFactory, final ChangeControl.Factory changeControlFactory, final ReviewDb db, final IdentifiedUser currentUser, final ChangeHooks hooks, @Assisted final Change.Id changeId, @Assisted @Nullable final String changeComment)
name|AbandonChange
parameter_list|(
specifier|final
name|AbandonedSender
