...
annotation|@
name|Inject
DECL|method|ListChildProjects ( ProjectCache projectCache, PermissionBackend permissionBackend, Provider<CurrentUser> user, AllProjectsName allProjectsName, ProjectJson json)
name|ListChildProjects
parameter_list|(
name|ProjectCache
name|projectCache
...
return|;
block|}
DECL|method|recursiveChildProjects (Project.NameKey parent)
specifier|private
name|List
argument_list|<
name|ProjectInfo
