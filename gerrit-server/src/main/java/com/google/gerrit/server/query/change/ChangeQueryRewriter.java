...
name|Rewrite
argument_list|(
literal|"status:open P=(project:*) B=(branch:*) S=(sortkey_after:*) L=(limit:*)"
argument_list|)
DECL|method|r05_byBranchOpenPrev ( @amedR) final ProjectPredicate p, @Named(R) final BranchPredicate b, @Named(R) final SortKeyPredicate.After s, @Named(R) final IntPredicate<ChangeData> l)
specifier|public
name|Predicate
argument_list|<
name|ChangeData
argument_list|>
name|r05_byBranchOpenPrev
parameter_list|(
annotation|@
name|Named
argument_list|(
...
name|Rewrite
argument_list|(
literal|"status:open P=(project:*) B=(branch:*) S=(sortkey_before:*) L=(limit:*)"
argument_list|)
DECL|method|r05_byBranchOpenNext ( @amedR) final ProjectPredicate p, @Named(R) final BranchPredicate b, @Named(R) final SortKeyPredicate.Before s, @Named(R) final IntPredicate<ChangeData> l)
specifier|public
name|Predicate
argument_list|<
name|ChangeData
argument_list|>
name|r05_byBranchOpenNext
parameter_list|(
annotation|@
name|Named
argument_list|(
