...
annotation|@
name|Inject
DECL|method|GetAgreements (Provider<IdentifiedUser> self, ProjectCache projectCache, IdentifiedUser.GenericFactory identifiedUserFactory, @GerritServerConfig Config config)
name|GetAgreements
parameter_list|(
name|Provider
argument_list|<
