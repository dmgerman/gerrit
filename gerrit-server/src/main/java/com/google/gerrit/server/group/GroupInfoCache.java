...
block|}
block|}
comment|/**    * Lookup the group summary    *<p>    * The return value can take on one of three forms:    *<ul>    *<li>{@code null}, if {@code id == null}.</li>    *<li>a valid info block, if {@code id} was loaded.</li>    *<li>an anonymous info block, if {@code id} was not loaded.</li>    *</ul>    *    * @param uuid the id desired.    * @return info block for the group.    */
