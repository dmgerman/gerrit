...
annotation|@
name|Inject
DECL|method|SetEditPreferences ( Provider<CurrentUser> self, Provider<MetaDataUpdate.User> metaDataUpdateFactory, GitRepositoryManager gitMgr, AllUsersName allUsersName)
name|SetEditPreferences
parameter_list|(
name|Provider
argument_list|<
