...
annotation|@
name|Inject
DECL|method|CreateProject (PerformCreateProject.Factory performCreateProjectFactory, Provider<ProjectsCollection> projectsCollection, Provider<GroupsCollection> groupsCollection, ProjectJson json, ProjectControl.GenericFactory projectControlFactory, Provider<CurrentUser> currentUser, Provider<PutConfig> putConfig, @Assisted String name)
name|CreateProject
parameter_list|(
name|PerformCreateProject
operator|.
