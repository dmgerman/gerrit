...
block|}
block|}
DECL|method|migrateLabelsToAllProjects (ReviewDb db, LabelTypes labelTypes)
specifier|private
name|void
name|migrateLabelsToAllProjects
parameter_list|(
...
control|)
block|{
comment|// Don't include IDs for this migration, since we are also updating all
comment|// existing PatchSetApprovals.
name|type
operator|.
name|setId
argument_list|(
...
block|}
block|}
DECL|method|migratePatchSetApprovals (ReviewDb db, LabelTypes labelTypes)
specifier|private
name|void
name|migratePatchSetApprovals
parameter_list|(
