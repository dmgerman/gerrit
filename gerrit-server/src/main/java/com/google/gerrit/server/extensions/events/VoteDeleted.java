...
annotation|@
name|Inject
DECL|method|VoteDeleted (DynamicSet<VoteDeletedListener> listeners, EventUtil util)
name|VoteDeleted
parameter_list|(
name|DynamicSet
argument_list|<
...
expr_stmt|;
block|}
DECL|method|fire (ChangeInfo change, RevisionInfo revision, Map<String, ApprovalInfo> approvals, Map<String, ApprovalInfo> oldApprovals, NotifyHandling notify, String message, AccountInfo remover, Timestamp when)
specifier|public
name|void
name|fire
parameter_list|(
