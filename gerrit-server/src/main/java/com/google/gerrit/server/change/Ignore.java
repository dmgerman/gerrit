...
annotation|@
name|Inject
DECL|method|Ignore (StarredChangesUtil stars)
name|Ignore
parameter_list|(
name|StarredChangesUtil
name|stars
...
try|try
block|{
comment|// Don't try to ignore own changes or already ignored changes
if|if
condition|(
name|canIgnore
argument_list|(
...
block|}
block|}
DECL|method|canIgnore (ChangeResource rsrc)
specifier|private
name|boolean
name|canIgnore
parameter_list|(
