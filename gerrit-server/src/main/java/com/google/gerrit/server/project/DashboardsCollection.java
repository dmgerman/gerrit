...
annotation|@
name|Inject
DECL|method|DashboardsCollection ( GitRepositoryManager gitManager, DynamicMap<RestView<DashboardResource>> views, Provider<ListDashboards> list, Provider<SetDefaultDashboard.CreateDefault> createDefault, PermissionBackend permissionBackend)
name|DashboardsCollection
parameter_list|(
name|GitRepositoryManager
name|gitManager
...
return|;
block|}
DECL|method|parse (ProjectControl ctl, DashboardInfo info, ProjectControl myCtl)
specifier|private
name|DashboardResource
name|parse
parameter_list|(
