...
annotation|@
name|Inject
DECL|method|ChangeJson ( Provider<ReviewDb> db, LabelNormalizer ln, Provider<CurrentUser> user, AnonymousUser au, IdentifiedUser.GenericFactory uf, ProjectControl.GenericFactory pcf, PatchSetInfoFactory psi, FileInfoJson fileInfoJson, AccountInfo.Loader.Factory ailf, DynamicMap<DownloadScheme> downloadSchemes, DynamicMap<DownloadCommand> downloadCommands, DynamicMap<RestView<ChangeResource>> changes, Revisions revisions)
name|ChangeJson
parameter_list|(
name|Provider
argument_list|<
...
expr_stmt|;
block|}
DECL|method|addCommand (String name, String command)
name|void
name|addCommand
parameter_list|(
name|String
