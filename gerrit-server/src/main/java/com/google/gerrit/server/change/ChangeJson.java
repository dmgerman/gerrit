...
condition|)
block|{
comment|// Use saved labels to avoid recomputing on the fly.
return|return
name|labelsFromSavedState
argument_list|(
name|cd
operator|.
name|getSubmitRecordLabels
...
block|}
block|}
DECL|method|labelsFromSavedState ( List<SubmitRecord.Label> savedLabels)
specifier|private
name|Map
argument_list|<
name|String
...
return|;
block|}
DECL|method|newLabelFromSubmitRecord (SubmitRecord.Label r, boolean standard)
specifier|private
name|LabelInfo
name|newLabelFromSubmitRecord
parameter_list|(
