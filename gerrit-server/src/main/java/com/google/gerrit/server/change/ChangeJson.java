...
annotation|@
name|Inject
DECL|method|ChangeJson ( Provider<ReviewDb> db, ApprovalTypes at, CurrentUser u, AnonymousUser au, ChangeControl.GenericFactory gf, PatchSetInfoFactory psi, PatchListCache plc, AccountInfo.Loader.Factory ailf, @CanonicalWebUrl Provider<String> curl, Urls urls)
name|ChangeJson
parameter_list|(
name|Provider
argument_list|<
...
return|;
block|}
DECL|method|initLabels (ChangeData cd, Map<String, LabelInfo> labels, boolean standard)
specifier|private
name|void
name|initLabels
parameter_list|(
...
block|}
block|}
DECL|method|setRecommendedAndDisliked (ChangeData cd, Collection<PatchSetApproval> approvals, ApprovalType type, LabelInfo label)
specifier|private
name|Collection
argument_list|<
name|PatchSetApproval
...
return|;
block|}
DECL|method|setAllApprovals (Map<String, LabelInfo> labels, Collection<PatchSetApproval> approvals)
specifier|private
name|void
name|setAllApprovals
parameter_list|(
...
return|;
block|}
DECL|method|removableReviewers (ChangeData cd)
specifier|private
name|Collection
argument_list|<
name|AccountInfo
