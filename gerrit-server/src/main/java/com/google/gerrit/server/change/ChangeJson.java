...
annotation|@
name|Inject
DECL|method|ChangeJson ( Provider<ReviewDb> db, ApprovalTypes at, CurrentUser u, AnonymousUser au, ChangeControl.GenericFactory gf, PatchSetInfoFactory psi, PatchListCache plc, @CanonicalWebUrl Provider<String> curl, Urls urls)
name|ChangeJson
parameter_list|(
name|Provider
argument_list|<
