...
annotation|@
name|Inject
DECL|method|DeleteChange ( Provider<ReviewDb> db, BatchUpdate.Factory updateFactory, Provider<DeleteChangeOp> opProvider, Provider<CurrentUser> user, PermissionBackend permissionBackend, @GerritServerConfig Config cfg)
specifier|public
name|DeleteChange
parameter_list|(
name|Provider
