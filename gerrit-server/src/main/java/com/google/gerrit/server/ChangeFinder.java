...
annotation|@
name|Inject
DECL|method|ChangeFinder ( IndexConfig indexConfig, @Named(CACHE_NAME) Cache<Change.Id, String> changeIdProjectCache, Provider<InternalChangeQuery> queryProvider, Provider<ReviewDb> reviewDb, ChangeControl.GenericFactory changeControlFactory)
name|ChangeFinder
parameter_list|(
name|IndexConfig
name|indexConfig
...
return|;
block|}
DECL|method|fromProjectNumber (CurrentUser user, String project, int changeNumber)
specifier|private
name|List
argument_list|<
name|ChangeControl
...
name|format
argument_list|(
literal|"passed project %s when creating ChangeNotes for %s, but actual project is"
argument_list|,
name|project
argument_list|,
name|cId
...
return|;
block|}
DECL|method|checkedAdd (ChangeData cd, List<ChangeControl> ctls, CurrentUser user)
specifier|private
specifier|static
name|void
name|checkedAdd
