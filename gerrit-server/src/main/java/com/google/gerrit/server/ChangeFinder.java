...
annotation|@
name|Inject
DECL|method|ChangeFinder ( IndexConfig indexConfig, Provider<InternalChangeQuery> queryProvider, Provider<ReviewDb> reviewDb, ChangeControl.GenericFactory changeControlFactory)
name|ChangeFinder
parameter_list|(
name|IndexConfig
name|indexConfig
