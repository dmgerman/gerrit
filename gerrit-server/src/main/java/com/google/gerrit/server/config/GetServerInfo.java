...
annotation|@
name|Inject
DECL|method|GetServerInfo ( @erritServerConfig Config config, AuthConfig authConfig, Realm realm, DynamicMap<DownloadScheme> downloadSchemes, DynamicMap<DownloadCommand> downloadCommands, GetArchive.AllowedFormats archiveFormats, AllProjectsName allProjectsName, AllUsersName allUsersName)
specifier|public
name|GetServerInfo
parameter_list|(
annotation|@
...
name|archives
decl_stmt|;
DECL|method|DownloadInfo (DynamicMap<DownloadScheme> downloadSchemes, DynamicMap<DownloadCommand> downloadCommands, GetArchive.AllowedFormats archiveFormats)
specifier|public
name|DownloadInfo
parameter_list|(
name|DynamicMap
