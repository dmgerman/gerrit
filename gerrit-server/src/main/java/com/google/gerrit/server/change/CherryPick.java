...
annotation|@
name|Inject
DECL|method|CherryPick ( PermissionBackend permissionBackend, Provider<CurrentUser> user, RetryHelper retryHelper, CherryPickChange cherryPickChange, ChangeJson.Factory json, ProjectControl.GenericFactory projectControlFactory)
name|CherryPick
parameter_list|(
name|PermissionBackend
name|permissionBackend
