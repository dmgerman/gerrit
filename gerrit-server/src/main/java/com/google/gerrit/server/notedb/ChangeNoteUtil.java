...
annotation|@
name|Inject
DECL|method|ChangeNoteUtil (AccountCache accountCache, @GerritPersonIdent PersonIdent serverIdent, @AnonymousCowardName String anonymousCowardName, @GerritServerId String serverId)
specifier|public
name|ChangeNoteUtil
parameter_list|(
name|AccountCache
...
return|;
block|}
comment|/**    * Build a note that contains the metadata for and the contents of all of the    * comments in the given list of comments.    *    * @param comments A list of the comments to be written to the    *            output stream. All of the comments in this list must have the    *            same side and must share the same patch set ID.    * @param out output stream to write to.    */
DECL|method|buildNote (List<PatchLineComment> comments, OutputStream out)
name|void
name|buildNote
parameter_list|(
name|List
