...
annotation|@
name|Inject
DECL|method|DeleteAssignee ( RetryHelper retryHelper, ChangeMessagesUtil cmUtil, Provider<ReviewDb> db, AssigneeChanged assigneeChanged, IdentifiedUser.GenericFactory userFactory, AccountLoader.Factory accountLoaderFactory)
name|DeleteAssignee
parameter_list|(
name|RetryHelper
name|retryHelper
