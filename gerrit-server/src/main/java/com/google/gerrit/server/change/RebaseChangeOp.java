...
name|Factory
block|{
DECL|method|create (ChangeControl ctl, PatchSet originalPatchSet, ObjectId baseCommitId)
name|RebaseChangeOp
name|create
parameter_list|(
name|ChangeControl
...
annotation|@
name|Inject
DECL|method|RebaseChangeOp ( PatchSetInserter.Factory patchSetInserterFactory, MergeUtil.Factory mergeUtilFactory, RebaseUtil rebaseUtil, ChangeResource.Factory changeResourceFactory, @Assisted ChangeControl ctl, @Assisted PatchSet originalPatchSet, @Assisted ObjectId baseCommitId)
name|RebaseChangeOp
parameter_list|(
name|PatchSetInserter
operator|.
