...
annotation|@
name|Inject
DECL|method|Restore (ChangeHooks hooks, RestoredSender.Factory restoredSenderFactory, Provider<ReviewDb> dbProvider, ChangeJson json)
name|Restore
parameter_list|(
name|ChangeHooks
name|hooks
...
throw|;
block|}
comment|// Create a message to accompany the restore change
name|ReviewDb
name|db
init|=
name|dbProvider
