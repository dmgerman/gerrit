...
name|filterGroups
argument_list|(
name|getAllExistingInternalGroups
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
return|;
block|}
DECL|method|getAllExistingInternalGroups ()
specifier|private
name|ImmutableList
argument_list|<
name|GroupDescription
...
block|}
block|}
DECL|method|filterGroups ( Collection<GroupDescription.Internal> groups)
specifier|private
name|List
argument_list|<
name|GroupDescription
