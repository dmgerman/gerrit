...
annotation|@
name|Inject
DECL|method|ListGroups (final GroupCache groupCache, final GroupControl.Factory groupControlFactory, final Provider<IdentifiedUser> identifiedUser, final IdentifiedUser.GenericFactory userFactory, final Provider<GetGroups> accountGetGroups)
specifier|protected
name|ListGroups
parameter_list|(
specifier|final
