...
annotation|@
name|Inject
DECL|method|SchemaCreator (SitePaths site, @Current SchemaVersion version, GitRepositoryManager mgr, AllProjectsName allProjectsName, @GerritPersonIdent PersonIdent au)
specifier|public
name|SchemaCreator
parameter_list|(
name|SitePaths
...
expr_stmt|;
block|}
DECL|method|SchemaCreator (@itePath File site, @Current SchemaVersion version, GitRepositoryManager gitMgr, AllProjectsName ap, @GerritPersonIdent PersonIdent au)
specifier|public
name|SchemaCreator
parameter_list|(
annotation|@
