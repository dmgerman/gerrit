...
return|;
block|}
DECL|method|format (ReviewerInfo out, PermissionBackend.ForChange perm, ChangeControl ctl)
specifier|public
name|ReviewerInfo
name|format
parameter_list|(
...
return|;
block|}
DECL|method|format ( ReviewerInfo out, PermissionBackend.ForChange perm, ChangeControl ctl, Iterable<PatchSetApproval> approvals)
specifier|public
name|ReviewerInfo
name|format
parameter_list|(
