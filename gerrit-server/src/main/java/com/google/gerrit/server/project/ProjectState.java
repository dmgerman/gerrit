...
annotation|@
name|Inject
DECL|method|ProjectState (final AnonymousUser anonymousUser, final ProjectCache projectCache, @WildProjectName final Project.NameKey wildProject, final ProjectControl.AssistedFactory projectControlFactory, @Assisted final ProjectConfig config)
specifier|protected
name|ProjectState
parameter_list|(
specifier|final
