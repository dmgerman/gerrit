...
try|try
block|{
comment|// Response should never be 'none' for a generated password, but
comment|// let's make sure.
name|Response
argument_list|<
name|String
argument_list|>
...
name|asRestApiException
argument_list|(
literal|"Cannot generate HTTP password"
argument_list|,
name|e
argument_list|)
throw|;
...
annotation|@
name|Override
DECL|method|setHttpPassword (String password)
specifier|public
name|String
