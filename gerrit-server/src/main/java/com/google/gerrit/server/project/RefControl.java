...
return|;
block|}
DECL|method|getAllRights (ApprovalCategory.Id actionId)
specifier|private
name|List
argument_list|<
name|RefRight
...
return|;
block|}
comment|/**    * Resolves all refRights which assign privileges to the 'Project Owners'    * group. All other refRights stay unchanged.    *    * @param refRights refRights to be resolved    * @return the resolved refRights    */
DECL|method|resolveOwnerGroups (final List<RefRight> refRights)
specifier|private
name|List
argument_list|<
name|RefRight
...
return|;
block|}
comment|/**    * Checks if the given refRight assigns privileges to the 'Project Owners'    * group.    * If yes, resolves the 'Project Owners' group to the concrete groups that    * own the project and creates new refRights for the concrete owner groups    * which are returned.    * If no, the given refRight is returned unchanged.    *    * @param refRight refRight    * @return the resolved refRights    */
DECL|method|resolveOwnerGroups (final RefRight refRight)
specifier|private
name|Set
argument_list|<
name|RefRight
