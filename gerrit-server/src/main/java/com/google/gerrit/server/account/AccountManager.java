...
annotation|@
name|Inject
DECL|method|AccountManager (SchemaFactory<ReviewDb> schema, AccountCache byIdCache, AccountByEmailCache byEmailCache, Realm accountMapper, IdentifiedUser.GenericFactory userFactory, ChangeUserName.Factory changeUserNameFactory, ProjectCache projectCache, AuditService auditService, AccountIndexCollection accountIndexes, Provider<InternalAccountQuery> accountQueryProvider)
name|AccountManager
parameter_list|(
name|SchemaFactory
argument_list|<
...
block|}
block|}
DECL|method|getAccountExternalId (ReviewDb db, AccountExternalId.Key key)
specifier|private
name|AccountExternalId
name|getAccountExternalId
parameter_list|(
...
return|;
block|}
comment|// We don't have at the moment an account_by_external_id cache
comment|// but by using the accounts cache we get the list of external_ids
comment|// without having to query the DB every time
if|if
condition|(
name|key
operator|.
