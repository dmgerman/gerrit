...
annotation|@
name|Inject
DECL|method|ProjectCacheImpl ( @amedCACHE_NAME) final Cache<Project.NameKey, ProjectState> byName)
name|ProjectCacheImpl
parameter_list|(
annotation|@
name|Named
...
annotation|@
name|Inject
DECL|method|Loader (ProjectState.Factory psf, SchemaFactory<ReviewDb> sf)
name|Loader
parameter_list|(
name|ProjectState
operator|.
