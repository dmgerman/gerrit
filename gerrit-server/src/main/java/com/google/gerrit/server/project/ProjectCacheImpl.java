...
annotation|@
name|Inject
DECL|method|ProjectCacheImpl ( final AllProjectsName allProjectsName, @Named(CACHE_NAME) final Cache<Project.NameKey, ProjectState> byName, @Named(CACHE_LIST) final Cache<ListKey, SortedSet<Project.NameKey>> list, ProjectCacheClock clock)
name|ProjectCacheImpl
parameter_list|(
specifier|final
name|AllProjectsName
