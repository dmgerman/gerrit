...
name|showMetadata
decl_stmt|;
DECL|method|VisibleRefFilter (TagCache tagCache, ChangeCache changeCache, Repository db, ProjectControl projectControl, ReviewDb reviewDb, boolean showMetadata)
specifier|public
name|VisibleRefFilter
parameter_list|(
name|TagCache
