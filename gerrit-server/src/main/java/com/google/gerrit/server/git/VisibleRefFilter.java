...
annotation|@
name|Inject
DECL|method|VisibleRefFilter ( TagCache tagCache, ChangeNotes.Factory changeNotesFactory, @Nullable SearchingChangeCacheImpl changeCache, Provider<ReviewDb> db, Provider<CurrentUser> user, @Assisted ProjectState projectState, @Assisted Repository git)
name|VisibleRefFilter
parameter_list|(
name|TagCache
name|tagCache
