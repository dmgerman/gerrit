...
annotation|@
name|Inject
DECL|method|PutTopic (Provider<ReviewDb> dbProvider, ChangeHooks hooks, ChangeMessagesUtil cmUtil, BatchUpdate.Factory batchUpdateFactory, TopicEdited topicEdited)
name|PutTopic
parameter_list|(
name|Provider
argument_list|<
