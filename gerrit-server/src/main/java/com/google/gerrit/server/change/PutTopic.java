...
annotation|@
name|Inject
DECL|method|PutTopic (Provider<ReviewDb> dbProvider, ChangeIndexer indexer, ChangeHooks hooks, ChangeUpdate.Factory updateFactory, ChangeMessagesUtil cmUtil)
name|PutTopic
parameter_list|(
name|Provider
argument_list|<
