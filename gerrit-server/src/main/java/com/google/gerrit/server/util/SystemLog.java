...
return|;
block|}
DECL|method|createAppender (Path logdir, String name, Layout layout, boolean rotate)
specifier|public
specifier|static
name|Appender
name|createAppender
...
return|;
block|}
DECL|method|createAsyncAppender ( String name, Layout layout, boolean forPlugin, boolean rotate)
specifier|private
name|AsyncAppender
name|createAsyncAppender
parameter_list|(
