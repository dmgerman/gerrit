...
name|changeEditResource
init|=
name|getOrCreateChangeEditResource
argument_list|(
name|filePath
argument_list|)
decl_stmt|;
...
block|}
block|}
DECL|method|getOrCreateChangeEditResource (String filePath)
specifier|private
name|ChangeEditResource
name|getOrCreateChangeEditResource
parameter_list|(
...
name|IOException
block|{
comment|// For some cases, the REST API automatically creates a change edit resource
comment|// if it doesn't exist. We mimic this behavior here.
try|try
block|{
return|return
name|getChangeEditResource
