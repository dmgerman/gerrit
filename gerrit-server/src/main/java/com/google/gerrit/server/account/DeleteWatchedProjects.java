...
annotation|@
name|Inject
DECL|method|DeleteWatchedProjects (Provider<ReviewDb> dbProvider, Provider<IdentifiedUser> self, AccountCache accountCache, WatchConfig.Accessor watchConfig)
name|DeleteWatchedProjects
parameter_list|(
name|Provider
argument_list|<
...
return|;
block|}
DECL|method|deleteFromDb (Account.Id accountId, List<ProjectWatchInfo> input)
specifier|private
name|void
name|deleteFromDb
parameter_list|(
...
block|}
block|}
DECL|method|deleteFromGit (Account.Id accountId, List<ProjectWatchInfo> input)
specifier|private
name|void
name|deleteFromGit
parameter_list|(
