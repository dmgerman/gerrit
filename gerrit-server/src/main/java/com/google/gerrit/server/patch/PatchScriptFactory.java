...
annotation|@
name|AssistedInject
DECL|method|PatchScriptFactory ( GitRepositoryManager grm, PatchSetUtil psUtil, Provider<PatchScriptBuilder> builderFactory, PatchListCache patchListCache, ReviewDb db, CommentsUtil commentsUtil, ChangeEditUtil editReader, Provider<CurrentUser> userProvider, ChangeControl.GenericFactory changeControlFactory, @Assisted ChangeNotes notes, @Assisted String fileName, @Assisted(R) @Nullable PatchSet.Id patchSetA, @Assisted(R) PatchSet.Id patchSetB, @Assisted DiffPreferencesInfo diffPrefs)
name|PatchScriptFactory
parameter_list|(
name|GitRepositoryManager
name|grm
...
annotation|@
name|AssistedInject
DECL|method|PatchScriptFactory ( GitRepositoryManager grm, PatchSetUtil psUtil, Provider<PatchScriptBuilder> builderFactory, PatchListCache patchListCache, ReviewDb db, CommentsUtil commentsUtil, ChangeEditUtil editReader, Provider<CurrentUser> userProvider, ChangeControl.GenericFactory changeControlFactory, @Assisted ChangeNotes notes, @Assisted String fileName, @Assisted int parentNum, @Assisted PatchSet.Id patchSetB, @Assisted DiffPreferencesInfo diffPrefs)
name|PatchScriptFactory
parameter_list|(
name|GitRepositoryManager
name|grm
...
block|}
block|}
DECL|method|loadCommentsAndHistory ( ChangeControl ctl, ChangeType changeType, String oldName, String newName)
specifier|private
name|void
name|loadCommentsAndHistory
parameter_list|(
