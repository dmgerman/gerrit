...
annotation|@
name|Inject
DECL|method|Reviewers (Provider<ReviewDb> dbProvider, AccountResolver resolver, ReviewerResource.Factory resourceFactory, DynamicMap<RestView<ReviewerResource>> views, AccountCache accountCache, Provider<ListReviewers> list)
name|Reviewers
parameter_list|(
name|Provider
argument_list|<
