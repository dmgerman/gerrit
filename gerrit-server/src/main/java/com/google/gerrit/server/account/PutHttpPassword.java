...
annotation|@
name|Inject
DECL|method|PutHttpPassword ( Provider<CurrentUser> self, PermissionBackend permissionBackend, ExternalIds externalIds, ExternalIdsUpdate.User externalIdsUpdate, HttpPasswordUpdateSender.Factory httpPasswordUpdateSenderFactory)
name|PutHttpPassword
parameter_list|(
name|Provider
argument_list|<
...
return|;
block|}
comment|// Used by the serviceuser plugin
...
name|error
argument_list|(
literal|"Cannot send HttpPassword update message to {}"
argument_list|,
name|user
operator|.
name|getAccount
