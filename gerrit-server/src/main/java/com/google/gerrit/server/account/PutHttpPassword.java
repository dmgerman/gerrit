...
annotation|@
name|Inject
DECL|method|PutHttpPassword ( Provider<CurrentUser> self, Provider<ReviewDb> dbProvider, AccountCache accountCache, ExternalIds externalIds, ExternalIdsUpdate.User externalIdsUpdate)
name|PutHttpPassword
parameter_list|(
name|Provider
argument_list|<
