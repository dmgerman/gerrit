...
argument_list|)
decl_stmt|;
comment|// Allow created timestamp in NoteDb to be any of:
comment|//  - The created timestamp of the change.
comment|//  - The timestamp of the first remaining patch set.
comment|//  - The last updated timestamp, if it is less than the created timestamp.
comment|//
...
decl_stmt|;
name|boolean
name|createdOnMatchesLastUpdatedOn
init|=
operator|!
name|timestampsDiffer
argument_list|(
...
comment|//
comment|// Allow the timestamp of the first patch set to match the creation time of
comment|// the change.
name|boolean
name|excludeAllCreatedOn
init|=
literal|false
decl_stmt|;
if|if
