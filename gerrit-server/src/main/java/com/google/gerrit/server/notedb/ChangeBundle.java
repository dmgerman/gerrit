...
return|;
block|}
DECL|method|limitToValidPatchSets (Map<K, V> in, final Function<K, PatchSet.Id> func)
specifier|private
parameter_list|<
name|K
parameter_list|,
...
annotation|@
name|AutoValue
DECL|class|ReviewerKey
specifier|static
specifier|abstract
class|class
name|ReviewerKey
block|{
DECL|method|toMap (ReviewerSet reviewers)
specifier|private
specifier|static
name|Map
argument_list|<
...
argument_list|(
operator|new
name|AutoValue_ChangeBundle_ReviewerKey
argument_list|(
name|c
operator|.
name|getRowKey
