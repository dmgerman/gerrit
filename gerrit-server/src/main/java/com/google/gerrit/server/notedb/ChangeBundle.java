...
block|{
comment|// At least one is from NoteDb, so we need to normalize UUIDs and
comment|// timestamps for both.
name|Multiset
argument_list|<
name|NormalizedChangeMessage
argument_list|>
name|as
init|=
name|bundleA
operator|.
name|normalizeChangeMessages
argument_list|()
decl_stmt|;
name|Multiset
argument_list|<
...
return|;
block|}
DECL|method|diffColumns (List<String> diffs, Class<T> clazz, String desc, T a, T b)
specifier|private
specifier|static
parameter_list|<
name|T
...
annotation|@
name|AutoValue
DECL|class|NormalizedChangeMessage
specifier|static
specifier|abstract
class|class
name|NormalizedChangeMessage
...
return|return
operator|new
name|AutoValue_ChangeBundle_NormalizedChangeMessage
argument_list|(
name|msg
operator|.
name|getKey
...
annotation|@
name|Override
DECL|method|compareTo (NormalizedChangeMessage o)
specifier|public
name|int
name|compareTo
parameter_list|(
...
block|}
block|}
DECL|method|normalizeChangeMessages ()
specifier|private
name|Multiset
argument_list|<
name|NormalizedChangeMessage
