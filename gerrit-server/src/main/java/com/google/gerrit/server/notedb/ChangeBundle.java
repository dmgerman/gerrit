...
return|;
block|}
DECL|method|limitToExistingPatchSets (Map<K, V> in, final Function<K, PatchSet.Id> func)
specifier|private
parameter_list|<
name|K
parameter_list|,
...
name|patchSets
decl_stmt|;
comment|// Filter out patch sets from ReviewDb side that are greater than latest.
if|if
condition|(
name|bundleA
operator|.
