...
name|theme
decl_stmt|;
DECL|method|ConfigInfo (ProjectControl control, TransferConfig config, DynamicMap<ProjectConfigEntry> pluginConfigEntries, PluginConfigFactory cfgFactory, DynamicMap<RestView<ProjectResource>> views)
specifier|public
name|ConfigInfo
parameter_list|(
name|ProjectControl
...
expr_stmt|;
block|}
DECL|method|getPluginConfig ( ProjectState project, DynamicMap<ProjectConfigEntry> pluginConfigEntries, PluginConfigFactory cfgFactory)
specifier|private
name|Map
argument_list|<
name|String
