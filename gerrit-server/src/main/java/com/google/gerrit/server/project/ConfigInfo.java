...
name|theme
decl_stmt|;
DECL|method|ConfigInfo (ProjectControl control, ProjectState projectState, TransferConfig config, DynamicMap<RestView<ProjectResource>> views, Provider<CurrentUser> currentUser)
specifier|public
name|ConfigInfo
parameter_list|(
name|ProjectControl
