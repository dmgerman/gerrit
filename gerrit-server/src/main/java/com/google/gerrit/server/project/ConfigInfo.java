...
name|theme
decl_stmt|;
DECL|method|ConfigInfo (Config gerritConfig, ProjectControl control, TransferConfig config, DynamicMap<ProjectConfigEntry> pluginConfigEntries, PluginConfigFactory cfgFactory, AllProjectsNameProvider allProjects, DynamicMap<RestView<ProjectResource>> views)
specifier|public
name|ConfigInfo
parameter_list|(
name|Config
