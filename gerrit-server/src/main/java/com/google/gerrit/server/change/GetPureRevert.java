...
annotation|@
name|Inject
DECL|method|GetPureRevert ( MergeUtil.Factory mergeUtilFactory, GitRepositoryManager repoManager, ProjectCache projectCache, ChangeNotes.Factory notesFactory, Provider<ReviewDb> dbProvider, PatchSetUtil psUtil, ChangeControl.GenericFactory changeControlFactory)
name|GetPureRevert
parameter_list|(
name|MergeUtil
operator|.
...
return|;
block|}
DECL|method|getPureRevert (ChangeNotes notes)
specifier|public
name|PureRevertInfo
name|getPureRevert
parameter_list|(
