...
annotation|@
name|Inject
DECL|method|GetPureRevert ( MergeUtil.Factory mergeUtilFactory, GitRepositoryManager repoManager, ProjectCache projectCache, ChangeNotes.Factory notesFactory, Provider<ReviewDb> dbProvider, PatchSetUtil psUtil)
name|GetPureRevert
parameter_list|(
name|MergeUtil
operator|.
