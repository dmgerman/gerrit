...
annotation|@
name|Inject
DECL|method|DeleteDraftChange (Provider<ReviewDb> db, BatchUpdate.Factory updateFactory, Provider<DeleteDraftChangeOp> opProvider, @GerritServerConfig Config cfg)
specifier|public
name|DeleteDraftChange
parameter_list|(
name|Provider
