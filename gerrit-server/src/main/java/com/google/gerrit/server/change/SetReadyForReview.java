...
annotation|@
name|Inject
DECL|method|SetReadyForReview ( RetryHelper retryHelper, WorkInProgressOp.Factory opFactory, Provider<ReviewDb> db, Provider<CurrentUser> self, PermissionBackend permissionBackend, ProjectControl.GenericFactory projectControlFactory)
name|SetReadyForReview
parameter_list|(
name|RetryHelper
name|retryHelper
...
name|error
argument_list|(
literal|"Cannot retrieve project owner ACL"
argument_list|,
name|e
argument_list|)
expr_stmt|;
