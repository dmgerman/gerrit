...
annotation|@
name|Inject
DECL|method|SetReadyForReview ( RetryHelper retryHelper, WorkInProgressOp.Factory opFactory, Provider<ReviewDb> db, Provider<CurrentUser> self, PermissionBackend permissionBackend)
name|SetReadyForReview
parameter_list|(
name|RetryHelper
name|retryHelper
