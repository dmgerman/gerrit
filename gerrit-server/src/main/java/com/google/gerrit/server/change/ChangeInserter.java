...
name|Factory
block|{
DECL|method|create (Repository git, RevWalk revWalk, ProjectControl ctl, Change c, RevCommit rc)
name|ChangeInserter
name|create
parameter_list|(
name|Repository
...
name|validated
decl_stmt|;
comment|// TODO(dborowitz): Remove; see validate().
annotation|@
name|Inject
...
expr_stmt|;
block|}
DECL|method|checkUser (ProjectControl ctl)
specifier|private
specifier|static
name|IdentifiedUser
name|checkUser
...
return|;
block|}
comment|// TODO(dborowitz): This is only public because callers expect validation to
comment|// happen before updating any refs, and they are still updating refs manually.
comment|// Make private once we have migrated ref updates into this class.
