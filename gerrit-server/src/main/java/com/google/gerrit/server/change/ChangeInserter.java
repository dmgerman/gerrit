...
annotation|@
name|Inject
DECL|method|ChangeInserter (PatchSetInfoFactory patchSetInfoFactory, ChangeHooks hooks, ApprovalsUtil approvalsUtil, ChangeMessagesUtil cmUtil, CreateChangeSender.Factory createChangeSenderFactory, HashtagsUtil hashtagsUtil, AccountCache accountCache, WorkQueue workQueue, CommitValidators.Factory commitValidatorsFactory, @Assisted RefControl refControl, @Assisted Change change, @Assisted RevCommit commit)
name|ChangeInserter
parameter_list|(
name|PatchSetInfoFactory
name|patchSetInfoFactory
...
name|hashtags
expr_stmt|;
comment|// TODO(dborowitz): Migrate HashtagsUtil so it doesn't create another
comment|// ChangeUpdate.
name|hashtagsUtil
operator|.
name|setHashtags
argument_list|(
