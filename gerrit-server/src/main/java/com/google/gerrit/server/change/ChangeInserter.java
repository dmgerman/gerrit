...
annotation|@
name|Inject
DECL|method|ChangeInserter (ProjectControl.GenericFactory projectControlFactory, PatchSetInfoFactory patchSetInfoFactory, ChangeHooks hooks, ApprovalsUtil approvalsUtil, ChangeMessagesUtil cmUtil, CreateChangeSender.Factory createChangeSenderFactory, WorkQueue workQueue, CommitValidators.Factory commitValidatorsFactory, @Assisted Change.Id changeId, @Assisted RevCommit commit, @Assisted String refName)
name|ChangeInserter
parameter_list|(
name|ProjectControl
operator|.
