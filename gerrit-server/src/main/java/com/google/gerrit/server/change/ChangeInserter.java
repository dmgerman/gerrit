...
annotation|@
name|Inject
DECL|method|ChangeInserter (Provider<ReviewDb> dbProvider, PatchSetInfoFactory patchSetInfoFactory, GitReferenceUpdated gitRefUpdated, ChangeHooks hooks, ApprovalsUtil approvalsUtil, TrackingFooters trackingFooters, ChangeIndexer indexer, CreateChangeSender.Factory createChangeSenderFactory, RequestScopePropagator requestScopePropagator, WorkQueue workQueue, @Assisted RefControl refControl, @Assisted Change change, @Assisted RevCommit commit)
name|ChangeInserter
parameter_list|(
name|Provider
argument_list|<
