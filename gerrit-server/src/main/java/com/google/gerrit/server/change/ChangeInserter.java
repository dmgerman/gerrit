...
annotation|@
name|Inject
DECL|method|ChangeInserter (ProjectControl.GenericFactory projectControlFactory, ChangeControl.GenericFactory changeControlFactory, PatchSetInfoFactory patchSetInfoFactory, PatchSetUtil psUtil, ChangeHooks hooks, ApprovalsUtil approvalsUtil, ChangeMessagesUtil cmUtil, CreateChangeSender.Factory createChangeSenderFactory, @SendEmailExecutor ExecutorService sendEmailExecutor, CommitValidators.Factory commitValidatorsFactory, @Assisted Change.Id changeId, @Assisted RevCommit commit, @Assisted String refName)
name|ChangeInserter
parameter_list|(
name|ProjectControl
operator|.
