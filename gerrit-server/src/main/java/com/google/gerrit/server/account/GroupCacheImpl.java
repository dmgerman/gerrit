...
annotation|@
name|Inject
DECL|method|GroupCacheImpl ( @amedBYID_NAME) LoadingCache<AccountGroup.Id, Optional<AccountGroup>> byId, @Named(BYNAME_NAME) LoadingCache<String, Optional<AccountGroup>> byName, @Named(BYUUID_NAME) LoadingCache<String, Optional<AccountGroup>> byUUID, SchemaFactory<ReviewDb> schema, Provider<GroupIndexer> indexer)
name|GroupCacheImpl
parameter_list|(
annotation|@
name|Named
