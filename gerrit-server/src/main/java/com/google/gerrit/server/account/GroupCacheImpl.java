...
name|format
argument_list|(
literal|"Cannot lookup members or sub-groups of group %s"
argument_list|,
name|groupUuid
operator|.
name|get
...
annotation|@
name|Inject
DECL|method|ByIdLoader (SchemaFactory<ReviewDb> sf, Groups groups)
name|ByIdLoader
parameter_list|(
name|SchemaFactory
argument_list|<
...
annotation|@
name|Inject
DECL|method|ByNameLoader (SchemaFactory<ReviewDb> sf, Groups groups)
name|ByNameLoader
parameter_list|(
name|SchemaFactory
argument_list|<
