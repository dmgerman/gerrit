...
block|}
block|}
comment|// TODO(dborowitz): I think VisibleRefFilter is the only user of ChangeCache
comment|// at all; probably we can just stop implementing that interface entirely.
