...
literal|"ldap:"
decl_stmt|;
DECL|method|getPoolProperties (Config config)
specifier|static
specifier|private
name|Map
argument_list|<
...
name|put
argument_list|(
literal|"com.sun.jndi.ldap.connect.pool.authentication"
argument_list|,
name|LdapRealm
operator|.
name|optional
...
name|put
argument_list|(
literal|"com.sun.jndi.ldap.connect.pool.initsize"
argument_list|,
name|String
operator|.
name|valueOf
...
name|put
argument_list|(
literal|"com.sun.jndi.ldap.connect.pool.prefsize"
argument_list|,
name|String
operator|.
name|valueOf
...
name|put
argument_list|(
literal|"com.sun.jndi.ldap.connect.pool.timeout"
argument_list|,
name|Long
operator|.
name|toString
...
decl_stmt|;
DECL|field|connectionPoolConfig
specifier|private
specifier|final
name|Map
argument_list|<
