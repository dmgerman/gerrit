...
expr_stmt|;
block|}
comment|/**    * Creates a new group.    *    * @param groupName the name for the new group    * @param groupDescription the description of the new group, {@code null}    *        if no description    * @param visibleToAll {@code true} to make the group visible to all    *        registered users, if {@code false} the group is only visible to    *        the group owners and Gerrit administrators    * @param ownerGroupId the group that should own the new group, if    *        {@code null} the new group will own itself    * @param initialMembers initial members to be added to the new group    * @param initialGroups initial groups to include in the new group    * @return the id of the new group    * @throws OrmException is thrown in case of any data store read or write    *         error    * @throws NameAlreadyUsedException is thrown in case a group with the given    *         name already exists    * @throws PermissionDeniedException user cannot create a group.    */
