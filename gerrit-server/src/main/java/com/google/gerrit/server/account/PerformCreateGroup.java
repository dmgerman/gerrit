...
annotation|@
name|Inject
DECL|method|PerformCreateGroup (ReviewDb db, AccountCache accountCache, GroupIncludeCache groupIncludeCache, IdentifiedUser currentUser, @GerritPersonIdent PersonIdent serverIdent, GroupCache groupCache, @Assisted CreateGroupArgs createGroupArgs, AuditService auditService)
name|PerformCreateGroup
parameter_list|(
name|ReviewDb
name|db
