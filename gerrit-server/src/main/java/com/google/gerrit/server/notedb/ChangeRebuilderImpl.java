...
name|result
argument_list|,
literal|"expected new NoteDbChangeState when rebuilding change %s"
argument_list|,
name|changeId
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|flushEventsToUpdate (ReviewDb db, NoteDbUpdateManager manager, EventList<Event> events, Change change)
specifier|private
name|void
name|flushEventsToUpdate
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|flushEventsToDraftUpdate (ReviewDb db, NoteDbUpdateManager manager, EventList<PatchLineCommentEvent> events, Change change)
specifier|private
name|void
name|flushEventsToDraftUpdate
parameter_list|(
...
return|;
block|}
DECL|method|getUser (ReviewDb db)
name|CurrentUser
name|getUser
parameter_list|(
name|ReviewDb
