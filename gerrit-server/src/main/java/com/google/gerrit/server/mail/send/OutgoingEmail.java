...
argument_list|()
decl_stmt|;
DECL|field|smtpRcptToPlaintextOnly
specifier|private
specifier|final
name|Set
argument_list|<
...
expr_stmt|;
block|}
comment|// Send plaintext emails: This is different than HTML emails as users have explicitly agreed
comment|// to receive this email as plaintext only at the cost of not being in the same email thread
comment|// as the other recipients.
for|for
control|(
name|Address
name|a
...
return|;
block|}
DECL|method|joinStrings (Iterator<Object> in, String joiner)
specifier|public
name|String
name|joinStrings
parameter_list|(
...
block|}
block|}
DECL|method|safeToString (Object obj)
specifier|private
specifier|static
name|String
name|safeToString
