...
annotation|@
name|Inject
DECL|method|AllGroupsIndexer ( SchemaFactory<ReviewDb> schemaFactory, @IndexExecutor(BATCH) ListeningExecutorService executor, GroupCache groupCache, Groups groups)
name|AllGroupsIndexer
parameter_list|(
name|SchemaFactory
argument_list|<
