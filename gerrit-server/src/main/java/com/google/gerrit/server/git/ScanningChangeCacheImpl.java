...
annotation|@
name|Inject
DECL|method|Loader (GitRepositoryManager repoManager, NotesMigration notesMigration, ChangeNotes.Factory notesFactory, OneOffRequestContext requestContext)
name|Loader
parameter_list|(
name|GitRepositoryManager
name|repoManager
...
block|}
block|}
DECL|method|scan (NotesMigration notesMigration, ChangeNotes.Factory notesFactory, Repository repo, ReviewDb db, Project.NameKey project)
specifier|public
specifier|static
name|List
argument_list|<
...
return|;
block|}
DECL|method|scanChangesFromNotedb ( ChangeNotes.Factory notesFactory, Repository repo, ReviewDb db, Project.NameKey project)
specifier|private
specifier|static
name|List
argument_list|<
...
return|;
block|}
DECL|method|scanNotedb (ChangeNotes.Factory notesFactory, Repository repo, ReviewDb db, Project.NameKey project)
specifier|public
specifier|static
name|List
argument_list|<
