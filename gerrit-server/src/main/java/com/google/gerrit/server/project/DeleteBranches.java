...
annotation|@
name|Inject
DECL|method|DeleteBranches (Provider<IdentifiedUser> identifiedUser, GitRepositoryManager repoManager, Provider<InternalChangeQuery> queryProvider, GitReferenceUpdated referenceUpdated)
name|DeleteBranches
parameter_list|(
name|Provider
argument_list|<
