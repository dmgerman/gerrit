...
annotation|@
name|Inject
DECL|method|ListProjects (CurrentUser currentUser, ProjectCache projectCache, GroupsCollection groupsCollection, GroupControl.Factory groupControlFactory, GitRepositoryManager repoManager, ProjectNode.Factory projectNodeFactory, WebLinks webLinks)
specifier|protected
name|ListProjects
parameter_list|(
name|CurrentUser
