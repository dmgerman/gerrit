...
name|warn
argument_list|(
literal|"Cannot query starred changes"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|starredChangeIds ( Iterable<StarredChange> scs)
specifier|private
specifier|static
name|ImmutableSet
argument_list|<
