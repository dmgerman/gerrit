...
annotation|@
name|Inject
DECL|method|RequestFactory ( CapabilityControl.Factory capabilityControlFactory, @Nullable StarredChangesUtil starredChangesUtil, AuthConfig authConfig, Realm realm, @AnonymousCowardName String anonymousCowardName, @CanonicalWebUrl Provider<String> canonicalUrl, AccountCache accountCache, GroupBackend groupBackend, @DisableReverseDnsLookup Boolean disableReverseDnsLookup, @RemotePeer Provider<SocketAddress> remotePeerProvider)
name|RequestFactory
parameter_list|(
name|CapabilityControl
operator|.
...
name|properties
decl_stmt|;
DECL|method|IdentifiedUser ( CapabilityControl.Factory capabilityControlFactory, @Nullable StarredChangesUtil starredChangesUtil, final AuthConfig authConfig, Realm realm, final String anonymousCowardName, final Provider<String> canonicalUrl, final AccountCache accountCache, final GroupBackend groupBackend, final Boolean disableReverseDnsLookup, @Nullable final Provider<SocketAddress> remotePeerProvider, final Account.Id id, @Nullable CurrentUser realUser)
specifier|private
name|IdentifiedUser
parameter_list|(
name|CapabilityControl
...
argument_list|(
literal|"StarredChangesUtil is missing"
argument_list|)
throw|;
block|}
try|try
...
parameter_list|()
block|{
comment|// Async query may have started before an update that the caller expects
comment|// to see the results of, so we can't trust it.
