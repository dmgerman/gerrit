...
annotation|@
name|Inject
DECL|method|RelatedChangesSorter ( GitRepositoryManager repoManager, PermissionBackend permissionBackend, Provider<ReviewDb> dbProvider)
name|RelatedChangesSorter
parameter_list|(
name|GitRepositoryManager
name|repoManager
...
expr_stmt|;
block|}
DECL|method|sort (List<ChangeData> in, PatchSet startPs, CurrentUser user)
specifier|public
name|List
argument_list|<
name|PatchSetData
...
return|;
block|}
DECL|method|walkAncestors ( PermissionBackend.WithUser perm, ListMultimap<PatchSetData, PatchSetData> parents, PatchSetData start)
specifier|private
specifier|static
name|Collection
argument_list|<
...
return|;
block|}
DECL|method|walkDescendants ( PermissionBackend.WithUser perm, ListMultimap<PatchSetData, PatchSetData> children, PatchSetData start, List<PatchSetData> otherPatchSetsOfStart, Iterable<PatchSetData> ancestors)
specifier|private
specifier|static
name|List
argument_list|<
...
block|}
block|}
DECL|method|walkDescendentsImpl ( PermissionBackend.WithUser perm, Set<Change.Id> alreadyEmittedChanges, ListMultimap<PatchSetData, PatchSetData> children, List<PatchSetData> start)
specifier|private
specifier|static
name|List
argument_list|<
...
return|;
block|}
DECL|method|isVisible (PatchSetData psd, PermissionBackend.WithUser perm)
specifier|private
specifier|static
name|boolean
name|isVisible
