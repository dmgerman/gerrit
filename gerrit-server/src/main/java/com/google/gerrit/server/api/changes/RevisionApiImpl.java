...
annotation|@
name|Inject
DECL|method|RevisionApiImpl (Changes changes, Provider<CherryPick> cherryPick, Provider<DeleteDraftPatchSet> deleteDraft, Provider<Rebase> rebase, Provider<PostReview> review, Provider<Submit> submit, Provider<Publish> publish, @Assisted RevisionResource r)
name|RevisionApiImpl
parameter_list|(
name|Changes
name|changes
