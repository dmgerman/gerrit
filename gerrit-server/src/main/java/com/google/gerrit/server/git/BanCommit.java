...
annotation|@
name|Inject
DECL|method|BanCommit (final Provider<IdentifiedUser> currentUser, final GitRepositoryManager repoManager, @GerritPersonIdent final PersonIdent gerritIdent)
name|BanCommit
parameter_list|(
specifier|final
name|Provider
