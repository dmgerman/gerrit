...
annotation|@
name|Inject
DECL|method|Drafts (DynamicMap<RestView<DraftResource>> views, Provider<CurrentUser> user, ListDrafts list, Provider<ReviewDb> dbProvider, PatchLineCommentsUtil plcUtil)
name|Drafts
parameter_list|(
name|DynamicMap
argument_list|<
