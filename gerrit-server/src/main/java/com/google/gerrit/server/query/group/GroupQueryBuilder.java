...
annotation|@
name|Inject
DECL|method|Arguments ( Provider<ReviewDb> db, GroupIndexCollection groupIndexCollection, GroupCache groupCache, GroupBackend groupBackend, AccountResolver accountResolver)
name|Arguments
parameter_list|(
name|Provider
argument_list|<
...
block|{
throw|throw
name|getExceptionForUnsupportedOperator
argument_list|(
literal|"member"
argument_list|)
throw|;
...
return|;
block|}
DECL|method|isFieldAbsentFromIndex (FieldDef<InternalGroup, ?> field)
specifier|private
name|boolean
name|isFieldAbsentFromIndex
parameter_list|(
...
return|;
block|}
DECL|method|getExceptionForUnsupportedOperator (String operatorName)
specifier|private
specifier|static
name|QueryParseException
name|getExceptionForUnsupportedOperator
...
name|format
argument_list|(
literal|"'%s' operator is not supported by group index version"
argument_list|,
name|operatorName
argument_list|)
argument_list|)
