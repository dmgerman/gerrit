...
return|;
block|}
DECL|method|byCommitsOnBranchNotMerged (Branch.NameKey branch, List<String> hashes)
specifier|public
name|Iterable
argument_list|<
name|ChangeData
...
annotation|@
name|VisibleForTesting
DECL|method|byCommitsOnBranchNotMerged (Schema<ChangeData> schema, Branch.NameKey branch, List<String> hashes, int batchSize)
name|Iterable
argument_list|<
name|ChangeData
argument_list|>
...
return|;
block|}
DECL|method|commitsOnBranchNotMerged ( Branch.NameKey branch, List<Predicate<ChangeData>> commits)
specifier|private
specifier|static
name|Predicate
argument_list|<
