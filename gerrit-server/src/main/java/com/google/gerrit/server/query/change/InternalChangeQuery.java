...
annotation|@
name|Inject
DECL|method|InternalChangeQuery (IndexConfig indexConfig, QueryProcessor queryProcessor, IndexCollection indexes, ChangeData.Factory changeDataFactory, NotesMigration notesMigration, ChangeNotes.Factory notesFactory)
name|InternalChangeQuery
parameter_list|(
name|IndexConfig
name|indexConfig
...
block|}
block|}
DECL|method|byCommitsOnBranchNotMergedFromDatabase ( Repository repo, ReviewDb db, Branch.NameKey branch, List<String> hashes)
specifier|private
name|Iterable
argument_list|<
name|ChangeData
