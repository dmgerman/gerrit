...
annotation|@
name|Inject
DECL|method|SiteIndexer (SchemaFactory<ReviewDb> schemaFactory, ChangeData.Factory changeDataFactory, GitRepositoryManager repoManager, @IndexExecutor(BATCH) ListeningExecutorService executor, ChangeIndexer.Factory indexerFactory, ChangeNotes.Factory notesFactory, @GerritServerConfig Config config)
name|SiteIndexer
parameter_list|(
name|SchemaFactory
argument_list|<
