...
annotation|@
name|Inject
DECL|method|ServerImpl (GetPreferences getPreferences, SetPreferences setPreferences, GetDiffPreferences getDiffPreferences, SetDiffPreferences setDiffPreferences)
name|ServerImpl
parameter_list|(
name|GetPreferences
name|getPreferences
