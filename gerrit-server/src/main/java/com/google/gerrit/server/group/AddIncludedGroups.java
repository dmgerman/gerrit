...
annotation|@
name|Inject
DECL|method|AddIncludedGroups (final GroupControl.Factory groupControlFactory, final Provider<GroupsCollection> groupsCollection, final GroupIncludeCache groupIncludeCache, final ReviewDb db, final Provider<CurrentUser> self)
specifier|public
name|AddIncludedGroups
parameter_list|(
specifier|final
...
name|id
decl_stmt|;
DECL|method|PutIncludedGroup (final Provider<AddIncludedGroups> put, String id)
name|PutIncludedGroup
parameter_list|(
specifier|final
name|Provider
