...
return|;
block|}
DECL|method|setSubmitRecordLabels (List<SubmitRecord.Label> labels)
specifier|public
name|void
name|setSubmitRecordLabels
parameter_list|(
name|List
argument_list|<
name|SubmitRecord
...
expr_stmt|;
block|}
DECL|method|getSubmitRecordLabels ()
specifier|public
name|List
argument_list|<
name|SubmitRecord
