...
annotation|@
name|Inject
DECL|method|ConsistencyChecker (Provider<ReviewDb> db, GitRepositoryManager repoManager, NotesMigration notesMigration, Provider<CurrentUser> user, @GerritPersonIdent Provider<PersonIdent> serverIdent, PatchSetInfoFactory patchSetInfoFactory, PatchSetInserter.Factory patchSetInserterFactory, BatchUpdate.Factory updateFactory, ChangeIndexer indexer, ChangeControl.GenericFactory changeControlFactory, ChangeNotes.Factory notesFactory, ChangeUpdate.Factory changeUpdateFactory, DynamicItem<AccountPatchReviewStore> accountPatchReviewStore)
name|ConsistencyChecker
parameter_list|(
name|Provider
argument_list|<
...
block|}
block|}
DECL|method|deletePatchSet (ProblemInfo p, Project.NameKey project, PatchSet.Id psId)
specifier|private
name|void
name|deletePatchSet
parameter_list|(
