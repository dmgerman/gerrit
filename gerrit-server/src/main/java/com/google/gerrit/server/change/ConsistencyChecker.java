...
annotation|@
name|Inject
DECL|method|ConsistencyChecker ( @erritPersonIdent Provider<PersonIdent> serverIdent, BatchUpdate.Factory updateFactory, ChangeControl.GenericFactory changeControlFactory, ChangeNotes.Factory notesFactory, DynamicItem<AccountPatchReviewStore> accountPatchReviewStore, GitRepositoryManager repoManager, PatchSetInfoFactory patchSetInfoFactory, PatchSetInserter.Factory patchSetInserterFactory, PatchSetUtil psUtil, Provider<CurrentUser> user, Provider<ReviewDb> db)
name|ConsistencyChecker
parameter_list|(
annotation|@
name|GerritPersonIdent
...
block|}
block|}
DECL|method|insertMergedPatchSet (RevCommit commit)
specifier|private
name|void
name|insertMergedPatchSet
parameter_list|(
