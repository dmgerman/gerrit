...
annotation|@
name|Inject
DECL|method|ConsistencyChecker (Provider<ReviewDb> db, GitRepositoryManager repoManager, Provider<CurrentUser> user, @GerritPersonIdent Provider<PersonIdent> serverIdent, PatchSetInfoFactory patchSetInfoFactory)
name|ConsistencyChecker
parameter_list|(
name|Provider
argument_list|<
