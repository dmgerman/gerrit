...
annotation|@
name|Inject
DECL|method|ConsistencyChecker ( @erritPersonIdent Provider<PersonIdent> serverIdent, ChangeControl.GenericFactory changeControlFactory, ChangeNotes.Factory notesFactory, DynamicItem<AccountPatchReviewStore> accountPatchReviewStore, GitRepositoryManager repoManager, PatchSetInfoFactory patchSetInfoFactory, PatchSetInserter.Factory patchSetInserterFactory, PatchSetUtil psUtil, Provider<CurrentUser> user, Provider<ReviewDb> db, RetryHelper retryHelper)
name|ConsistencyChecker
parameter_list|(
annotation|@
name|GerritPersonIdent
