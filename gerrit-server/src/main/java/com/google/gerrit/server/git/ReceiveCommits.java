...
argument_list|()
decl_stmt|;
DECL|method|CreateRequest (RevCommit c, String refName)
name|CreateRequest
parameter_list|(
name|RevCommit
name|c
...
return|;
block|}
DECL|method|insertChange (RequestState state)
specifier|private
name|void
name|insertChange
parameter_list|(
...
return|;
block|}
DECL|method|insertPatchSet (RequestState state)
name|PatchSet
operator|.
name|Id
name|insertPatchSet
...
argument_list|()
expr_stmt|;
comment|//TODO(ekempin): mark changes as merged inside of ReplaceOp
if|if
condition|(
name|replaceOp
operator|.
...
expr_stmt|;
block|}
DECL|method|updateGroups (RequestState state)
specifier|private
name|void
name|updateGroups
parameter_list|(
...
block|}
block|}
DECL|method|validCommit (RevWalk rw, RefControl ctl, ReceiveCommand cmd, ObjectId id)
specifier|private
name|boolean
name|validCommit
parameter_list|(
...
block|}
block|}
DECL|method|closeChange (ReceiveCommand cmd, PatchSet.Id psi, ObjectId commitId)
specifier|private
name|Change
operator|.
name|Key
...
return|;
block|}
DECL|method|markChangeMergedByPush (ReviewDb db, final PatchSetInfo info, final String mergedIntoRef)
specifier|private
name|void
name|markChangeMergedByPush
parameter_list|(
...
block|}
block|}
DECL|method|sendMergedEmail (final PatchSet ps, final PatchSetInfo info)
specifier|private
name|void
name|sendMergedEmail
parameter_list|(
...
return|;
block|}
DECL|method|synchronizedIncrement (Task p)
specifier|private
specifier|static
name|void
name|synchronizedIncrement
...
block|}
block|}
DECL|method|requestState (Thread caller)
specifier|private
name|RequestState
name|requestState
parameter_list|(
...
name|close
decl_stmt|;
DECL|method|RequestState (ReviewDb db, Repository repo, RevWalk rw)
name|RequestState
parameter_list|(
name|ReviewDb
name|db
...
expr_stmt|;
block|}
DECL|method|RequestState (Project.NameKey projectName)
name|RequestState
parameter_list|(
name|Project
operator|.
