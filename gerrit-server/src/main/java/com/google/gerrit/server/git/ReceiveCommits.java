...
block|}
block|}
comment|/**      * Validate the new patch set commit for this change.      *<p>      *<strong>Side effects:</strong>      *<ul>      *<li>May add error or warning messages to the progress monitor</li>      *<li>Will reject {@code cmd} prior to returning false</li>      *<li>May reset {@code rp.getRevWalk()}; do not call in the middle of a      *     walk.</li>      *</ul>      *      * @param autoClose whether the caller intends to auto-close the change      *     after adding a new patch set.      * @return whether the new commit is valid      * @throws IOException      * @throws OrmException      */
...
condition|)
block|{
comment|// TODO(dborowitz): When does this happen? Only when an edit ref is
comment|// involved?
name|cmd
operator|.
name|execute
...
block|}
block|}
DECL|method|insertPatchSetWithoutBatchUpdate ()
name|void
name|insertPatchSetWithoutBatchUpdate
parameter_list|()
throws|throws
