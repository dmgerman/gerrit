...
return|;
block|}
DECL|method|parse (Repository repo, Map<String, Ref> advertisedRefs)
name|String
name|parse
parameter_list|(
name|Repository
...
condition|)
block|{
comment|// Command was already rejected, but progress needs to update.
name|commandProgress
operator|.
name|update
argument_list|(
...
return|;
block|}
DECL|method|markHeadsAsUninteresting (final RevWalk walk, Set<ObjectId> existing)
specifier|private
name|void
name|markHeadsAsUninteresting
parameter_list|(
