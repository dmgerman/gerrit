...
annotation|@
name|Inject
DECL|method|Revert ( Provider<ReviewDb> db, PermissionBackend permissionBackend, Provider<CurrentUser> user, GitRepositoryManager repoManager, ChangeInserter.Factory changeInserterFactory, ChangeMessagesUtil cmUtil, RetryHelper retryHelper, Sequences seq, PatchSetUtil psUtil, RevertedSender.Factory revertedSenderFactory, ChangeJson.Factory json, @GerritPersonIdent PersonIdent serverIdent, ApprovalsUtil approvalsUtil, ChangeReverted changeReverted)
name|Revert
parameter_list|(
name|Provider
argument_list|<
