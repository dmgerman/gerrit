...
annotation|@
name|Inject
DECL|method|Revert ( Provider<ReviewDb> db, PermissionBackend permissionBackend, GitRepositoryManager repoManager, ChangeInserter.Factory changeInserterFactory, ChangeMessagesUtil cmUtil, RetryHelper retryHelper, Sequences seq, PatchSetUtil psUtil, RevertedSender.Factory revertedSenderFactory, ChangeJson.Factory json, @GerritPersonIdent PersonIdent serverIdent, ApprovalsUtil approvalsUtil, ChangeReverted changeReverted, ProjectControl.GenericFactory projectControlFactory)
name|Revert
parameter_list|(
name|Provider
argument_list|<
...
return|;
block|}
DECL|method|revert ( BatchUpdate.Factory updateFactory, ChangeNotes notes, CurrentUser user, String message)
specifier|private
name|Change
operator|.
name|Id
