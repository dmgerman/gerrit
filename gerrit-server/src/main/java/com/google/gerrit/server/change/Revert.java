...
annotation|@
name|Inject
DECL|method|Revert ( Provider<ReviewDb> db, GitRepositoryManager repoManager, ChangeInserter.Factory changeInserterFactory, ChangeMessagesUtil cmUtil, RetryHelper retryHelper, Sequences seq, PatchSetUtil psUtil, RevertedSender.Factory revertedSenderFactory, ChangeJson.Factory json, @GerritPersonIdent PersonIdent serverIdent, ApprovalsUtil approvalsUtil, ChangeReverted changeReverted)
name|Revert
parameter_list|(
name|Provider
argument_list|<
...
annotation|@
name|Override
DECL|method|applyImpl ( BatchUpdate.Factory updateFactory, ChangeResource req, RevertInput input)
specifier|protected
name|ChangeInfo
name|applyImpl
parameter_list|(
...
return|;
block|}
DECL|method|revert (BatchUpdate.Factory updateFactory, ChangeControl ctl, String message)
specifier|private
name|Change
operator|.
name|Id
