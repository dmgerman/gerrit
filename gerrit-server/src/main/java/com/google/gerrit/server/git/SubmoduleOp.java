...
annotation|@
name|Inject
DECL|method|SubmoduleOp ( GitModules.Factory gitmodulesFactory, @GerritPersonIdent PersonIdent myIdent, @GerritServerConfig Config cfg, GitReferenceUpdated gitRefUpdated, ProjectCache projectCache, @Nullable Account account, ChangeHooks changeHooks)
specifier|public
name|SubmoduleOp
parameter_list|(
name|GitModules
...
DECL|method|updateGitlinks (ReviewDb db, Branch.NameKey subscriber, Collection<SubmoduleSubscription> updates, MergeOpRepoManager orm)
specifier|private
name|void
name|updateGitlinks
parameter_list|(
