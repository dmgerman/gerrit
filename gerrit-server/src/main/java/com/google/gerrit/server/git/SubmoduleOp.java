...
annotation|@
name|Inject
DECL|method|SubmoduleOp ( GitModules.Factory gitmodulesFactory, @GerritPersonIdent PersonIdent myIdent, @GerritServerConfig Config cfg, GitRepositoryManager repoManager, GitReferenceUpdated gitRefUpdated, ProjectCache projectCache, @Nullable Account account, ChangeHooks changeHooks)
specifier|public
name|SubmoduleOp
parameter_list|(
name|GitModules
...
name|SubmoduleSubscription
argument_list|>
DECL|method|superProjectSubscriptionsForSubmoduleBranch ( Branch.NameKey branch)
...
return|;
block|}
DECL|method|updateSuperProjects (ReviewDb db, Collection<Branch.NameKey> updatedBranches, String updateId)
specifier|protected
name|void
