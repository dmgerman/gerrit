...
annotation|@
name|Inject
DECL|method|SubmoduleOp ( @anonicalWebUrl @ullable Provider<String> urlProvider, @GerritPersonIdent PersonIdent myIdent, GitRepositoryManager repoManager, GitReferenceUpdated gitRefUpdated, @Nullable Account account, ChangeHooks changeHooks, SubmoduleSectionParser.Factory subSecParserFactory)
specifier|public
name|SubmoduleOp
parameter_list|(
annotation|@
