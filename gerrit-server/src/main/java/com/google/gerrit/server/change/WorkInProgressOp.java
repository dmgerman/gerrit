...
annotation|@
name|Inject
DECL|method|WorkInProgressOp ( ChangeMessagesUtil cmUtil, EmailReviewComments.Factory email, PatchSetUtil psUtil, @Assisted boolean workInProgress, @Assisted Input in)
name|WorkInProgressOp
parameter_list|(
name|ChangeMessagesUtil
name|cmUtil
