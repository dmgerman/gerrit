...
name|manager
decl_stmt|;
DECL|method|Plugin (String name, File jar, Manifest manifest, FileSnapshot snapshot, @Nullable Class<? extends Module> sysModule, @Nullable Class<? extends Module> sshModule)
specifier|public
name|Plugin
parameter_list|(
name|String
