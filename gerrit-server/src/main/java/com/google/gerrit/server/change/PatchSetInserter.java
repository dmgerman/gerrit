...
annotation|@
name|Inject
DECL|method|PatchSetInserter (ChangeHooks hooks, ReviewDb db, ChangeUpdate.Factory updateFactory, ApprovalsUtil approvalsUtil, ApprovalCopier approvalCopier, PatchSetInfoFactory patchSetInfoFactory, GitReferenceUpdated gitRefUpdated, CommitValidators.Factory commitValidatorsFactory, MergeabilityChecker mergeabilityChecker, ReplacePatchSetSender.Factory replacePatchSetFactory, @Assisted Repository git, @Assisted RevWalk revWalk, @Assisted ChangeControl ctl, @Assisted RevCommit commit)
specifier|public
name|PatchSetInserter
parameter_list|(
name|ChangeHooks
