...
return|;
block|}
DECL|method|insertPatchSet (Change change, final PatchSet patchSet, final RevCommit commit, RefControl refControl, ChangeMessage changeMessage, boolean copyLabels)
specifier|public
name|Change
name|insertPatchSet
parameter_list|(
