...
annotation|@
name|AssistedInject
DECL|method|PatchListLoader (GitRepositoryManager mgr, PatchListCache plc, @GerritServerConfig Config cfg, @DiffExecutor ExecutorService de, @Assisted PatchListKey k, @Assisted Project.NameKey p)
name|PatchListLoader
parameter_list|(
name|GitRepositoryManager
name|mgr
...
block|}
block|}
DECL|method|getFileSize (Repository repo, ObjectReader reader, String path, RevTree t)
specifier|private
specifier|static
name|long
name|getFileSize
