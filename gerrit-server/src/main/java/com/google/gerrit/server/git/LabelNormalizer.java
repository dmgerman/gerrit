...
return|;
block|}
DECL|method|applyRightFloor (ChangeNotes notes, LabelType lt, PatchSetApproval a)
specifier|private
name|boolean
name|applyRightFloor
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// Check if the user is allowed to vote on the label at all
try|try
block|{
name|forChange
operator|.
...
return|;
block|}
comment|// Squash vote to nearest allowed value
try|try
block|{
name|forChange
operator|.
