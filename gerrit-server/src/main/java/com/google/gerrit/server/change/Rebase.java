...
annotation|@
name|Inject
DECL|method|Rebase (BatchUpdate.Factory updateFactory, GitRepositoryManager repoManager, RebaseChangeOp.Factory rebaseFactory, RebaseUtil rebaseUtil, ChangeJson.Factory json, Provider<ReviewDb> dbProvider, Provider<InternalChangeQuery> queryProvider)
specifier|public
name|Rebase
parameter_list|(
name|BatchUpdate
...
return|;
block|}
DECL|method|parseBase (Project.NameKey project, String base)
specifier|private
name|PatchSet
name|parseBase
parameter_list|(
