...
annotation|@
name|Inject
DECL|method|Rebase ( RetryHelper retryHelper, GitRepositoryManager repoManager, RebaseChangeOp.Factory rebaseFactory, RebaseUtil rebaseUtil, ChangeJson.Factory json, Provider<ReviewDb> dbProvider, Provider<CurrentUser> userProvider, ChangeControl.GenericFactory changeControlFactory)
specifier|public
name|Rebase
parameter_list|(
name|RetryHelper
...
annotation|@
name|Inject
DECL|method|CurrentRevision ( RetryHelper retryHelper, PatchSetUtil psUtil, Rebase rebase, ChangeControl.GenericFactory changeControlFactory)
name|CurrentRevision
parameter_list|(
name|RetryHelper
name|retryHelper
