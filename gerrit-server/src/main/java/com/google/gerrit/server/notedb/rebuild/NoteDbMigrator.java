...
annotation|@
name|Inject
DECL|method|Builder ( SitePaths sitePaths, SchemaFactory<ReviewDb> schemaFactory, ChangeRebuilder rebuilder, WorkQueue workQueue, NotesMigration globalNotesMigration)
name|Builder
parameter_list|(
name|SitePaths
name|sitePaths
...
name|forceRebuild
decl_stmt|;
DECL|method|NoteDbMigrator ( SitePaths sitePaths, SchemaFactory<ReviewDb> schemaFactory, ChangeRebuilder rebuilder, NotesMigration globalNotesMigration, ListeningExecutorService executor, ImmutableList<Project.NameKey> projects, ImmutableList<Change.Id> changes, OutputStream progressOut, boolean trial, boolean forceRebuild)
specifier|private
name|NoteDbMigrator
parameter_list|(
name|SitePaths
