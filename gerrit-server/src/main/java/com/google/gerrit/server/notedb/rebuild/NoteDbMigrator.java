...
annotation|@
name|Inject
DECL|method|Builder ( @erritServerConfig Config cfg, SitePaths sitePaths, SchemaFactory<ReviewDb> schemaFactory, GitRepositoryManager repoManager, AllProjectsName allProjects, ChangeRebuilder rebuilder, WorkQueue workQueue, NotesMigration globalNotesMigration)
name|Builder
parameter_list|(
annotation|@
name|GerritServerConfig
...
name|sequenceGap
decl_stmt|;
DECL|method|NoteDbMigrator ( SitePaths sitePaths, SchemaFactory<ReviewDb> schemaFactory, GitRepositoryManager repoManager, AllProjectsName allProjects, ChangeRebuilder rebuilder, NotesMigration globalNotesMigration, ListeningExecutorService executor, ImmutableList<Project.NameKey> projects, ImmutableList<Change.Id> changes, OutputStream progressOut, NotesMigrationState stopAtState, boolean trial, boolean forceRebuild, int sequenceGap)
specifier|private
name|NoteDbMigrator
parameter_list|(
name|SitePaths
