...
annotation|@
name|Inject
DECL|method|Files (DynamicMap<RestView<FileResource>> views, Provider<ListFiles> list, GitRepositoryManager repoManager)
name|Files
parameter_list|(
name|DynamicMap
argument_list|<
...
return|;
block|}
DECL|method|reversePatchSets (RevisionResource resource)
specifier|private
name|List
argument_list|<
name|PatchSet
