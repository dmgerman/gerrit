...
annotation|@
name|Inject
DECL|method|ListFiles ( Provider<ReviewDb> db, Provider<CurrentUser> self, FileInfoJson fileInfoJson, Revisions revisions, GitRepositoryManager gitManager, PatchListCache patchListCache, PatchSetUtil psUtil, DynamicItem<AccountPatchReviewStore> accountPatchReviewStore, Provider<GetCommit> getCommit)
name|ListFiles
parameter_list|(
name|Provider
argument_list|<
