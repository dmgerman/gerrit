...
annotation|@
name|Inject
DECL|method|GroupsCollection (final DynamicMap<RestView<GroupResource>> views, final Provider<ListGroups> list, final GroupControl.Factory groupControlFactory, final GroupBackend groupBackend, final Provider<CurrentUser> self)
name|GroupsCollection
parameter_list|(
specifier|final
name|DynamicMap
