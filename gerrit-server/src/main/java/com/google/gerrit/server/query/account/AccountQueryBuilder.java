...
annotation|@
name|Inject
DECL|method|Arguments ( Provider<CurrentUser> self, Provider<ReviewDb> db, ChangeFinder changeFinder, ChangeControl.GenericFactory changeControlFactory, IdentifiedUser.GenericFactory userFactory)
specifier|public
name|Arguments
parameter_list|(
name|Provider
