...
annotation|@
name|Inject
DECL|method|CreateAccount (ReviewDb db, Provider<IdentifiedUser> currentUser, GroupsCollection groupsCollection, SshKeyCache sshKeyCache, AccountCache accountCache, AccountByEmailCache byEmailCache, AccountLoader.Factory infoLoader, DynamicSet<AccountExternalIdCreator> externalIdCreators, @Assisted String username, AuditService auditService)
name|CreateAccount
parameter_list|(
name|ReviewDb
name|db
