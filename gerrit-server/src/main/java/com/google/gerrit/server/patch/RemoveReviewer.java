...
annotation|@
name|Inject
DECL|method|RemoveReviewer (final ReviewDb db, final ChangeControl.Factory changeControlFactory, @Assisted Change.Id changeId, @Assisted Account.Id reviewerId)
name|RemoveReviewer
parameter_list|(
specifier|final
name|ReviewDb
