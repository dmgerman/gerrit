...
annotation|@
name|Inject
DECL|method|DeleteDraftPatchSet (Provider<ReviewDb> db, BatchUpdate.Factory updateFactory, PatchSetInfoFactory patchSetInfoFactory, PatchSetUtil psUtil, Provider<DeleteDraftChangeOp> deleteChangeOpProvider, @GerritServerConfig Config cfg)
specifier|public
name|DeleteDraftPatchSet
parameter_list|(
name|Provider
