...
annotation|@
name|Inject
DECL|method|DeleteDraftPatchSet (Provider<ReviewDb> dbProvider, GitRepositoryManager gitManager, GitReferenceUpdated gitRefUpdated, PatchSetInfoFactory patchSetInfoFactory)
specifier|public
name|DeleteDraftPatchSet
parameter_list|(
name|Provider
...
annotation|@
name|Inject
DECL|method|Action (Provider<ReviewDb> dbProvider, GitRepositoryManager gitManager, GitReferenceUpdated gitRefUpdated, PatchSetInfoFactory patchSetInfoFactory)
specifier|public
name|Action
parameter_list|(
name|Provider
