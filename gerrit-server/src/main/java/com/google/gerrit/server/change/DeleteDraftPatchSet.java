...
annotation|@
name|Inject
DECL|method|DeleteDraftPatchSet ( Provider<ReviewDb> db, RetryHelper retryHelper, PatchSetInfoFactory patchSetInfoFactory, PatchSetUtil psUtil, Provider<DeleteChangeOp> deleteChangeOpProvider, DynamicItem<AccountPatchReviewStore> accountPatchReviewStore, @GerritServerConfig Config cfg, ChangeControl.GenericFactory changeControlFactory)
specifier|public
name|DeleteDraftPatchSet
parameter_list|(
name|Provider
