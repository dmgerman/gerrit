...
annotation|@
name|Inject
DECL|method|ChangeEditModifier (@erritPersonIdent PersonIdent gerritIdent, GitRepositoryManager gitManager, ChangeIndexer indexer, Provider<ReviewDb> reviewDb, Provider<CurrentUser> currentUser)
name|ChangeEditModifier
parameter_list|(
annotation|@
name|GerritPersonIdent
