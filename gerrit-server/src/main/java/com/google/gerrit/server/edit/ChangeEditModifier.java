...
name|DELETE_ENTRY
block|,
DECL|enumConstant|RENAME_ENTRY
name|RENAME_ENTRY
block|,
...
annotation|@
name|Inject
DECL|method|ChangeEditModifier (@erritPersonIdent PersonIdent gerritIdent, GitRepositoryManager gitManager, ChangeIndexer indexer, Provider<ReviewDb> reviewDb, Provider<CurrentUser> currentUser, ChangeControl.GenericFactory changeControlFactory)
name|ChangeEditModifier
parameter_list|(
annotation|@
name|GerritPersonIdent
...
return|;
block|}
comment|/**    * Rename file in existing change edit.    *    * @param edit change edit    * @param file path to rename    * @param newFile path to rename the file to    * @return result    * @throws AuthException    * @throws InvalidChangeOperationException    * @throws IOException    */
DECL|method|renameFile (ChangeEdit edit, String file, String newFile)
specifier|public
name|RefUpdate
operator|.
name|Result
...
return|;
block|}
DECL|method|modify (TreeOperation op, ChangeEdit edit, String file, @Nullable String newFile, @Nullable RawInput content)
specifier|private
name|RefUpdate
operator|.
name|Result
...
return|;
block|}
DECL|method|writeNewTree ( TreeOperation op, RevWalk rw, final ObjectInserter ins, RevCommit prevEdit, ObjectReader reader, String fileName, @Nullable String newFile, @Nullable final RawInput content)
specifier|private
specifier|static
name|ObjectId
name|writeNewTree
...
return|;
block|}
DECL|method|addFileToCommit (String newFile, DirCacheEditor dce, TreeWalk tw)
specifier|private
specifier|static
name|void
name|addFileToCommit
