...
return|;
block|}
DECL|method|writeNewTree (TreeOperation op, RevWalk rw, ObjectInserter ins, RevCommit prevEdit, ObjectReader reader, String fileName, final @Nullable ObjectId content)
specifier|private
specifier|static
name|ObjectId
name|writeNewTree
