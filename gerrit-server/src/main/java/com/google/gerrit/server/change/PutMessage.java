...
annotation|@
name|Inject
DECL|method|PutMessage ( RetryHelper retryHelper, GitRepositoryManager repositoryManager, Provider<CurrentUser> currentUserProvider, Provider<ReviewDb> db, PatchSetInserter.Factory psInserterFactory, PermissionBackend permissionBackend, @GerritPersonIdent PersonIdent gerritIdent, PatchSetUtil psUtil, NotifyUtil notifyUtil)
name|PutMessage
parameter_list|(
name|RetryHelper
name|retryHelper
...
annotation|@
name|Override
DECL|method|applyImpl ( BatchUpdate.Factory updateFactory, ChangeResource resource, Input input)
specifier|protected
name|Response
argument_list|<
name|String
