...
annotation|@
name|Inject
DECL|method|PutMessage ( RetryHelper retryHelper, GitRepositoryManager repositoryManager, Provider<CurrentUser> currentUserProvider, Provider<ReviewDb> db, PatchSetInserter.Factory psInserterFactory, PermissionBackend permissionBackend, @GerritPersonIdent PersonIdent gerritIdent, PatchSetUtil psUtil, NotifyUtil notifyUtil, ProjectCache projectCache, ChangeControl.GenericFactory changeControlFactory)
name|PutMessage
parameter_list|(
name|RetryHelper
name|retryHelper
