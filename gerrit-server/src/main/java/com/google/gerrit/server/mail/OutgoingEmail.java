...
block|}
block|}
comment|/** Returns all watches that are relevant for this project */
...
condition|)
block|{
comment|// the all projects watch settings are only relevant if the user did not configure
comment|// any specific rules for the concrete project
name|projectWatches
operator|.
name|add
argument_list|(
