...
annotation|@
name|Inject
DECL|method|StarredChangesUtil (GitRepositoryManager repoManager, AllUsersName allUsers, NotesMigration migration, Provider<ReviewDb> dbProvider, @GerritPersonIdent PersonIdent serverIdent, ChangeIndexer indexer, Provider<InternalChangeQuery> queryProvider)
name|StarredChangesUtil
parameter_list|(
name|GitRepositoryManager
name|repoManager
