...
annotation|@
name|Inject
DECL|method|StarredChangesUtil (GitRepositoryManager repoManager, AllUsersName allUsers, Provider<ReviewDb> dbProvider, @GerritPersonIdent PersonIdent serverIdent, ChangeIndexer indexer, Provider<InternalChangeQuery> queryProvider, @GerritServerConfig Config cfg)
name|StarredChangesUtil
parameter_list|(
name|GitRepositoryManager
name|repoManager
...
literal|null
argument_list|,
literal|"readStarredChangesFromGit"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
