...
annotation|@
name|Inject
DECL|method|AccountCacheImpl (@amedBYID_NAME) LoadingCache<Account.Id, AccountState> byId, @Named(BYUSER_NAME) LoadingCache<String, Optional<Account.Id>> byUsername, AccountIndexCollection indexes)
name|AccountCacheImpl
parameter_list|(
annotation|@
name|Named
...
annotation|@
name|Inject
DECL|method|ByIdLoader (SchemaFactory<ReviewDb> sf, GroupCache groupCache, GeneralPreferencesLoader loader, @Named(BYUSER_NAME) LoadingCache<String, Optional<Account.Id>> byUsername)
name|ByIdLoader
parameter_list|(
name|SchemaFactory
argument_list|<
