...
annotation|@
name|Inject
DECL|method|ByIdLoader (SchemaFactory<ReviewDb> sf, GroupCache groupCache, GeneralPreferencesLoader loader, @Named(BYUSER_NAME) LoadingCache<String, Optional<Account.Id>> byUsername, @GerritServerConfig Config cfg, Provider<WatchConfig.Accessor> watchConfig)
name|ByIdLoader
parameter_list|(
name|SchemaFactory
argument_list|<
...
annotation|@
name|Inject
DECL|method|ByNameLoader (SchemaFactory<ReviewDb> sf, AccountIndexCollection accountIndexes, Provider<InternalAccountQuery> accountQueryProvider)
name|ByNameLoader
parameter_list|(
name|SchemaFactory
argument_list|<
