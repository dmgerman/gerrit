...
annotation|@
name|Inject
DECL|method|ByIdLoader ( SchemaFactory<ReviewDb> sf, AllUsersName allUsersName, Accounts accounts, GroupCache groupCache, Groups groups, GeneralPreferencesLoader loader, Provider<WatchConfig.Accessor> watchConfig, ExternalIds externalIds)
name|ByIdLoader
parameter_list|(
name|SchemaFactory
argument_list|<
