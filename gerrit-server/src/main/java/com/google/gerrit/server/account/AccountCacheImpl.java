...
annotation|@
name|Inject
DECL|method|AccountCacheImpl (final SchemaFactory<ReviewDb> sf, final AuthConfig auth, final GroupCache groupCache, @Named(CACHE_NAME) final Cache<Account.Id, AccountState> rawCache)
name|AccountCacheImpl
parameter_list|(
specifier|final
name|SchemaFactory
