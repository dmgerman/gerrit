...
annotation|@
name|Nullable
DECL|method|addByAccountId ( ChangeResource rsrc, AddReviewerInput input, boolean allowGroup, boolean allowByEmail)
specifier|private
name|Addition
name|addByAccountId
parameter_list|(
...
annotation|@
name|Nullable
DECL|method|addWholeGroup ( ChangeResource rsrc, AddReviewerInput input, boolean allowGroup, boolean allowByEmail)
specifier|private
name|Addition
name|addWholeGroup
parameter_list|(
...
annotation|@
name|Nullable
DECL|method|addByEmail (ChangeResource rsrc, AddReviewerInput input)
specifier|private
name|Addition
name|addByEmail
parameter_list|(
...
throw|;
block|}
DECL|method|putAccountByEmail ( String reviewer, ChangeResource rsrc, ReviewerState state, NotifyHandling notify, ListMultimap<RecipientType, Account.Id> accountsToNotify)
specifier|private
name|Addition
name|putAccountByEmail
parameter_list|(
...
name|BadRequestException
argument_list|(
literal|"feature only supported in NoteDb"
argument_list|)
throw|;
block|}
name|Address
...
expr_stmt|;
block|}
DECL|method|Addition ( String reviewer, ChangeResource rsrc, @Nullable Map<Account.Id, ChangeControl> reviewers, @Nullable Collection<Address> reviewersByEmail, ReviewerState state, @Nullable NotifyHandling notify, ListMultimap<RecipientType, Account.Id> accountsToNotify)
specifier|protected
name|Addition
parameter_list|(
name|String
