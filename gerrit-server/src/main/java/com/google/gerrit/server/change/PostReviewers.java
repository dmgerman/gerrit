...
return|;
block|}
comment|// TODO(hiesel) Refactor this as it starts to become unreadable
...
expr_stmt|;
block|}
DECL|method|Addition ( String reviewer, ChangeResource rsrc, @Nullable Map<Account.Id, ChangeControl> reviewers, @Nullable Collection<Address> reviewersByEmail, ReviewerState state, NotifyHandling notify, ListMultimap<RecipientType, Account.Id> accountsToNotify)
specifier|protected
name|Addition
parameter_list|(
name|String
...
name|patchSet
decl_stmt|;
DECL|method|Op ( ChangeResource rsrc, Map<Account.Id, ChangeControl> reviewers, Collection<Address> reviewersByEmail, ReviewerState state, NotifyHandling notify, ListMultimap<RecipientType, Account.Id> accountsToNotify)
name|Op
parameter_list|(
name|ChangeResource
name|rsrc
