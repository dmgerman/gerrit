...
block|}
block|}
DECL|method|putAccount (String reviewer, ReviewerResource rsrc)
specifier|private
name|AddReviewerResult
name|putAccount
parameter_list|(
...
return|;
block|}
DECL|method|addReviewers ( ChangeResource rsrc, AddReviewerResult result, Map<Account.Id, ChangeControl> reviewers)
specifier|private
name|void
name|addReviewers
parameter_list|(
