...
name|remoteAdmin
decl_stmt|;
DECL|field|externalPluginFactory
specifier|private
specifier|final
name|UniversalServerPluginProvider
name|externalPluginFactory
decl_stmt|;
annotation|@
name|Inject
DECL|method|PluginLoader (SitePaths sitePaths, PluginGuiceEnvironment pe, ServerInformationImpl sii, PluginUser.Factory puf, Provider<PluginCleanerTask> pct, @GerritServerConfig Config cfg, @CanonicalWebUrl Provider<String> provider, PersistentCacheFactory cacheFactory, UniversalServerPluginProvider extPluginFactory)
specifier|public
name|PluginLoader
parameter_list|(
name|SitePaths
...
name|warn
argument_list|(
literal|"File is not a JAR nor JS plugin and "
operator|+
literal|"no Plugin provider was found that handles it: {}"
argument_list|,
name|fileName
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|jarsFirstSortedPluginsSet ( Map<String, File> activePlugins)
specifier|private
name|TreeSet
argument_list|<
name|Entry
...
return|;
block|}
DECL|method|syncDisabledPlugins (Multimap<String, File> jars)
specifier|private
name|void
name|syncDisabledPlugins
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|runPlugin (String name, File plugin, Plugin oldPlugin)
specifier|private
name|Plugin
name|runPlugin
parameter_list|(
...
argument_list|()
expr_stmt|;
comment|// Pluggable plugin provider may have assigned
comment|// a plugin name that could be actually
comment|// different from the initial
comment|// one assigned during scan. It is safer then
comment|// to reassign it.
name|boolean
name|reload
init|=
name|oldPlugin
...
block|}
block|}
DECL|method|stopRemovedPlugins (Multimap<String, File> jars)
specifier|private
name|void
name|stopRemovedPlugins
parameter_list|(
...
block|}
block|}
DECL|method|dropRemovedDisabledPlugins (Multimap<String, File> jars)
specifier|private
name|void
name|dropRemovedDisabledPlugins
parameter_list|(
...
block|}
block|}
DECL|method|nameOf (File plugin)
specifier|public
specifier|static
name|String
name|nameOf
...
return|;
block|}
DECL|method|loadPlugin (String name, File srcPlugin, FileSnapshot snapshot)
specifier|private
name|Plugin
name|loadPlugin
parameter_list|(
...
block|}
block|}
DECL|method|loadJarPlugin (String name, File srcJar, FileSnapshot snapshot, File tmp)
specifier|private
name|Plugin
name|loadJarPlugin
parameter_list|(
...
return|;
block|}
DECL|method|loadExternalPlugin (File scriptFile, FileSnapshot snapshot)
specifier|private
name|ServerPlugin
name|loadExternalPlugin
parameter_list|(
...
DECL|method|filterDisabled ( Multimap<String, File> jars)
specifier|private
specifier|static
name|Map
argument_list|<
...
name|pluginFiles
init|=
name|scanFilesInPluginsDirectory
argument_list|(
name|pluginsDir
argument_list|)
decl_stmt|;
...
name|warn
argument_list|(
literal|"Cannot prune plugin list"
argument_list|,
name|e
operator|.
name|getCause
...
return|;
block|}
DECL|method|scanFilesInPluginsDirectory (File pluginsDir)
specifier|private
name|List
argument_list|<
name|File
...
return|;
block|}
DECL|method|filterDisabledPlugins ( Collection<File> files)
specifier|private
specifier|static
name|Iterable
argument_list|<
...
return|;
block|}
DECL|method|getGerritJarPluginName (File srcFile)
specifier|public
specifier|static
name|String
...
return|;
block|}
DECL|method|asMultimap (List<File> plugins)
specifier|private
name|Multimap
argument_list|<
name|String
...
return|;
block|}
DECL|method|isJarPlugin (String name)
specifier|private
specifier|static
name|boolean
name|isJarPlugin
