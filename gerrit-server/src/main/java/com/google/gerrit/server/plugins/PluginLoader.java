...
expr_stmt|;
block|}
DECL|method|addAllEntries (Map<String, File> from, TreeSet<Entry<String, File>> to)
specifier|private
name|void
name|addAllEntries
parameter_list|(
...
return|;
block|}
DECL|method|loadServerPlugin (File scriptFile, FileSnapshot snapshot)
specifier|private
name|ServerPlugin
name|loadServerPlugin
parameter_list|(
...
DECL|method|filterDisabled ( Multimap<String, File> pluginFiles)
specifier|private
specifier|static
name|Map
argument_list|<
