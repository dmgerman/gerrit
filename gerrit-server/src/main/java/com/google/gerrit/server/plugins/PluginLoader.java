...
return|;
block|}
DECL|method|getPluginName (Object pluginObject)
specifier|public
name|String
name|getPluginName
parameter_list|(
...
argument_list|(
literal|"Object does not belong to a plugin"
argument_list|)
throw|;
block|}
name|String
...
name|IllegalArgumentException
argument_list|(
literal|"Object does not belong to a plugin (loaded from "
operator|+
name|loaderFileName
operator|+
literal|")"
...
return|;
block|}
DECL|method|removeSuffix (String loaderFileName, char suffixTerm)
specifier|private
name|String
name|removeSuffix
parameter_list|(
