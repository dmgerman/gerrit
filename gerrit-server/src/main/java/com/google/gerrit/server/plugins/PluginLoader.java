...
annotation|@
name|Inject
DECL|method|PluginLoader (SitePaths sitePaths, PluginGuiceEnvironment pe, @GerritServerConfig Config cfg)
specifier|public
name|PluginLoader
parameter_list|(
name|SitePaths
...
block|}
block|}
DECL|method|copyToTemp (String name, InputStream in)
specifier|private
name|File
name|copyToTemp
parameter_list|(
...
name|format
argument_list|(
literal|"Detected %s was replaced/overwritten."
operator|+
literal|" This is not a safe way to update a plugin."
argument_list|,
name|jar
operator|.
name|getAbsolutePath
...
return|;
block|}
DECL|method|loadPlugin (String name, File jarFile, FileSnapshot snapshot)
specifier|private
name|Plugin
name|loadPlugin
parameter_list|(
