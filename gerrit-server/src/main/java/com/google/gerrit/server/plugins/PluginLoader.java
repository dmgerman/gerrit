...
return|;
block|}
comment|// Scan the $site_path/plugins directory and fetch all files that end
comment|// with *.jar. The Key in returned multimap is the plugin name. Values are
comment|// the files. Plugins can optionally provide their name in MANIFEST file.
...
return|;
block|}
DECL|method|scanJarsInPluginsDirectory (File pluginsDir)
specifier|private
specifier|static
name|List
argument_list|<
