...
expr_stmt|;
block|}
DECL|method|needsQuoting (String path)
specifier|private
specifier|static
name|boolean
name|needsQuoting
...
parameter_list|)
block|{
comment|// We should quote the path if the quoted form of the path
comment|// differs by more than simply having a leading and trailing
comment|// double quote added.
comment|//
return|return
operator|!
name|QuotedString
