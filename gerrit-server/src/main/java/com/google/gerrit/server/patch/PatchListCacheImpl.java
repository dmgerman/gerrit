...
annotation|@
name|Inject
DECL|method|PatchListCacheImpl ( @amedFILE_NAME) Cache<PatchListKey, PatchList> fileCache, @Named(INTRA_NAME) Cache<IntraLineDiffKey, IntraLineDiff> intraCache, PatchListLoader.Factory fileLoaderFactory, IntraLineLoader.Factory intraLoaderFactory, @GerritServerConfig Config cfg)
name|PatchListCacheImpl
parameter_list|(
annotation|@
name|Named
