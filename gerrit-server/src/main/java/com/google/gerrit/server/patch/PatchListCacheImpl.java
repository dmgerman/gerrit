...
annotation|@
name|Inject
DECL|method|PatchListCacheImpl (final GitRepositoryManager grm, @GerritServerConfig final Config config, @Named(CACHE_NAME) final Cache<PatchListKey, PatchList> raw)
name|PatchListCacheImpl
parameter_list|(
specifier|final
name|GitRepositoryManager
