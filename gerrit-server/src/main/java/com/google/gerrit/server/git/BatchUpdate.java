...
name|schemaFactory
decl_stmt|;
DECL|field|logThresholdNanos
specifier|private
specifier|final
name|long
name|logThresholdNanos
decl_stmt|;
DECL|field|project
specifier|private
specifier|final
...
literal|null
argument_list|,
literal|"updateDebugLogThreshold"
argument_list|,
name|SECONDS
operator|.
name|toMillis
...
block|}
block|}
DECL|class|SlowUpdateException
specifier|private
specifier|static
class|class
name|SlowUpdateException
extends|extends
name|Exception
block|{
...
literal|1L
decl_stmt|;
DECL|method|SlowUpdateException (String fmt, Object... args)
specifier|private
name|SlowUpdateException
parameter_list|(
name|String
...
block|}
block|}
DECL|method|maybeLogSlowUpdate (long startNanos, String desc)
specifier|private
name|void
name|maybeLogSlowUpdate
parameter_list|(
...
name|SlowUpdateException
argument_list|(
literal|"Slow %s update (%d ms) to %s for %s"
argument_list|,
name|desc
argument_list|,
name|NANOSECONDS
