...
annotation|@
name|Inject
DECL|method|QueryProcessor (Provider<ReviewDb> db, Provider<CurrentUser> userProvider, ChangeControl.GenericFactory changeControlFactory, IndexRewriter rewriter, IndexConfig indexConfig, Metrics metrics)
name|QueryProcessor
parameter_list|(
name|Provider
argument_list|<
...
name|newTimer
argument_list|(
literal|"change/query/query_latency"
argument_list|,
operator|new
name|Description
argument_list|(
literal|"Successful change query latency,"
operator|+
