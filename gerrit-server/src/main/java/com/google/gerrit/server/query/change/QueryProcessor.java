...
annotation|@
name|Inject
DECL|method|QueryProcessor (EventFactory eventFactory, ChangeQueryBuilder.Factory queryBuilder, CurrentUser currentUser, ChangeQueryRewriter queryRewriter, TrackingFooters trackingFooters)
name|QueryProcessor
parameter_list|(
name|EventFactory
name|eventFactory
...
return|;
block|}
DECL|method|parseQuery (String queryString, Predicate<ChangeData> visibleToMe)
specifier|private
name|Predicate
argument_list|<
name|ChangeData
