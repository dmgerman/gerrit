...
annotation|@
name|Inject
DECL|method|QueryProcessor (EventFactory eventFactory, ChangeQueryBuilder.Factory queryBuilder, CurrentUser currentUser, ChangeQueryRewriter queryRewriter, Provider<ReviewDb> db, GitRepositoryManager repoManager)
name|QueryProcessor
parameter_list|(
name|EventFactory
name|eventFactory
...
DECL|method|queryChanges (final String queryString)
specifier|public
name|List
argument_list|<
name|ChangeData
