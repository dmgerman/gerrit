...
annotation|@
name|Inject
DECL|method|SetWorkInProgress ( WorkInProgressOp.Factory opFactory, RetryHelper retryHelper, Provider<ReviewDb> db, Provider<CurrentUser> self, PermissionBackend permissionBackend, ProjectControl.GenericFactory projectControlFactory)
name|SetWorkInProgress
parameter_list|(
name|WorkInProgressOp
operator|.
