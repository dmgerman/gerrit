...
annotation|@
name|Inject
DECL|method|IndexRewriteImpl (IndexCollection indexes, Provider<ReviewDb> db, BasicRewritesImpl basicRewrites, SqlRewriterImpl sqlRewriter)
name|IndexRewriteImpl
parameter_list|(
name|IndexCollection
name|indexes
