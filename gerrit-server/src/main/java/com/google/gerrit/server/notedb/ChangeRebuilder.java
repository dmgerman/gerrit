...
expr_stmt|;
block|}
DECL|method|rebuildAsync (final Change change, ListeningExecutorService executor, final Repository changeRepo)
specifier|public
name|ListenableFuture
argument_list|<
name|?
...
return|;
block|}
DECL|method|rebuild (Change change, Repository changeRepo)
specifier|public
name|void
name|rebuild
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// TODO(dborowitz): share manager across changes.
name|NoteDbUpdateManager
name|manager
init|=
name|updateManagerFactory
...
expr_stmt|;
block|}
DECL|method|createStarredChangesRefs (Change.Id changeId, ChainedReceiveCommands allUsersCmds, Repository allUsersRepo)
specifier|private
name|void
name|createStarredChangesRefs
parameter_list|(
...
block|}
block|}
DECL|method|getHashtagsEvents (Change change, Repository changeRepo, RevWalk rw)
specifier|private
name|List
argument_list|<
name|HashtagsEvent
...
return|;
block|}
DECL|method|sameUpdate (Event event, AbstractChangeUpdate update)
specifier|private
specifier|static
name|boolean
name|sameUpdate
