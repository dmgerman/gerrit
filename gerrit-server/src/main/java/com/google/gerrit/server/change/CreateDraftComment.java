...
annotation|@
name|Inject
DECL|method|CreateDraftComment (Provider<ReviewDb> db, BatchUpdate.Factory updateFactory, Provider<CommentJson> commentJson, PatchLineCommentsUtil plcUtil, PatchListCache patchListCache)
name|CreateDraftComment
parameter_list|(
name|Provider
argument_list|<
