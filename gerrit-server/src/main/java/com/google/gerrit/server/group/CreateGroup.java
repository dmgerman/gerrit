...
annotation|@
name|Inject
DECL|method|CreateGroup ( Provider<IdentifiedUser> self, @GerritPersonIdent PersonIdent serverIdent, ReviewDb db, AccountCache accountCache, GroupCache groupCache, GroupsCollection groups, GroupJson json, AuditService auditService, DynamicSet<GroupCreationValidationListener> groupCreationValidationListeners, @GerritServerConfig Config cfg, @Assisted String name)
name|CreateGroup
parameter_list|(
name|Provider
argument_list|<
...
return|;
block|}
DECL|method|addMembers (AccountGroup.Id groupId, Collection<? extends Account.Id> members)
specifier|private
name|void
name|addMembers
parameter_list|(
