...
annotation|@
name|Inject
DECL|method|CreateGroup (Provider<IdentifiedUser> self, GroupsCollection groups, PerformCreateGroup.Factory performCreateGroupFactory, GroupJson json, DynamicSet<GroupCreationValidationListener> groupCreationValidationListeners, @GerritServerConfig Config cfg, @Assisted String name)
name|CreateGroup
parameter_list|(
name|Provider
argument_list|<
