...
annotation|@
name|Inject
DECL|method|Factory ( GitRepositoryManager repoManager, AccountCache accountCache, MetaDataUpdate.User updateFactory, ProjectCache projectCache, Provider<IdentifiedUser> user, @GerritPersonIdent PersonIdent serverIdent)
name|Factory
parameter_list|(
name|GitRepositoryManager
name|repoManager
...
return|;
block|}
DECL|method|create (Change change, Date when)
specifier|public
name|ChangeUpdate
name|create
parameter_list|(
...
annotation|@
name|VisibleForTesting
DECL|method|ChangeUpdate (GitRepositoryManager repoManager, AccountCache accountCache, LabelTypes labelTypes, Change change, Account account, Date when, TimeZone tz)
name|ChangeUpdate
parameter_list|(
name|GitRepositoryManager
name|repoManager
...
expr_stmt|;
block|}
DECL|method|ChangeUpdate (GitRepositoryManager repoManager, AccountCache accountCache, @Nullable MetaDataUpdate.User updateFactory, LabelTypes labelTypes, Change change, Account account, Date when, TimeZone tz)
specifier|private
name|ChangeUpdate
parameter_list|(
name|GitRepositoryManager
