...
block|}
block|}
DECL|method|controlFor (Change.Id id, CurrentUser user)
specifier|public
name|ChangeControl
name|controlFor
parameter_list|(
...
return|;
block|}
DECL|method|validateFor (Change.Id id, CurrentUser user)
specifier|public
name|ChangeControl
name|validateFor
parameter_list|(
...
name|change
decl_stmt|;
DECL|method|ChangeControl (ApprovalsUtil au, RefControl r, Change c)
name|ChangeControl
parameter_list|(
name|ApprovalsUtil
name|au
...
return|;
block|}
DECL|method|cannotSubmitDraft (ReviewDb db, PatchSet patchSet, ChangeData cd)
specifier|private
name|List
argument_list|<
name|SubmitRecord
...
return|;
block|}
DECL|method|getSubmitTypeRecord (ReviewDb db, PatchSet patchSet)
specifier|public
name|SubmitTypeRecord
...
block|}
block|}
DECL|method|logInvalidResult (Term rule, Term record, String reason)
specifier|private
name|List
argument_list|<
name|SubmitRecord
...
return|;
block|}
DECL|method|logInvalidType (Term rule, String record)
specifier|private
name|SubmitTypeRecord
name|logInvalidType
parameter_list|(
...
return|;
block|}
DECL|method|logTypeRuleError (String err, Exception e)
specifier|private
name|SubmitTypeRecord
name|logTypeRuleError
parameter_list|(
...
name|typeRuleError
argument_list|(
literal|"Error evaluating project type rules, check server log"
argument_list|)
return|;
block|}
DECL|method|logTypeRuleError (String err)
specifier|private
name|SubmitTypeRecord
name|logTypeRuleError
parameter_list|(
...
return|;
block|}
DECL|method|typeRuleError (String err)
specifier|private
name|SubmitTypeRecord
name|typeRuleError
parameter_list|(
