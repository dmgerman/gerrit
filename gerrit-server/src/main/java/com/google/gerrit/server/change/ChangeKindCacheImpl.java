...
annotation|@
name|Inject
DECL|method|ChangeKindCacheImpl ( @erritServerConfig Config serverConfig, @Named(ID_CACHE) LoadingCache<Key, ChangeKind> cache, ChangeData.Factory changeDataFactory, ProjectCache projectCache, GitRepositoryManager repoManager)
name|ChangeKindCacheImpl
parameter_list|(
annotation|@
name|GerritServerConfig
