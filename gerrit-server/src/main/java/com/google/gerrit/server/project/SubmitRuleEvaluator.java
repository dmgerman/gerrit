...
annotation|@
name|Inject
DECL|method|SubmitRuleEvaluator ( AccountCache accountCache, Accounts accounts, Emails emails, @Assisted ChangeData cd)
name|SubmitRuleEvaluator
parameter_list|(
name|AccountCache
name|accountCache
...
name|format
argument_list|(
literal|"Cannot load rules.pl for %s"
argument_list|,
name|getProjectName
argument_list|()
argument_list|)
