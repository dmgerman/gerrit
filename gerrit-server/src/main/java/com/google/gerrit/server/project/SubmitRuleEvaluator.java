...
annotation|@
name|Inject
DECL|method|SubmitRuleEvaluator ( AccountCache accountCache, Accounts accounts, Emails emails, ProjectCache projectCache, Provider<ReviewDb> dbProvider, ChangeControl.GenericFactory changeControlFactory, @Assisted CurrentUser user, @Assisted ChangeData cd)
name|SubmitRuleEvaluator
parameter_list|(
name|AccountCache
name|accountCache
