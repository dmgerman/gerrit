...
return|;
block|}
DECL|method|refresh (final Change change, final PatchSet ps, final Ref ref, SubmitType type, String strategy, Repository git)
specifier|private
name|boolean
name|refresh
parameter_list|(
...
return|;
block|}
DECL|method|isMergeable (Change change, PatchSet ps, Ref ref, SubmitType type, String strategy, Repository git)
specifier|private
name|boolean
name|isMergeable
parameter_list|(
