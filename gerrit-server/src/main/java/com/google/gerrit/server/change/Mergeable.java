...
return|;
block|}
DECL|method|refresh (Change change, PatchSet ps, String submitType, Repository git, Map<String, Ref> refs, Ref ref)
specifier|private
name|boolean
name|refresh
parameter_list|(
...
name|format
argument_list|(
literal|"Change %d uses unsupported submit_type \"%s\""
argument_list|,
name|change
operator|.
name|getId
