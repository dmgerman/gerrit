...
annotation|@
name|Inject
DECL|method|DeleteChangeOp ( PatchSetUtil psUtil, StarredChangesUtil starredChangesUtil, DynamicItem<AccountPatchReviewStore> accountPatchReviewStore, @GerritServerConfig Config cfg, ChangeDeleted changeDeleted)
name|DeleteChangeOp
parameter_list|(
name|PatchSetUtil
name|psUtil
...
return|;
block|}
DECL|method|deleteChangeElementsFromDb (ChangeContext ctx, Change.Id id)
specifier|private
name|void
name|deleteChangeElementsFromDb
parameter_list|(
