...
name|db
decl_stmt|;
DECL|method|Loader (EntryKey key, Branch.NameKey dest, Repository repo, ReviewDb db)
name|Loader
parameter_list|(
name|EntryKey
name|key
...
annotation|@
name|Inject
DECL|method|MergeabilityCacheImpl ( SubmitStrategyFactory submitStrategyFactory, @Named(CACHE_NAME) Cache<EntryKey, Boolean> cache)
name|MergeabilityCacheImpl
parameter_list|(
name|SubmitStrategyFactory
name|submitStrategyFactory
