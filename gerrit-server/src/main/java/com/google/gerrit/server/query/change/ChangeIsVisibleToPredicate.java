...
name|permissionBackend
decl_stmt|;
DECL|method|ChangeIsVisibleToPredicate ( Provider<ReviewDb> db, ChangeNotes.Factory notesFactory, ChangeControl.GenericFactory changeControlFactory, CurrentUser user, PermissionBackend permissionBackend)
specifier|public
name|ChangeIsVisibleToPredicate
parameter_list|(
name|Provider
