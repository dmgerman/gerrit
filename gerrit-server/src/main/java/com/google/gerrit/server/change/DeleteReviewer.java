...
annotation|@
name|Inject
DECL|method|DeleteReviewer (Provider<ReviewDb> dbProvider, ChangeUpdate.Factory updateFactory, ApprovalsUtil approvalsUtil, ChangeIndexer indexer, IdentifiedUser.GenericFactory userFactory)
name|DeleteReviewer
parameter_list|(
name|Provider
argument_list|<
