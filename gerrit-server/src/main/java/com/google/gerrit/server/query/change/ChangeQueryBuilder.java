...
expr_stmt|;
block|}
DECL|method|Arguments ( Provider<ReviewDb> db, Provider<InternalChangeQuery> queryProvider, IndexRewriter rewriter, IdentifiedUser.GenericFactory userFactory, Provider<CurrentUser> self, CapabilityControl.Factory capabilityControlFactory, GroupDetailFactory.Factory groupDetailFactory, ChangeControl.GenericFactory changeControlGenericFactory, ChangeData.Factory changeDataFactory, FieldDef.FillArgs fillArgs, PatchLineCommentsUtil plcUtil, AccountResolver accountResolver, GroupBackend groupBackend, AllProjectsName allProjectsName, AllUsersNameProvider allUsersName, PatchListCache patchListCache, GitRepositoryManager repoManager, ProjectCache projectCache, GroupCache groupCache, Provider<ListChildProjects> listChildProjects, SubmitStrategyFactory submitStrategyFactory, ConflictsCache conflictsCache, TrackingFooters trackingFooters, ChangeIndex index, IndexConfig indexConfig, boolean allowsDrafts)
specifier|private
name|Arguments
parameter_list|(
name|Provider
...
annotation|@
name|VisibleForTesting
DECL|method|ChangeQueryBuilder ( Definition<ChangeData, ? extends QueryBuilder<ChangeData>> def, Arguments args)
specifier|protected
name|ChangeQueryBuilder
parameter_list|(
name|Definition
...
block|}
block|}
comment|// expand a group predicate into multiple user predicates
if|if
condition|(
name|group
operator|!=
...
return|;
block|}
DECL|method|getMemberIds (AccountGroup.UUID groupUUID, Set<AccountGroup.UUID> seenGroups)
specifier|private
name|Set
argument_list|<
name|Account
...
block|}
block|}
comment|// Get members of subgroups
if|if
condition|(
name|groupDetail
operator|.
