...
annotation|@
name|VisibleForTesting
DECL|method|ChangeQueryBuilder ( QueryBuilder.Definition<ChangeData, ? extends ChangeQueryBuilder> def, Arguments args, CurrentUser currentUser)
specifier|protected
name|ChangeQueryBuilder
parameter_list|(
name|QueryBuilder
...
expr_stmt|;
block|}
DECL|method|setAllowFileRegex (boolean on)
specifier|public
name|void
...
throw|;
block|}
DECL|method|requireIndex (String field, String value)
specifier|private
name|ChangeIndex
name|requireIndex
parameter_list|(
...
name|error
argument_list|(
literal|"secondary index must be enabled for "
operator|+
name|field
operator|+
literal|":"
