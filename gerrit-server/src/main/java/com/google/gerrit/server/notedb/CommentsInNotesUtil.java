...
annotation|@
name|Inject
DECL|method|CommentsInNotesUtil (AccountCache accountCache, @GerritPersonIdent PersonIdent serverIdent, @AnonymousCowardName String anonymousCowardName, ChangeNoteUtil changeNoteUtil)
specifier|public
name|CommentsInNotesUtil
parameter_list|(
name|AccountCache
