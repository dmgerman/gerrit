...
DECL|method|writeCommentsToNoteMap (NoteMap noteMap, Map<RevId, List<PatchLineComment>> allComments, ObjectInserter inserter)
specifier|public
name|void
...
argument_list|)
expr_stmt|;
comment|// We allow comments for multiple commits to be written in the same
comment|// update, even though the rest of the metadata update is associated with
comment|// a single patch set.
name|noteMap
operator|.
name|set
argument_list|(
...
block|}
block|}
DECL|method|addCommentToMap (Map<RevId, List<PatchLineComment>> map, PatchLineComment c)
specifier|static
name|void
