...
name|alreadyAccepted
decl_stmt|;
DECL|method|ChangeDataCache (Change change, Provider<ReviewDb> db, ProjectCache projectCache)
name|ChangeDataCache
parameter_list|(
name|Change
name|change
