...
expr_stmt|;
block|}
comment|/**    * Rebases a commit    *    * @param git Repository to find commits in    * @param original The commit to rebase    * @param base Base to rebase against    * @return CommitBuilder the newly rebased commit    * @throws IOException Merged failed    */
DECL|method|rebaseCommit (Repository git, RevCommit original, RevCommit base, PersonIdent committerIdent)
specifier|public
specifier|static
name|CommitBuilder
name|rebaseCommit
