...
return|;
block|}
DECL|method|abandon (final PatchSet.Id patchSetId, final IdentifiedUser user, final String message, final ReviewDb db, final AbandonedSender.Factory senderFactory, final ChangeHookRunner hooks)
specifier|public
specifier|static
name|void
name|abandon
...
expr_stmt|;
block|}
DECL|method|publishDraftPatchSet (final ReviewDb db, final PatchSet.Id patchSetId)
specifier|public
specifier|static
name|void
...
expr_stmt|;
block|}
DECL|method|deleteDraftPatchSet (final PatchSet.Id patchSetId, GitRepositoryManager gitManager, final ReplicationQueue replication, final PatchSetInfoFactory patchSetInfoFactory, final ReviewDb db)
specifier|public
specifier|static
name|void
