...
annotation|@
name|Inject
DECL|method|ChangeUtil (Provider<CurrentUser> user, Provider<ReviewDb> db, Sequences seq, PatchSetUtil psUtil, RevertedSender.Factory revertedSenderFactory, ChangeInserter.Factory changeInserterFactory, GitRepositoryManager gitManager, BatchUpdate.Factory updateFactory, ChangeMessagesUtil changeMessagesUtil, ChangeUpdate.Factory changeUpdateFactory)
name|ChangeUtil
parameter_list|(
name|Provider
argument_list|<
