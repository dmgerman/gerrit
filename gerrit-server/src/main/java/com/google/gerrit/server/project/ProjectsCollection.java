...
annotation|@
name|Inject
DECL|method|ProjectsCollection ( DynamicMap<RestView<ProjectResource>> views, Provider<ListProjects> list, ProjectControl.GenericFactory controlFactory, PermissionBackend permissionBackend, CreateProject.Factory factory, Provider<CurrentUser> user)
name|ProjectsCollection
parameter_list|(
name|DynamicMap
argument_list|<
