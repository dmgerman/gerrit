...
annotation|@
name|Inject
DECL|method|CommitValidators (@erritPersonIdent PersonIdent gerritIdent, @CanonicalWebUrl @Nullable String canonicalWebUrl, @GerritServerConfig Config config, DynamicSet<CommitValidationListener> commitValidationListeners, AllUsersName allUsers, @Assisted SshInfo sshInfo, @Assisted Repository repo, @Assisted RefControl refControl)
name|CommitValidators
parameter_list|(
annotation|@
name|GerritPersonIdent
