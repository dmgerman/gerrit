...
name|Policy
block|{
comment|/** Use {@link Factory#forGerritCommits}. */
DECL|enumConstant|GERRIT
name|GERRIT
block|,
comment|/** Use {@link Factory#forReceiveCommits}. */
...
argument_list|,
operator|new
name|BlockExternalIdUpdateListener
argument_list|(
name|allUsers
argument_list|)
argument_list|)
...
block|}
block|}
comment|/** Blocks any update to refs/meta/external-ids */
DECL|class|BlockExternalIdUpdateListener
specifier|public
specifier|static
class|class
name|BlockExternalIdUpdateListener
...
name|allUsers
decl_stmt|;
DECL|method|BlockExternalIdUpdateListener (AllUsersName allUsers)
specifier|public
name|BlockExternalIdUpdateListener
parameter_list|(
name|AllUsersName
