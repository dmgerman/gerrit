...
annotation|@
name|Inject
DECL|method|Factory ( @erritPersonIdent PersonIdent gerritIdent, @CanonicalWebUrl @Nullable String canonicalWebUrl, @GerritServerConfig Config cfg, DynamicSet<CommitValidationListener> pluginValidators, AllUsersName allUsers, ExternalIdsConsistencyChecker externalIdsConsistencyChecker, ProjectCache projectCache)
name|Factory
parameter_list|(
annotation|@
name|GerritPersonIdent
...
name|allUsers
decl_stmt|;
DECL|method|AccountValidator (AllUsersName allUsers)
specifier|public
name|AccountValidator
parameter_list|(
name|AllUsersName
...
comment|// MergeValidators.AccountValidator
return|return
name|Collections
operator|.
name|emptyList
...
name|CommitValidationException
argument_list|(
literal|"account update not allowed"
argument_list|)
throw|;
block|}
block|}
...
return|;
block|}
DECL|method|getAccountConfigBlobId (RevWalk rw, ObjectId id)
specifier|private
name|ObjectId
name|getAccountConfigBlobId
parameter_list|(
