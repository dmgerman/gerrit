...
annotation|@
name|Inject
DECL|method|Factory ( @erritPersonIdent PersonIdent gerritIdent, @CanonicalWebUrl @Nullable String canonicalWebUrl, @GerritServerConfig Config cfg, DynamicSet<CommitValidationListener> pluginValidators, AllUsersName allUsers, ExternalIdsConsistencyChecker externalIdsConsistencyChecker)
name|Factory
parameter_list|(
annotation|@
name|GerritPersonIdent
...
expr_stmt|;
block|}
DECL|method|forReceiveCommits ( PermissionBackend.ForRef perm, RefControl refctl, SshInfo sshInfo, Repository repo, RevWalk rw)
specifier|public
name|CommitValidators
...
return|;
block|}
DECL|method|forGerritCommits ( PermissionBackend.ForRef perm, RefControl refctl, SshInfo sshInfo, RevWalk rw)
specifier|public
name|CommitValidators
...
return|;
block|}
DECL|method|forMergedCommits (PermissionBackend.ForRef perm, RefControl refControl)
specifier|public
name|CommitValidators
