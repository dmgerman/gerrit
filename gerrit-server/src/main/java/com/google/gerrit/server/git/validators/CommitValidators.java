...
return|;
block|}
DECL|method|forReceiveCommits ( PermissionBackend.ForRef perm, Branch.NameKey branch, IdentifiedUser user, SshInfo sshInfo, Repository repo, RevWalk rw, boolean skipValidation)
specifier|public
name|CommitValidators
name|forReceiveCommits
parameter_list|(
...
return|;
block|}
DECL|method|hasAllCommitsValidators ()
specifier|public
name|boolean
name|hasAllCommitsValidators
parameter_list|()
block|{
return|return
name|validators
...
expr_stmt|;
block|}
DECL|method|PluginCommitValidationListener ( final DynamicSet<CommitValidationListener> commitValidationListeners, boolean skipValidation)
specifier|public
name|PluginCommitValidationListener
parameter_list|(
specifier|final
