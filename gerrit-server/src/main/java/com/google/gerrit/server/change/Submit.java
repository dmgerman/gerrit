...
block|}
block|}
comment|/**    * @param changes list of changes to be submitted at once    * @param identifiedUser the user who is checking to submit    * @return a reason why any of the changes is not submittable or null    */
DECL|method|problemsForSubmittingChanges (List<ChangeData> changes, IdentifiedUser identifiedUser)
specifier|private
name|String
