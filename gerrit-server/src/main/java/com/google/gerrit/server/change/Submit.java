...
annotation|@
name|Inject
DECL|method|Submit (Provider<ReviewDb> dbProvider, GitRepositoryManager repoManager, ChangeUpdate.Factory updateFactory, ApprovalsUtil approvalsUtil, MergeQueue mergeQueue, ChangeIndexer indexer)
name|Submit
parameter_list|(
name|Provider
argument_list|<
