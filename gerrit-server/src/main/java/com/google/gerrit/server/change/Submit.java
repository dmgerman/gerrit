...
block|}
block|}
DECL|method|areChangesSubmittable (List<ChangeData> changes, IdentifiedUser identifiedUser)
specifier|private
name|boolean
name|areChangesSubmittable
parameter_list|(
name|List
argument_list|<
name|ChangeData
...
name|error
argument_list|(
literal|"Failed to get a ChangeControl for Change.Id "
operator|+
name|String
operator|.
name|valueOf
...
argument_list|)
decl_stmt|;
comment|// TODO(sbeller):
comment|// If the button is visible but disabled the problem of submitting
comment|// is at another change in the same topic. Tell the user via
comment|// tooltip. Caution: Check access control for those changes.
return|return
operator|new
name|UiAction
operator|.
