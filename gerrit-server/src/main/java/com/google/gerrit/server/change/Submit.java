...
annotation|@
name|Inject
DECL|method|Submit ( Provider<ReviewDb> dbProvider, GitRepositoryManager repoManager, PermissionBackend permissionBackend, RetryHelper retryHelper, ChangeData.Factory changeDataFactory, ChangeMessagesUtil cmUtil, ChangeNotes.Factory changeNotesFactory, MergeOp.Factory mergeOpFactory, Provider<MergeSuperSet> mergeSuperSet, AccountsCollection accounts, @GerritServerConfig Config cfg, Provider<InternalChangeQuery> queryProvider, PatchSetUtil psUtil)
name|Submit
parameter_list|(
name|Provider
argument_list|<
...
annotation|@
name|Override
DECL|method|applyImpl ( BatchUpdate.Factory updateFactory, RevisionResource rsrc, SubmitInput input)
specifier|protected
name|Output
name|applyImpl
parameter_list|(
...
return|;
block|}
DECL|method|mergeChange ( BatchUpdate.Factory updateFactory, RevisionResource rsrc, IdentifiedUser submitter, SubmitInput input)
specifier|public
name|Change
name|mergeChange
parameter_list|(
...
name|OrmRuntimeException
argument_list|(
literal|"Could not check submit permission"
argument_list|,
name|e
argument_list|)
throw|;
...
annotation|@
name|Inject
DECL|method|CurrentRevision ( Provider<ReviewDb> dbProvider, RetryHelper retryHelper, Submit submit, ChangeJson.Factory json, PatchSetUtil psUtil)
name|CurrentRevision
parameter_list|(
name|Provider
argument_list|<
...
annotation|@
name|Override
DECL|method|applyImpl ( BatchUpdate.Factory updateFactory, ChangeResource rsrc, SubmitInput input)
specifier|protected
name|ChangeInfo
name|applyImpl
parameter_list|(
