...
annotation|@
name|Inject
DECL|method|CurrentRevision ( Provider<ReviewDb> dbProvider, Submit submit, ChangeJson.Factory json, PatchSetUtil psUtil, ChangeControl.GenericFactory changeControlFactory)
name|CurrentRevision
parameter_list|(
name|Provider
argument_list|<
