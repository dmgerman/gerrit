...
init|=
literal|"Clicking the button would fail for this change."
decl_stmt|;
...
DECL|method|problemsForSubmittingChanges ( RevisionResource resource, List<ChangeData> changeList, IdentifiedUser identifiedUser)
specifier|private
name|String
