...
return|;
block|}
DECL|method|createStrategy (SubmitType submitType, BatchRefUpdate branchUpdate)
specifier|private
name|SubmitStrategy
name|createStrategy
parameter_list|(
...
block|}
block|}
DECL|method|updateBranch (SubmitStrategy strategy, BatchRefUpdate branchUpdate)
specifier|private
name|BatchRefUpdate
name|updateBranch
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// TODO(dborowitz): This message is also used by all new patch set ref
comment|// updates; find a better wording that works for that case too.
name|branchUpdate
operator|.
...
block|}
block|}
DECL|method|fireRefUpdated (BatchRefUpdate branchUpdate)
specifier|private
name|void
name|fireRefUpdated
parameter_list|(
