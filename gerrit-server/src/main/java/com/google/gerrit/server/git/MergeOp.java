...
return|;
block|}
DECL|method|checkMergeStrategyResults (ChangeSet cs, Map<Branch.NameKey, SubmitStrategy> strategies, Map<Branch.NameKey, BranchBatch> batches)
specifier|private
name|void
name|checkMergeStrategyResults
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|checkCommitStatus (Map<Branch.NameKey, BranchBatch> batches)
specifier|private
name|void
name|checkCommitStatus
parameter_list|(
...
block|}
block|}
DECL|method|findUnmergedChanges ( Map<Branch.NameKey, SubmitStrategy> strategies, Map<Branch.NameKey, BranchBatch> batches)
specifier|private
name|void
name|findUnmergedChanges
parameter_list|(
...
name|StringBuilder
argument_list|(
literal|"Error updating status of change"
argument_list|)
decl_stmt|;
if|if
condition|(
...
return|;
block|}
DECL|method|saveApprovals (LabelNormalizer.Result normalized, ChangeUpdate update)
specifier|private
name|void
name|saveApprovals
parameter_list|(
...
block|}
block|}
DECL|method|convertPatchSet ( Iterable<PatchSetApproval> approvals, final PatchSet.Id psId)
specifier|private
specifier|static
name|Iterable
argument_list|<
