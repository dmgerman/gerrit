...
argument_list|()
operator|+
literal|" was abandoned while processing this change set"
argument_list|)
throw|;
case|case
name|DRAFT
...
name|MERGED
case|:
comment|// we're racing here, but having it already merged is fine.
case|case
name|SUBMITTED
case|:
comment|// ok
...
name|logDebug
argument_list|(
literal|"Submitting all calculated changes while "
operator|+
literal|"enforcing submit rules"
argument_list|)
expr_stmt|;
name|submitAllChanges
argument_list|(
...
name|logDebug
argument_list|(
literal|"Submitting all calculated changes ignoring submit rules"
argument_list|)
expr_stmt|;
name|submitAllChanges
argument_list|(
...
condition|)
block|{
comment|// For cherry picking we have relaxed atomic guarantees
comment|// as traditionally Gerrit kept going cherry picking if one
comment|// failed. We want to keep it for now.
...
block|}
block|}
DECL|method|preMerge (SubmitStrategy strategy, List<Change> submitted, CodeReviewCommit branchTip)
specifier|private
name|MergeTip
name|preMerge
parameter_list|(
...
return|;
block|}
DECL|method|createStrategy (Branch.NameKey destBranch, SubmitType submitType, CodeReviewCommit branchTip)
specifier|private
name|SubmitStrategy
name|createStrategy
parameter_list|(
...
return|;
block|}
DECL|method|updateChangeStatus (List<Change> submitted, Branch.NameKey destBranch, boolean dryRun)
specifier|private
name|void
name|updateChangeStatus
parameter_list|(
