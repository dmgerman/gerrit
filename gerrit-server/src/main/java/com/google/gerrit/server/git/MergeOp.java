...
argument_list|()
decl_stmt|;
comment|// in case superproject subscription is disabled, allProjects would be null
if|if
condition|(
name|allProjects
operator|==
...
argument_list|()
decl_stmt|;
comment|// in case superproject subscription is disabled, allBranches would be null
if|if
condition|(
name|allBranches
operator|==
