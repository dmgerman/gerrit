...
argument_list|)
decl_stmt|;
DECL|field|DUPLICATE_MESSAGE_INTERVAL
specifier|private
specifier|static
specifier|final
name|long
name|DUPLICATE_MESSAGE_INTERVAL
init|=
name|MILLISECONDS
operator|.
name|convert
...
expr_stmt|;
block|}
DECL|method|isDuplicate (ChangeMessage msg)
specifier|private
name|boolean
name|isDuplicate
parameter_list|(
...
name|warn
argument_list|(
literal|"Cannot check previous merge failure message"
argument_list|,
name|err
argument_list|)
expr_stmt|;
