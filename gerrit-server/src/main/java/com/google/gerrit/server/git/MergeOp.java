...
name|ins
decl_stmt|;
DECL|method|OpenRepo (Repository repo)
name|OpenRepo
parameter_list|(
name|Repository
name|repo
...
return|;
block|}
DECL|method|getPendingRefUpdate (OpenRepo repo, Branch.NameKey destBranch)
specifier|private
name|RefUpdate
...
block|}
block|}
DECL|method|getBranchTip (OpenRepo repo, Branch.NameKey destBranch)
specifier|private
name|CodeReviewCommit
name|getBranchTip
parameter_list|(
