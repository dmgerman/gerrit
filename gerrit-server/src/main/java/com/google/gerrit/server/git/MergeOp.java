...
return|;
block|}
DECL|method|saveApprovals (Change c, ChangeNotes notes, PatchSet.Id merged)
specifier|private
name|PatchSetApproval
name|saveApprovals
parameter_list|(
...
block|}
block|}
comment|// TODO(dborowitz): Store normalized labels in notedb.
name|db
operator|.
