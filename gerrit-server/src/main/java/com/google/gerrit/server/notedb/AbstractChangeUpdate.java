...
expr_stmt|;
block|}
DECL|method|AbstractChangeUpdate ( NotesMigration migration, ChangeNoteUtil noteUtil, PersonIdent serverIdent, String anonymousCowardName, @Nullable ChangeNotes notes, @Nullable Change change, Account.Id accountId, PersonIdent authorIdent, Date when)
specifier|protected
name|AbstractChangeUpdate
parameter_list|(
name|NotesMigration
