...
return|;
block|}
DECL|method|getPublished (ReviewDb db, ChangeNotes notes, Comment.Key key)
specifier|public
name|Optional
argument_list|<
name|Comment
...
return|;
block|}
DECL|method|getDraft ( ReviewDb db, ChangeNotes notes, IdentifiedUser user, Comment.Key key)
specifier|public
name|Optional
argument_list|<
name|Comment
...
name|format
argument_list|(
literal|"Expected draft %s to belong to account %s, but it belongs to %s"
argument_list|,
name|key
argument_list|,
name|user
...
return|;
block|}
DECL|method|getReviewDb (ReviewDb db, ChangeNotes notes, Comment.Key key)
specifier|private
name|Optional
argument_list|<
name|Comment
