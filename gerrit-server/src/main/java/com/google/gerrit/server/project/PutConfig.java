...
annotation|@
name|Inject
DECL|method|PutConfig (MetaDataUpdate.User metaDataUpdateFactory, ProjectCache projectCache, Provider<CurrentUser> self, ProjectState.Factory projectStateFactory, TransferConfig config)
name|PutConfig
parameter_list|(
name|MetaDataUpdate
operator|.
