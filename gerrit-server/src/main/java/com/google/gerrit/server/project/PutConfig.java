...
annotation|@
name|Inject
DECL|method|PutConfig (MetaDataUpdate.User metaDataUpdateFactory, ProjectCache projectCache, GitRepositoryManager gitMgr, ProjectState.Factory projectStateFactory, TransferConfig config, DynamicMap<RestView<ProjectResource>> views, Provider<CurrentUser> currentUser)
name|PutConfig
parameter_list|(
name|MetaDataUpdate
operator|.
