...
annotation|@
name|Inject
DECL|method|PutConfig (MetaDataUpdate.User metaDataUpdateFactory, ProjectCache projectCache, Provider<CurrentUser> self, ProjectState.Factory projectStateFactory, TransferConfig config, DynamicMap<RestView<ProjectResource>> views, ChangeHooks hooks, Provider<CurrentUser> currentUser)
name|PutConfig
parameter_list|(
name|MetaDataUpdate
operator|.
