...
annotation|@
name|Inject
DECL|method|CreateChange ( @nonymousCowardName String anonymousCowardName, Provider<ReviewDb> db, GitRepositoryManager gitManager, AccountCache accountCache, Sequences seq, @GerritPersonIdent PersonIdent myIdent, Provider<CurrentUser> user, ProjectsCollection projectsCollection, ChangeInserter.Factory changeInserterFactory, ChangeJson.Factory json, ChangeFinder changeFinder, BatchUpdate.Factory updateFactory, PatchSetUtil psUtil, @GerritServerConfig Config config, MergeUtil.Factory mergeUtilFactory, NotifyUtil notifyUtil)
name|CreateChange
parameter_list|(
annotation|@
name|AnonymousCowardName
...
annotation|@
name|Override
DECL|method|apply (TopLevelResource parent, ChangeInput input)
specifier|public
name|Response
argument_list|<
name|ChangeInfo
...
return|;
block|}
comment|/**    * Remove comment lines from a commit message.    *    *<p>Based on {@link org.eclipse.jgit.util.ChangeIdUtil#clean}.    *    * @param msg    * @return message without comment lines, possibly empty.    */
DECL|method|clean (String msg)
specifier|private
name|String
name|clean
parameter_list|(
