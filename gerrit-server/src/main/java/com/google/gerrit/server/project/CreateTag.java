...
annotation|@
name|Inject
DECL|method|CreateTag (Provider<IdentifiedUser> identifiedUser, GitRepositoryManager repoManager, TagCache tagCache, GitReferenceUpdated referenceUpdated, ChangeHooks hooks, @Assisted String ref)
name|CreateTag
parameter_list|(
name|Provider
argument_list|<
