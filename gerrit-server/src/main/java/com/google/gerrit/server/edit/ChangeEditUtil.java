...
annotation|@
name|Inject
DECL|method|ChangeEditUtil (GitRepositoryManager gitManager, PatchSetInserter.Factory patchSetInserterFactory, ProjectControl.GenericFactory projectControlFactory, ChangeControl.GenericFactory changeControlFactory, ChangeIndexer indexer, ProjectCache projectCache, Provider<ReviewDb> db, Provider<CurrentUser> user, ChangeKindCache changeKindCache, BatchUpdate.Factory updateFactory, PatchSetUtil psUtil)
name|ChangeEditUtil
parameter_list|(
name|GitRepositoryManager
name|gitManager
...
block|}
block|}
comment|/**    * Promote change edit to patch set, by squashing the edit into    * its parent.    *    * @param edit change edit to publish    * @throws NoSuchProjectException    * @throws IOException    * @throws OrmException    * @throws UpdateException    * @throws RestApiException    */
...
return|;
block|}
DECL|method|insertPatchSet (ChangeEdit edit, Change change, Repository repo, RevWalk rw, ObjectInserter oi, PatchSet basePatchSet, RevCommit squashed)
specifier|private
name|Change
name|insertPatchSet
parameter_list|(
