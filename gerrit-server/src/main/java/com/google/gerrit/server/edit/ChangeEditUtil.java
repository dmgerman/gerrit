...
annotation|@
name|Inject
DECL|method|ChangeEditUtil (GitRepositoryManager gitManager, PatchSetInserter.Factory patchSetInserterFactory, ProjectControl.GenericFactory projectControlFactory, ChangeIndexer indexer, ProjectCache projectCache, Provider<ReviewDb> db, Provider<CurrentUser> user, ChangeKindCache changeKindCache, BatchUpdate.Factory updateFactory)
name|ChangeEditUtil
parameter_list|(
name|GitRepositoryManager
name|gitManager
