...
condition|)
block|{
comment|// The change key exists on the destination branch.
throw|throw
operator|new
name|InvalidChangeOperationException
argument_list|(
literal|"Change with same change-id: "
operator|+
name|changeKey
operator|+
literal|" already resides on the same branch. "
operator|+
literal|"Cannot create a new change."
argument_list|)
throw|;
block|}
else|else
