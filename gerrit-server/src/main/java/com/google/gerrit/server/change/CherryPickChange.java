...
return|;
block|}
DECL|method|createNewChange (Repository git, RevWalk revWalk, ObjectInserter oi, Change.Key changeKey, Project.NameKey project, Ref destRef, CodeReviewCommit cherryPickCommit, RefControl refControl, IdentifiedUser identifiedUser, String topic, Branch.NameKey sourceBranch)
specifier|private
name|Change
name|createNewChange
parameter_list|(
