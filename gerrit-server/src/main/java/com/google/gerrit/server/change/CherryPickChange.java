...
expr_stmt|;
block|}
DECL|method|cherryPick ( BatchUpdate.Factory batchUpdateFactory, Change change, PatchSet patch, CherryPickInput input, String ref, RefControl refControl)
specifier|public
name|Change
operator|.
name|Id
