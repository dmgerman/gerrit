...
argument_list|)
expr_stmt|;
name|addMessageToDestinationChange
argument_list|(
name|newChange
argument_list|,
name|change
...
expr_stmt|;
block|}
DECL|method|addMessageToDestinationChange (Change change, String sourceBranch, IdentifiedUser identifiedUser, RefControl refControl)
specifier|private
name|void
name|addMessageToDestinationChange
parameter_list|(
