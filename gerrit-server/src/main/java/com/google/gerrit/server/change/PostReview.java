...
annotation|@
name|Inject
DECL|method|PostReview (Provider<ReviewDb> db, ChangesCollection changes, ChangeUpdate.Factory updateFactory, ApprovalsUtil approvalsUtil, ChangeIndexer indexer, AccountsCollection accounts, EmailReviewComments.Factory email, ChangeHooks hooks)
name|PostReview
parameter_list|(
name|Provider
argument_list|<
