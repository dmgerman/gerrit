...
annotation|@
name|Inject
DECL|method|PostReview (ReviewDb db, AccountsCollection accounts, EmailReviewComments.Factory email, ChangeHooks hooks)
name|PostReview
parameter_list|(
name|ReviewDb
name|db
...
return|;
block|}
DECL|method|onBehalfOf (RevisionResource rev, Input in)
specifier|private
name|RevisionResource
name|onBehalfOf
parameter_list|(
