...
annotation|@
name|Inject
DECL|method|PostReview ( Provider<ReviewDb> db, Factory batchUpdateFactory, ChangesCollection changes, ChangeData.Factory changeDataFactory, ApprovalsUtil approvalsUtil, ChangeMessagesUtil cmUtil, CommentsUtil commentsUtil, PatchSetUtil psUtil, PatchListCache patchListCache, AccountsCollection accounts, EmailReviewComments.Factory email, CommentAdded commentAdded, PostReviewers postReviewers, NotesMigration migration, NotifyUtil notifyUtil, @GerritServerConfig Config gerritConfig)
name|PostReview
parameter_list|(
name|Provider
argument_list|<
...
return|;
block|}
DECL|method|checkLabels (RevisionResource rsrc, boolean strict, Map<String, Short> labels)
specifier|private
name|void
name|checkLabels
parameter_list|(
...
argument_list|()
decl_stmt|;
DECL|method|Op ( PatchSet.Id psId, ReviewInput in, ListMultimap<RecipientType, Account.Id> accountsToNotify)
specifier|private
name|Op
parameter_list|(
name|PatchSet
...
return|;
block|}
DECL|method|publishComment (ChangeContext ctx, Comment c, PatchSet ps)
specifier|private
name|Comment
name|publishComment
parameter_list|(
