...
return|;
block|}
DECL|method|checkLabels ( RevisionResource rsrc, LabelTypes labelTypes, boolean strict, Map<String, Short> labels)
specifier|private
name|void
name|checkLabels
parameter_list|(
...
argument_list|()
decl_stmt|;
DECL|method|Op ( ProjectState projectState, PatchSet.Id psId, ReviewInput in, ListMultimap<RecipientType, Account.Id> accountsToNotify)
specifier|private
name|Op
parameter_list|(
name|ProjectState
