...
annotation|@
name|Inject
DECL|method|TestSubmitType ( Provider<ReviewDb> db, AccountCache accountCache, Accounts accounts, Emails emails, ChangeData.Factory changeDataFactory, RulesCache rules)
name|TestSubmitType
parameter_list|(
name|Provider
argument_list|<
