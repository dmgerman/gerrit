...
annotation|@
name|Inject
DECL|method|WebLinks (DynamicSet<PatchSetWebLink> patchSetLinks, DynamicSet<FileWebLink> fileLinks, DynamicSet<FileHistoryWebLink> fileLogLinks, DynamicSet<DiffWebLink> diffLinks, DynamicSet<ProjectWebLink> projectLinks, DynamicSet<BranchWebLink> branchLinks )
specifier|public
name|WebLinks
parameter_list|(
name|DynamicSet
...
DECL|method|getFileHistoryLinks (final String project, final String revision, final String file)
specifier|public
name|FluentIterable
argument_list|<
name|WebLinkInfo
...
return|;
block|}
DECL|method|getFileHistoryLinksCommon ( final String project, final String revision, final String file)
specifier|public
name|FluentIterable
argument_list|<
name|WebLinkInfoCommon
