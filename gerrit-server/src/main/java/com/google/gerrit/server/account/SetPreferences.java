...
annotation|@
name|Inject
DECL|method|SetPreferences (Provider<CurrentUser> self, AccountCache cache, ReviewDb db, MetaDataUpdate.User metaDataUpdateFactory, ProjectCache projectCache)
name|SetPreferences
parameter_list|(
name|Provider
argument_list|<
...
return|;
block|}
DECL|method|storeMyMenus (Account.Id accountId, List<TopMenu.MenuItem> my)
specifier|private
name|void
name|storeMyMenus
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|storeMyMenus (String ref, List<TopMenu.MenuItem> my)
specifier|public
name|void
name|storeMyMenus
parameter_list|(
