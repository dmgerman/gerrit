...
annotation|@
name|Inject
DECL|method|ProjectControl ( @itUploadPackGroups Set<AccountGroup.UUID> uploadGroups, @GitReceivePackGroups Set<AccountGroup.UUID> receiveGroups, ProjectCache pc, PermissionCollection.Factory permissionFilter, ChangeControl.Factory changeControlFactory, VisibleRefFilter.Factory refFilter, Provider<InternalChangeQuery> queryProvider, @CanonicalWebUrl @Nullable String canonicalWebUrl, PermissionBackend permissionBackend, @Assisted CurrentUser who, @Assisted ProjectState ps, Metrics metrics)
name|ProjectControl
parameter_list|(
annotation|@
name|GitUploadPackGroups
...
return|;
block|}
DECL|method|canReadCommitFromVisibleRef (Repository repo, RevCommit commit)
specifier|private
name|boolean
name|canReadCommitFromVisibleRef
parameter_list|(
...
block|}
block|}
DECL|method|isMergedIntoVisibleRef ( Repository repo, RevWalk rw, RevCommit commit, Collection<Ref> unfilteredRefs)
name|boolean
name|isMergedIntoVisibleRef
parameter_list|(
name|Repository
