...
parameter_list|)
block|{
comment|// TODO(hiesel) Hide refs/changes and replace this method by a proper READ check of all refs
return|return
name|user
operator|.
name|isInternalUser
...
return|;
block|}
comment|/** @return {@code Capable.OK} if the user can upload to at least one reference */
