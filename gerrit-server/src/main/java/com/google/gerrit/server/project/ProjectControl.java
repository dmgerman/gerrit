...
annotation|@
name|Inject
DECL|method|ProjectControl (final SystemConfig systemConfig, @GitUploadPackGroups Set<AccountGroup.Id> uploadGroups, @GitReceivePackGroups Set<AccountGroup.Id> receiveGroups, final RefControl.Factory refControlFactory, @Assisted CurrentUser who, @Assisted ProjectState ps)
name|ProjectControl
parameter_list|(
specifier|final
name|SystemConfig
...
return|;
block|}
comment|/**    * @return the effective groups of the current user for this project    */
DECL|method|getEffectiveUserGroups ()
specifier|private
name|Set
argument_list|<
name|AccountGroup
