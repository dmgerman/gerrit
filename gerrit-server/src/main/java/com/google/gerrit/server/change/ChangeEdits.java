...
annotation|@
name|Inject
DECL|method|Create (ChangeEditUtil editUtil, ChangeEditModifier editModifier, GitRepositoryManager repositoryManager, Put putEdit, @Assisted @Nullable String path)
name|Create
parameter_list|(
name|ChangeEditUtil
name|editUtil
...
annotation|@
name|Inject
DECL|method|Post (ChangeEditUtil editUtil, ChangeEditModifier editModifier, GitRepositoryManager repoManager)
name|Post
parameter_list|(
name|ChangeEditUtil
name|editUtil
...
annotation|@
name|Inject
DECL|method|EditMessage (ChangeEditModifier editModifier, ChangeEditUtil editUtil, GitRepositoryManager repositoryManager)
name|EditMessage
parameter_list|(
name|ChangeEditModifier
name|editModifier
...
return|;
block|}
DECL|method|getOrCreateChangeEdit (Repository repository, ChangeControl changeControl)
specifier|private
name|ChangeEdit
name|getOrCreateChangeEdit
parameter_list|(
