...
annotation|@
name|Inject
DECL|method|Create (Provider<ReviewDb> db, ChangeEditUtil editUtil, ChangeEditModifier editModifier, PatchSetUtil psUtil, Put putEdit, @Assisted Change change, @Assisted @Nullable String path)
name|Create
parameter_list|(
name|Provider
argument_list|<
...
annotation|@
name|Inject
DECL|method|DeleteFile (ChangeEditUtil editUtil, ChangeEditModifier editModifier, PatchSetUtil psUtil, Provider<ReviewDb> db, @Assisted String path)
name|DeleteFile
parameter_list|(
name|ChangeEditUtil
name|editUtil
...
annotation|@
name|Inject
DECL|method|Post (Provider<ReviewDb> db, ChangeEditUtil editUtil, ChangeEditModifier editModifier, PatchSetUtil psUtil)
name|Post
parameter_list|(
name|Provider
argument_list|<
...
annotation|@
name|Inject
DECL|method|EditMessage (Provider<ReviewDb> db, ChangeEditModifier editModifier, ChangeEditUtil editUtil, PatchSetUtil psUtil)
name|EditMessage
parameter_list|(
name|Provider
argument_list|<
...
annotation|@
name|Inject
DECL|method|GetMessage (ChangeEditUtil editUtil)
name|GetMessage
parameter_list|(
name|ChangeEditUtil
name|editUtil
