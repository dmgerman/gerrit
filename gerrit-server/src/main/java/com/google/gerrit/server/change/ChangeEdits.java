...
annotation|@
name|Inject
DECL|method|ChangeEdits (DynamicMap<RestView<ChangeEditResource>> views, Create.Factory createFactory, Detail detail, ChangeEditUtil editUtil, Post post, DeleteEdit.Factory deleteEditFactory)
name|ChangeEdits
parameter_list|(
name|DynamicMap
argument_list|<
