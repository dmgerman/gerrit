...
name|format
argument_list|(
literal|"fatal: %s does not have \"Create Project\" capability."
argument_list|,
name|currentUser
operator|.
name|getUserName
...
parameter_list|)
block|{
name|handleRepositoryExistsException
argument_list|(
name|nameKey
argument_list|)
expr_stmt|;
...
literal|1
argument_list|,
literal|"fatal: Argument NAME is required"
argument_list|)
throw|;
block|}
if|if
...
block|}
block|}
DECL|method|handleRepositoryExistsException (final Project.NameKey projectName)
specifier|private
name|void
name|handleRepositoryExistsException
parameter_list|(
