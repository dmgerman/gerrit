...
annotation|@
name|Inject
DECL|field|deleteDraftPatchSetImpl
specifier|private
name|DeleteDraftPatchSet
name|deleteDraftPatchSetImpl
decl_stmt|;
annotation|@
name|Inject
...
block|}
block|}
DECL|method|applyReview (final ChangeControl ctl, final PatchSet patchSet, final ReviewInput review)
specifier|private
name|void
name|applyReview
parameter_list|(
