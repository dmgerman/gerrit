...
name|changeId
operator|+
literal|": you do not have submit permission"
argument_list|)
throw|;
block|}
break|break;
...
literal|1
argument_list|,
literal|"Unsupported label status "
operator|+
name|lbl
operator|.
name|status
...
name|writeError
argument_list|(
literal|"error: not permitted to abandon change"
argument_list|)
expr_stmt|;
break|break;
case|case
...
name|writeError
argument_list|(
literal|"error: not permitted to restore change"
argument_list|)
expr_stmt|;
break|break;
default|default:
name|writeError
argument_list|(
literal|"error: failure in review"
argument_list|)
expr_stmt|;
block|}
block|}
