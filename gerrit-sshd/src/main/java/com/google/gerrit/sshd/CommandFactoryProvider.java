...
annotation|@
name|Inject
DECL|method|CommandFactoryProvider ( @ommandNameCommands.ROOT) final DispatchCommandProvider d, @GerritServerConfig final Config cfg, final WorkQueue workQueue, final SshLog l, final SshScope s, SchemaFactory<ReviewDb> sf, DynamicItem<SshCreateCommandInterceptor> i)
name|CommandFactoryProvider
parameter_list|(
annotation|@
name|CommandName
