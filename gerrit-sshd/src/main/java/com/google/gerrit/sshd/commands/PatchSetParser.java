...
annotation|@
name|Inject
DECL|method|PatchSetParser (Provider<ReviewDb> db, Provider<InternalChangeQuery> queryProvider, ChangeNotes.Factory notesFactory, PatchSetUtil psUtil)
name|PatchSetParser
parameter_list|(
name|Provider
argument_list|<
...
throw|;
block|}
DECL|method|getNotes (Change.Id changeId)
specifier|private
name|ChangeNotes
name|getNotes
parameter_list|(
