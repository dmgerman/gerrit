...
argument_list|()
decl_stmt|;
DECL|field|sensitiveParameters
specifier|private
name|Set
argument_list|<
name|String
...
expr_stmt|;
block|}
DECL|method|getMaskedArguments ()
specifier|public
name|List
argument_list|<
name|String
argument_list|>
name|getMaskedArguments
parameter_list|()
block|{
return|return
name|maskedArgv
return|;
block|}
DECL|method|getFormattedMaskedArguments (String delimiter)
specifier|public
name|String
name|getFormattedMaskedArguments
parameter_list|(
name|String
name|delimiter
parameter_list|)
...
return|;
block|}
DECL|method|setMaskedArguments (List<String> argv)
specifier|public
name|void
name|setMaskedArguments
parameter_list|(
name|List
argument_list|<
name|String
...
expr_stmt|;
block|}
DECL|method|isSensitiveParameter (String param)
specifier|public
name|boolean
name|isSensitiveParameter
parameter_list|(
name|String
name|param
parameter_list|)
...
return|;
block|}
DECL|method|maskSensitiveParameters ()
specifier|private
name|void
...
argument_list|)
expr_stmt|;
comment|// When arg != key then parameter contains '=' sign and we mask them right away.
comment|// Otherwise we mask the next parameter as indicated by maskNext.
if|if
condition|(
operator|!
name|maskNext
...
block|}
block|}
DECL|method|extractKey (String arg)
specifier|private
name|String
name|extractKey
parameter_list|(
