...
name|SignatureECDSA
operator|.
name|NISTP256Factory
argument_list|()
argument_list|,
operator|new
name|SignatureECDSA
operator|.
name|NISTP384Factory
argument_list|()
argument_list|,
operator|new
name|SignatureECDSA
operator|.
name|NISTP521Factory
argument_list|()
argument_list|)
argument_list|)
expr_stmt|;
