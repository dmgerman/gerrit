...
condition|)
block|{
comment|// Since Apache SSHD does not allow to turn off closing idle connections,
comment|// we fake it by using the highest timeout allowed by Apache SSHD, which
comment|// amounts to ~24 days.
name|idleTimeoutSeconds
operator|=
name|MILLISECONDS
operator|.
