...
annotation|@
name|Inject
DECL|method|SshKeyCacheImpl ( @amedCACHE_NAME) final Cache<String, Iterable<SshKeyCacheEntry>> cache)
name|SshKeyCacheImpl
parameter_list|(
annotation|@
name|Named
...
annotation|@
name|Override
DECL|method|createEntry (String username)
specifier|public
name|Iterable
argument_list|<
name|SshKeyCacheEntry
...
annotation|@
name|Override
DECL|method|missing (String username)
specifier|public
name|Iterable
argument_list|<
name|SshKeyCacheEntry
