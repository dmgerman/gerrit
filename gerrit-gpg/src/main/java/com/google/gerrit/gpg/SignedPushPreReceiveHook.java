...
annotation|@
name|Inject
DECL|method|SignedPushPreReceiveHook ( GitRepositoryManager repoManager, AllUsersName allUsers, Provider<IdentifiedUser> user, GerritPublicKeyChecker.Factory keyCheckerFactory)
specifier|public
name|SignedPushPreReceiveHook
parameter_list|(
name|GitRepositoryManager
