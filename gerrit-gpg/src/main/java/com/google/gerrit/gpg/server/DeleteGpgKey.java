...
annotation|@
name|Inject
DECL|method|DeleteGpgKey ( @erritPersonIdent Provider<PersonIdent> serverIdent, Provider<PublicKeyStore> storeProvider, ExternalIdsUpdate.User externalIdsUpdateFactory, DeleteKeySender.Factory deleteKeySenderFactory)
name|DeleteGpgKey
parameter_list|(
annotation|@
name|GerritPersonIdent
...
name|error
argument_list|(
literal|"Cannot send GPG key deletion message to {}"
argument_list|,
name|rsrc
operator|.
name|getUser
