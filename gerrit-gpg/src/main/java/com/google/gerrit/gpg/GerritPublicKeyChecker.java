...
annotation|@
name|Inject
DECL|method|Factory (@erritServerConfig Config cfg, Provider<ReviewDb> db, AccountIndexCollection accountIndexes, Provider<InternalAccountQuery> accountQueryProvider, IdentifiedUser.GenericFactory userFactory, @CanonicalWebUrl String webUrl)
name|Factory
parameter_list|(
annotation|@
name|GerritServerConfig
