...
block|}
block|}
comment|/**      * Create a checker that can check arbitrary public keys.      *<p>      * Each key is checked against the set of identities in the database      * belonging to the same user as the key.      *      * @return a new checker.      */
DECL|method|create ()
specifier|public
name|GerritPublicKeyChecker
name|create
...
return|;
block|}
comment|/**      * Create a checker for checking a single public key against a known user.      *<p>      * The top-level key passed to {@link #check(PGPPublicKey, PublicKeyStore)}      * must belong to the given user. (Other keys checked in the course of      * verifying the web of trust are checked against the set of identities in      * the database belonging to the same user as the key.)      *      * @param expectedUser the user      * @return a new checker.      */
...
block|}
block|}
DECL|method|GerritPublicKeyChecker (Factory factory, IdentifiedUser expectedUser)
specifier|private
name|GerritPublicKeyChecker
parameter_list|(
name|Factory
