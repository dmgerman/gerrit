...
annotation|@
name|Inject
DECL|method|GpgKeys ( DynamicMap<RestView<GpgKey>> views, Provider<ReviewDb> db, Provider<CurrentUser> self, Provider<PublicKeyStore> storeProvider, GerritPublicKeyChecker.Factory checkerFactory)
name|GpgKeys
parameter_list|(
name|DynamicMap
argument_list|<
