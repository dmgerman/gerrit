...
annotation|@
name|Inject
DECL|method|GpgKeys (DynamicMap<RestView<GpgKey>> views, Provider<ReviewDb> db, Provider<PublicKeyStore> storeProvider, PublicKeyChecker checker)
name|GpgKeys
parameter_list|(
name|DynamicMap
argument_list|<
...
annotation|@
name|Inject
DECL|method|Get (Provider<PublicKeyStore> storeProvider, PublicKeyChecker checker)
name|Get
parameter_list|(
name|Provider
argument_list|<
...
block|}
block|}
DECL|method|toJson (PGPPublicKeyRing keyRing, PublicKeyChecker checker, PublicKeyStore store)
specifier|static
name|GpgKeyInfo
name|toJson
parameter_list|(
