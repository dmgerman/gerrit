...
begin_comment
comment|/**  * Simple map-like structure to pass configuration to CodeMirror.  *  * @see<a href="http://codemirror.net/doc/manual.html#config">CodeMirror config</a>  * @see CodeMirror#create(com.google.gerrit.client.diff.DisplaySide, com.google.gwt.dom.client.Element, Configuration)  */
end_comment
