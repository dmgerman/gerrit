...
expr_stmt|;
block|}
DECL|method|ExtensionPanel (GerritUiExtensionPoint extensionPoint, List<String> panelNames)
specifier|public
name|ExtensionPanel
parameter_list|(
name|GerritUiExtensionPoint
...
expr_stmt|;
block|}
DECL|method|create (List<String> panelNames)
specifier|private
name|List
argument_list|<
name|Context
...
return|;
block|}
DECL|method|getOrderedDefs (List<String> panelNames)
specifier|private
name|List
argument_list|<
name|Definition
...
return|;
block|}
DECL|method|addDef (Definition def, Map<String, List<Definition>> defsOrderedByName)
specifier|private
specifier|static
name|void
name|addDef
...
name|init
parameter_list|()
comment|/*-{       function PanelDefinition(n, c, x) {         this.pluginName = n;         this.onLoad = c;         this.name = x;       };       return PanelDefinition;     }-*/
function_decl|;
...
name|getPanelName
parameter_list|()
comment|/*-{ return this.pluginName + "." + this.name; }-*/
function_decl|;
...
name|getPluginName
parameter_list|()
comment|/*-{ return this.pluginName; }-*/
function_decl|;
block|}
DECL|class|Context
specifier|static
