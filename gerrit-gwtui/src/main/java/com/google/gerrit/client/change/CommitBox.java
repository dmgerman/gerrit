...
name|more
decl_stmt|;
DECL|field|parentNotCurrentText
annotation|@
name|UiField
name|Element
name|parentNotCurrentText
decl_stmt|;
DECL|field|expanded
specifier|private
name|boolean
...
expr_stmt|;
block|}
DECL|method|setParentNotCurrent (boolean parentNotCurrent)
name|void
name|setParentNotCurrent
parameter_list|(
name|boolean
name|parentNotCurrent
parameter_list|)
block|{
comment|// display the orange ball if parent has moved on (not current)
name|UIObject
operator|.
name|setVisible
argument_list|(
...
block|}
block|}
DECL|method|toAnchor (String href, String name)
specifier|private
name|void
name|toAnchor
parameter_list|(
...
block|}
block|}
DECL|method|addLinks (String project, CommitInfo c, FlowPanel panel)
specifier|private
name|void
name|addLinks
parameter_list|(
...
block|}
block|}
DECL|method|getCommitLabel (CommitInfo c)
specifier|private
name|CopyableLabel
name|getCommitLabel
parameter_list|(
