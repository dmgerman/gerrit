...
expr_stmt|;
block|}
DECL|method|addExtensionPoints ()
specifier|private
name|void
name|addExtensionPoints
parameter_list|()
...
expr_stmt|;
block|}
DECL|method|addExtensionPoint (GerritUiExtensionPoint extensionPoint, Panel p)
specifier|private
name|void
name|addExtensionPoint
parameter_list|(
...
block|}
block|}
DECL|method|initChangeAction (ChangeInfo info)
specifier|private
name|void
name|initChangeAction
parameter_list|(
name|ChangeInfo
name|info
parameter_list|)
...
block|}
block|}
DECL|method|loadFileList (final RevisionInfo base, final RevisionInfo rev, final Timestamp myLastReply, CallbackGroup group, final List<NativeMap<JsArray<CommentInfo>>> comments, final List<NativeMap<JsArray<CommentInfo>>> drafts)
specifier|private
name|void
name|loadFileList
parameter_list|(
