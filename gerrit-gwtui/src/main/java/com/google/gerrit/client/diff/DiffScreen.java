...
name|header
decl_stmt|;
DECL|method|DiffScreen ( @ullable Project.NameKey project, DiffObject base, DiffObject revision, String path, DisplaySide startSide, int startLine, DiffView diffScreenType)
name|DiffScreen
parameter_list|(
annotation|@
name|Nullable
