...
expr_stmt|;
block|}
comment|// If there is a safe picture involved, we show it
if|if
condition|(
name|script
operator|.
...
block|}
block|}
DECL|method|createImage (String url)
specifier|private
name|SafeHtml
name|createImage
parameter_list|(
...
return|;
block|}
DECL|method|appendImageLine (final PatchScript script, final SafeHtmlBuilder m)
specifier|private
name|void
name|appendImageLine
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// Populate icons to lineNumber column header.
if|if
condition|(
name|headerSideA
operator|.
...
expr_stmt|;
block|}
DECL|method|createFileCommentBorderRow (final int row)
specifier|private
name|void
name|createFileCommentBorderRow
parameter_list|(
...
block|}
block|}
DECL|method|createSkipLine (int row, SkippedLine line, boolean isHugeFile)
specifier|private
name|void
name|createSkipLine
parameter_list|(
