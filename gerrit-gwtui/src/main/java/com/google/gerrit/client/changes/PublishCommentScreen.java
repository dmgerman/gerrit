...
condition|)
block|{
comment|// Legacy type, use radio buttons.
...
block|{
comment|// TODO Newer style label.
block|}
block|}
block|}
DECL|method|initApprovalType (final PatchSetPublishDetail r, final Panel body, final ApprovalType ct, final PermissionRange range)
specifier|private
name|void
name|initApprovalType
parameter_list|(
...
name|value
decl_stmt|;
DECL|method|ValueRadioButton (ApprovalCategory c, ApprovalCategoryValue v)
name|ValueRadioButton
parameter_list|(
name|ApprovalCategory
name|c
