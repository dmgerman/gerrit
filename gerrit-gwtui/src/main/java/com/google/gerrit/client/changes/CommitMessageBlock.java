...
expr_stmt|;
block|}
DECL|class|CommitMessageEditDialog
specifier|private
specifier|abstract
class|class
name|CommitMessageEditDialog
extends|extends
name|CommentedActionDialog
argument_list|<
name|JavaScriptObject
...
decl_stmt|;
DECL|method|CommitMessageEditDialog (final String title, final String heading, final String commitMessage, AsyncCallback<JavaScriptObject> callback)
specifier|public
name|CommitMessageEditDialog
parameter_list|(
specifier|final
...
parameter_list|)
block|{
comment|// Trim the new text so we don't consider trailing
comment|// newlines as changes
name|sendButton
operator|.
name|setEnabled
argument_list|(
...
block|}
block|}
DECL|method|display (final PatchSet.Id patchSetId, final String revision, Boolean starred, Boolean canEditCommitMessage, final String commitMessage, CommentLinkProcessor commentLinkProcessor)
specifier|public
name|void
name|display
parameter_list|(
