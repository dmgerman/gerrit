...
block|}
block|}
DECL|method|display (final Map<AccountGroup.Id, AccountGroup> groups, final List<RefRight> refRights)
name|void
name|display
parameter_list|(
specifier|final
...
block|}
block|}
DECL|method|populate (final int row, final Map<AccountGroup.Id, AccountGroup> groups, final RefRight r)
name|void
name|populate
parameter_list|(
specifier|final
