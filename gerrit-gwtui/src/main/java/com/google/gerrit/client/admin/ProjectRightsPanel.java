...
expr_stmt|;
block|}
DECL|method|initParent (final Panel body)
specifier|private
name|void
name|initParent
parameter_list|(
...
block|{
comment|// If its not a range, the maximum box was disabled.  Use the min
comment|// value as the max, and select the min from the category values.
comment|//
name|max
operator|=
name|min
...
return|;
block|}
DECL|method|display (final Map<AccountGroup.Id, AccountGroup> groups, final List<InheritedRefRight> refRights)
name|void
name|display
parameter_list|(
specifier|final
...
block|}
block|}
DECL|method|populate (final int row, final Map<AccountGroup.Id, AccountGroup> groups, final InheritedRefRight r)
name|void
name|populate
parameter_list|(
specifier|final
