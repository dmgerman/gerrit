...
expr_stmt|;
block|}
DECL|method|loadPlugins (HostPageData hpd, final String token)
specifier|private
name|void
name|loadPlugins
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|addProjectLink (final HidingMenuBar m, final String text, final String panel)
specifier|private
specifier|static
name|void
name|addProjectLink
