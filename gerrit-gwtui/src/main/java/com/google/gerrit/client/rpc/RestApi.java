...
name|cb
decl_stmt|;
DECL|method|HttpImpl (boolean bg, HttpCallback<T> cb)
name|HttpImpl
parameter_list|(
name|boolean
name|bg
...
expr_stmt|;
block|}
DECL|method|get (HttpCallback<T> cb)
specifier|public
parameter_list|<
name|T
extends|extends
...
expr_stmt|;
block|}
DECL|method|delete (HttpCallback<T> cb)
specifier|public
parameter_list|<
name|T
extends|extends
...
expr_stmt|;
block|}
DECL|method|send (Method method, HttpCallback<T> cb)
specifier|private
parameter_list|<
name|T
extends|extends
...
expr_stmt|;
block|}
DECL|method|post (String content, HttpCallback<T> cb)
specifier|public
parameter_list|<
name|T
extends|extends
...
expr_stmt|;
block|}
DECL|method|put (HttpCallback<T> cb)
specifier|public
parameter_list|<
name|T
extends|extends
...
expr_stmt|;
block|}
DECL|method|put (String content, HttpCallback<T> cb)
specifier|public
parameter_list|<
name|T
extends|extends
...
expr_stmt|;
block|}
DECL|method|sendJSON ( Method method, JavaScriptObject content, HttpCallback<T> cb)
specifier|private
parameter_list|<
name|T
extends|extends
...
function_decl|;
DECL|method|decodeBase64 (String a)
specifier|private
specifier|static
specifier|native
name|String
...
name|a
parameter_list|)
comment|/*-{ return $wnd.atob(a) }-*/
function_decl|;
DECL|method|sendRaw (Method method, String body, HttpCallback<T> cb)
specifier|private
parameter_list|<
name|T
extends|extends
...
return|;
block|}
DECL|method|isEncodedBase64 (Response res)
specifier|private
specifier|static
name|boolean
name|isEncodedBase64
...
return|;
block|}
DECL|method|simpleType (String type)
specifier|private
specifier|static
name|String
name|simpleType
