...
argument_list|)
decl_stmt|;
comment|// Without this, CM will put line widgets too far down in the right spot,
comment|// and padding widgets will be informed of wrong offset height. Reset to
comment|// 10 (default) after initial rendering.
name|cfg
operator|.
name|setInfinity
argument_list|(
