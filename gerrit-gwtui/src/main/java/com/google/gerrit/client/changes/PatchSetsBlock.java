...
name|regNavigation
decl_stmt|;
DECL|field|patchSetPanelsList
specifier|private
name|List
argument_list|<
name|PatchSetComplexDisclosurePanel
argument_list|>
name|patchSetPanelsList
decl_stmt|;
...
decl_stmt|;
comment|/** Patch sets on this change, in order. */
...
DECL|method|display (final ChangeDetail detail, final PatchSet.Id diffBaseId)
specifier|public
name|void
name|display
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|refresh (final PatchSet.Id diffBaseId)
specifier|public
name|void
name|refresh
parameter_list|(
...
DECL|method|activate (final PatchSet.Id patchSetId)
specifier|public
name|void
name|activate
parameter_list|(
...
block|}
block|}
DECL|method|indexOf (PatchSet.Id id)
specifier|private
name|int
name|indexOf
parameter_list|(
...
name|patchSetId
decl_stmt|;
DECL|method|ActivationHandler (PatchSet.Id patchSetId)
name|ActivationHandler
parameter_list|(
name|PatchSet
operator|.
