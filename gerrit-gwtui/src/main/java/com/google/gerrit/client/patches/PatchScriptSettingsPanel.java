...
argument_list|()
decl_stmt|;
comment|// WHOLE_FILE_CONTEXT is the last option in the list.
name|int
name|lastIndex
init|=
name|options
...
condition|)
block|{
comment|// Select the next longest context from WHOLE_FILE_CONTEXT
name|context
operator|.
...
return|;
block|}
DECL|method|setValue (final DiffPreferencesInfo dp)
specifier|public
name|void
name|setValue
parameter_list|(
