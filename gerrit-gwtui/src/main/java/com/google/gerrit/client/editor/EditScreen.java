...
name|editFileInfo
decl_stmt|;
DECL|field|patchSetDiffInfo
specifier|private
name|DiffInfo
name|patchSetDiffInfo
decl_stmt|;
DECL|field|header
annotation|@
name|UiField
...
parameter_list|)
block|{
comment|// ignore non valid numbers
comment|// We don't want to popup another ugly dialog just to say
comment|// "The number you've provided is invalid, try again"
block|}
block|}
block|}
block|}
...
expr_stmt|;
block|}
DECL|method|initEditor (HttpResponse<NativeString> file, EditFileInfo info, DiffInfo diffInfo)
specifier|private
name|void
name|initEditor
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|renderLinks (EditFileInfo info, DiffInfo diffInfo)
specifier|private
name|void
name|renderLinks
parameter_list|(
...
block|}
block|}
DECL|method|renderPluginLinks (List<DiffWebLinkInfo> links)
specifier|private
name|void
name|renderPluginLinks
parameter_list|(
