...
argument_list|()
decl_stmt|;
comment|/**    * TODO: Handle ordering of line widgets. CodeMirror seems to have a bug when    * multiple line widgets are added to a line: it puts the first widget above    * the line when the line is clicked upon.    */
DECL|field|COMMENT_BOX_CONFIG
specifier|private
specifier|static
specifier|final
name|Configuration
name|COMMENT_BOX_CONFIG
init|=
name|Configuration
operator|.
name|create
...
return|;
block|}
DECL|method|removeCommentBox (Side side, int line)
name|void
name|removeCommentBox
parameter_list|(
name|Side
name|side
parameter_list|,
...
return|;
block|}
DECL|method|getLineBoxMapFromSide (Side side)
specifier|private
name|Map
argument_list|<
name|Integer
