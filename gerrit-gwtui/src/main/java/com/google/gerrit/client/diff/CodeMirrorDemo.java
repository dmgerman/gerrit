...
argument_list|)
decl_stmt|;
comment|/**          * Ugly workaround because CodeMirror never hides lines completely.          * TODO: Change to use CodeMirror's official workaround after          * updating the library to latest HEAD.          */
if|if
condition|(
name|hiddenSkipMap
operator|.
