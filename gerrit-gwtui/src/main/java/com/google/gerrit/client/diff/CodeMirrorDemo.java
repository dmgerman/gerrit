...
parameter_list|()
block|{
comment|/**          * Prevent feedback loop, Chrome seems fine but Firefox chokes.          * However on Chrome this may cause scrolling to be out of sync          * if scrolled too fast.          */
name|double
name|now
init|=
operator|(
