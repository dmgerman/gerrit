...
block|}
block|}
DECL|method|updateTableLayoutForLabels (ChangeList list)
specifier|private
name|void
name|updateTableLayoutForLabels
parameter_list|(
name|ChangeList
name|list
parameter_list|)
...
block|}
block|}
comment|// TODO(sop): Highlight changes I haven't reviewed on my dashboard.
comment|// final Element tr = DOM.getParent(fmt.getElement(row, 0));
comment|// UIObject.setStyleName(tr, Gerrit.RESOURCES.css().needsReview(),
comment|// !haveReview&& highlightUnreviewed);
name|setRowItem
argument_list|(
name|row
argument_list|,
