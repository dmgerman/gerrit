...
expr_stmt|;
block|}
DECL|method|init (String e, String r, String o)
specifier|private
specifier|static
specifier|final
specifier|native
...
expr_stmt|;
block|}
DECL|method|onEdit (InputElement checkbox, int idx)
name|void
name|onEdit
parameter_list|(
name|InputElement
...
name|alert
argument_list|(
literal|"inline edit is not yet implemented"
argument_list|)
expr_stmt|;
block|}
...
argument_list|()
expr_stmt|;
comment|// TODO(davido): Consider to modify path column in edit mode as well
comment|// to navigate to edit dialog instead of to SBS2.
if|if
condition|(
name|mode
operator|==
