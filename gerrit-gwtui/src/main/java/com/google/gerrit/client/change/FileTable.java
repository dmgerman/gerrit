...
parameter_list|()
function_decl|;
DECL|method|editButton ()
name|String
name|editButton
parameter_list|()
function_decl|;
DECL|method|removeButton ()
name|String
name|removeButton
parameter_list|()
function_decl|;
...
expr_stmt|;
block|}
DECL|method|init (String d, String e, String m, String t, String r, String o)
specifier|private
specifier|static
specifier|final
specifier|native
...
block|}
block|}
DECL|method|onEditMessage (NativeEvent e, int idx)
specifier|private
specifier|static
name|void
name|onEditMessage
...
name|deleted
decl_stmt|;
DECL|method|DisplayCommand (NativeMap<FileInfo> map, JsArray<FileInfo> list, Timestamp myLastReply, NativeMap<JsArray<CommentInfo>> comments, NativeMap<JsArray<CommentInfo>> drafts, Mode mode)
specifier|private
name|DisplayCommand
parameter_list|(
name|NativeMap
...
expr_stmt|;
block|}
DECL|method|columnEdit (SafeHtmlBuilder sb, FileInfo info)
specifier|private
name|void
name|columnEdit
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|columnPathEdit (SafeHtmlBuilder sb, FileInfo info)
specifier|private
name|void
name|columnPathEdit
parameter_list|(
