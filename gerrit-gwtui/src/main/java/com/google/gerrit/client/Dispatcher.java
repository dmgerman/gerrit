...
name|Dispatcher
block|{
DECL|field|useChangeScreen2
specifier|private
specifier|static
name|boolean
name|useChangeScreen2
decl_stmt|;
...
return|;
block|}
DECL|method|toPatch (String type, PatchSet.Id diffBase, PatchSet.Id revision, String fileName)
specifier|private
specifier|static
name|String
name|toPatch
...
block|}
block|}
DECL|method|change2 (final String token)
specifier|private
specifier|static
name|void
name|change2
...
expr_stmt|;
block|}
DECL|method|patch (String token, PatchSet.Id base, Patch.Key id, int patchIndex, PatchSetDetail patchSetDetail, PatchTable patchTable, String panelType)
specifier|public
specifier|static
name|void
name|patch
...
expr_stmt|;
block|}
DECL|method|patch (String token, final PatchSet.Id baseId, final Patch.Key id, final int patchIndex, final PatchSetDetail patchSetDetail, final PatchTable patchTable, final PatchScreen.TopView topView, final String panelType)
specifier|public
specifier|static
name|void
name|patch
