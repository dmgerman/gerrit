...
block|}
block|}
DECL|method|toEditScreen (PatchSet.Id revision, String fileName)
specifier|public
specifier|static
name|String
name|toEditScreen
...
expr_stmt|;
block|}
DECL|method|patch (String token, PatchSet.Id baseId, Patch.Key id, DisplaySide side, int line, int patchIndex, PatchSetDetail patchSetDetail, PatchTable patchTable, PatchScreen.TopView topView, String panelType)
specifier|public
specifier|static
name|void
name|patch
...
expr_stmt|;
block|}
DECL|method|sbs1 (final String token, final PatchSet.Id baseId, final Patch.Key id, final int patchIndex, final PatchSetDetail patchSetDetail, final PatchTable patchTable, final PatchScreen.TopView topView, final PatchScreen.Type type)
specifier|private
specifier|static
name|void
name|sbs1
