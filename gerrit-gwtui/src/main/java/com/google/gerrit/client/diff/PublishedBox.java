...
name|avatar
decl_stmt|;
DECL|method|PublishedBox ( CommentGroup group, CommentLinkProcessor clp, @Nullable Project.NameKey project, PatchSet.Id psId, CommentInfo info, DisplaySide displaySide, boolean open)
name|PublishedBox
parameter_list|(
name|CommentGroup
name|group
