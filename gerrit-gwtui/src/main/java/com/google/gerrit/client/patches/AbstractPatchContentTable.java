...
name|onlyOneHunk
decl_stmt|;
DECL|field|headerSideA
specifier|protected
name|PatchSetSelectBox
name|headerSideA
decl_stmt|;
DECL|field|headerSideB
specifier|protected
name|PatchSetSelectBox
name|headerSideB
decl_stmt|;
...
parameter_list|()
function_decl|;
DECL|method|initHeaders (PatchScript script, PatchSetDetail detail)
specifier|protected
name|void
name|initHeaders
parameter_list|(
...
block|}
block|}
DECL|method|display (final Patch.Key k, final PatchSet.Id a, final PatchSet.Id b, final PatchScript s, final PatchSetDetail d)
specifier|public
name|void
name|display
parameter_list|(
...
DECL|method|hasEdits (PatchScript script)
specifier|private
name|boolean
name|hasEdits
parameter_list|(
...
DECL|method|hasMeta (PatchScript script)
specifier|private
name|boolean
name|hasMeta
parameter_list|(
...
return|;
block|}
DECL|method|appendNoDifferences (SafeHtmlBuilder m)
specifier|protected
name|void
...
return|;
block|}
DECL|method|render (PatchScript script, final PatchSetDetail detail)
specifier|protected
specifier|abstract
name|void
name|render
...
block|}
block|}
DECL|method|destroyCommentRow (int row)
specifier|protected
name|void
name|destroyCommentRow
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|destroyComment (int row, int col, int span)
specifier|private
name|void
name|destroyComment
parameter_list|(
