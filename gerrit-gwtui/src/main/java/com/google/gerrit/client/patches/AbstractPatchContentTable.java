...
expr_stmt|;
block|}
DECL|method|addStyle (final int row, final int col, final String style)
specifier|protected
name|void
name|addStyle
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|setHtml (final int row, final int col, final String html)
specifier|protected
name|void
name|setHtml
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|setWidget (final int row, final int col, final Widget widget)
specifier|protected
name|void
name|setWidget
parameter_list|(
