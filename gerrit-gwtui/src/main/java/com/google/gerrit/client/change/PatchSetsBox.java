...
condition|)
block|{
comment|// TODO(davido): It shouldn't be necessary to make this call.
comment|// PatchSetsBox is constructed via PatchSetsAction which is
comment|// only initialized by CS2 after loading the EditInfo in that path.
name|ChangeApi
operator|.
name|edit
argument_list|(
