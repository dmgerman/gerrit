...
DECL|method|getContent (PatchSet.Id id, String filename, HttpCallback<NativeString> cb)
specifier|public
specifier|static
name|void
name|getContent
...
DECL|method|getContentOrMessage (PatchSet.Id id, String path, HttpCallback<NativeString> cb)
specifier|public
specifier|static
name|void
