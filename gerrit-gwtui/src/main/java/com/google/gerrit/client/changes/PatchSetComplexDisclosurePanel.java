...
expr_stmt|;
block|}
DECL|method|canDeletePatchSet (PatchSetDetail detail)
specifier|private
name|boolean
name|canDeletePatchSet
parameter_list|(
...
return|;
block|}
comment|// If the draft PS is the only one in a draft change, just delete the change.
if|if
condition|(
name|changeDetail
operator|.
...
block|}
block|}
DECL|method|createCommentedCallback (final Button b, final boolean redirect)
specifier|private
name|AsyncCallback
argument_list|<
name|ChangeDetail
