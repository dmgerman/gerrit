...
name|discard2
decl_stmt|;
DECL|method|DraftBox ( CommentGroup group, CommentLinkProcessor clp, @Nullable Project.NameKey pj, PatchSet.Id id, CommentInfo info, boolean expandAllComments)
name|DraftBox
parameter_list|(
name|CommentGroup
name|group
