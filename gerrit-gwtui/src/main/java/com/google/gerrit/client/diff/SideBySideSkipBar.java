...
name|otherBar
decl_stmt|;
DECL|method|SideBySideSkipBar (SideBySideSkipManager manager, final CodeMirror cm)
name|SideBySideSkipBar
parameter_list|(
name|SideBySideSkipManager
name|manager
...
expr_stmt|;
block|}
DECL|method|link (SideBySideSkipBar barA, SideBySideSkipBar barB)
specifier|static
name|void
name|link
parameter_list|(
