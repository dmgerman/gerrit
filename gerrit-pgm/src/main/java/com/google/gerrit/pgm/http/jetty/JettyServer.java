...
return|;
block|}
DECL|method|getBaseResource (ServletContextHandler app)
specifier|private
name|Resource
name|getBaseResource
parameter_list|(
...
return|;
block|}
DECL|method|unpackWar (File srcwar)
specifier|private
specifier|static
name|Resource
name|unpackWar
...
block|}
block|}
DECL|method|useDeveloperBuild (ServletContextHandler app)
specifier|private
name|Resource
name|useDeveloperBuild
parameter_list|(
...
name|FileNotFoundException
argument_list|(
literal|"Cannot find web application root"
argument_list|)
throw|;
block|}
if|if
...
name|FileNotFoundException
argument_list|(
literal|"Cannot find web root from "
operator|+
name|u
argument_list|)
throw|;
...
name|target
init|=
name|targetForBrowser
argument_list|(
name|System
operator|.
name|getProperty
argument_list|(
literal|"gerrit.browser"
argument_list|)
argument_list|)
decl_stmt|;
specifier|final
...
block|}
block|}
DECL|method|targetForBrowser (String browser)
specifier|private
specifier|static
name|String
name|targetForBrowser
...
block|}
block|}
DECL|method|build (File root, File gen, String target)
specifier|private
specifier|static
name|void
name|build
...
expr_stmt|;
block|}
DECL|method|loadBuckProperties (File gen)
specifier|private
specifier|static
name|Properties
name|loadBuckProperties
...
return|;
block|}
DECL|method|useMavenDeveloperBuild (File dir)
specifier|private
name|Resource
name|useMavenDeveloperBuild
parameter_list|(
...
argument_list|()
expr_stmt|;
comment|// pop the module we are in
comment|// Drop down into gerrit-gwtui to find the WAR assets we need.
comment|//
name|dir
operator|=
operator|new
