...
annotation|@
name|Inject
DECL|method|InitAdminUser ( InitFlags flags, ConsoleUI ui, VersionedAuthorizedKeysOnInit.Factory authorizedKeysFactory)
name|InitAdminUser
parameter_list|(
name|InitFlags
name|flags
...
literal|true
argument_list|)
DECL|method|set (AccountIndexCollection indexCollection)
name|void
name|set
parameter_list|(
name|AccountIndexCollection
...
name|save
argument_list|(
literal|"Added SSH key for initial admin user\n"
argument_list|)
expr_stmt|;
block|}
name|AccountGroup
