...
annotation|@
name|Inject
DECL|method|Module (@ommandExecutor final WorkQueue.Executor executor)
name|Module
parameter_list|(
annotation|@
name|CommandExecutor
...
annotation|@
name|Inject
DECL|method|ProjectQoSFilter (final Provider<CurrentUser> userProvider, @CommandExecutor final WorkQueue.Executor executor, final ServletContext context, @GerritServerConfig final Config cfg)
name|ProjectQoSFilter
parameter_list|(
specifier|final
name|Provider
