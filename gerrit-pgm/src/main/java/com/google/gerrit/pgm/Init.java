...
annotation|@
name|Inject
DECL|method|SiteRun (final ConsoleUI ui, final SitePaths site, final InitFlags flags, final SchemaUpdater schemaUpdater, final SchemaFactory<ReviewDb> schema, final GitRepositoryManager repositoryManager, final Browser browser)
name|SiteRun
parameter_list|(
specifier|final
name|ConsoleUI
