...
expr_stmt|;
block|}
DECL|method|init_container (final Config cfg)
specifier|private
name|void
name|init_container
parameter_list|(
...
argument_list|()
argument_list|,
literal|"Local username to run as"
argument_list|)
decl_stmt|;
name|set
argument_list|(
...
name|println
argument_list|(
literal|"warn: Cannot find gerrit.war; skipping java.start"
argument_list|)
expr_stmt|;
name|mywar
operator|=
...
comment|// current hostname instead so the user can login from any host.
comment|//
specifier|final
name|URI
name|uri
