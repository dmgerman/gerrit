...
annotation|@
name|Inject
DECL|method|SiteRun (ConsoleUI ui, SitePaths site, InitFlags flags, SchemaUpdater schemaUpdater, SchemaFactory<ReviewDb> schema, GitRepositoryManager repositoryManager, IndexManagerOnInit indexManager)
name|SiteRun
parameter_list|(
name|ConsoleUI
name|ui
