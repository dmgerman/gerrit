...
block|}
block|}
DECL|method|injectXmlFile (final Document hostDoc, final String id, final String fileName)
specifier|private
name|void
name|injectXmlFile
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|injectCssFile (final Document hostDoc, final String id, final String fileName)
specifier|private
name|void
name|injectCssFile
parameter_list|(
...
name|ServletException
argument_list|(
literal|"Error transforming host page"
argument_list|,
name|e
argument_list|)
throw|;
...
name|ServletException
argument_list|(
literal|"Cannot compress host page"
argument_list|,
name|e
argument_list|)
throw|;
...
block|}
block|}
DECL|method|timeEq (final long a, final long b)
specifier|private
specifier|static
name|boolean
name|timeEq
