...
begin_comment
comment|/**  * Tests for checking the bindings of the root REST API.  *  *<p>These tests only verify that the root REST endpoints are correctly bound, they do no test the  * functionality of the root REST endpoints (for details see JavaDoc on {@link  * AbstractRestApiBindingsTest}).  */
end_comment
