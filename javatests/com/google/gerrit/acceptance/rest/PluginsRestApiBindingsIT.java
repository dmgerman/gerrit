...
begin_comment
comment|/**  * Tests for checking the bindings of the plugins REST API.  *  *<p>These tests only verify that the plugin REST endpoints are correctly bound, they do no test  * the functionality of the plugin REST endpoints (for details see JavaDoc on {@link  * AbstractRestApiBindingsTest}).  */
end_comment
