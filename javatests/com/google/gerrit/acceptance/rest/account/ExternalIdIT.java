...
argument_list|)
decl_stmt|;
name|insertExtIdWithDuplicateEmail
argument_list|(
name|extIdWithDuplicateEmail
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|insertExtIdWithDuplicateEmail (ExternalId extId)
specifier|private
name|void
name|insertExtIdWithDuplicateEmail
parameter_list|(
...
name|Exception
block|{
comment|// Cannot use AccountsUpdate to insert an external ID with duplicate email.
try|try
init|(
name|Repository
name|repo
