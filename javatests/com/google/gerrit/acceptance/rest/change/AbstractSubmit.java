...
decl_stmt|;
DECL|field|onSubmitValidatorHandle
specifier|private
name|RegistrationHandle
name|onSubmitValidatorHandle
decl_stmt|;
...
name|this
operator|.
name|addOnSubmitValidationListener
argument_list|(
operator|new
name|OnSubmitValidationListener
argument_list|()
...
return|;
block|}
DECL|method|addOnSubmitValidationListener (OnSubmitValidationListener listener)
specifier|protected
name|void
name|addOnSubmitValidationListener
parameter_list|(
...
DECL|method|createProjectForPush (@ullable NameKey parent, SubmitType submitType)
specifier|protected
name|Project
operator|.
name|NameKey
