...
return|;
block|}
DECL|method|createProjectForPush ( String name, @Nullable Project.NameKey parent, boolean createEmptyCommit, SubmitType submitType)
specifier|protected
name|Project
operator|.
name|NameKey
...
return|;
block|}
DECL|method|directUpdateSubmodule (String project, String refName, String path, AnyObjectId id)
specifier|protected
name|void
