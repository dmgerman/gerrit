...
argument_list|)
expr_stmt|;
comment|// Make sure that both changes have different timestamps.
name|String
name|changeId1
init|=
name|createChange
...
argument_list|()
expr_stmt|;
comment|// Expect that the author is preserved for the superRepo commit.
name|expectToHaveAuthor
argument_list|(
name|superRepo
argument_list|,
literal|"master"
...
argument_list|()
expr_stmt|;
comment|// Expect that the Gerrit server identity is chosen as author for the superRepo commit.
name|expectToHaveAuthor
argument_list|(
name|superRepo
argument_list|,
