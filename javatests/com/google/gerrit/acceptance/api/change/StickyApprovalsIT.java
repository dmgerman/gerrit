...
annotation|@
name|Test
DECL|method|stickyOnAnyScore ()
specifier|public
name|void
name|stickyOnAnyScore
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|stickyAcrossMultiplePatchSetsDoNotRegressPerformance ()
specifier|public
name|void
name|stickyAcrossMultiplePatchSetsDoNotRegressPerformance
parameter_list|()
throws|throws
name|Exception
block|{
comment|// The purpose of this test is to make sure that we compute change kind only against the parent
comment|// patch set. Change kind is a heavy operation. In prior version of Gerrit, we computed the
comment|// change kind against all prior patch sets. This is a regression that made Gerrit do expensive
comment|// work in O(num-patch-sets). This test ensures that we aren't regressing.
try|try
init|(
name|ProjectConfigUpdate
name|u
...
argument_list|)
expr_stmt|;
name|assertChangeKindCacheContains
argument_list|(
name|revisions
operator|.
name|get
...
argument_list|)
expr_stmt|;
name|assertChangeKindCacheDoesNotContain
argument_list|(
name|revisions
operator|.
name|get
...
expr_stmt|;
block|}
DECL|method|assertChangeKindCacheContains (ObjectId prior, ObjectId next)
specifier|private
name|void
name|assertChangeKindCacheContains
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|assertChangeKindCacheDoesNotContain (ObjectId prior, ObjectId next)
specifier|private
name|void
name|assertChangeKindCacheDoesNotContain
parameter_list|(
