...
expr_stmt|;
block|}
DECL|class|CustomAttributeModule
specifier|static
class|class
name|CustomAttributeModule
extends|extends
name|AbstractModule
block|{
DECL|class|MyInfo
...
annotation|@
name|Test
DECL|method|queryChangeWithCustomAttributes ()
specifier|public
name|void
name|queryChangeWithCustomAttributes
parameter_list|()
throws|throws
name|Exception
block|{
...
init|)
block|{
comment|// Plugin attributes only set in queries.
name|assertThat
argument_list|(
name|gApi
operator|.
