...
annotation|@
name|Test
DECL|method|revertChangeWithLongSubject ()
specifier|public
name|void
name|revertChangeWithLongSubject
parameter_list|()
throws|throws
name|Exception
block|{
...
name|changeTitle
init|=
literal|"This change has a very long title and therefore it will be cut to 50 characters when the"
operator|+
literal|" revert change will revert this change"
decl_stmt|;
name|String
name|result
init|=
...
annotation|@
name|Test
DECL|method|revertSubmissionWithoutMessage ()
specifier|public
name|void
name|revertSubmissionWithoutMessage
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|revertSubmissionRevertsChangeWithLongSubject ()
specifier|public
name|void
name|revertSubmissionRevertsChangeWithLongSubject
parameter_list|()
throws|throws
name|Exception
block|{
...
name|changeTitle
init|=
literal|"This change has a very long title and therefore it will be cut to 56 characters when the"
operator|+
literal|" revert change will revert this change"
decl_stmt|;
name|String
...
annotation|@
name|Test
DECL|method|revertSubmissionSubjects ()
specifier|public
name|void
name|revertSubmissionSubjects
parameter_list|()
throws|throws
name|Exception
block|{
...
name|isEqualTo
argument_list|(
literal|"Revert^2 \"second change\""
argument_list|)
expr_stmt|;
name|assertThat
argument_list|(
...
name|isEqualTo
argument_list|(
literal|"Revert^3 \"second change\""
argument_list|)
expr_stmt|;
block|}
annotation|@
name|Test
DECL|method|revertSubmissionWithUserChangedSubjects ()
specifier|public
name|void
name|revertSubmissionWithUserChangedSubjects
parameter_list|()
throws|throws
name|Exception
block|{
