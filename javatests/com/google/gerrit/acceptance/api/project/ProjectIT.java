...
annotation|@
name|Test
DECL|method|cannotPushLabelDefinitionWithDuplicateValues ()
specifier|public
name|void
name|cannotPushLabelDefinitionWithDuplicateValues
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertMessage
argument_list|(
literal|"project.config: duplicate value \"1 lgtm\" for label \"code-review\""
argument_list|)
expr_stmt|;
block|}
annotation|@
name|Test
DECL|method|getProjectThatHasLabelDefinitionWithDuplicateValues ()
specifier|public
name|void
name|getProjectThatHasLabelDefinitionWithDuplicateValues
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Update the definition of the Code-Review label so that it has the value "+1 LGTM" twice.
comment|// This update bypasses all validation checks so that the duplicate label value doesn't get
comment|// rejected.
name|Config
name|cfg
init|=
...
name|message
argument_list|(
literal|"Set label with duplicate value"
argument_list|)
operator|.
name|parent
argument_list|(
...
expr_stmt|;
block|}
comment|// Verify that project info can be retrieved and that the label value "+1 LGTM" appears only
comment|// once.
name|ProjectInfo
name|projectInfo
init|=
