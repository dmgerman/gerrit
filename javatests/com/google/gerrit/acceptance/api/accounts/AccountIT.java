...
annotation|@
name|UseSsh
DECL|method|createWithSshKeysByAccountCreator ()
specifier|public
name|void
name|createWithSshKeysByAccountCreator
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"foo:baz"
decl_stmt|;
comment|// Use ExternalIdNotes to insert two external IDs with the same email.
comment|// This allows us to verify that deleting the email removes this email from all external IDs.
try|try
init|(
name|Repository
name|allUsersRepo
