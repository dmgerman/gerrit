...
annotation|@
name|Test
DECL|method|authenticateWhenUsernameExtIdAlreadyExists ()
specifier|public
name|void
name|authenticateWhenUsernameExtIdAlreadyExists
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Create account with SCHEME_USERNAME external ID, but no SCHEME_GERRIT external ID.
name|Account
operator|.
name|Id
name|accountId
...
argument_list|)
decl_stmt|;
comment|// Expect that the missing SCHEME_GERRIT external ID was created.
name|assertAuthResultForExistingAccount
argument_list|(
name|authResult
argument_list|,
