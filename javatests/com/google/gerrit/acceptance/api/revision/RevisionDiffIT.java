...
annotation|@
name|Test
DECL|method|diffBetweenPatchSetsOfMergeCommitCanBeRetrievedForCommitMessageAndMergeList ()
specifier|public
name|void
name|diffBetweenPatchSetsOfMergeCommitCanBeRetrievedForCommitMessageAndMergeList
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Call both of them in succession to ensure that they don't share the same cache keys.
name|DiffInfo
name|commitMessageDiffInfo
init|=
name|getDiffRequest
argument_list|(
name|changeId
