...
annotation|@
name|Test
DECL|method|cherryPickWithoutMessage ()
specifier|public
name|void
name|cherryPickWithoutMessage
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"foo"
decl_stmt|;
comment|// Create change to cherry-pick
name|PushOneCommit
operator|.
name|Result
name|change
...
argument_list|()
decl_stmt|;
comment|// Create target branch to cherry-pick to.
name|gApi
operator|.
name|projects
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// Cherry-pick without message.
name|CherryPickInput
name|input
init|=
operator|new
...
name|id
decl_stmt|;
comment|// Expect that the message of the cherry-picked commit was used for the cherry-pick change.
name|ChangeInfo
name|changeInfo
init|=
name|gApi
...
annotation|@
name|Test
DECL|method|cherryPickToNonExistingBranch ()
specifier|public
name|void
name|cherryPickToNonExistingBranch
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
comment|// TODO(ekempin): This should rather result in an UnprocessableEntityException.
name|BadRequestException
name|thrown
init|=
name|assertThrows
...
annotation|@
name|Test
DECL|method|cherryPickToNonExistingBaseCommit ()
specifier|public
name|void
name|cherryPickToNonExistingBaseCommit
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|cannotGetContentOfDirectory ()
specifier|public
name|void
name|cannotGetContentOfDirectory
parameter_list|()
throws|throws
name|Exception
block|{
