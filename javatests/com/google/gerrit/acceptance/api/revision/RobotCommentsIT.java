...
annotation|@
name|Test
DECL|method|getFixPreviewWithNonexistingFixId ()
specifier|public
name|void
name|getFixPreviewWithNonexistingFixId
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Ignore
DECL|method|getFixPreviewForNonExistingFile ()
specifier|public
name|void
name|getFixPreviewForNonExistingFile
parameter_list|()
throws|throws
name|Exception
block|{
...
name|containsExactly
argument_list|(
literal|"Third linsome replacement codeth line"
argument_list|)
expr_stmt|;
name|assertThat
argument_list|(
