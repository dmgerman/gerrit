...
condition|)
block|{
name|assertGroupOwnerPermissions
argument_list|(
name|g
operator|.
name|id
...
argument_list|()
decl_stmt|;
comment|// get owner from group that was created during init
name|assertThat
argument_list|(
name|Url
operator|.
...
argument_list|()
decl_stmt|;
comment|// get owner from newly created group
name|assertThat
argument_list|(
name|Url
operator|.
...
annotation|@
name|Test
DECL|method|pushToGroupBranchForNonAllUsersRepo ()
specifier|public
name|void
name|pushToGroupBranchForNonAllUsersRepo
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|pushToGroupBranch ( Project.NameKey project, String expectedErrorOnCreate, String expectedErrorOnUpdate)
specifier|private
name|void
name|pushToGroupBranch
parameter_list|(
...
annotation|@
name|Test
DECL|method|pushGroupsAccessSectionChangeToAllUsersFails ()
specifier|public
name|void
name|pushGroupsAccessSectionChangeToAllUsersFails
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|pushNonGroupsAccessSectionChangeToAllUsersSucceeds ()
specifier|public
name|void
name|pushNonGroupsAccessSectionChangeToAllUsersSucceeds
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Add an access section for refs/groups manually to see that mutation other data does not
comment|// trigger a validation error.
name|ProjectConfig
name|projectConfig
init|=
name|projectCache
...
name|contains
argument_list|(
literal|"[access \"refs/groups/foo\"]"
argument_list|)
expr_stmt|;
name|Config
name|cfg
...
annotation|@
name|Test
DECL|method|pushGroupsAccessSectionChangeToCustomProjectSucceeds ()
specifier|public
name|void
name|pushGroupsAccessSectionChangeToCustomProjectSucceeds
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"groups"
argument_list|,
literal|"global:Registered-Users\tRegistered Users"
argument_list|,
name|ProjectConfig
operator|.
name|PROJECT_CONFIG
...
block|}
block|}
DECL|method|assertGroupOwnerPermissions (String groupUuid, String expectedOwnerUuid)
specifier|private
name|void
name|assertGroupOwnerPermissions
parameter_list|(
