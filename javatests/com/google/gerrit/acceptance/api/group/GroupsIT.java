...
argument_list|)
expr_stmt|;
comment|/**      * Make sure the new commit is created in a different second. This is added for NoteDb since the      * resolution of Timestamp is 1s there. Adding here is enough because the sort used in {@code      * GetAuditLog} is stable and we process {@code AccountGroupMemberAudit} before {@code      * AccountGroupByIdAud}.      */
name|Thread
operator|.
name|sleep
argument_list|(
...
return|;
block|}
DECL|method|assertPermission ( Project.NameKey project, String ref, String permission, GroupReference groupReference)
specifier|private
name|void
name|assertPermission
parameter_list|(
