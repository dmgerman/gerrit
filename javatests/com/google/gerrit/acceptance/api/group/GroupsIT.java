...
DECL|method|createUniqueGroup ()
specifier|protected
name|String
name|createUniqueGroup
parameter_list|()
throws|throws
name|Exception
block|{
...
name|Exception
block|{
comment|// TODO(hanwen): rewrite to use groupOperations. This requires passing the owner
comment|// group's UUID rathen than its name.
name|name
operator|=
name|name
argument_list|(
