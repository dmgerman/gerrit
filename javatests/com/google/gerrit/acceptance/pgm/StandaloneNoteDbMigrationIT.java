...
argument_list|)
expr_stmt|;
comment|// Set gc.pruneExpire=now so GC prunes all unreachable objects from All-Users, which allows us
comment|// to reliably test that it behaves as expected.
name|Path
name|cfgPath
init|=
name|sitePaths
...
name|assertWithMessage
argument_list|(
literal|"Expected All-Users config at %s"
argument_list|,
name|cfgPath
argument_list|)
operator|.
...
name|Exception
block|{
name|assertNoAutoMigrateConfig
argument_list|(
name|gerritConfig
argument_list|)
expr_stmt|;
...
name|named
argument_list|(
literal|"loose object files in All-Users"
argument_list|)
operator|.
name|isEmpty
argument_list|()
...
name|named
argument_list|(
literal|"packfiles in All-Users"
argument_list|)
operator|.
name|hasSize
argument_list|(
...
annotation|@
name|Test
DECL|method|onlineMigrationViaConfig ()
specifier|public
name|void
name|onlineMigrationViaConfig
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Auto-migration is turned off in notedb.config, which takes precedence, but is still on in
comment|// gerrit.config. This means Puppet can continue overwriting gerrit.config without turning
comment|// auto-migration back on.
name|assertAutoMigrateConfig
argument_list|(
name|gerritConfig
argument_list|,
...
annotation|@
name|Test
DECL|method|onlineMigrationTrialModeViaFlag ()
specifier|public
name|void
name|onlineMigrationTrialModeViaFlag
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|onlineMigrationTrialModeViaConfig ()
specifier|public
name|void
name|onlineMigrationTrialModeViaConfig
parameter_list|()
throws|throws
name|Exception
block|{
...
DECL|interface|StartServerWithMigration
specifier|private
interface|interface
name|StartServerWithMigration
block|{
DECL|method|start (IndexUpgradeController u)
name|ServerContext
name|start
parameter_list|(
...
function_decl|;
block|}
DECL|method|testOnlineMigration (StartServerWithMigration start)
specifier|private
name|void
name|testOnlineMigration
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|testOnlineMigration ( StartServerWithMigration start, NotesMigrationState expectedEndState)
specifier|private
name|void
name|testOnlineMigration
parameter_list|(
...
return|;
block|}
DECL|method|assertNoAutoMigrateConfig (StoredConfig cfg)
specifier|private
specifier|static
name|void
name|assertNoAutoMigrateConfig
...
expr_stmt|;
block|}
DECL|method|assertAutoMigrateConfig (StoredConfig cfg, boolean expected)
specifier|private
specifier|static
name|void
name|assertAutoMigrateConfig
...
expr_stmt|;
block|}
DECL|method|assertNoTrialConfig (StoredConfig cfg)
specifier|private
specifier|static
name|void
name|assertNoTrialConfig
...
expr_stmt|;
block|}
DECL|method|assertTrialConfig (StoredConfig cfg, boolean expected)
specifier|private
specifier|static
name|void
name|assertTrialConfig
