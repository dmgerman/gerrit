...
case|:
return|return
literal|"docker.elastic.co/elasticsearch/elasticsearch:5.6.14"
return|;
case|case
name|V6_2
case|:
...
case|:
return|return
literal|"docker.elastic.co/elasticsearch/elasticsearch-oss:6.5.4"
return|;
case|case
name|V6_6
case|:
return|return
literal|"docker.elastic.co/elasticsearch/elasticsearch-oss:6.6.0"
return|;
case|case
name|V7_0
case|:
return|return
literal|"docker.elastic.co/elasticsearch/elasticsearch-oss:7.0.0-alpha2"
return|;
block|}
throw|throw
operator|new
