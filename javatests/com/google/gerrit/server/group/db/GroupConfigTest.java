...
static|static
block|{
comment|// Necessary so that toString() methods of ReviewDb entities work correctly.
name|KeyUtil
operator|.
name|setEncoderImpl
argument_list|(
...
annotation|@
name|Test
DECL|method|automaticallyLoadedNewGroupDoesNotChangeOnReload ()
specifier|public
name|void
name|automaticallyLoadedNewGroupDoesNotChangeOnReload
parameter_list|()
throws|throws
name|Exception
block|{
