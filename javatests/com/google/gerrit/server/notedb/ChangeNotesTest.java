...
annotation|@
name|Test
DECL|method|readOnlyUntilExpires ()
specifier|public
name|void
name|readOnlyUntilExpires
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// Write succeeded; lease still exists, even though it's expired.
name|notes
operator|=
name|newNotes
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// New lease takes precedence.
name|update
operator|=
name|newUpdate
argument_list|(
...
annotation|@
name|Test
DECL|method|readOnlyUntilCleared ()
specifier|public
name|void
name|readOnlyUntilCleared
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|// Sentinel timestamp of 0 can be written to clear lease.
name|update
operator|=
name|newUpdate
argument_list|(
