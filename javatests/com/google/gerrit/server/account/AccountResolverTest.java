...
annotation|@
name|Test
DECL|method|shouldUseCustomAccountActivityPredicate ()
specifier|public
name|void
name|shouldUseCustomAccountActivityPredicate
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Searchers always short-circuit when finding a non-empty result list,
comment|// and this one didn't filter out inactive results,
comment|// so the second searcher never ran.
name|assertThat
argument_list|(
name|result
operator|.
...
name|visibilitySupplier
argument_list|,
name|activityPrediate
argument_list|()
argument_list|)
return|;
block|}
DECL|method|search ( String input, ImmutableList<Searcher<?>> searchers, Supplier<Predicate<AccountState>> visibilitySupplier, Predicate<AccountState> activityPredicate)
specifier|private
name|Result
name|search
parameter_list|(
