...
annotation|@
name|Test
DECL|method|storedSubmitRecordsWithRequirements ()
specifier|public
name|void
name|storedSubmitRecordsWithRequirements
parameter_list|()
block|{
name|SubmitRecord
name|r
...
name|SubmitRequirement
argument_list|(
literal|"short reason"
argument_list|,
literal|"Full reason can be a long string with special symbols like<> \\ / ; :"
argument_list|,
literal|null
argument_list|)
decl_stmt|;
