...
name|resolve
argument_list|(
literal|"bazel-out/local-fastbuild/genfiles"
argument_list|)
expr_stmt|;
block|}
else|else
...
parameter_list|)
block|{
comment|// TODO(davido): Fix Bazel standalone mode
if|if
condition|(
name|bazel
condition|)
...
argument_list|(
literal|"Cannot find build file in: "
operator|+
name|pluginSource
argument_list|)
throw|;
...
block|}
block|}
DECL|method|loadBuildProperties (Path propertiesPath)
specifier|private
name|Properties
name|loadBuildProperties
parameter_list|(
