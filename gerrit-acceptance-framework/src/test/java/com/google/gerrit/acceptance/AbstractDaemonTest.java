...
return|;
block|}
DECL|method|createDraftChange (String topic)
specifier|protected
name|PushOneCommit
operator|.
name|Result
...
argument_list|()
decl_stmt|;
name|amendChangeAndMarkChangeAndPatchSetsAsDraft
argument_list|(
name|r
operator|.
name|getChangeId
...
expr_stmt|;
block|}
DECL|method|markChangeAsDraft (Project.NameKey project, Change.Id id)
specifier|protected
name|void
name|markChangeAsDraft
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|setCurrentPatchSetAsDraft (Change.Id id)
specifier|protected
name|void
name|setCurrentPatchSetAsDraft
parameter_list|(
...
argument_list|,
operator|new
name|SetDraftStatusOfCurrentPatchSetOp
argument_list|(
literal|true
argument_list|)
argument_list|)
...
expr_stmt|;
block|}
DECL|method|setDraftStatusOfPatchSets (Change.Id id, boolean draftStatus)
specifier|protected
name|void
name|setDraftStatusOfPatchSets
parameter_list|(
name|Change
operator|.
name|Id
...
block|}
block|}
DECL|class|SetDraftStatusOfCurrentPatchSetOp
specifier|private
class|class
name|SetDraftStatusOfCurrentPatchSetOp
implements|implements
...
name|draftStatus
decl_stmt|;
DECL|method|SetDraftStatusOfCurrentPatchSetOp (boolean draftStatus)
name|SetDraftStatusOfCurrentPatchSetOp
parameter_list|(
name|boolean
name|draftStatus
...
argument_list|)
decl_stmt|;
comment|// Change status in ReviewDb.
name|currentPatchSet
operator|.
name|setDraft
argument_list|(
...
expr_stmt|;
block|}
DECL|method|amendChangeAndMarkPatchSetAsDraft (String changeId)
specifier|protected
name|PushOneCommit
operator|.
name|Result
...
return|;
block|}
DECL|method|amendChangeAndMarkChangeAndPatchSetsAsDraft (String changeId)
specifier|protected
name|PushOneCommit
operator|.
name|Result
