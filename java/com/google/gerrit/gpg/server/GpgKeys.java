...
throw|;
block|}
DECL|method|findGpgKey (String str, Iterable<ExternalId> existingExtIds)
specifier|static
name|ExternalId
name|findGpgKey
parameter_list|(
...
return|;
block|}
DECL|method|parseFingerprint (ExternalId gpgKeyExtId)
specifier|static
name|byte
index|[]
name|parseFingerprint
...
name|log
argument_list|(
literal|"No public key stored for fingerprint %s"
argument_list|,
name|Fingerprint
operator|.
name|toString
