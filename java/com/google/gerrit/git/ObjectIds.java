...
return|;
block|}
comment|/**    * Copy a nullable ID, preserving null.    *    * @param id object ID.    * @return {@link AnyObjectId#copy} of {@code id}, or {@code null} if {@code id} is null.    */
annotation|@
name|Nullable
DECL|method|copyOrNull (@ullable AnyObjectId id)
specifier|public
specifier|static
name|ObjectId
name|copyOrNull
...
return|;
block|}
comment|/**    * Copy a nullable ID, converting null to {@code zeroId}.    *    * @param id object ID.    * @return {@link AnyObjectId#copy} of {@code id}, or {@link ObjectId#zeroId} if {@code id} is    *     null.    */
DECL|method|copyOrZero (@ullable AnyObjectId id)
specifier|public
specifier|static
name|ObjectId
name|copyOrZero
