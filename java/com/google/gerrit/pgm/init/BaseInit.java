...
expr_stmt|;
block|}
DECL|method|BaseInit ( Path sitePath, boolean standalone, PluginsDistribution pluginsDistribution, List<String> pluginsToInstall)
specifier|public
name|BaseInit
parameter_list|(
name|Path
...
name|flags
decl_stmt|;
DECL|field|noteDbSchemaUpdater
specifier|final
name|NoteDbSchemaUpdater
name|noteDbSchemaUpdater
decl_stmt|;
...
annotation|@
name|Inject
DECL|method|SiteRun ( ConsoleUI ui, SitePaths site, InitFlags flags, NoteDbSchemaUpdater noteDbSchemaUpdater, @ReviewDbFactory SchemaFactory<ReviewDb> schema, GitRepositoryManager repositoryManager)
name|SiteRun
parameter_list|(
name|ConsoleUI
name|ui
...
name|UpdateUI
block|{
DECL|field|consoleUi
specifier|private
specifier|final
name|ConsoleUI
name|consoleUi
decl_stmt|;
DECL|method|UpdateUIImpl (ConsoleUI consoleUi)
name|UpdateUIImpl
parameter_list|(
name|ConsoleUI
name|consoleUi
