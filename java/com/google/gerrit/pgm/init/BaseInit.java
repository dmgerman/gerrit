...
name|flags
decl_stmt|;
DECL|field|reviewDbSchemaUpdater
specifier|final
name|ReviewDbSchemaUpdater
name|reviewDbSchemaUpdater
decl_stmt|;
...
annotation|@
name|Inject
DECL|method|SiteRun ( ConsoleUI ui, SitePaths site, InitFlags flags, ReviewDbSchemaUpdater reviewDbSchemaUpdater, NoteDbSchemaUpdater noteDbSchemaUpdater, @ReviewDbFactory SchemaFactory<ReviewDb> schema, GitRepositoryManager repositoryManager)
name|SiteRun
parameter_list|(
name|ConsoleUI
name|ui
...
name|pruneList
decl_stmt|;
DECL|method|UpdateUIImpl (ConsoleUI consoleUi, List<String> pruneList)
name|UpdateUIImpl
parameter_list|(
name|ConsoleUI
name|consoleUi
