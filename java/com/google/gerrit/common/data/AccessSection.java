...
literal|"^"
decl_stmt|;
comment|/** Name of the access section. It could be a ref pattern or something else. */
DECL|field|name
specifier|private
name|String
name|name
...
name|permissions
decl_stmt|;
DECL|method|AccessSection (String name)
specifier|public
name|AccessSection
parameter_list|(
name|String
...
DECL|method|isValidRefSectionName (String name)
specifier|public
specifier|static
name|boolean
