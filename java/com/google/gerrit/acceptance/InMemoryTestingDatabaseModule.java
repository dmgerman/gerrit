...
name|repoManager
decl_stmt|;
DECL|field|inMemoryDatabaseInstance
annotation|@
name|Nullable
specifier|private
specifier|final
...
decl_stmt|;
DECL|method|InMemoryTestingDatabaseModule ( Config cfg, Path sitePath, @Nullable InMemoryRepositoryManager repoManager, @Nullable InMemoryDatabase.Instance inMemoryDatabaseInstance)
name|InMemoryTestingDatabaseModule
parameter_list|(
name|Config
name|cfg
