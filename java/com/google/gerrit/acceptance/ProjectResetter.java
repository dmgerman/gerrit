...
annotation|@
name|Inject
DECL|method|Builder ( GitRepositoryManager repoManager, AllUsersName allUsersName, @Nullable AccountCreator accountCreator, @Nullable AccountCache accountCache, @Nullable ProjectCache projectCache)
specifier|public
name|Builder
parameter_list|(
name|GitRepositoryManager
...
decl_stmt|;
DECL|method|ProjectResetter ( GitRepositoryManager repoManager, AllUsersName allUsersName, @Nullable AccountCreator accountCreator, @Nullable AccountCache accountCache, @Nullable ProjectCache projectCache, Multimap<Project.NameKey, String> refPatternByProject)
specifier|private
name|ProjectResetter
parameter_list|(
name|GitRepositoryManager
