...
annotation|@
name|Inject
DECL|method|Builder ( GitRepositoryManager repoManager, AllUsersName allUsersName, @Nullable AccountCreator accountCreator, @Nullable AccountCache accountCache, @Nullable AccountIndexer accountIndexer, @Nullable ProjectCache projectCache)
specifier|public
name|Builder
parameter_list|(
name|GitRepositoryManager
...
decl_stmt|;
DECL|method|ProjectResetter ( GitRepositoryManager repoManager, AllUsersName allUsersName, @Nullable AccountCreator accountCreator, @Nullable AccountCache accountCache, @Nullable AccountIndexer accountIndexer, @Nullable ProjectCache projectCache, Multimap<Project.NameKey, String> refPatternByProject)
specifier|private
name|ProjectResetter
parameter_list|(
name|GitRepositoryManager
...
argument_list|()
expr_stmt|;
comment|// TODO(ekempin): Evict groups from cache if group refs were modified.
...
block|}
block|}
DECL|method|accountIds (Collection<String> refs)
specifier|private
name|Set
argument_list|<
name|Account
