...
name|Exception
block|{
comment|// TODO(dborowitz): When inlining:
comment|// * add a variant that takes a single String
comment|// * explicitly add multiple values in callers instead of looping
name|TestProjectUpdate
operator|.
name|Builder
name|b
...
expr_stmt|;
block|}
DECL|method|grantLabel ( String label, int min, int max, Project.NameKey project, String ref, AccountGroup.UUID groupUUID, boolean exclusive)
specifier|protected
name|void
name|grantLabel
parameter_list|(
