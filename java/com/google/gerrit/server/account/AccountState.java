...
name|properties
decl_stmt|;
DECL|method|AccountState ( AllUsersName allUsersName, Account account, ImmutableSet<ExternalId> externalIds, Supplier<ImmutableMap<ProjectWatchKey, ImmutableSet<NotifyType>>> projectWatches, Supplier<GeneralPreferencesInfo> generalPreferences, Supplier<DiffPreferencesInfo> diffPreferences)
specifier|private
name|AccountState
parameter_list|(
name|AllUsersName
