...
annotation|@
name|Inject
DECL|method|Server ( GitRepositoryManager repoManager, GitReferenceUpdated gitRefUpdated, AllUsersName allUsersName, OutgoingEmailValidator emailValidator, @GerritPersonIdent Provider<PersonIdent> serverIdent, Provider<MetaDataUpdate.Server> metaDataUpdateServerFactory, RetryHelper retryHelper)
specifier|public
name|Server
parameter_list|(
name|GitRepositoryManager
...
decl_stmt|;
DECL|method|AccountsUpdate ( GitRepositoryManager repoManager, GitReferenceUpdated gitRefUpdated, @Nullable IdentifiedUser currentUser, AllUsersName allUsersName, OutgoingEmailValidator emailValidator, PersonIdent committerIdent, MetaDataUpdateFactory metaDataUpdateFactory, RetryHelper retryHelper)
specifier|private
name|AccountsUpdate
parameter_list|(
name|GitRepositoryManager
...
annotation|@
name|VisibleForTesting
DECL|method|AccountsUpdate ( GitRepositoryManager repoManager, GitReferenceUpdated gitRefUpdated, @Nullable IdentifiedUser currentUser, AllUsersName allUsersName, OutgoingEmailValidator emailValidator, PersonIdent committerIdent, MetaDataUpdateFactory metaDataUpdateFactory, RetryHelper retryHelper, Runnable afterReadRevision)
specifier|public
name|AccountsUpdate
parameter_list|(
name|GitRepositoryManager
...
return|;
block|}
DECL|method|commit (UpdatedAccount updatedAccount)
specifier|private
name|void
name|commit
parameter_list|(
