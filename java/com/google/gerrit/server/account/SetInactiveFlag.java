...
annotation|@
name|Inject
DECL|method|SetInactiveFlag ( DynamicSet<AccountActivationValidationListener> accountActivationValidationListeners, @ServerInitiated Provider<AccountsUpdate> accountsUpdateProvider)
name|SetInactiveFlag
parameter_list|(
name|DynamicSet
argument_list|<
