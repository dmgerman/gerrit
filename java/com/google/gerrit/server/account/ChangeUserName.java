...
name|Factory
block|{
DECL|method|create ( @ssistedR) String message, IdentifiedUser user, @Assisted(R) String newUsername)
name|ChangeUserName
name|create
parameter_list|(
annotation|@
...
annotation|@
name|Inject
DECL|method|ChangeUserName ( SshKeyCache sshKeyCache, ExternalIds externalIds, AccountsUpdate.Server accountsUpdate, @Assisted(R) String message, @Assisted IdentifiedUser user, @Nullable @Assisted(R) String newUsername)
name|ChangeUserName
parameter_list|(
name|SshKeyCache
name|sshKeyCache
