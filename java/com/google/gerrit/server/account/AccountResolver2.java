...
annotation|@
name|Inject
DECL|method|AccountResolver2 ( AccountCache byId, Emails emails, AccountControl.Factory accountControlFactory, Provider<InternalAccountQuery> accountQueryProvider, Realm realm, @AnonymousCowardName String anonymousCowardName)
name|AccountResolver2
parameter_list|(
name|AccountCache
name|byId
