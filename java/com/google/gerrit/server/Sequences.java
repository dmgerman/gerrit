...
name|groupSeq
decl_stmt|;
DECL|field|readGroupSeqFromNoteDb
specifier|private
specifier|final
name|boolean
name|readGroupSeqFromNoteDb
decl_stmt|;
...
name|readGroupSeqFromNoteDb
operator|=
name|readGroupFromNoteDbSetting
argument_list|(
name|cfg
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|readGroupFromNoteDbSetting (Config cfg)
specifier|public
specifier|static
name|boolean
name|readGroupFromNoteDbSetting
...
argument_list|)
expr_stmt|;
comment|// NoteDb stores next available group ID.
return|return
name|groupId
return|;
block|}
