...
name|slave
decl_stmt|;
DECL|method|AbstractIndexModule ( Map<String, Integer> singleVersions, int threads, boolean onlineUpgrade, boolean slave)
specifier|protected
name|AbstractIndexModule
parameter_list|(
name|Map
...
literal|"unused"
argument_list|)
DECL|method|createDummyIndexFactory (Schema<?> schema)
specifier|private
specifier|static
parameter_list|<
name|T
