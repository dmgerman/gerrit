...
annotation|@
name|AssistedInject
DECL|method|GroupIndexerImpl ( GroupCache groupCache, DynamicSet<GroupIndexedListener> indexedListener, StalenessChecker stalenessChecker, @IndexExecutor(BATCH) ListeningExecutorService batchExecutor, @GerritServerConfig Config config, @Assisted GroupIndexCollection indexes)
name|GroupIndexerImpl
parameter_list|(
name|GroupCache
name|groupCache
...
annotation|@
name|AssistedInject
DECL|method|GroupIndexerImpl ( GroupCache groupCache, DynamicSet<GroupIndexedListener> indexedListener, StalenessChecker stalenessChecker, @IndexExecutor(BATCH) ListeningExecutorService batchExecutor, @GerritServerConfig Config config, @Assisted @Nullable GroupIndex index)
name|GroupIndexerImpl
parameter_list|(
name|GroupCache
name|groupCache
...
literal|"deprecation"
argument_list|)
DECL|method|reindexIfStaleAsync ( AccountGroup.UUID uuid)
specifier|private
name|com
operator|.
name|google
