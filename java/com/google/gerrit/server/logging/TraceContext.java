...
return|;
block|}
comment|/**    * Opens a new timer that logs the time for an operation if request tracing is enabled.    *    *<p>If request tracing is not enabled this is a no-op.    *    * @param message the message    * @param key meta data key    * @param value meta data value    * @return the trace timer    */
DECL|method|newTimer (String message, String key, Object value)
specifier|public
specifier|static
name|TraceTimer
name|newTimer
...
return|;
block|}
comment|/**    * Opens a new timer that logs the time for an operation if request tracing is enabled.    *    *<p>If request tracing is not enabled this is a no-op.    *    * @param message the message    * @param key1 first meta data key    * @param value1 first meta data value    * @param key2 second meta data key    * @param value2 second meta data value    * @return the trace timer    */
DECL|method|newTimer ( String message, String key1, Object value1, String key2, Object value2)
specifier|public
specifier|static
name|TraceTimer
name|newTimer
...
return|;
block|}
comment|/**    * Opens a new timer that logs the time for an operation if request tracing is enabled.    *    *<p>If request tracing is not enabled this is a no-op.    *    * @param message the message    * @param key1 first meta data key    * @param value1 first meta data value    * @param key2 second meta data key    * @param value2 second meta data value    * @param key3 third meta data key    * @param value3 third meta data value    * @return the trace timer    */
DECL|method|newTimer ( String message, String key1, Object value1, String key2, Object value2, String key3, Object value3)
specifier|public
specifier|static
name|TraceTimer
name|newTimer
...
return|;
block|}
comment|/**    * Opens a new timer that logs the time for an operation if request tracing is enabled.    *    *<p>If request tracing is not enabled this is a no-op.    *    * @param message the message    * @param key1 first meta data key    * @param value1 first meta data value    * @param key2 second meta data key    * @param value2 second meta data value    * @param key3 third meta data key    * @param value3 third meta data value    * @param key4 fourth meta data key    * @param value4 fourth meta data value    * @return the trace timer    */
DECL|method|newTimer ( String message, String key1, Object value1, String key2, Object value2, String key3, Object value3, String key4, Object value4)
specifier|public
specifier|static
name|TraceTimer
name|newTimer
...
expr_stmt|;
block|}
DECL|method|TraceTimer ( String format, @Nullable Object arg1, @Nullable Object arg2, @Nullable Object arg3, @Nullable Object arg4, @Nullable Object arg5, @Nullable Object arg6)
specifier|private
name|TraceTimer
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|TraceTimer ( String format, @Nullable Object arg1, @Nullable Object arg2, @Nullable Object arg3, @Nullable Object arg4, @Nullable Object arg5, @Nullable Object arg6, @Nullable Object arg7, @Nullable Object arg8)
specifier|private
name|TraceTimer
parameter_list|(
name|String
