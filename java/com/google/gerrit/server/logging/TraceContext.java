...
return|;
block|}
comment|/**    * Opens a new timer that logs the time for an operation if request tracing is enabled.    *    * @param operation the name of operation the is being performed    * @param key meta data key    * @param value meta data value    * @return the trace timer    */
DECL|method|newTimer (String operation, String key, @Nullable Object value)
specifier|public
specifier|static
name|TraceTimer
name|newTimer
...
return|;
block|}
comment|/**    * Opens a new timer that logs the time for an operation if request tracing is enabled.    *    * @param operation the name of operation the is being performed    * @param key1 first meta data key    * @param value1 first meta data value    * @param key2 second meta data key    * @param value2 second meta data value    * @return the trace timer    */
DECL|method|newTimer ( String operation, String key1, @Nullable Object value1, String key2, @Nullable Object value2)
specifier|public
specifier|static
name|TraceTimer
name|newTimer
...
return|;
block|}
comment|/**    * Opens a new timer that logs the time for an operation if request tracing is enabled.    *    * @param operation the name of operation the is being performed    * @param key1 first meta data key    * @param value1 first meta data value    * @param key2 second meta data key    * @param value2 second meta data value    * @param key3 third meta data key    * @param value3 third meta data value    * @return the trace timer    */
DECL|method|newTimer ( String operation, String key1, @Nullable Object value1, String key2, @Nullable Object value2, String key3, @Nullable Object value3)
specifier|public
specifier|static
name|TraceTimer
name|newTimer
...
expr_stmt|;
block|}
DECL|method|TraceTimer (String operation, String key, @Nullable Object value)
specifier|private
name|TraceTimer
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|TraceTimer ( String operation, String key1, @Nullable Object value1, String key2, @Nullable Object value2)
specifier|private
name|TraceTimer
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|TraceTimer ( String operation, String key1, @Nullable Object value1, String key2, @Nullable Object value2, String key3, @Nullable Object value3)
specifier|private
name|TraceTimer
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|TraceTimer ( String operation, String key1, @Nullable Object value1, String key2, @Nullable Object value2, String key3, @Nullable Object value3, String key4, @Nullable Object value4)
specifier|private
name|TraceTimer
parameter_list|(
name|String
...
name|log
argument_list|(
literal|"%s (%s=%s, %s=%s, %s=%s, %s=%s) (%d ms)"
argument_list|,
name|operation
argument_list|,
name|key1
