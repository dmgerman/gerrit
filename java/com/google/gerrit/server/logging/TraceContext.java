...
return|;
block|}
comment|/**    * Opens a new trace context for request tracing.    *    *<ul>    *<li>sets a tag with a generated trace ID    *<li>enables force logging    *</ul>    *    *<p>No-op if {@code trace} is {@code false}.    *    * @param trace whether tracing should be started    * @param traceIdConsumer consumer for the trace ID, should be used to return the generated trace    *     ID to the client, not invoked if {@code trace} is {@code false}    * @return the trace context    */
