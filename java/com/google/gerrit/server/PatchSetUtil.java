...
annotation|@
name|Inject
DECL|method|PatchSetUtil ( NotesMigration migration, Provider<ApprovalsUtil> approvalsUtilProvider, ProjectCache projectCache, Provider<ReviewDb> dbProvider, GitRepositoryManager repoManager)
name|PatchSetUtil
parameter_list|(
name|NotesMigration
name|migration
