...
name|log
argument_list|(
literal|"Skipping reviewer predicate for %s in default field query"
operator|+
literal|" because the number of matched accounts (%d) exceeds the limit of %d"
argument_list|,
name|who
argument_list|,
name|accounts
...
name|log
argument_list|(
literal|"Parsing %s as account failed: %s"
argument_list|,
name|who
argument_list|,
name|e
