...
name|projectCache
decl_stmt|;
DECL|method|ChangeIsVisibleToPredicate ( Provider<ReviewDb> db, ChangeNotes.Factory notesFactory, CurrentUser user, PermissionBackend permissionBackend, ProjectCache projectCache)
specifier|public
name|ChangeIsVisibleToPredicate
parameter_list|(
name|Provider
