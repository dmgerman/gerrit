...
name|log
argument_list|(
literal|"Invalid gitweb.pathSeparator: %s"
argument_list|,
name|c
argument_list|)
expr_stmt|;
...
name|log
argument_list|(
literal|"gitweb.pathSeparator is not a single character: %s"
argument_list|,
name|pathSeparator
argument_list|)
expr_stmt|;
...
annotation|@
name|Inject
DECL|method|GitwebConfig ( GitwebCgiConfig cgiConfig, @GerritServerConfig Config cfg, @Nullable @CanonicalWebUrl String gerritUrl)
name|GitwebConfig
parameter_list|(
