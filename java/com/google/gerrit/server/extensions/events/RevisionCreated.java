...
begin_comment
comment|/** Helper class to fire an event when a revision has been created for a change. */
end_comment
...
annotation|@
name|Inject
DECL|method|RevisionCreated (PluginSetContext<RevisionCreatedListener> listeners, EventUtil util)
name|RevisionCreated
parameter_list|(
name|PluginSetContext
argument_list|<
...
block|}
block|}
comment|/** Event to be fired when a revision has been created for a change. */
DECL|class|Event
specifier|private
specifier|static
class|class
