...
begin_comment
comment|/** Helper class to fire an event when a change has been restored. */
end_comment
...
annotation|@
name|Inject
DECL|method|ChangeRestored (PluginSetContext<ChangeRestoredListener> listeners, EventUtil util)
name|ChangeRestored
parameter_list|(
name|PluginSetContext
argument_list|<
...
expr_stmt|;
block|}
DECL|method|fire ( Change change, PatchSet ps, AccountState restorer, String reason, Timestamp when)
specifier|public
name|void
name|fire
parameter_list|(
...
block|}
block|}
comment|/** Event to be fired when a change has been restored. */
DECL|class|Event
specifier|private
specifier|static
class|class
