...
annotation|@
name|Inject
DECL|method|TopicEdited (PluginSetContext<TopicEditedListener> listeners, EventUtil util)
name|TopicEdited
parameter_list|(
name|PluginSetContext
argument_list|<
...
expr_stmt|;
block|}
DECL|method|fire (Change change, AccountState account, String oldTopicName, Timestamp when)
specifier|public
name|void
name|fire
parameter_list|(
