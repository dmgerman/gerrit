...
annotation|@
name|Inject
DECL|method|Mergeable ( GitRepositoryManager gitManager, ProjectCache projectCache, MergeUtil.Factory mergeUtilFactory, ChangeData.Factory changeDataFactory, Provider<ReviewDb> db, ChangeIndexer indexer, MergeabilityCache cache, SubmitRuleEvaluator.Factory submitRuleEvaluatorFactory)
name|Mergeable
parameter_list|(
name|GitRepositoryManager
name|gitManager
...
name|log
argument_list|(
literal|"Invalid revision on patch set %s"
argument_list|,
name|ps
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|invalidateETag (Change.Id id, ReviewDb db)
specifier|private
specifier|static
name|void
name|invalidateETag
