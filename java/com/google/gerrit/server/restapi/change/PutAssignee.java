...
annotation|@
name|Inject
DECL|method|PutAssignee ( AccountResolver accountResolver, SetAssigneeOp.Factory assigneeFactory, RetryHelper retryHelper, Provider<ReviewDb> db, ReviewerAdder reviewerAdder, AccountLoader.Factory accountLoaderFactory, PermissionBackend permissionBackend)
name|PutAssignee
parameter_list|(
name|AccountResolver
name|accountResolver
