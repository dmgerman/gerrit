...
annotation|@
name|Inject
DECL|method|TestSubmitRule ( Provider<ReviewDb> db, ChangeData.Factory changeDataFactory, RulesCache rules, AccountLoader.Factory infoFactory, ProjectCache projectCache, DefaultSubmitRule defaultSubmitRule, PrologRule prologRule)
name|TestSubmitRule
parameter_list|(
name|Provider
argument_list|<
