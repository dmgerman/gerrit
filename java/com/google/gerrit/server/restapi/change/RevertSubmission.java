...
name|results
decl_stmt|;
DECL|field|patternRevertSubject
specifier|private
specifier|static
specifier|final
name|Pattern
name|patternRevertSubject
init|=
name|Pattern
operator|.
name|compile
...
argument_list|)
decl_stmt|;
DECL|field|patternRevertSubjectWithNum
specifier|private
specifier|static
specifier|final
name|Pattern
name|patternRevertSubjectWithNum
init|=
name|Pattern
operator|.
name|compile
...
argument_list|)
decl_stmt|;
name|checkPermissionsForAllChanges
argument_list|(
name|changeResource
argument_list|,
name|changeDatas
...
return|;
block|}
DECL|method|createTopic (String topic, String submissionId)
specifier|private
name|String
name|createTopic
parameter_list|(
...
return|;
block|}
DECL|method|checkPermissionsForAllChanges ( ChangeResource changeResource, List<ChangeData> changeDatas)
specifier|private
name|void
name|checkPermissionsForAllChanges
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|createCherryPickInput (RevertInput revertInput)
specifier|private
name|CherryPickInput
name|createCherryPickInput
parameter_list|(
...
expr_stmt|;
block|}
comment|// For performance purposes: Almost all cases will end here.
if|if
condition|(
operator|!
name|subject
