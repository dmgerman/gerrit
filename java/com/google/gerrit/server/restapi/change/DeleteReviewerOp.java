...
annotation|@
name|Inject
DECL|method|DeleteReviewerOp ( ApprovalsUtil approvalsUtil, PatchSetUtil psUtil, ChangeMessagesUtil cmUtil, IdentifiedUser.GenericFactory userFactory, ReviewerDeleted reviewerDeleted, Provider<IdentifiedUser> user, DeleteReviewerSender.Factory deleteReviewerSenderFactory, NotifyUtil notifyUtil, RemoveReviewerControl removeReviewerControl, ProjectCache projectCache, @Assisted AccountState reviewerAccount, @Assisted DeleteReviewerInput input)
name|DeleteReviewerOp
parameter_list|(
name|ApprovalsUtil
name|approvalsUtil
