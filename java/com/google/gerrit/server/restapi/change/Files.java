...
annotation|@
name|Inject
DECL|method|ListFiles ( Provider<ReviewDb> db, Provider<CurrentUser> self, FileInfoJson fileInfoJson, Revisions revisions, GitRepositoryManager gitManager, PatchListCache patchListCache, PatchSetUtil psUtil, PluginItemContext<AccountPatchReviewStore> accountPatchReviewStore, GerritApi gApi)
name|ListFiles
parameter_list|(
name|Provider
argument_list|<
...
name|format
argument_list|(
literal|"invalid parent number: %d"
argument_list|,
name|parentNum
argument_list|)
argument_list|)
