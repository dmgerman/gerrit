...
annotation|@
name|Inject
DECL|method|Abandon ( ChangeJson.Factory json, RetryHelper retryHelper, AbandonOp.Factory abandonOpFactory, NotifyUtil notifyUtil, PatchSetUtil patchSetUtil)
name|Abandon
parameter_list|(
name|ChangeJson
operator|.
