...
argument_list|)
DECL|method|setExcludeGroups (boolean excludeGroups)
specifier|public
name|SuggestChangeReviewers
...
name|name
operator|=
literal|"--reviewer-state"
argument_list|,
name|usage
operator|=
literal|"The type of reviewers that should be suggested"
operator|+
literal|" (can be 'REVIEWER' or 'CC', default is 'REVIEWER')"
argument_list|)
DECL|method|setReviewerState (ReviewerState reviewerState)
specifier|public
name|SuggestChangeReviewers
...
name|format
argument_list|(
literal|"Unsupported reviewer state: %s"
argument_list|,
name|ReviewerState
operator|.
name|REMOVED
