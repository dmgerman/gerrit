...
annotation|@
name|Inject
DECL|method|TestSubmitType (ChangeData.Factory changeDataFactory, RulesCache rules, PrologRule prologRule)
name|TestSubmitType
parameter_list|(
name|ChangeData
operator|.
...
annotation|@
name|Inject
DECL|method|Get ( ChangeData.Factory changeDataFactory, SubmitRuleEvaluator.Factory submitRuleEvaluatorFactory)
name|Get
parameter_list|(
name|ChangeData
operator|.
