...
return|;
block|}
comment|/** Creates the changes in the given project. This is public for reuse in the project API. */
DECL|method|execute ( BatchUpdate.Factory updateFactory, ChangeInput input, ProjectResource projectResource)
specifier|public
name|Response
argument_list|<
name|ChangeInfo
