...
annotation|@
name|Inject
DECL|method|Revert ( PermissionBackend permissionBackend, BatchUpdate.Factory updateFactory, GitRepositoryManager repoManager, ChangeInserter.Factory changeInserterFactory, ChangeMessagesUtil cmUtil, Sequences seq, PatchSetUtil psUtil, RevertedSender.Factory revertedSenderFactory, ChangeJson.Factory json, ApprovalsUtil approvalsUtil, ChangeReverted changeReverted, ContributorAgreementsChecker contributorAgreements, ProjectCache projectCache, NotifyResolver notifyResolver, CommitUtil commitUtil)
name|Revert
parameter_list|(
name|PermissionBackend
name|permissionBackend
