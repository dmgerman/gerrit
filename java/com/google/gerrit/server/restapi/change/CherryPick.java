...
annotation|@
name|Inject
DECL|method|CherryPick ( PermissionBackend permissionBackend, Provider<CurrentUser> user, RetryHelper retryHelper, CherryPickChange cherryPickChange, ChangeJson.Factory json, ContributorAgreementsChecker contributorAgreements)
name|CherryPick
parameter_list|(
name|PermissionBackend
name|permissionBackend
