...
annotation|@
name|Inject
DECL|method|CherryPick ( PermissionBackend permissionBackend, BatchUpdate.Factory updateFactory, CherryPickChange cherryPickChange, ChangeJson.Factory json, ContributorAgreementsChecker contributorAgreements, ProjectCache projectCache)
name|CherryPick
parameter_list|(
name|PermissionBackend
name|permissionBackend
...
annotation|@
name|Override
DECL|method|apply (RevisionResource rsrc, CherryPickInput input)
specifier|public
name|Response
argument_list|<
name|CherryPickChangeInfo
