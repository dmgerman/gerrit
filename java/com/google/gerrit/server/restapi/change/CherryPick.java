...
annotation|@
name|Inject
DECL|method|CherryPick ( PermissionBackend permissionBackend, Provider<CurrentUser> user, RetryHelper retryHelper, CherryPickChange cherryPickChange, ChangeJson.Factory json, ContributorAgreementsChecker contributorAgreements, ProjectCache projectCache)
name|CherryPick
parameter_list|(
name|PermissionBackend
name|permissionBackend
...
name|error
argument_list|(
literal|"Failed to check if project state permits write: "
operator|+
name|rsrc
operator|.
name|getProject
