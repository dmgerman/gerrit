...
annotation|@
name|Inject
DECL|method|Reviewers ( ApprovalsUtil approvalsUtil, AccountsCollection accounts, ReviewerResource.Factory resourceFactory, DynamicMap<RestView<ReviewerResource>> views, ListReviewers list)
name|Reviewers
parameter_list|(
name|ApprovalsUtil
name|approvalsUtil
