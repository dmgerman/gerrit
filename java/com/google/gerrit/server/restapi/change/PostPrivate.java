...
annotation|@
name|Inject
DECL|method|PostPrivate ( PermissionBackend permissionBackend, BatchUpdate.Factory updateFactory, SetPrivateOp.Factory setPrivateOpFactory, @GerritServerConfig Config config)
name|PostPrivate
parameter_list|(
name|PermissionBackend
name|permissionBackend
...
annotation|@
name|Override
DECL|method|apply (ChangeResource rsrc, InputWithMessage input)
specifier|public
name|Response
argument_list|<
name|String
