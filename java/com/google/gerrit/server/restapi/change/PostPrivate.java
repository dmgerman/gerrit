...
annotation|@
name|Inject
DECL|method|PostPrivate ( Provider<ReviewDb> dbProvider, RetryHelper retryHelper, ChangeMessagesUtil cmUtil, PermissionBackend permissionBackend, SetPrivateOp.Factory setPrivateOpFactory)
name|PostPrivate
parameter_list|(
name|Provider
argument_list|<
