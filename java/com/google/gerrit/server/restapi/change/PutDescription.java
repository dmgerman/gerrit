...
annotation|@
name|Inject
DECL|method|PutDescription ( BatchUpdate.Factory updateFactory, ChangeMessagesUtil cmUtil, PatchSetUtil psUtil)
name|PutDescription
parameter_list|(
name|BatchUpdate
operator|.
...
annotation|@
name|Override
DECL|method|apply (RevisionResource rsrc, DescriptionInput input)
specifier|public
name|Response
argument_list|<
name|String
