...
annotation|@
name|Inject
DECL|method|SetEditPreferences ( Provider<MetaDataUpdate.User> metaDataUpdateFactory, AllUsersName allUsersName, AccountCache accountCache)
name|SetEditPreferences
parameter_list|(
name|Provider
argument_list|<
...
annotation|@
name|Override
DECL|method|apply ( ConfigResource configResource, EditPreferencesInfo input)
specifier|public
name|Response
argument_list|<
name|EditPreferencesInfo
...
block|}
block|}
DECL|method|hasSetFields (EditPreferencesInfo in)
specifier|private
specifier|static
name|boolean
name|hasSetFields
