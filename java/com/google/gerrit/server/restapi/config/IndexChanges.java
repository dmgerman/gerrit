...
annotation|@
name|Inject
DECL|method|IndexChanges ( ChangeFinder changeFinder, SchemaFactory<ReviewDb> schemaFactory, ChangeData.Factory changeDataFactory, ChangeIndexer indexer)
name|IndexChanges
parameter_list|(
name|ChangeFinder
name|changeFinder
...
name|log
argument_list|(
literal|"Failed to index change %s"
argument_list|,
name|id
argument_list|)
expr_stmt|;
