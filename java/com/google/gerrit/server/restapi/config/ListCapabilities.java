...
annotation|@
name|Inject
DECL|method|ListCapabilities ( PermissionBackend permissionBackend, DynamicMap<CapabilityDefinition> pluginCapabilities)
specifier|public
name|ListCapabilities
parameter_list|(
name|PermissionBackend
...
name|log
argument_list|(
literal|"Plugin name '%s' must match '%s' to use capabilities; rename the plugin"
argument_list|,
name|pluginName
argument_list|,
name|PLUGIN_NAME_PATTERN
