...
annotation|@
name|Inject
DECL|method|SetPreferences ( Provider<MetaDataUpdate.User> metaDataUpdateFactory, AllUsersName allUsersName, AccountCache accountCache)
name|SetPreferences
parameter_list|(
name|Provider
argument_list|<
...
annotation|@
name|Override
DECL|method|apply (ConfigResource rsrc, GeneralPreferencesInfo input)
specifier|public
name|Response
argument_list|<
name|GeneralPreferencesInfo
