...
annotation|@
name|Inject
DECL|method|PutUsername ( Provider<CurrentUser> self, PermissionBackend permissionBackend, ExternalIds externalIds, AccountsUpdate.Server accountsUpdate, SshKeyCache sshKeyCache, Realm realm)
name|PutUsername
parameter_list|(
name|Provider
argument_list|<
