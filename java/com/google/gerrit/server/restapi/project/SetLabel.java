...
annotation|@
name|Inject
DECL|method|SetLabel ( Provider<CurrentUser> user, PermissionBackend permissionBackend, MetaDataUpdate.User updateFactory, ProjectConfig.Factory projectConfigFactory, ProjectCache projectCache)
specifier|public
name|SetLabel
parameter_list|(
name|Provider
...
annotation|@
name|Override
DECL|method|apply (LabelResource rsrc, LabelDefinitionInput input)
specifier|public
name|Response
argument_list|<
name|LabelDefinitionInfo
...
name|format
argument_list|(
literal|"name %s conflicts with existing label %s"
argument_list|,
name|newName
argument_list|,
name|labelName
