...
annotation|@
name|Inject
DECL|method|SetParent ( ProjectCache cache, PermissionBackend permissionBackend, MetaDataUpdate.Server updateFactory, AllProjectsName allProjects, AllUsersName allUsers)
name|SetParent
parameter_list|(
name|ProjectCache
name|cache
