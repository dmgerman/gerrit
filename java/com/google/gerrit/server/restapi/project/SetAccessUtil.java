...
annotation|@
name|Inject
DECL|method|SetAccessUtil ( GroupsCollection groupsCollection, AllProjectsName allProjects, Provider<SetParent> setParent, ListCapabilities listCapabilities)
specifier|private
name|SetAccessUtil
parameter_list|(
name|GroupsCollection
...
block|}
block|}
DECL|method|isCapability (String name)
specifier|private
name|boolean
name|isCapability
parameter_list|(
