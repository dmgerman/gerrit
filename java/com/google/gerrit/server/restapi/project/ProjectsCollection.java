...
name|hasQuery
decl_stmt|;
DECL|field|isDisplayActiveAndReadonlyQuery
specifier|private
name|boolean
name|isDisplayActiveAndReadonlyQuery
decl_stmt|;
annotation|@
name|Inject
DECL|method|ProjectsCollection ( DynamicMap<RestView<ProjectResource>> views, Provider<ListProjects> list, Provider<GerritApi> gApi, Provider<QueryProjects> queryProjects, ProjectCache projectCache, PermissionBackend permissionBackend, Provider<CurrentUser> user)
specifier|public
name|ProjectsCollection
parameter_list|(
name|DynamicMap
...
condition|)
block|{
comment|// Temporary workaround for v2.16. Should be removed as soon as the Projects Lucene Index
comment|// sorting is fixed
if|if
condition|(
name|isDisplayActiveAndReadonlyQuery
condition|)
...
parameter_list|)
block|{
comment|// Explicitly ignored because this fix is for full listing only
block|}
annotation|@
name|Override
specifier|public
