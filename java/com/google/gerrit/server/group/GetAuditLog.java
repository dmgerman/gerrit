...
annotation|@
name|Inject
DECL|method|GetAuditLog ( Provider<ReviewDb> db, AccountLoader.Factory accountLoaderFactory, GroupCache groupCache, GroupJson groupJson, GroupBackend groupBackend, Groups groups)
specifier|public
name|GetAuditLog
parameter_list|(
name|Provider
