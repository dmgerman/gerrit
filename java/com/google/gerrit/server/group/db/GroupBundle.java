...
block|}
block|}
DECL|method|create ( Source source, AccountGroup group, Collection<AccountGroupMember> members, Collection<AccountGroupMemberAudit> memberAudit, Collection<AccountGroupById> byId, Collection<AccountGroupByIdAud> byIdAudit)
specifier|public
specifier|static
name|GroupBundle
name|create
...
return|;
block|}
DECL|method|logIfNotUnique ( Source source, AccountGroup.UUID uuid, Collection<T> collection, Class<T> clazz)
specifier|private
specifier|static
parameter_list|<
name|T
