...
argument_list|)
decl_stmt|;
DECL|field|groupOwnerPermissions
specifier|private
specifier|final
...
literal|false
decl_stmt|;
DECL|method|GroupConfig (GroupOwnerPermissions groupOwnerPermissions, AccountGroup.UUID groupUuid)
specifier|private
name|GroupConfig
parameter_list|(
name|GroupOwnerPermissions
...
expr_stmt|;
block|}
DECL|method|createForNewGroup ( AllUsersName allUsersName, Repository repository, InternalGroupCreation groupCreation, MetaDataUpdateFactory metaDataUpdateFactory)
specifier|public
specifier|static
name|GroupConfig
...
return|;
block|}
DECL|method|loadForGroupNoOwnerUpdate ( AllUsersName allUsersName, Repository repository, AccountGroup.UUID groupUuid)
specifier|public
specifier|static
name|GroupConfig
...
return|;
block|}
DECL|method|loadForGroup ( AllUsersName allUsersName, Repository repository, AccountGroup.UUID groupUuid, MetaDataUpdateFactory metaDataUpdateFactory)
specifier|public
specifier|static
name|GroupConfig
name|loadForGroup
...
name|format
argument_list|(
literal|"Group owner for group %s not found."
argument_list|,
name|groupUuid
operator|.
name|get
...
expr_stmt|;
block|}
DECL|method|createFrom ( AccountGroup.UUID groupUuid, AccountGroup.UUID ownerGroupUuid, Config config, ImmutableSet<Account.Id> members, ImmutableSet<AccountGroup.UUID> subgroups, Timestamp createdOn)
specifier|private
specifier|static
name|InternalGroup
name|createFrom
...
return|;
block|}
DECL|method|updateOwnerPermissions ()
specifier|private
name|AccountGroup
operator|.
name|UUID
...
condition|)
block|{
comment|// new group, by default it owns itself
name|newOwnerGroupReference
operator|=
operator|new
name|GroupReference
