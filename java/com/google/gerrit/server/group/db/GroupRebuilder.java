...
annotation|@
name|VisibleForTesting
DECL|method|GroupRebuilder ( Provider<PersonIdent> serverIdent, AllUsersName allUsers, MetaDataUpdate.InternalFactory metaDataUpdateFactory, AuditLogFormatter auditLogFormatter)
name|GroupRebuilder
parameter_list|(
name|Provider
argument_list|<
