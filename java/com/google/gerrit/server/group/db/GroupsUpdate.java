...
return|;
block|}
DECL|method|createFor (InternalGroupCreation groupCreation)
specifier|private
name|GroupConfig
name|createFor
parameter_list|(
...
name|previousName
init|=
name|getPreviousNameIfModified
argument_list|(
name|originalGroup
argument_list|,
name|updatedGroup
...
return|;
block|}
DECL|method|getPreviousNameIfModified ( Optional<InternalGroup> originalGroup, InternalGroup updatedGroup)
specifier|private
specifier|static
name|Optional
argument_list|<
