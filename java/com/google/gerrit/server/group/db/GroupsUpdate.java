...
block|{
comment|// Set updatedOn to a specific value so that the same timestamp is used for ReviewDb and
comment|// NoteDb. This timestamp is also used by audit events.
name|updatedOn
operator|=
name|Optional
operator|.
...
name|deletedMembers
init|=
name|deleteGroupMembersInReviewDb
argument_list|(
name|db
argument_list|,
name|group
...
init|=
name|deleteSubgroupsInReviewDb
argument_list|(
name|db
argument_list|,
name|group
...
expr_stmt|;
block|}
DECL|method|addGroupMembersInReviewDb ( ReviewDb db, AccountGroup.Id groupId, ImmutableSet<Account.Id> originalMembers, ImmutableSet<Account.Id> updatedMembers)
specifier|private
specifier|static
name|Set
argument_list|<
...
return|;
block|}
DECL|method|deleteGroupMembersInReviewDb ( ReviewDb db, AccountGroup.Id groupId, ImmutableSet<Account.Id> originalMembers, ImmutableSet<Account.Id> updatedMembers)
specifier|private
specifier|static
name|Set
argument_list|<
...
return|;
block|}
DECL|method|toAccountGroupMembers ( AccountGroup.Id groupId, Set<Account.Id> accountIds)
specifier|private
specifier|static
name|ImmutableSet
argument_list|<
...
return|;
block|}
DECL|method|addSubgroupsInReviewDb ( ReviewDb db, AccountGroup.Id parentGroupId, ImmutableSet<AccountGroup.UUID> originalSubgroups, ImmutableSet<AccountGroup.UUID> updatedSubgroups)
specifier|private
specifier|static
name|Set
argument_list|<
...
return|;
block|}
DECL|method|deleteSubgroupsInReviewDb ( ReviewDb db, AccountGroup.Id parentGroupId, ImmutableSet<AccountGroup.UUID> originalSubgroups, ImmutableSet<AccountGroup.UUID> updatedSubgroups)
specifier|private
specifier|static
name|Set
argument_list|<
...
return|;
block|}
DECL|method|toAccountGroupByIds ( AccountGroup.Id parentGroupId, Set<AccountGroup.UUID> subgroupUuids)
specifier|private
specifier|static
name|ImmutableSet
argument_list|<
