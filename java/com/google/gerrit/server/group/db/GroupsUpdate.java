...
comment|// doesn't require this ugly code. In addition, allow to pass in the repository.
DECL|method|getMetaDataUpdateFactory ( @ullable IdentifiedUser currentUser, MetaDataUpdate.User metaDataUpdateUserFactory, MetaDataUpdate.Server metaDataUpdateServerFactory)
specifier|private
specifier|static
name|MetaDataUpdateFactory
name|getMetaDataUpdateFactory
