...
annotation|@
name|Inject
DECL|method|AuditLogReader ( @erritServerId String serverId, GitRepositoryManager repoManager, AllUsersName allUsers)
name|AuditLogReader
parameter_list|(
annotation|@
name|GerritServerId
...
DECL|method|getMembersAudit (AccountGroup.UUID uuid)
name|ImmutableList
argument_list|<
name|AccountGroupMemberAudit
argument_list|>
...
return|;
block|}
DECL|method|getSubgroupsAudit (AccountGroup.UUID uuid)
name|ImmutableList
argument_list|<
name|AccountGroupByIdAud
argument_list|>
...
parameter_list|>
block|{
DECL|method|parseAuditLog (AccountGroup.UUID uuid)
specifier|final
name|ImmutableList
argument_list|<
name|T
...
block|}
block|}
DECL|method|visit ( AccountGroup.Id groupId, ParsedCommit pc, ImmutableList.Builder<T> result)
specifier|protected
specifier|abstract
name|void
name|visit
...
function_decl|;
block|}
DECL|class|MembersAuditLogParser
specifier|private
class|class
name|MembersAuditLogParser
extends|extends
...
annotation|@
name|Override
DECL|method|visit ( AccountGroup.Id groupId, ParsedCommit pc, ImmutableList.Builder<AccountGroupMemberAudit> result)
specifier|protected
name|void
name|visit
parameter_list|(
...
block|}
block|}
DECL|class|SubgroupsAuditLogParser
specifier|private
class|class
name|SubgroupsAuditLogParser
extends|extends
...
annotation|@
name|Override
DECL|method|visit ( AccountGroup.Id groupId, ParsedCommit pc, ImmutableList.Builder<AccountGroupByIdAud> result)
specifier|protected
name|void
name|visit
parameter_list|(
