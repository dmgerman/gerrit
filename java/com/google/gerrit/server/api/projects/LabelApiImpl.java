...
annotation|@
name|Inject
DECL|method|LabelApiImpl ( LabelsCollection labels, CreateLabel createLabel, GetLabel getLabel, SetLabel setLabel, ProjectCache projectCache, @Assisted ProjectResource project, @Assisted String label)
name|LabelApiImpl
parameter_list|(
name|LabelsCollection
name|labels
