...
annotation|@
name|Inject
DECL|method|TagApiImpl ( ListTags listTags, CreateTag createTag, DeleteTag deleteTag, TagsCollection tags, @Assisted ProjectResource project, @Assisted String ref)
name|TagApiImpl
parameter_list|(
name|ListTags
name|listTags
