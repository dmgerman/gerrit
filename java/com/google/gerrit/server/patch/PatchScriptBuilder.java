...
return|;
block|}
DECL|method|isNewlineAtEndDeleted (Side a, Side b)
specifier|private
name|boolean
name|isNewlineAtEndDeleted
parameter_list|(
...
return|;
block|}
DECL|method|isNewlineAtEndAdded (Side a, Side b)
specifier|private
name|boolean
name|isNewlineAtEndAdded
parameter_list|(
...
return|;
block|}
DECL|method|packContent (Side a, Side b, boolean ignoredWhitespace)
specifier|private
name|void
name|packContent
parameter_list|(
...
block|}
block|}
DECL|class|SideResolver
specifier|private
class|class
name|SideResolver
block|{
DECL|method|resolve (final String path, final Side other, final ObjectId within)
name|Side
name|resolve
parameter_list|(
specifier|final
...
block|}
block|}
DECL|method|createSide ( String path, ObjectId id, FileMode mode, byte[] srcContent, Text src, MimeType mimeType, DisplayMethod displayMethod, boolean reuse)
specifier|private
name|Side
name|createSide
parameter_list|(
...
return|;
block|}
DECL|method|find (String path, ObjectId within)
specifier|private
name|TreeWalk
name|find
parameter_list|(
