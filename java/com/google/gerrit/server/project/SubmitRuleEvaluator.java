...
name|submitRules
decl_stmt|;
DECL|field|submitRuleEvaluationLatency
specifier|private
specifier|final
name|Timer0
name|submitRuleEvaluationLatency
decl_stmt|;
DECL|field|submitTypeEvaluationLatency
specifier|private
specifier|final
name|Timer0
name|submitTypeEvaluationLatency
decl_stmt|;
DECL|field|opts
specifier|private
specifier|final
...
annotation|@
name|Inject
DECL|method|SubmitRuleEvaluator ( ProjectCache projectCache, PrologRule prologRule, PluginSetContext<SubmitRule> submitRules, MetricMaker metricMaker, @Assisted SubmitRuleOptions options)
specifier|private
name|SubmitRuleEvaluator
parameter_list|(
name|ProjectCache
...
name|newTimer
argument_list|(
literal|"change/submit_rule_evaluation"
argument_list|,
operator|new
name|Description
argument_list|(
literal|"Latency for evaluating submit rules on a change."
argument_list|)
operator|.
name|setCumulative
argument_list|()
...
name|newTimer
argument_list|(
literal|"change/submit_type_evaluation"
argument_list|,
operator|new
name|Description
argument_list|(
literal|"Latency for evaluating the submit type on a change."
argument_list|)
operator|.
name|setCumulative
argument_list|()
