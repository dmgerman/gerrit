...
annotation|@
name|Inject
DECL|method|SetHead ( GitRepositoryManager repoManager, Provider<IdentifiedUser> identifiedUser, DynamicSet<HeadUpdatedListener> headUpdatedListeners, PermissionBackend permissionBackend)
name|SetHead
parameter_list|(
name|GitRepositoryManager
name|repoManager
