...
annotation|@
name|Inject
DECL|method|ProjectCacheImpl ( final AllProjectsName allProjectsName, final AllUsersName allUsersName, @Named(CACHE_NAME) LoadingCache<String, ProjectState> byName, @Named(CACHE_LIST) LoadingCache<ListKey, SortedSet<Project.NameKey>> list, ProjectCacheClock clock, Provider<ProjectIndexer> indexer)
name|ProjectCacheImpl
parameter_list|(
specifier|final
name|AllProjectsName
