...
name|okGroupIds
expr_stmt|;
comment|// matchProjects defaults to match all projects when missing.
name|List
argument_list|<
name|String
argument_list|>
...
condition|)
block|{
comment|// Doesn't match, isn't checked.
continue|continue;
block|}
comment|// excludeProjects defaults to exclude no projects when missing.
name|List
argument_list|<
name|String
argument_list|>
...
block|}
block|}
DECL|method|projectMatchesAnyPattern (String projectName, List<String> regexes)
specifier|private
name|boolean
name|projectMatchesAnyPattern
parameter_list|(
...
parameter_list|)
block|{
comment|// Should never happen: Regular expressions validated when reading project.config.
throw|throw
operator|new
name|IllegalStateException
argument_list|(
literal|"Invalid matchProjects or excludeProjects clause in project.config"
argument_list|,
name|e
argument_list|)
throw|;
