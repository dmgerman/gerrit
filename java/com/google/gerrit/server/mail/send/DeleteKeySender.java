...
annotation|@
name|AssistedInject
DECL|method|DeleteKeySender ( EmailArguments ea, PermissionBackend permissionBackend, IdentifiedUser callingUser, @Assisted IdentifiedUser user, @Assisted AccountSshKey sshKey)
specifier|public
name|DeleteKeySender
parameter_list|(
name|EmailArguments
...
annotation|@
name|AssistedInject
DECL|method|DeleteKeySender ( EmailArguments ea, PermissionBackend permissionBackend, IdentifiedUser callingUser, @Assisted IdentifiedUser user, @Assisted List<String> gpgKeyFingerprints)
specifier|public
name|DeleteKeySender
parameter_list|(
name|EmailArguments
...
condition|)
block|{
comment|// Send email if the user self-removed a key; this notification is necessary to alert
comment|// the user if their account was compromised and a key was unexpectedly deleted.
return|return
literal|true
return|;
block|}
try|try
block|{
comment|// Don't email if an administrator removed a key on behalf of the user.
name|permissionBackend
operator|.
name|user
argument_list|(
