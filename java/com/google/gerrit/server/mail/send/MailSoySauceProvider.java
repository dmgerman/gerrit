...
annotation|@
name|Inject
DECL|method|MailSoySauceProvider ( SitePaths site, SoyAstCache cache, PluginSetContext<MailSoyTemplateProvider> templateProviders)
name|MailSoySauceProvider
parameter_list|(
name|SitePaths
name|site
...
return|;
block|}
DECL|method|addTemplate (SoyFileSet.Builder builder, String resourcePath, String name)
specifier|private
name|void
name|addTemplate
parameter_list|(
