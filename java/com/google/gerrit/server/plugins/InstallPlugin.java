...
annotation|@
name|Inject
DECL|method|Create (PluginLoader loader, Provider<InstallPlugin> install)
name|Create
parameter_list|(
name|PluginLoader
name|loader
...
annotation|@
name|Override
DECL|method|apply ( TopLevelResource parentResource, IdString id, InstallPluginInput input)
specifier|public
name|Response
argument_list|<
name|PluginInfo
