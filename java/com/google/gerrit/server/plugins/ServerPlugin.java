...
decl_stmt|;
DECL|method|ServerPlugin ( String name, String pluginCanonicalWebUrl, PluginUser pluginUser, Path srcJar, FileSnapshot snapshot, PluginContentScanner scanner, Path dataDir, ClassLoader classLoader, String metricsPrefix, GerritRuntime gerritRuntime)
specifier|public
name|ServerPlugin
parameter_list|(
name|String
...
literal|"unchecked"
argument_list|)
DECL|method|load (@ullable String name, ClassLoader pluginLoader)
specifier|protected
specifier|static
name|Class
argument_list|<
