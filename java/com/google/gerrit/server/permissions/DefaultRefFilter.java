...
name|Factory
block|{
DECL|method|create (CurrentUser who, ProjectState projectState)
name|DefaultRefFilter
name|create
parameter_list|(
name|CurrentUser
...
annotation|@
name|Inject
DECL|method|DefaultRefFilter ( TagCache tagCache, ChangeNotes.Factory changeNotesFactory, @Nullable SearchingChangeCacheImpl changeCache, Provider<ReviewDb> db, GroupCache groupCache, PermissionBackend permissionBackend, @Assisted CurrentUser user, @Assisted ProjectState projectState)
name|DefaultRefFilter
parameter_list|(
name|TagCache
name|tagCache
