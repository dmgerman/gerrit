...
annotation|@
name|Inject
DECL|method|DefaultRefFilter ( TagCache tagCache, ChangeNotes.Factory changeNotesFactory, @Nullable SearchingChangeCacheImpl changeCache, Provider<ReviewDb> db, GroupCache groupCache, PermissionBackend permissionBackend, MetricMaker metricMaker, @Assisted ProjectControl projectControl)
name|DefaultRefFilter
parameter_list|(
name|TagCache
name|tagCache
