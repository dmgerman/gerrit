...
comment|// we have to investigate (deferred tags) separately then perform a reachability check starting
...
return|;
block|}
comment|/**    * Filters refs by visibility. Returns tags where visibility can't be trivially computed    * separately for later ref-walk-based visibility computation. Tags where visibility is trivial to    * compute will be returned as part of {@link Result#visibleRefs()}.    */
