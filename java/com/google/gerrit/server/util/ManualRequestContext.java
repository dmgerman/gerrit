...
name|old
decl_stmt|;
DECL|method|ManualRequestContext (CurrentUser user, ThreadLocalRequestContext requestContext)
specifier|public
name|ManualRequestContext
parameter_list|(
name|CurrentUser
...
expr_stmt|;
block|}
DECL|method|ManualRequestContext ( Provider<CurrentUser> userProvider, ThreadLocalRequestContext requestContext)
specifier|public
name|ManualRequestContext
parameter_list|(
name|Provider
