...
annotation|@
name|Inject
DECL|method|AllProjectsCreator ( GitRepositoryManager mgr, AllProjectsName allProjectsName, SystemGroupBackend systemGroupBackend, @GerritPersonIdent PersonIdent serverUser, NotesMigration notesMigration)
name|AllProjectsCreator
parameter_list|(
name|GitRepositoryManager
name|mgr
