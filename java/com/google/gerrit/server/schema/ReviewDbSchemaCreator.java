...
annotation|@
name|Inject
DECL|method|ReviewDbSchemaCreator ( GitRepositoryManager repoManager, AllProjectsCreator ap, AllUsersCreator auc, AllUsersName allUsersName, @GerritPersonIdent PersonIdent au, DataSourceType dst, GroupIndexCollection ic, String serverId, Config config, MetricMaker metricMaker, AllProjectsName apName)
specifier|public
name|ReviewDbSchemaCreator
parameter_list|(
name|GitRepositoryManager
