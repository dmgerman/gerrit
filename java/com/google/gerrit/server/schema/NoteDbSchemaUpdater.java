...
annotation|@
name|Inject
DECL|method|NoteDbSchemaUpdater ( @erritServerConfig Config cfg, NotesMigration notesMigration, NoteDbSchemaVersionManager versionManager, NoteDbSchemaVersion.Arguments args, GitRepositoryManager repoManager, AllUsersName allUsersName)
name|NoteDbSchemaUpdater
parameter_list|(
annotation|@
name|GerritServerConfig
...
expr_stmt|;
block|}
DECL|method|NoteDbSchemaUpdater ( Config cfg, AllUsersName allUsersName, GitRepositoryManager repoManager, NotesMigration notesMigration, NoteDbSchemaVersionManager versionManager, NoteDbSchemaVersion.Arguments args, ImmutableSortedMap<Integer, Class<? extends NoteDbSchemaVersion>> schemaVersions)
name|NoteDbSchemaUpdater
parameter_list|(
name|Config
name|cfg
