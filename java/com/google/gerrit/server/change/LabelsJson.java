...
annotation|@
name|Inject
DECL|method|LabelsJson ( Provider<ReviewDb> db, ApprovalsUtil approvalsUtil, ChangeNotes.Factory notesFactory, PermissionBackend permissionBackend, @Assisted Iterable<ListChangesOption> options)
name|LabelsJson
parameter_list|(
name|Provider
argument_list|<
