...
name|projectCache
decl_stmt|;
DECL|field|changeETagComputation
specifier|private
specifier|final
name|PluginSetContext
argument_list|<
...
annotation|@
name|Inject
DECL|method|ChangeResource ( AccountCache accountCache, ApprovalsUtil approvalUtil, PatchSetUtil patchSetUtil, PermissionBackend permissionBackend, StarredChangesUtil starredChangesUtil, ProjectCache projectCache, PluginSetContext<ChangeETagComputation> changeETagComputation, @Assisted ChangeNotes notes, @Assisted CurrentUser user)
name|ChangeResource
parameter_list|(
name|AccountCache
name|accountCache
