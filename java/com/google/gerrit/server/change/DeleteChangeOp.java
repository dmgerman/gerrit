...
name|log
argument_list|(
literal|"Deleting change %s, current patch set %d is commit %s"
argument_list|,
name|id
argument_list|,
name|ctx
...
expr_stmt|;
block|}
name|removeUserEdits
argument_list|(
name|ctx
argument_list|)
expr_stmt|;
block|}
DECL|method|removeUserEdits (RepoContext ctx)
specifier|private
name|void
name|removeUserEdits
parameter_list|(
...
block|}
block|}
DECL|method|removeRef (RepoContext ctx, Map.Entry<String, ObjectId> entry, String prefix)
specifier|private
name|void
name|removeRef
parameter_list|(
