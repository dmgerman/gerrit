...
name|Factory
block|{
DECL|method|create (ChangeMessagesUtil cmUtil, boolean isPrivate, Input input)
name|SetPrivateOp
name|create
parameter_list|(
name|ChangeMessagesUtil
...
annotation|@
name|Inject
DECL|method|SetPrivateOp ( PrivateStateChanged privateStateChanged, @Assisted ChangeMessagesUtil cmUtil, @Assisted boolean isPrivate, @Assisted Input input)
name|SetPrivateOp
parameter_list|(
name|PrivateStateChanged
name|privateStateChanged
