...
annotation|@
name|Inject
DECL|method|Revisions ( DynamicMap<RestView<RevisionResource>> views, Provider<ReviewDb> dbProvider, ChangeEditUtil editUtil, PatchSetUtil psUtil, PermissionBackend permissionBackend)
name|Revisions
parameter_list|(
name|DynamicMap
argument_list|<
