...
return|;
block|}
DECL|method|resolveNotify (ChangeNotes notes, AddReviewerInput input)
specifier|private
name|NotifyResolver
operator|.
name|Result
...
annotation|@
name|Nullable
DECL|method|addByAccountId ( AddReviewerInput input, ChangeNotes notes, CurrentUser user, NotifyResolver.Result notify)
specifier|private
name|ReviewerAddition
name|addByAccountId
parameter_list|(
...
annotation|@
name|Nullable
DECL|method|addWholeGroup ( AddReviewerInput input, ChangeNotes notes, CurrentUser user, NotifyResolver.Result notify, boolean confirmed, boolean allowGroup, boolean allowByEmail)
specifier|private
name|ReviewerAddition
name|addWholeGroup
parameter_list|(
...
annotation|@
name|Nullable
DECL|method|addByEmail ( AddReviewerInput input, ChangeNotes notes, CurrentUser user, NotifyResolver.Result notify)
specifier|private
name|ReviewerAddition
name|addByEmail
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|ReviewerAddition ( AddReviewerInput input, ChangeNotes notes, CurrentUser caller, @Nullable Iterable<Account.Id> reviewers, @Nullable Iterable<Address> reviewersByEmail, NotifyResolver.Result notify, boolean exactMatchFound)
specifier|private
name|ReviewerAddition
parameter_list|(
name|AddReviewerInput
