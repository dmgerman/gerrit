...
condition|)
block|{
comment|// TODO(dborowitz): How best to report this? Erroring out would match existing
comment|// ReceiveCommits behavior, but it may be worth rethinking.
name|AddReviewerResult
name|result
init|=
name|reviewerError
...
name|BadRequestException
argument_list|(
literal|"Failed to add reviewer "
operator|+
name|result
operator|.
name|input
...
block|}
block|}
DECL|method|newAddReviewerInput ( Account.Id accountId, ReviewerState state)
specifier|private
specifier|static
name|InternalAddReviewerInput
name|newAddReviewerInput
