...
annotation|@
name|Inject
DECL|method|ChangeInserter ( PermissionBackend permissionBackend, ProjectCache projectCache, PatchSetInfoFactory patchSetInfoFactory, PatchSetUtil psUtil, ApprovalsUtil approvalsUtil, ChangeMessagesUtil cmUtil, CreateChangeSender.Factory createChangeSenderFactory, @SendEmailExecutor ExecutorService sendEmailExecutor, CommitValidators.Factory commitValidatorsFactory, CommentAdded commentAdded, RevisionCreated revisionCreated, NotesMigration migration, @Assisted Change.Id changeId, @Assisted ObjectId commitId, @Assisted String refName)
name|ChangeInserter
parameter_list|(
name|PermissionBackend
name|permissionBackend
