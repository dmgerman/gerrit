...
name|metrics
decl_stmt|;
DECL|field|enableParallelFormatting
specifier|private
specifier|final
name|boolean
name|enableParallelFormatting
decl_stmt|;
DECL|field|fanOutExecutor
specifier|private
specifier|final
name|ExecutorService
name|fanOutExecutor
...
annotation|@
name|Inject
DECL|method|ChangeJson ( Provider<ReviewDb> db, Provider<CurrentUser> user, AnonymousUser au, PermissionBackend permissionBackend, GitRepositoryManager repoManager, ProjectCache projectCache, MergeUtil.Factory mergeUtilFactory, IdentifiedUser.GenericFactory uf, ChangeData.Factory cdf, FileInfoJson fileInfoJson, AccountLoader.Factory ailf, DynamicMap<DownloadScheme> downloadSchemes, DynamicMap<DownloadCommand> downloadCommands, WebLinks webLinks, ChangeMessagesUtil cmUtil, Provider<ConsistencyChecker> checkerProvider, ActionJson actionJson, GpgApiAdapter gpgApi, ChangeNotes.Factory notesFactory, ChangeResource.Factory changeResourceFactory, ChangeKindCache changeKindCache, ApprovalsUtil approvalsUtil, RemoveReviewerControl removeReviewerControl, TrackingFooters trackingFooters, Metrics metrics, @GerritServerConfig Config config, @FanOutExecutor ExecutorService fanOutExecutor, @Assisted Iterable<ListChangesOption> options)
name|ChangeJson
parameter_list|(
name|Provider
argument_list|<
...
literal|"change"
argument_list|,
literal|"enableParallelFormatting"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
init|)
block|{
comment|// Create a list of formatting calls that can be called sequentially or in parallel
name|List
argument_list|<
name|Callable
argument_list|<
...
condition|)
block|{
comment|// Format these changes in the request thread as the multithreading overhead would be too
comment|// high.
name|List
argument_list|<
name|ChangeInfo
...
return|;
block|}
comment|// Format the changes in parallel on the executor
name|List
argument_list|<
name|ChangeInfo
argument_list|>
...
block|}
block|}
DECL|method|toChangeInfoImpl (ChangeData cd, Optional<PatchSet.Id> limitToPsId)
specifier|private
name|ChangeInfo
name|toChangeInfoImpl
parameter_list|(
