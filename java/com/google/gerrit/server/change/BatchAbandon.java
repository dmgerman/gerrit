...
annotation|@
name|Inject
DECL|method|BatchAbandon ( AbandonOp.Factory abandonOpFactory, ChangeCleanupConfig cfg, PluginItemContext<AccountPatchReviewStore> accountPatchReviewStore)
name|BatchAbandon
parameter_list|(
name|AbandonOp
operator|.
...
expr_stmt|;
block|}
DECL|method|cleanupAccountPatchReview (Collection<ChangeData> changes)
specifier|private
name|void
name|cleanupAccountPatchReview
parameter_list|(
