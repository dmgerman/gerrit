...
annotation|@
name|Inject
DECL|method|AccountGroupUUIDHandler ( final GroupBackend groupBackend, final GroupControl.Factory groupControlFactory, @Assisted final CmdLineParser parser, @Assisted final OptionDef option, @Assisted final Setter<AccountGroup.UUID> setter, GroupCache groupCache)
specifier|public
name|AccountGroupUUIDHandler
parameter_list|(
specifier|final
