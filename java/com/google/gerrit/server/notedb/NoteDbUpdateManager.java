...
annotation|@
name|Inject
DECL|method|NoteDbUpdateManager ( @erritServerConfig Config cfg, @GerritPersonIdent Provider<PersonIdent> serverIdent, GitRepositoryManager repoManager, AllUsersName allUsersName, NoteDbMetrics metrics, @Assisted Project.NameKey projectName)
name|NoteDbUpdateManager
parameter_list|(
annotation|@
name|GerritServerConfig
...
expr_stmt|;
block|}
DECL|method|addUpdates ( ListMultimap<String, U> all, OpenRepo or, Optional<Integer> maxUpdates)
specifier|private
specifier|static
parameter_list|<
name|U
