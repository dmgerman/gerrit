...
name|AutoCloseable
block|{
DECL|field|MAX_UPDATES_DEFAULT
specifier|private
specifier|static
specifier|final
name|int
name|MAX_UPDATES_DEFAULT
init|=
literal|1000
decl_stmt|;
comment|/** Limits the number of patch sets that can be created. Can be overridden in the config. */
DECL|field|MAX_PATCH_SETS_DEFAULT
specifier|private
specifier|static
specifier|final
name|int
name|MAX_PATCH_SETS_DEFAULT
init|=
literal|1500
decl_stmt|;
