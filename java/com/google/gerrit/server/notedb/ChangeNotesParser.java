...
block|}
block|}
comment|/**    * Subset of field on patch sets that are mutable after patch set creation, and therefore may be    * parsed before the rest of the patch set is available.    *    *<p>In the future, if {@code PatchSet} becomes an immutable type with a builder, this class can    * be replaced with the builder. For now, keep it as simple as possible.    */
DECL|class|PendingPatchSetFields
specifier|static
class|class
name|PendingPatchSetFields
block|{
DECL|field|groups
name|List
argument_list|<
...
block|{
throw|throw
name|patchSetFieldBeforeDefinition
argument_list|(
name|psId
argument_list|,
name|FOOTER_GROUPS
...
block|}
block|}
DECL|method|patchSetFieldBeforeDefinition ( PatchSet.Id psId, FooterKey footerPatchSetDescription)
specifier|private
name|ConfigInvalidException
name|patchSetFieldBeforeDefinition
parameter_list|(
...
parameter_list|,
name|FooterKey
name|footerPatchSetDescription
parameter_list|)
block|{
return|return
name|parseException
argument_list|(
literal|"%s field found for patch set %s before it was defined"
argument_list|,
name|footerPatchSetDescription
operator|.
name|getName
