...
annotation|@
name|Inject
DECL|method|OnlineNoteDbMigrator ( @erritServerConfig Config cfg, GcAllUsers gcAllUsers, OnlineUpgrader indexUpgrader, Provider<NoteDbMigrator.Builder> migratorBuilderProvider, @Named(TRIAL) boolean trial)
name|OnlineNoteDbMigrator
parameter_list|(
annotation|@
name|GerritServerConfig
...
name|log
argument_list|(
literal|"Online NoteDb migration completed in %ss"
argument_list|,
name|sw
operator|.
name|elapsed
