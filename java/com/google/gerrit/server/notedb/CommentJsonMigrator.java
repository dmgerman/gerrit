...
annotation|@
name|Inject
DECL|method|CommentJsonMigrator ( ChangeNoteJson changeNoteJson, GerritServerIdProvider gerritServerIdProvider)
name|CommentJsonMigrator
parameter_list|(
name|ChangeNoteJson
name|changeNoteJson
...
expr_stmt|;
block|}
DECL|method|CommentJsonMigrator (ChangeNoteJson changeNoteJson, String serverId)
name|CommentJsonMigrator
parameter_list|(
name|ChangeNoteJson
name|changeNoteJson
