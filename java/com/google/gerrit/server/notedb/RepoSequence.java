...
annotation|@
name|VisibleForTesting
DECL|method|RepoSequence ( GitRepositoryManager repoManager, GitReferenceUpdated gitRefUpdated, Project.NameKey projectName, String name, Seed seed, int batchSize, Runnable afterReadRef, Retryer<RefUpdate.Result> retryer)
name|RepoSequence
parameter_list|(
name|GitRepositoryManager
name|repoManager
...
expr_stmt|;
block|}
DECL|method|RepoSequence ( GitRepositoryManager repoManager, GitReferenceUpdated gitRefUpdated, Project.NameKey projectName, String name, Seed seed, int batchSize, Runnable afterReadRef, Retryer<RefUpdate.Result> retryer, int floor)
name|RepoSequence
parameter_list|(
name|GitRepositoryManager
name|repoManager
...
condition|)
block|{
comment|// a concurrent write updated the ref already to this or a higher value
return|return
name|RefUpdate
operator|.
name|Result
