...
decl_stmt|;
comment|/** Count of auto-rebuild attempts that failed. */
DECL|field|autoRebuildFailureCount
specifier|final
name|Counter1
argument_list|<
name|NoteDbTable
...
name|newTimer
argument_list|(
literal|"notedb/auto_rebuild_latency"
argument_list|,
operator|new
name|Description
argument_list|(
literal|"NoteDb auto-rebuilding latency by table"
argument_list|)
operator|.
name|setCumulative
argument_list|()
...
name|newCounter
argument_list|(
literal|"notedb/auto_rebuild_failure_count"
argument_list|,
operator|new
name|Description
argument_list|(
literal|"NoteDb auto-rebuilding attempts that failed by table"
argument_list|)
operator|.
name|setCumulative
argument_list|()
