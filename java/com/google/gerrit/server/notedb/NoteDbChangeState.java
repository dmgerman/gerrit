...
return|;
block|}
comment|// TODO(dborowitz): Ugly. Refactor these static methods into a Checker class
comment|// or something. They do not belong in NoteDbChangeState itself because:
comment|//  - need to inject Config but don't want a whole Factory
