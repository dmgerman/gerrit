...
annotation|@
name|Inject
DECL|method|StreamEventsApiListener ( PluginItemContext<EventDispatcher> dispatcher, Provider<ReviewDb> db, EventFactory eventFactory, ProjectCache projectCache, GitRepositoryManager repoManager, PatchSetUtil psUtil, ChangeNotes.Factory changeNotesFactory)
name|StreamEventsApiListener
parameter_list|(
name|PluginItemContext
argument_list|<
