...
annotation|@
name|Inject
DECL|method|EventBroker ( PluginSetContext<UserScopedEventListener> listeners, PluginSetContext<EventListener> unrestrictedListeners, PermissionBackend permissionBackend, ProjectCache projectCache, ChangeNotes.Factory notesFactory, Provider<ReviewDb> dbProvider)
specifier|public
name|EventBroker
parameter_list|(
name|PluginSetContext
