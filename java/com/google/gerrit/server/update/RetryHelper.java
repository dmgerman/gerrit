...
return|;
block|}
comment|/**    * Creates an action for querying an index that is executed with retrying when called.    *    * @param actionName the name of the action, used as metric bucket    * @param action the action that should be executed    * @return the retryable action, callers need to call {@link RetryableAction#call()} to execute    *     the action    */
DECL|method|indexQuery (String actionName, Action<T> action)
specifier|public
parameter_list|<
name|T
parameter_list|>
...
begin_function
DECL|method|executeWithTimeoutCount ( ActionType actionType, Action<T> action, Options opts, Retryer<T> retryer)
specifier|private
parameter_list|<
name|T
parameter_list|>
