...
annotation|@
name|AssistedInject
DECL|method|PrologRuleEvaluator ( AccountCache accountCache, Accounts accounts, Emails emails, ProjectCache projectCache, @Assisted ChangeData cd, @Assisted SubmitRuleOptions options)
specifier|private
name|PrologRuleEvaluator
parameter_list|(
name|AccountCache
