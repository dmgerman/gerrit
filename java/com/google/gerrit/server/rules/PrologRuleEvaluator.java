...
DECL|method|create (ChangeData cd, SubmitRuleOptions options)
name|PrologRuleEvaluator
name|create
parameter_list|(
name|ChangeData
...
annotation|@
name|AssistedInject
DECL|method|PrologRuleEvaluator ( AccountCache accountCache, Accounts accounts, Emails emails, RulesCache rulesCache, PrologEnvironment.Factory envFactory, ProjectCache projectCache, @Assisted ChangeData cd, @Assisted SubmitRuleOptions options)
specifier|private
name|PrologRuleEvaluator
parameter_list|(
name|AccountCache
