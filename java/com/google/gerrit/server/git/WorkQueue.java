...
annotation|@
name|Inject
DECL|method|WorkQueue (MetricMaker metrics, IdGenerator idGenerator, @GerritServerConfig Config cfg)
name|WorkQueue
parameter_list|(
name|MetricMaker
name|metrics
...
DECL|method|WorkQueue (MetricMaker metrics, IdGenerator idGenerator, int defaultThreadPoolSize)
specifier|public
name|WorkQueue
parameter_list|(
name|MetricMaker
...
return|;
block|}
DECL|method|createQueue (int poolsize, String prefix, int threadPriority)
specifier|public
name|ScheduledThreadPoolExecutor
name|createQueue
parameter_list|(
