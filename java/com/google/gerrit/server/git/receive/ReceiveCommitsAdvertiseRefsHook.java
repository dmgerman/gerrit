...
name|user
decl_stmt|;
DECL|method|ReceiveCommitsAdvertiseRefsHook ( Provider<InternalChangeQuery> queryProvider, Project.NameKey projectName, Account.Id user)
specifier|public
name|ReceiveCommitsAdvertiseRefsHook
parameter_list|(
name|Provider
...
name|ServiceMayNotContinueException
block|{
comment|// Advertise the user's most recent open changes. It's likely that the user has one of these in
comment|// their local repo and they can serve as starting points to figure out the common ancestor of
comment|// what the client and server have in common.
name|int
name|limit
init|=
literal|32
