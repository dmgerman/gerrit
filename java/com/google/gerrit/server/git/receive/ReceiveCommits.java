...
expr_stmt|;
block|}
comment|// Process the magicCommand last, so magicBranch settings can't interact with regular
comment|// commands.
name|boolean
name|first
init|=
...
block|}
block|}
comment|/*    * Interpret a normal push, and optionally add a corresponding command to actualCommands.    */
