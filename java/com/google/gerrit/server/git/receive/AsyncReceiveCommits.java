...
name|newHistogram
argument_list|(
literal|"receivecommits/changes"
argument_list|,
operator|new
name|Description
argument_list|(
...
literal|"type"
argument_list|,
literal|"type of update (replace, create, autoclose)"
argument_list|)
argument_list|)
expr_stmt|;
name|latencyPerChange
...
name|newTimer
argument_list|(
literal|"receivecommits/latency"
argument_list|,
operator|new
name|Description
argument_list|(
literal|"average delay per updated change"
argument_list|)
operator|.
name|setUnit
argument_list|(
...
literal|"type"
argument_list|,
literal|"type of update (create/replace, autoclose)"
argument_list|)
argument_list|)
expr_stmt|;
name|timeouts
