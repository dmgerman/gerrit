...
DECL|method|validCommit ( ObjectReader objectReader, ReceiveCommand cmd, RevCommit commit, boolean isMerged, List<ValidationMessage> messages, NoteMap rejectCommits, @Nullable Change change)
specifier|public
name|boolean
name|validCommit
parameter_list|(
...
return|;
block|}
comment|/**    * Validates a single commit. If the commit does not validate, the command is rejected.    *    * @param objectReader the object reader to use.    * @param cmd the ReceiveCommand executing the push.    * @param commit the commit being validated.    * @param isMerged whether this is a merge commit created by magicBranch --merge option    * @param change the change for which this is a new patchset.    * @param skipValidation whether 'skip-validation' was requested.    */
DECL|method|validCommit ( ObjectReader objectReader, ReceiveCommand cmd, RevCommit commit, boolean isMerged, List<ValidationMessage> messages, NoteMap rejectCommits, @Nullable Change change, boolean skipValidation)
specifier|public
name|boolean
name|validCommit
parameter_list|(
