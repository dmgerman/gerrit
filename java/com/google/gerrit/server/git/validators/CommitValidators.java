...
return|;
block|}
DECL|method|forGerritCommits ( PermissionBackend.ForRef perm, Branch.NameKey branch, IdentifiedUser user, SshInfo sshInfo, RevWalk rw, ProjectState projectState)
specifier|public
name|CommitValidators
...
name|projectState
decl_stmt|;
DECL|method|ConfigValidator ( Branch.NameKey branch, IdentifiedUser user, RevWalk rw, AllUsersName allUsers, AllProjectsName allProjects, ProjectState projectState)
specifier|public
name|ConfigValidator
parameter_list|(
name|Branch
...
condition|)
block|{
comment|// Check if the new config modifies any access sections for refs/groups/. These are
comment|// managed by Gerrit and modifications are not allowed.
name|Set
argument_list|<
name|AccessSection
argument_list|>
...
decl_stmt|;
name|boolean
name|modifiesGroupsAccessSection
init|=
name|diff
operator|.
name|stream
