...
annotation|@
name|Inject
DECL|method|MergeSuperSet ( @erritServerConfig Config cfg, ChangeData.Factory changeDataFactory, Provider<InternalChangeQuery> queryProvider, Provider<MergeOpRepoManager> repoManagerProvider, DynamicItem<MergeSuperSetComputation> mergeSuperSetComputation, PermissionBackend permissionBackend, ProjectCache projectCache)
name|MergeSuperSet
parameter_list|(
annotation|@
name|GerritServerConfig
