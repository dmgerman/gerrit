...
begin_function
unit|}   }
DECL|method|getEtagWithRetry ( HttpServletRequest req, TraceContext traceContext, ViewData viewData, ETagView<RestResource> view, RestResource rsrc)
specifier|private
name|String
name|getEtagWithRetry
parameter_list|(
name|HttpServletRequest
name|req
parameter_list|,
...
name|newTimer
argument_list|(
literal|"RestApiServlet#getEtagWithRetry:view"
argument_list|,
name|Metadata
operator|.
name|builder
...
argument_list|(
literal|"Failed to get ETag for view"
argument_list|,
name|e
argument_list|)
throw|;
...
begin_function
DECL|method|getEtagWithRetry ( HttpServletRequest req, TraceContext traceContext, RestResource.HasETag rsrc)
specifier|private
name|String
name|getEtagWithRetry
parameter_list|(
...
name|newTimer
argument_list|(
literal|"RestApiServlet#getEtagWithRetry:resource"
argument_list|,
name|Metadata
operator|.
name|builder
...
name|IllegalStateException
argument_list|(
literal|"Failed to get ETag for resource"
argument_list|,
name|e
argument_list|)
throw|;
...
begin_function
DECL|method|notModified ( HttpServletRequest req, TraceContext traceContext, ViewData viewData, RestResource rsrc)
specifier|private
name|boolean
name|notModified
parameter_list|(
...
begin_function
DECL|method|configureCaching ( HttpServletRequest req, HttpServletResponse res, TraceContext traceContext, R rsrc, ViewData viewData, CacheControl cacheControl)
specifier|private
parameter_list|<
name|R
extends|extends
...
begin_function
DECL|method|setCacheHeaders ( HttpServletRequest req, HttpServletResponse res, CacheControl cacheControl)
specifier|private
specifier|static
parameter_list|<
name|R
...
begin_function
DECL|method|addResourceStateHeaders ( HttpServletRequest req, HttpServletResponse res, TraceContext traceContext, ViewData viewData, RestResource rsrc)
specifier|private
name|void
name|addResourceStateHeaders
parameter_list|(
...
begin_function
DECL|method|replyError ( HttpServletRequest req, HttpServletResponse res, int statusCode, String msg, CacheControl cacheControl, @Nullable Throwable err)
specifier|public
specifier|static
name|long
name|replyError
