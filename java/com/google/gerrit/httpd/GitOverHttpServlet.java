...
annotation|@
name|Inject
DECL|method|UploadFilter ( UploadValidators.Factory uploadValidatorsFactory, PermissionBackend permissionBackend, Provider<CurrentUser> userProvider, GroupAuditService groupAuditService, Metrics metrics, PluginSetContext<RequestListener> requestListeners)
name|UploadFilter
parameter_list|(
name|UploadValidators
operator|.
