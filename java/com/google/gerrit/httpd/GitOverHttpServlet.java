...
annotation|@
name|Inject
DECL|method|UploadFactory ( TransferConfig tc, DynamicSet<PreUploadHook> preUploadHooks, DynamicSet<PostUploadHook> postUploadHooks, PluginSetContext<UploadPackInitializer> uploadPackInitializers, PermissionBackend permissionBackend)
name|UploadFactory
parameter_list|(
name|TransferConfig
name|tc
...
decl_stmt|;
DECL|field|enableRefPermissionBackend
specifier|private
specifier|final
name|boolean
...
annotation|@
name|Inject
DECL|method|UploadFilter ( UploadValidators.Factory uploadValidatorsFactory, TransferConfig config, PermissionBackend permissionBackend, Provider<CurrentUser> userProvider, GroupAuditService groupAuditService, Metrics metrics, PluginSetContext<RequestListener> requestListeners)
name|UploadFilter
parameter_list|(
name|UploadValidators
operator|.
