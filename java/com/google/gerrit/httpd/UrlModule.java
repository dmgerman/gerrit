...
name|authConfig
decl_stmt|;
DECL|method|UrlModule (GerritOptions options, AuthConfig authConfig)
name|UrlModule
parameter_list|(
name|GerritOptions
name|options
...
expr_stmt|;
block|}
DECL|method|toGerrit (String target, HttpServletRequest req, HttpServletResponse rsp, boolean gwt)
specifier|static
name|void
name|toGerrit
parameter_list|(
