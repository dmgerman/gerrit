...
name|canWriteConfig
decl_stmt|;
DECL|method|ProjectAccessHandler ( GroupBackend groupBackend, ProjectConfig.Factory projectConfigFactory, MetaDataUpdate.User metaDataUpdateFactory, AllProjectsName allProjects, Provider<SetParent> setParent, CurrentUser user, NameKey projectName, ObjectId base, List<AccessSection> sectionList, NameKey parentProjectName, String message, ContributorAgreementsChecker contributorAgreements, PermissionBackend permissionBackend, boolean checkIfOwner)
specifier|protected
name|ProjectAccessHandler
parameter_list|(
name|GroupBackend
