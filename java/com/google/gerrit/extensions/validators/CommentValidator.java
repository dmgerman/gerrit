...
begin_comment
comment|/**  * Validates review comments and messages. Rejecting any comment/message will prevent all comments  * from being published.  */
end_comment

begin_interface
annotation|@
name|ExtensionPoint
DECL|interface|CommentValidator
specifier|public
interface|interface
