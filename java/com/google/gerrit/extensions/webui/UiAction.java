...
return|;
block|}
DECL|method|getVisibleCondition ()
specifier|public
name|BooleanCondition
name|getVisibleCondition
parameter_list|()
...
block|}
comment|/**      * Set if the action's button is visible on screen for the current client. If not visible the      * action description may not be sent to the client.      */
DECL|method|setVisible (BooleanCondition visible)
specifier|public
name|Description
name|setVisible
parameter_list|(
...
return|;
block|}
DECL|method|getEnabledCondition ()
specifier|public
name|BooleanCondition
name|getEnabledCondition
parameter_list|()
...
block|}
comment|/** Set if the button should be invokable (true), or greyed out (false). */
DECL|method|setEnabled (BooleanCondition enabled)
specifier|public
name|Description
name|setEnabled
parameter_list|(
