...
return|;
block|}
comment|/** Set a plugin option on the request, appending to existing options. */
DECL|method|withPluginOption (String name, String value)
specifier|public
name|QueryRequest
name|withPluginOption
parameter_list|(
name|String
name|name
parameter_list|,
...
return|;
block|}
comment|/** Set a plugin option on the request, replacing existing options. */
DECL|method|withPluginOptions (ListMultimap<String, String> options)
specifier|public
name|QueryRequest
