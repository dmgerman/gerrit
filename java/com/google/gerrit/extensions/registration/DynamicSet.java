...
name|provider
decl_stmt|;
DECL|method|Entry (String pluginName, Provider<T> provider)
specifier|private
name|Entry
parameter_list|(
name|String
...
name|items
decl_stmt|;
DECL|method|DynamicSet (Collection<AtomicReference<NamedProvider<T>>> base)
name|DynamicSet
parameter_list|(
name|Collection
argument_list|<
...
name|item
decl_stmt|;
DECL|method|ReloadableHandle (AtomicReference<NamedProvider<T>> ref, Key<T> key, NamedProvider<T> item)
name|ReloadableHandle
parameter_list|(
name|AtomicReference
argument_list|<
