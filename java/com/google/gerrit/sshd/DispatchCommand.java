...
annotation|@
name|Inject
DECL|method|DispatchCommand ( PermissionBackend permissionBackend, DynamicSet<SshExecuteCommandInterceptor> commandInterceptors, @Assisted Map<String, CommandProvider> all)
name|DispatchCommand
parameter_list|(
name|PermissionBackend
name|permissionBackend
