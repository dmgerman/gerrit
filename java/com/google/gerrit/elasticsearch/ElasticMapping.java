...
name|ElasticMapping
block|{
DECL|method|createMapping (Schema<?> schema, ElasticQueryAdapter adapter)
specifier|static
...
argument_list|()
decl_stmt|;
DECL|method|Builder (ElasticQueryAdapter adapter)
name|Builder
parameter_list|(
name|ElasticQueryAdapter
name|adapter
...
return|;
block|}
DECL|method|addStringWithAnalyzer (String name)
name|Builder
name|addStringWithAnalyzer
parameter_list|(
name|String
