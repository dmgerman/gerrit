...
name|queryBuilder
decl_stmt|;
DECL|method|AbstractElasticIndex ( @erritServerConfig Config cfg, SitePaths sitePaths, Schema<V> schema, ElasticRestClientBuilder clientBuilder, String indexName)
name|AbstractElasticIndex
parameter_list|(
annotation|@
name|GerritServerConfig
...
return|;
block|}
DECL|method|performRequest ( String method, String payload, String uri, Map<String, String> params)
specifier|protected
name|Response
name|performRequest
parameter_list|(
