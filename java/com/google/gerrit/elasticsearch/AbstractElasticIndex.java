...
name|search
decl_stmt|;
DECL|method|ElasticQuerySource (Predicate<V> p, QueryOptions opts, String type, Sort sort)
name|ElasticQuerySource
parameter_list|(
name|Predicate
argument_list|<
...
expr_stmt|;
block|}
DECL|method|ElasticQuerySource ( Predicate<V> p, QueryOptions opts, Collection<String> types, Collection<Sort> sorts)
name|ElasticQuerySource
parameter_list|(
name|Predicate
argument_list|<
