...
annotation|@
name|Inject
DECL|method|ElasticAccountIndex ( @erritServerConfig Config cfg, SitePaths sitePaths, Provider<AccountCache> accountCache, ElasticRestClientBuilder clientBuilder, @Assisted Schema<AccountState> schema)
name|ElasticAccountIndex
parameter_list|(
annotation|@
name|GerritServerConfig
