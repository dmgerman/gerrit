...
argument_list|()
operator|+
literal|"/branches/master/mergeable?source=branchA"
argument_list|)
decl_stmt|;
name|MergeableInfo
name|m
...
annotation|@
name|Test
DECL|method|dryRunMerge_Conflicts ()
specifier|public
name|void
name|dryRunMerge_Conflicts
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|newMergeChangeInput (String targetBranch, String sourceRef, ChangeStatus status)
specifier|private
name|ChangeInput
name|newMergeChangeInput
parameter_list|(
...
return|;
block|}
DECL|method|changeInTwoBranches (String fileInMaster, String fileInBranchA)
specifier|private
name|void
name|changeInTwoBranches
parameter_list|(
...
argument_list|()
expr_stmt|;
comment|// create a new branch branchA
name|createBranch
argument_list|(
operator|new
name|Branch
...
argument_list|)
expr_stmt|;
comment|// create another commit in master
name|Result
name|changeToMaster
init|=
name|pushFactory
...
name|testRepo
argument_list|,
literal|"change to master"
argument_list|,
name|fileInMaster
argument_list|,
literal|"master content"
argument_list|)
operator|.
name|to
argument_list|(
...
name|testRepo
argument_list|,
literal|"change to branchA"
argument_list|,
name|fileInBranchA
argument_list|,
literal|"branchA content"
argument_list|)
decl_stmt|;
name|commit
operator|.
