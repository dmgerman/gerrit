...
annotation|@
name|Test
DECL|method|noNotificationForDraftChangesForWatchersInNotifyConfig ()
specifier|public
name|void
name|noNotificationForDraftChangesForWatchersInNotifyConfig
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|noNotificationForDraftPatchSetsForWatchersInNotifyConfig ()
specifier|public
name|void
name|noNotificationForDraftPatchSetsForWatchersInNotifyConfig
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|watchProjectNoNotificationForDraftChange ()
specifier|public
name|void
name|watchProjectNoNotificationForDraftChange
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|watchProjectNotifyOnDraftChange ()
specifier|public
name|void
name|watchProjectNotifyOnDraftChange
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// create group that can view all drafts
name|GroupInfo
name|groupThatCanViewDrafts
init|=
name|gApi
operator|.
name|groups
...
name|create
argument_list|(
literal|"groupThatCanViewDrafts"
argument_list|)
operator|.
name|get
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// watch project as user that can't view drafts
name|setApiUser
argument_list|(
name|user
argument_list|)
...
comment|// userThatCanViewDrafts, but not for user
name|setApiUser
argument_list|(
name|admin
argument_list|)
...
annotation|@
name|Test
DECL|method|deleteAllProjectWatches ()
specifier|public
name|void
...
annotation|@
name|Test
DECL|method|deleteAllProjectWatchesIfWatchConfigIsTheOnlyFileInUserBranch ()
specifier|public
name|void
name|deleteAllProjectWatchesIfWatchConfigIsTheOnlyFileInUserBranch
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Create account that has no files in its refs/users/ branch.
name|Account
operator|.
name|Id
name|id
...
name|id
decl_stmt|;
comment|// Add a project watch so that a watch.config file in the refs/users/ branch is created.
name|Map
argument_list|<
name|ProjectWatchKey
argument_list|,
...
argument_list|()
expr_stmt|;
comment|// Delete all project watches so that the watch.config file in the refs/users/ branch is
comment|// deleted.
name|watchConfig
operator|.
name|deleteAllProjectWatches
