...
argument_list|)
decl_stmt|;
comment|// Out of the above, only submit 3 and 5.
name|submitStatusOnly
argument_list|(
name|change3
operator|.
...
annotation|@
name|Test
DECL|method|submitChangeAfterParentFailsDueToConflict ()
specifier|public
name|void
name|submitChangeAfterParentFailsDueToConflict
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// change4 is a clean merge, so should succeed in the same run where change3
comment|// failed.
name|ChangeInfo
name|info4
init|=
