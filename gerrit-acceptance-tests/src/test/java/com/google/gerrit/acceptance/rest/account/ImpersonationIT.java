...
annotation|@
name|Test
DECL|method|voteOnBehalfOfPublishesDrafts ()
specifier|public
name|void
name|voteOnBehalfOfPublishesDrafts
parameter_list|()
throws|throws
name|Exception
block|{
...
name|PUBLISH
expr_stmt|;
comment|// TODO(dborowitz): This doesn't seem appropriate, disallow it.
name|gApi
operator|.
name|changes
argument_list|()
...
annotation|@
name|Test
DECL|method|voteOnBehalfOfSucceedsWhenUserCannotSeeDestinationRef ()
specifier|public
name|void
name|voteOnBehalfOfSucceedsWhenUserCannotSeeDestinationRef
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// TODO(dborowitz): Make this fail instead.
name|revision
operator|.
name|review
argument_list|(
...
annotation|@
name|Test
DECL|method|submitOnBehalfOfInvisibleUserIsAllowed ()
specifier|public
name|void
name|submitOnBehalfOfInvisibleUserIsAllowed
parameter_list|()
throws|throws
name|Exception
block|{
