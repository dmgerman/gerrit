...
expr_stmt|;
block|}
DECL|method|ensureUserBranchCreated (TestAccount account)
specifier|private
name|void
name|ensureUserBranchCreated
parameter_list|(
...
name|Exception
block|{
comment|// Change something in the user preferences to ensure that the user branch is created.
name|setApiUser
argument_list|(
name|account
argument_list|)
