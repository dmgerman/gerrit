...
annotation|@
name|Test
DECL|method|createWithInvalidSshKey ()
specifier|public
name|void
name|createWithInvalidSshKey
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"invalid key"
expr_stmt|;
comment|// Invalid key should cause the creation to fail
name|BadRequestException
name|thrown
init|=
name|assertThrows
...
argument_list|)
expr_stmt|;
comment|// Account is reindexed twice; once on removing the new email,
comment|// and then again on unsetting the email preferred.
name|accountIndexedCounter
operator|.
name|assertReindexOf
argument_list|(
