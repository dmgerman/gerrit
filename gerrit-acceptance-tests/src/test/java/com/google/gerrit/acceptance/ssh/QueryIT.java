...
annotation|@
name|Test
DECL|method|testTimestampInTextQuery ()
specifier|public
name|void
name|testTimestampInTextQuery
parameter_list|()
throws|throws
name|Exception
block|{
...
name|textResult
init|=
name|executeSuccessfulTextQuery
argument_list|(
name|result
operator|.
name|getChangeId
...
name|isEqualTo
argument_list|(
literal|"2009-09-30 14:00:02 PDT"
argument_list|)
expr_stmt|;
name|long
name|expectedCreatedOn
init|=
name|result
operator|.
name|getChange
...
expr_stmt|;
block|}
DECL|method|getValueFromText (String text, String key)
specifier|private
name|String
name|getValueFromText
parameter_list|(
...
return|;
block|}
DECL|method|executeSuccessfulTextQuery (String params, SshSession session)
specifier|private
name|String
name|executeSuccessfulTextQuery
parameter_list|(
...
name|exec
argument_list|(
literal|"gerrit query --format=TEXT "
operator|+
name|params
argument_list|)
decl_stmt|;
...
return|;
block|}
DECL|method|executeSuccessfulTextQuery (String params)
specifier|private
name|String
name|executeSuccessfulTextQuery
parameter_list|(
