...
name|isEqualTo
argument_list|(
literal|"Problems with change(s): 2"
argument_list|)
expr_stmt|;
block|}
else|else
...
annotation|@
name|Test
DECL|method|revisionActionVisitor ()
specifier|public
name|void
name|revisionActionVisitor
parameter_list|()
throws|throws
name|Exception
block|{
...
name|visitedRevisionActionsAssertions
argument_list|(
name|origActions
argument_list|,
name|gApi
...
expr_stmt|;
block|}
DECL|method|visitedRevisionActionsAssertions ( Map<String, ActionInfo> origActions, Map<String, ActionInfo> newActions)
specifier|private
name|void
name|visitedRevisionActionsAssertions
parameter_list|(
...
return|;
block|}
DECL|method|createDraftWithTopic ()
specifier|private
name|PushOneCommit
operator|.
name|Result
