...
block|}
comment|/** Returns fully started Gerrit server */
DECL|method|start (Config base, boolean memory, boolean index)
specifier|static
name|GerritServer
name|start
parameter_list|(
...
return|;
block|}
comment|/** Runs the reindex command. Works only if the site is not currently running. */
DECL|method|reindex (File site)
specifier|private
specifier|static
name|void
name|reindex
