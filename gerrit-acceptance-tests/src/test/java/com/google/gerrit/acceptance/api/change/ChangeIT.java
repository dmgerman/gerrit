...
annotation|@
name|Test
DECL|method|implicitlyCcOnNonVotingReview ()
specifier|public
name|void
name|implicitlyCcOnNonVotingReview
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// If we're not reading from NoteDb, then the CCed user will be returned
comment|// in the REVIEWER state.
name|ReviewerState
name|state
init|=
name|notesMigration
