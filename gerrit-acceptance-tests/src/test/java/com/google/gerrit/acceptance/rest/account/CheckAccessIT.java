...
argument_list|)
expr_stmt|;
comment|// deny(secretProject, Permission.READ, SystemGroupBackend.REGISTERED_USERS, "refs/*");
name|grant
argument_list|(
name|Permission
operator|.
...
name|format
argument_list|(
literal|"want RestApiException for %s"
argument_list|,
name|newGson
argument_list|()
operator|.
...
name|format
argument_list|(
literal|"check.check(%s): exception %s"
argument_list|,
name|in
argument_list|,
name|e
...
name|format
argument_list|(
literal|"check.access(%s) = %d, want %d"
argument_list|,
name|in
argument_list|,
name|info
