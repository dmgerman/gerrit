...
argument_list|()
expr_stmt|;
comment|// Other user trying to move from WIP to ready should fail.
name|GitUtil
operator|.
name|fetch
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Other user trying to move from ready to WIP should fail.
name|GitUtil
operator|.
name|fetch
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Other user trying to move from ready to ready should succeed.
name|r
operator|=
name|amendChange
argument_list|(
...
name|Exception
block|{
comment|// create draft by pushing to 'refs/drafts/' will get a private change.
name|PushOneCommit
operator|.
name|Result
name|r
...
argument_list|()
expr_stmt|;
comment|// create draft by using 'draft' option will get a private change, too.
name|r
operator|=
name|pushTo
argument_list|(
