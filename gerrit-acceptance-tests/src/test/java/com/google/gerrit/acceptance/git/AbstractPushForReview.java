...
argument_list|)
expr_stmt|;
comment|// TODO(dborowitz): The template currently doesn't include the ChangeMessage (aka cover letter)
comment|// text at all. Update this to look for the (3 commnets) text once that's fixed.
name|assertThat
argument_list|(
name|m
operator|.
