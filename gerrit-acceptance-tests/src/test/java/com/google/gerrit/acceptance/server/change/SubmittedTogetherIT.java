...
annotation|@
name|Test
DECL|method|hiddenDraftInTopic ()
specifier|public
name|void
name|hiddenDraftInTopic
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|hiddenDraftInTopicOldApi ()
specifier|public
name|void
name|hiddenDraftInTopicOldApi
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|draftPatchSetInTopic ()
specifier|public
name|void
name|draftPatchSetInTopic
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// TODO(jrn): use insertChangeId(id1) once jgit TestRepository accepts
comment|// the leading "I".
name|commitBuilder
argument_list|()
operator|.
name|insertChangeId
...
name|message
argument_list|(
literal|"draft patch set on change 1"
argument_list|)
operator|.
name|create
argument_list|()
...
name|message
argument_list|(
literal|"change with same topic"
argument_list|)
operator|.
name|create
argument_list|()
...
annotation|@
name|Test
DECL|method|doNotRevealVisibleAncestorOfHiddenDraft ()
specifier|public
name|void
name|doNotRevealVisibleAncestorOfHiddenDraft
parameter_list|()
throws|throws
name|Exception
block|{
