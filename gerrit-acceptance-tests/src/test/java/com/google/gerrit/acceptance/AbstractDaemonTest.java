...
return|;
block|}
DECL|method|beforeTest (Description description, boolean memory, boolean enableHttpd)
specifier|private
name|void
name|beforeTest
parameter_list|(
...
condition|)
block|{
comment|// TODO(dborowitz): Use different project names.
name|in
operator|.
name|name
operator|=
...
return|;
block|}
DECL|method|setRepo (TestRepository<?> testRepo)
specifier|protected
name|void
name|setRepo
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|createProject (String name, Project.NameKey parent)
specifier|protected
name|void
name|createProject
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|createProject (String name, Project.NameKey parent, boolean createEmptyCommit)
specifier|protected
name|void
name|createProject
parameter_list|(
