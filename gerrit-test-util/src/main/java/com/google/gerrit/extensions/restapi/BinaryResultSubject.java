...
name|BinaryResult
argument_list|>
DECL|field|BINARY_RESULT_SUBJECT_FACTORY
name|BINARY_RESULT_SUBJECT_FACTORY
init|=
operator|new
name|SubjectFactory
argument_list|<
...
return|;
block|}
DECL|method|BinaryResultSubject (FailureStrategy failureStrategy, BinaryResult binaryResult)
specifier|private
name|BinaryResultSubject
parameter_list|(
name|FailureStrategy
