...
name|EditFilter
block|{
DECL|method|get (SparseFileContent src, EditList.Hunk hunk)
specifier|final
name|String
name|get
parameter_list|(
...
parameter_list|()
function_decl|;
DECL|method|getCur (EditList.Hunk hunk)
specifier|abstract
name|int
name|getCur
parameter_list|(
...
parameter_list|)
function_decl|;
DECL|method|isModified (EditList.Hunk hunk)
specifier|abstract
name|boolean
name|isModified
parameter_list|(
...
parameter_list|)
function_decl|;
DECL|method|incSelf (EditList.Hunk hunk)
specifier|abstract
name|void
name|incSelf
parameter_list|(
...
parameter_list|)
function_decl|;
DECL|method|incOther (EditList.Hunk hunk)
specifier|abstract
name|void
name|incOther
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|setEditList (EditList all)
specifier|public
name|void
name|setEditList
parameter_list|(
...
condition|)
block|{
comment|// If side is B and src isn't the complete file we can't
comment|// add it to the buffer here. This can happen if the file
comment|// was really large and we chose not to syntax highlight.
comment|//
name|buf
operator|.
name|append
