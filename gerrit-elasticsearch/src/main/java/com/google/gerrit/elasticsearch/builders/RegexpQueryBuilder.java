...
begin_comment
comment|/**  * A Query that does fuzzy matching for a specific value. A trimmed down version of {@link  * org.elasticsearch.index.query.RegexpQueryBuilder} for this very package.  */
end_comment
