...
begin_comment
comment|/**  * Constructs a query that only match on documents that the field has a value in them.  *  *<p>A trimmed down version of org.elasticsearch.index.query.ExistsQueryBuilder.  */
end_comment
