...
annotation|@
name|AssistedInject
DECL|method|ElasticGroupIndex ( @erritServerConfig Config cfg, SitePaths sitePaths, Provider<GroupCache> groupCache, ElasticRestClientBuilder clientBuilder, @Assisted Schema<AccountGroup> schema)
name|ElasticGroupIndex
parameter_list|(
annotation|@
name|GerritServerConfig
