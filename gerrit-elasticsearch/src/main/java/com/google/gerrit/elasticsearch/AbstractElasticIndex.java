...
name|queryBuilder
decl_stmt|;
DECL|method|AbstractElasticIndex ( @erritServerConfig Config cfg, FillArgs fillArgs, SitePaths sitePaths, Schema<V> schema, ElasticRestClientBuilder clientBuilder, String indexName)
name|AbstractElasticIndex
parameter_list|(
annotation|@
name|GerritServerConfig
