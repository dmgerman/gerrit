...
annotation|@
name|AssistedInject
DECL|method|ElasticChangeIndex ( @erritServerConfig Config cfg, Provider<ReviewDb> db, ChangeData.Factory changeDataFactory, FillArgs fillArgs, SitePaths sitePaths, ElasticRestClientBuilder clientBuilder, @Assisted Schema<ChangeData> schema)
name|ElasticChangeIndex
parameter_list|(
annotation|@
name|GerritServerConfig
