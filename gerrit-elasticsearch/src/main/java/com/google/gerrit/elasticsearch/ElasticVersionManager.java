...
annotation|@
name|Inject
DECL|method|ElasticVersionManager ( @erritServerConfig Config cfg, SitePaths sitePaths, Collection<IndexDefinition<?, ?, ?>> defs, ElasticIndexVersionDiscovery versionDiscovery)
name|ElasticVersionManager
parameter_list|(
annotation|@
name|GerritServerConfig
...
block|}
block|}
DECL|method|initIndex (IndexDefinition<K, V, I> def)
specifier|private
parameter_list|<
name|K
parameter_list|,
...
block|}
block|}
DECL|method|scanVersions ( IndexDefinition<K, V, I> def)
specifier|private
parameter_list|<
name|K
parameter_list|,
