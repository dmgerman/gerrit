...
begin_comment
comment|/**  * A Query that matches documents containing a term. A trimmed down version of {@link  * org.elasticsearch.index.query.TermQueryBuilder} for this very package.  */
end_comment
