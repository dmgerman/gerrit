...
annotation|@
name|Inject
DECL|method|SubmitAction (final Submit.Factory submitFactory, final ChangeDetailFactory.Factory changeDetailFactory, @Assisted final PatchSet.Id patchSetId)
name|SubmitAction
parameter_list|(
specifier|final
name|Submit
