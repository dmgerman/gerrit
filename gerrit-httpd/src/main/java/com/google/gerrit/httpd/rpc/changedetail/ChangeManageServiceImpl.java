...
annotation|@
name|Inject
DECL|method|ChangeManageServiceImpl (final SubmitAction.Factory patchSetAction, final RebaseChangeHandler.Factory rebaseChangeFactory, final RestoreChangeHandler.Factory restoreChangeHandlerFactory, final PublishAction.Factory publishAction, final DeleteDraftChange.Factory deleteDraftChangeFactory, final EditCommitMessageHandler.Factory editCommitMessageHandler)
name|ChangeManageServiceImpl
parameter_list|(
specifier|final
name|SubmitAction
