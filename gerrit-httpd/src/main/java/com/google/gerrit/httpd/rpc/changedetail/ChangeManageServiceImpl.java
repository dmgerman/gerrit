...
decl_stmt|;
DECL|field|editCommitMessageHandlerFactory
specifier|private
specifier|final
...
annotation|@
name|Inject
DECL|method|ChangeManageServiceImpl (final SubmitAction.Factory patchSetAction, final RebaseChangeHandler.Factory rebaseChangeFactory, final RestoreChangeHandler.Factory restoreChangeHandlerFactory, final RevertChange.Factory revertChangeFactory, final PublishAction.Factory publishAction, final DeleteDraftChange.Factory deleteDraftChangeFactory, final EditCommitMessageHandler.Factory editCommitMessageHandler)
name|ChangeManageServiceImpl
parameter_list|(
specifier|final
name|SubmitAction
...
expr_stmt|;
block|}
DECL|method|createNewPatchSet (Id patchSetId, String message, AsyncCallback<ChangeDetail> callback)
specifier|public
name|void
