...
name|checkIfOwner
decl_stmt|;
DECL|method|ProjectAccessHandler ( final ProjectControl.Factory projectControlFactory, final GroupBackend groupBackend, final MetaDataUpdate.User metaDataUpdateFactory, final Project.NameKey projectName, final ObjectId base, final List<AccessSection> sectionList, final String message, final boolean checkIfOwner)
specifier|protected
name|ProjectAccessHandler
parameter_list|(
specifier|final
