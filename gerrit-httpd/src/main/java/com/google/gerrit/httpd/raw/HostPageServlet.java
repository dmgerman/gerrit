...
annotation|@
name|Inject
DECL|method|HostPageServlet (final Provider<CurrentUser> cu, final SitePaths sp, final GerritConfig gc, final ServletContext servletContext)
name|HostPageServlet
parameter_list|(
specifier|final
name|Provider
