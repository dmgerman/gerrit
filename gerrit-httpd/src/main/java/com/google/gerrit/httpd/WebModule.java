...
annotation|@
name|Inject
DECL|method|WebModule (final Provider<SshInfo> sshInfoProvider, final Provider<SshKeyCache> sshKeyCacheProvider, final AuthConfig authConfig, final Injector creatingInjector)
name|WebModule
parameter_list|(
specifier|final
name|Provider
