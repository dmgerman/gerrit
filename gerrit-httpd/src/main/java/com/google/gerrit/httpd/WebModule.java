...
annotation|@
name|Inject
DECL|method|WebModule (final Provider<SshInfo> sshInfoProvider, final Provider<SshKeyCache> sshKeyCacheProvider, final AuthConfig authConfig)
name|WebModule
parameter_list|(
specifier|final
name|Provider
...
expr_stmt|;
block|}
DECL|method|WebModule (final Provider<SshInfo> sshInfoProvider, final Provider<SshKeyCache> sshKeyCacheProvider, final AuthType loginType)
name|WebModule
parameter_list|(
specifier|final
name|Provider
