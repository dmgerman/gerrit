...
annotation|@
name|Inject
DECL|method|ChangeDetailServiceImpl (final ChangeDetailFactory.Factory changeDetail, final IncludedInDetailFactory.Factory includedInDetail, final PatchSetDetailFactory.Factory patchSetDetail, final PatchSetPublishDetailFactory.Factory patchSetPublishDetail, final AlterTopicHandler.Factory alterTopic)
name|ChangeDetailServiceImpl
parameter_list|(
specifier|final
name|ChangeDetailFactory
...
expr_stmt|;
block|}
DECL|method|alterTopic (final Change.Id id, final String topic, final String message, final AsyncCallback<ChangeDetail> callback)
specifier|public
name|void
name|alterTopic
parameter_list|(
