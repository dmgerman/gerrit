...
argument_list|()
decl_stmt|;
DECL|method|create ( @ullable String accessToken, @Nullable String xdMethod, @Nullable String xdContentType, ImmutableListMultimap<String, String> config, ImmutableListMultimap<String, String> params)
specifier|static
name|QueryParams
name|create
parameter_list|(
...
return|return
operator|new
name|AutoValue_ParameterParser_QueryParams
argument_list|(
name|accessToken
argument_list|,
name|xdMethod
...
block|}
block|}
DECL|method|getQueryParams (HttpServletRequest req)
specifier|public
specifier|static
name|QueryParams
name|getQueryParams
