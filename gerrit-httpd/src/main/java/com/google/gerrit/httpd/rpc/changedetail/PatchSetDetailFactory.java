...
name|Factory
block|{
DECL|method|create (@ssistedR) PatchSet.Id psIdA, @Assisted(R) PatchSet.Id psIdB, AccountDiffPreference diffPrefs)
name|PatchSetDetailFactory
name|create
parameter_list|(
annotation|@
...
annotation|@
name|Inject
DECL|method|PatchSetDetailFactory (final GitRepositoryManager grm, final PatchSetInfoFactory psif, final ReviewDb db, final PatchListCache patchListCache, final ChangeControl.Factory changeControlFactory, @Assisted(R) final PatchSet.Id psIdNew, @Assisted(R) @Nullable final PatchSet.Id psIdOld, @Assisted @Nullable final AccountDiffPreference diffPrefs)
name|PatchSetDetailFactory
parameter_list|(
specifier|final
name|GitRepositoryManager
