...
annotation|@
name|Inject
DECL|method|PatchSetDetailFactory (final PatchSetInfoFactory psif, final ReviewDb db, final PatchListCache patchListCache, final Provider<CurrentUser> userProvider, final ChangeControl.GenericFactory changeControlFactory, final ChangesCollection changes, final Revisions revisions, final PatchLineCommentsUtil plcUtil, @Assisted(R) @Nullable final PatchSet.Id psIdBase, @Assisted(R) final PatchSet.Id psIdNew, @Assisted @Nullable final AccountDiffPreference diffPrefs)
name|PatchSetDetailFactory
parameter_list|(
specifier|final
name|PatchSetInfoFactory
