...
annotation|@
name|Inject
DECL|method|Resolver ( GitRepositoryManager manager, PermissionBackend permissionBackend, Provider<CurrentUser> userProvider, ProjectControl.GenericFactory projectControlFactory)
name|Resolver
parameter_list|(
name|GitRepositoryManager
name|manager
...
annotation|@
name|Inject
DECL|method|UploadFactory ( TransferConfig tc, DynamicSet<PreUploadHook> preUploadHooks, DynamicSet<PostUploadHook> postUploadHooks)
name|UploadFactory
parameter_list|(
name|TransferConfig
name|tc
...
annotation|@
name|Inject
DECL|method|UploadFilter ( VisibleRefFilter.Factory refFilterFactory, UploadValidators.Factory uploadValidatorsFactory, PermissionBackend permissionBackend)
name|UploadFilter
parameter_list|(
name|VisibleRefFilter
operator|.
...
annotation|@
name|Inject
DECL|method|ReceiveFactory (AsyncReceiveCommits.Factory factory)
name|ReceiveFactory
parameter_list|(
name|AsyncReceiveCommits
operator|.
...
annotation|@
name|Inject
DECL|method|ReceiveFilter ( @amedID_CACHE) Cache<AdvertisedObjectsCacheKey, Set<ObjectId>> cache, PermissionBackend permissionBackend)
name|ReceiveFilter
parameter_list|(
annotation|@
name|Named
