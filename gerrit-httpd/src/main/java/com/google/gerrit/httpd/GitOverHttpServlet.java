...
annotation|@
name|Inject
DECL|method|UploadFactory (TransferConfig tc)
name|UploadFactory
parameter_list|(
name|TransferConfig
name|tc
...
annotation|@
name|Inject
DECL|method|ReceiveFactory (AsyncReceiveCommits.Factory factory, TransferConfig config, DynamicSet<ReceivePackInitializer> receivePackInitializers)
name|ReceiveFactory
parameter_list|(
name|AsyncReceiveCommits
operator|.
