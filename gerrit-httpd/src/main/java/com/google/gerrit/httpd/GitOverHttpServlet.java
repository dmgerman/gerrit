...
annotation|@
name|Inject
DECL|method|UploadFilter ( VisibleRefFilter.Factory refFilterFactory, UploadValidators.Factory uploadValidatorsFactory, PermissionBackend permissionBackend, Provider<CurrentUser> userProvider, AuditService auditService)
name|UploadFilter
parameter_list|(
name|VisibleRefFilter
operator|.
...
annotation|@
name|Inject
DECL|method|ReceiveFilter ( @amedID_CACHE) Cache<AdvertisedObjectsCacheKey, Set<ObjectId>> cache, PermissionBackend permissionBackend, Provider<CurrentUser> userProvider, AuditService auditService)
name|ReceiveFilter
parameter_list|(
annotation|@
name|Named
