...
annotation|@
name|Inject
DECL|method|ProjectServlet (final Resolver resolver, final UploadFactory upload, final UploadFilter uploadFilter, final ReceiveFactory receive, final ReceiveFilter receiveFilter, @CanonicalWebUrl @Nullable Provider<String> urlProvider)
name|ProjectServlet
parameter_list|(
specifier|final
name|Resolver
...
annotation|@
name|Inject
DECL|method|UploadFactory (final TransferConfig tc)
name|UploadFactory
parameter_list|(
specifier|final
name|TransferConfig
...
annotation|@
name|Inject
DECL|method|ReceiveFactory (final ReceiveCommits.Factory factory)
name|ReceiveFactory
parameter_list|(
specifier|final
name|ReceiveCommits
