...
annotation|@
name|Inject
DECL|method|PatchDetailServiceImpl (final Provider<ReviewDb> schema, final Provider<CurrentUser> currentUser, final PatchScriptFactory.Factory patchScriptFactoryFactory, final ChangeControl.GenericFactory changeControlFactory)
name|PatchDetailServiceImpl
parameter_list|(
specifier|final
name|Provider
