...
expr_stmt|;
block|}
DECL|method|deleteDraftPatchSet (final PatchSet.Id psid, final AsyncCallback<VoidResult> callback)
specifier|public
name|void
name|deleteDraftPatchSet
parameter_list|(
