...
throw|;
block|}
comment|// Assume the administrator pointed us the distribution, which
comment|// also has the corresponding CSS and logo file.
comment|//
name|css
operator|=
operator|new
...
block|{
comment|// Try to use the OS packaged CGI.
comment|//
specifier|final
name|File
name|s
