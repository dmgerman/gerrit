...
annotation|@
name|Inject
DECL|method|GroupAdminServiceImpl (final Provider<ReviewDb> schema, final Provider<IdentifiedUser> currentUser, final GroupIncludeCache groupIncludeCache, final GroupCache groupCache, final GroupControl.Factory groupControlFactory, final GroupDetailHandler.Factory groupDetailFactory)
name|GroupAdminServiceImpl
parameter_list|(
specifier|final
name|Provider
