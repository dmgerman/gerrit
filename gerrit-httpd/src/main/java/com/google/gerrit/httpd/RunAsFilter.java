...
annotation|@
name|Inject
DECL|method|RunAsFilter ( Provider<ReviewDb> db, AuthConfig config, DynamicItem<WebSession> session, PermissionBackend permissionBackend, AccountResolver accountResolver)
name|RunAsFilter
parameter_list|(
name|Provider
argument_list|<
