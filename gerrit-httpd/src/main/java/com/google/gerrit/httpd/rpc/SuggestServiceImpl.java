...
annotation|@
name|Inject
DECL|method|SuggestServiceImpl (final Provider<ReviewDb> schema, final ProjectCache projectCache, final AccountCache accountCache, final GroupControl.Factory groupControlFactory, final Provider<CurrentUser> currentUser)
name|SuggestServiceImpl
parameter_list|(
specifier|final
name|Provider
