...
annotation|@
name|Inject
DECL|method|ReviewProjectAccess (final ProjectControl.Factory projectControlFactory, final GroupBackend groupBackend, final MetaDataUpdate.User metaDataUpdateFactory, final ReviewDb db, final IdentifiedUser user, final PatchSetInfoFactory patchSetInfoFactory, final Provider<PostReviewers> reviewersProvider, final ChangeControl.GenericFactory changeFactory, @Assisted final Project.NameKey projectName, @Nullable @Assisted final ObjectId base, @Assisted List<AccessSection> sectionList, @Nullable @Assisted String message)
name|ReviewProjectAccess
parameter_list|(
specifier|final
name|ProjectControl
