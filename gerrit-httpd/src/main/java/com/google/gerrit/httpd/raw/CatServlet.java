...
block|}
block|}
DECL|method|openOutputStream (HttpServletRequest req, HttpServletResponse rsp, ObjectLoader blobLoader, RevCommit fromCommit, long when, String path, String suffix, byte[] raw)
specifier|private
name|OutputStream
name|openOutputStream
parameter_list|(
