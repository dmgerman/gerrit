...
annotation|@
name|Inject
DECL|method|OpenIdServiceImpl (final Provider<WebSession> cf, final Provider<IdentifiedUser> iu, @CanonicalWebUrl @Nullable final Provider<String> up, @Named(R) final Cache<String, List> openidCache, @GerritServerConfig final Config config, final AccountManager am)
name|OpenIdServiceImpl
parameter_list|(
specifier|final
name|Provider
...
expr_stmt|;
block|}
DECL|method|discover (final String openidIdentifier, final SignInMode mode, final boolean remember, final String returnToken, final AsyncCallback<DiscoveryResult> callback)
specifier|public
name|void
name|discover
parameter_list|(
