...
annotation|@
name|Inject
DECL|method|OpenIdServiceImpl (final Provider<WebSession> cf, final Provider<IdentifiedUser> iu, @CanonicalWebUrl @Nullable final Provider<String> up, @Named(R) final Cache<String, List> openidCache, @GerritServerConfig final Config config, final AuthConfig ac, final AccountManager am)
name|OpenIdServiceImpl
parameter_list|(
specifier|final
name|Provider
