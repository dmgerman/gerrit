...
name|testMerge
decl_stmt|;
DECL|field|currentPatchSetAncestors
specifier|private
name|List
argument_list|<
name|PatchSetAncestor
argument_list|>
name|currentPatchSetAncestors
decl_stmt|;
DECL|field|currentDepPatchSets
specifier|private
name|List
argument_list|<
name|PatchSet
argument_list|>
name|currentDepPatchSets
decl_stmt|;
DECL|field|currentDepChanges
specifier|private
name|List
argument_list|<
name|Change
argument_list|>
name|currentDepChanges
decl_stmt|;
annotation|@
name|Inject
DECL|method|ChangeDetailFactory ( final PatchSetDetailFactory.Factory patchSetDetail, final ReviewDb db, final GitRepositoryManager repoManager, final ChangeControl.Factory changeControlFactory, final AccountInfoCacheFactory.Factory accountInfoCacheFactory, final AnonymousUser anonymousUser, final Mergeable mergeable, @GerritServerConfig final Config cfg, @Assisted final Change.Id id)
name|ChangeDetailFactory
parameter_list|(
specifier|final
name|PatchSetDetailFactory
...
name|warn
argument_list|(
literal|"Cannot check mergeable"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|isReviewer (Change change)
specifier|private
name|boolean
name|isReviewer
parameter_list|(
...
parameter_list|)
block|{
comment|// Return true if the currently logged in user is a reviewer of the change.
try|try
block|{
return|return
name|control
