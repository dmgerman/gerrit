...
argument_list|)
expr_stmt|;
name|consumeRawInputRequestBody
argument_list|(
name|req
argument_list|,
name|type
...
begin_function
unit|}    private
DECL|method|consumeRawInputRequestBody (HttpServletRequest req, Type type)
name|void
name|consumeRawInputRequestBody
parameter_list|(
name|HttpServletRequest
...
begin_function
DECL|method|rawInputRequest (HttpServletRequest req, Type type)
specifier|private
specifier|static
name|boolean
name|rawInputRequest
