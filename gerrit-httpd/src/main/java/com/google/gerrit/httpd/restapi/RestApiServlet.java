...
annotation|@
name|Inject
DECL|method|Globals (Provider<CurrentUser> currentUser, DynamicItem<WebSession> webSession, Provider<ParameterParser> paramParser, AuditService auditService, RestApiMetrics metrics)
name|Globals
parameter_list|(
name|Provider
argument_list|<
...
begin_function
DECL|method|isGetOrHead (HttpServletRequest req)
specifier|private
specifier|static
name|boolean
name|isGetOrHead
