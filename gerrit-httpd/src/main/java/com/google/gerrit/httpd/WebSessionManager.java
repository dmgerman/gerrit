...
annotation|@
name|Inject
DECL|method|WebSessionManager (@erritServerConfig Config cfg, @Named(CACHE_NAME) final Cache<Key, Val> cache)
name|WebSessionManager
parameter_list|(
annotation|@
name|GerritServerConfig
...
name|expiresAt
decl_stmt|;
DECL|method|Val (final Account.Id accountId, final long refreshCookieAt, final boolean persistentCookie, final AccountExternalId.Key externalId, final String xsrfToken, final long expiresAt)
name|Val
parameter_list|(
specifier|final
name|Account
