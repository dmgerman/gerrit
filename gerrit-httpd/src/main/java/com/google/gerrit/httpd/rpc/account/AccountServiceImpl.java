...
annotation|@
name|Inject
DECL|method|AccountServiceImpl (final Provider<ReviewDb> schema, final Provider<IdentifiedUser> identifiedUser, final ProjectControl.Factory projectControlFactory, final AgreementInfoFactory.Factory agreementInfoFactory, final ChangeQueryBuilder queryBuilder)
name|AccountServiceImpl
parameter_list|(
specifier|final
name|Provider
