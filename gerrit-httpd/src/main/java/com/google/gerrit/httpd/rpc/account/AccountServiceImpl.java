...
annotation|@
name|Inject
DECL|method|AccountServiceImpl (final Provider<ReviewDb> schema, final Provider<IdentifiedUser> identifiedUser, final ProjectControl.Factory projectControlFactory, final AgreementInfoFactory.Factory agreementInfoFactory, final Provider<ChangeQueryBuilder> queryBuilder)
name|AccountServiceImpl
parameter_list|(
specifier|final
name|Provider
