...
name|URL_REGEX
init|=
literal|"^/.*/(?:info/refs|git-upload-pack|git-receive-pack)$"
decl_stmt|;
DECL|class|Module
specifier|static
class|class
...
annotation|@
name|Inject
DECL|method|GitOverHttpFilter (Resolver resolver, UploadFactory upload, UploadFilter uploadFilter, ReceiveFactory receive, ReceiveFilter receiveFilter)
name|GitOverHttpFilter
parameter_list|(
name|Resolver
name|resolver
...
name|ServletException
block|{
comment|// JGit doesn't handle parsing the request as-is. It assumes
comment|// the relevant data is available in getPathInfo(), but this
comment|// isn't true in GuiceFilter. Massage the request for JGit.
specifier|final
name|HttpServletRequest
name|req
init|=
