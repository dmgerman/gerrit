...
literal|null
decl_stmt|;
comment|// first check if there is a suitable git cookie; such cookies are
comment|// expected to have names starting with the prefix git-
if|if
condition|(
name|req
operator|.
...
block|}
block|}
comment|// if there is no suitable git cookie fall back to Basic authentication
if|if
condition|(
name|authInfo
operator|==
