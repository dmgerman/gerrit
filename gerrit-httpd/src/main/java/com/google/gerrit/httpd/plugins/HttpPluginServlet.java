...
argument_list|)
decl_stmt|;
DECL|field|JAR_ENTRY_COMPARATOR_BY_NAME
specifier|private
specifier|static
specifier|final
name|Comparator
...
name|JarEntry
argument_list|>
name|JAR_ENTRY_COMPARATOR_BY_NAME
init|=
operator|new
name|Comparator
argument_list|<
...
block|}
block|}
DECL|method|appendEntriesSection (JarFile jar, List<JarEntry> entries, String sectionTitle, StringBuilder md, String prefix, int nameOffset)
specifier|private
name|void
...
return|;
block|}
DECL|method|jarFileOf (Plugin plugin)
specifier|private
specifier|static
name|JarFile
name|jarFileOf
