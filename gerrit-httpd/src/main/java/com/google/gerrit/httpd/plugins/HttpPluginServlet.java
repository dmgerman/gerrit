...
annotation|@
name|Inject
DECL|method|HttpPluginServlet (MimeUtilFileTypeRegistry mimeUtil, @CanonicalWebUrl Provider<String> webUrl, @Named(HttpPluginModule.PLUGIN_RESOURCES) Cache<ResourceKey, Resource> cache, @GerritServerConfig Config cfg, SshInfo sshInfo, ListPluginsServlet listServlet)
name|HttpPluginServlet
parameter_list|(
name|MimeUtilFileTypeRegistry
name|mimeUtil
