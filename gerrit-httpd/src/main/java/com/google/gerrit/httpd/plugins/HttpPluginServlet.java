...
expr_stmt|;
block|}
DECL|method|getRealFileEntry (JarFile jar, String file)
specifier|private
name|JarEntry
name|getRealFileEntry
parameter_list|(
...
parameter_list|)
block|{
comment|// TODO: Replace with a loop iterating over possible formatters
return|return
name|jar
operator|.
name|getJarEntry
...
return|;
block|}
DECL|method|isValidEntry (JarEntry entry)
specifier|private
name|boolean
name|isValidEntry
parameter_list|(
...
return|;
block|}
DECL|method|sendResource (JarFile jar, JarEntry entry, HttpServletResponse res, String pluginName)
specifier|private
name|void
name|sendResource
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|sendResource (JarFile jar, JarEntry entry, HttpServletResponse res, String pluginName, boolean format)
specifier|private
name|void
name|sendResource
parameter_list|(
...
name|format
argument_list|(
literal|"Plugin '%s' file '%s' too large to format"
argument_list|,
name|pluginName
argument_list|,
name|entryName
