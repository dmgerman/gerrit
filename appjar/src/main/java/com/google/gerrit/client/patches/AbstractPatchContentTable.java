...
parameter_list|)
function_decl|;
DECL|method|createCommentEditor (int suggestRow, final int column, final int line, final short side)
specifier|protected
name|void
...
condition|)
block|{
comment|// Skip over any current comment panels, so we add onto the end.
comment|//
name|suggestRow
operator|++
expr_stmt|;
