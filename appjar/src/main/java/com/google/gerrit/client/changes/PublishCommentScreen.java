...
expr_stmt|;
block|}
DECL|method|setValue (Element rbutton, ApprovalCategoryValue val)
specifier|private
specifier|static
specifier|native
name|void
...
name|val
parameter_list|)
comment|/*-{ rbutton["__gerritValue"] = val; }-*/
function_decl|;
DECL|method|getValue (Element rbutton)
specifier|private
specifier|static
specifier|native
name|ApprovalCategoryValue
...
name|rbutton
parameter_list|)
comment|/*-{ return rbutton["__gerritValue"]; }-*/
function_decl|;
block|}
end_class
