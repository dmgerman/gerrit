...
comment|// have a vested interest in the change and any remarks made onit.
comment|//
name|add
argument_list|(
name|RecipientType
...
condition|)
block|{
comment|// If the only recipient is because we CC'd the user we are sending
comment|// from, this message isn't very worthwhile. Users shouldn't use
comment|// us in order to email themselves.
comment|//
return|return;
block|}
name|msg
