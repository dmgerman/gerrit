...
return|;
block|}
DECL|method|createOptions (File outputFile)
specifier|private
name|Options
name|createOptions
parameter_list|(
...
condition|)
block|{
comment|// We have to use UNSAFE mode in order to make embedding work. But in
comment|// UNSAFE mode we'll also need css file in the same directory, so we
comment|// have to add css files into the SRCS.
continue|continue;
block|}
name|String
name|outName
...
expr_stmt|;
block|}
DECL|method|renderInput (Options options, File inputFile)
specifier|private
name|void
name|renderInput
parameter_list|(
