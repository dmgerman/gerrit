...
block|}
block|}
DECL|method|initIndex ( IndexDefinition<K, V, I> def, FileBasedConfig cfg)
specifier|private
parameter_list|<
name|K
parameter_list|,
...
block|}
block|}
comment|// TODO: include index name.
name|markNotReady
argument_list|(
name|cfg
argument_list|,
...
argument_list|>
argument_list|>
DECL|method|scanVersions (IndexDefinition<K, V, I> def, Config cfg)
name|scanVersions
parameter_list|(
name|IndexDefinition
argument_list|<
...
return|;
block|}
DECL|method|markNotReady (FileBasedConfig cfg, Iterable<Version<V>> versions, Collection<Version<V>> inUse)
specifier|private
parameter_list|<
name|V
parameter_list|>
