...
name|closedIndex
decl_stmt|;
DECL|method|LuceneChangeIndex (Config cfg, SitePaths sitePaths, ListeningScheduledExecutorService executor, FillArgs fillArgs, Schema<ChangeData> fields, boolean readOnly)
name|LuceneChangeIndex
parameter_list|(
name|Config
name|cfg
