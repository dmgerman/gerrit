...
return|;
block|}
comment|// Request the numeric ID field even if the caller did not request it,
comment|// otherwise we can't actually construct a ChangeData.
return|return
name|Sets
operator|.
name|union
...
return|;
block|}
DECL|method|schemaHasRequestedField (FieldDef<ChangeData, ?> field, Set<String> requested)
specifier|private
name|boolean
name|schemaHasRequestedField
parameter_list|(
...
return|;
block|}
DECL|method|decodePatchSets (Document doc, ChangeData cd)
specifier|private
name|void
name|decodePatchSets
parameter_list|(
...
block|}
block|}
DECL|method|decodeApprovals (Document doc, ChangeData cd)
specifier|private
name|void
name|decodeApprovals
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|decodeChangedLines (Document doc, ChangeData cd)
specifier|private
name|void
name|decodeChangedLines
parameter_list|(
...
block|}
block|}
DECL|method|decodeReviewedBy (Document doc, ChangeData cd)
specifier|private
name|void
name|decodeReviewedBy
parameter_list|(
