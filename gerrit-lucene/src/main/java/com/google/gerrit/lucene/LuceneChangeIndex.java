...
name|readOnly
decl_stmt|;
DECL|method|LuceneChangeIndex (@erritServerConfig Config cfg, SitePaths sitePaths, IndexCollection indexes, @IndexExecutor ListeningScheduledExecutorService executor, FillArgs fillArgs, Schema<ChangeData> schema, boolean readOnly)
name|LuceneChangeIndex
parameter_list|(
annotation|@
name|GerritServerConfig
