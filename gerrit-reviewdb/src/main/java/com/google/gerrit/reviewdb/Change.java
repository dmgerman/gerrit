...
begin_comment
comment|/**    * Null if the change has never been tested.    * Empty if it has been tested but against a branch that does    * not exist.    */
end_comment
...
literal|false
argument_list|)
DECL|field|lastSha1MergeTested
specifier|protected
name|RevId
...
begin_function
DECL|method|getLastSha1MergeTested ()
specifier|public
name|RevId
...
begin_function
DECL|method|setLastSha1MergeTested (RevId lastSha1MergeTested)
specifier|public
name|void
name|setLastSha1MergeTested
parameter_list|(
