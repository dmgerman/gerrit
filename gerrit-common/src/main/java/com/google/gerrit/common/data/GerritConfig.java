...
name|suggestFrom
decl_stmt|;
comment|// Hack to pass FindReplace across the JSON serialization boundary, which
comment|// doesn't work with interfaces.
DECL|class|CommentLink
specifier|public
specifier|static
class|class
name|CommentLink
block|{
DECL|method|newCommentLink (String find, String link)
specifier|public
specifier|static
name|CommentLink
name|newCommentLink
...
return|;
block|}
DECL|method|newRawCommentLink (String find, String repl)
specifier|public
specifier|static
name|CommentLink
name|newRawCommentLink
parameter_list|(
name|String
name|find
parameter_list|,
...
name|isLink
decl_stmt|;
DECL|method|CommentLink ()
specifier|protected
name|CommentLink
parameter_list|()
block|{     }
DECL|method|CommentLink (String find, String repl, boolean isLink)
specifier|private
name|CommentLink
parameter_list|(
name|String
...
return|;
block|}
DECL|method|getSerializableCommentLinks ()
specifier|public
name|List
argument_list|<
name|CommentLink
argument_list|>
name|getSerializableCommentLinks
parameter_list|()
block|{
return|return
name|commentLinks
return|;
block|}
DECL|method|setSerializableCommentLinks (List<CommentLink> commentLinks)
specifier|public
name|void
name|setSerializableCommentLinks
parameter_list|(
name|List
argument_list|<
name|CommentLink
