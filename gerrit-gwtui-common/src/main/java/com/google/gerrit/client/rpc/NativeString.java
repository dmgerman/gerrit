...
argument_list|()
decl_stmt|;
comment|// Used from core and plugins
DECL|method|init ()
specifier|private
specifier|static
specifier|native
...
name|init
parameter_list|()
comment|/*-{     if ($wnd.Gerrit === undefined || $wnd.Gerrit.JsonString === undefined) {       return function(s){this.s=s};     } else {       return $wnd.Gerrit.JsonString;     }   }-*/
function_decl|;
