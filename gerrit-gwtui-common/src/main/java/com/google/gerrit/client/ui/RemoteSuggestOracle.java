...
name|last
decl_stmt|;
DECL|field|requestRetentionTimer
specifier|private
name|Timer
name|requestRetentionTimer
decl_stmt|;
DECL|field|cancelOutstandingRequest
specifier|private
name|boolean
name|cancelOutstandingRequest
decl_stmt|;
DECL|field|serveSuggestions
specifier|private
name|boolean
name|serveSuggestions
decl_stmt|;
...
return|return;
block|}
comment|// Use a timer for key stroke retention, such that we don't query the
comment|// backend for each and every keystroke we receive.
if|if
condition|(
name|requestRetentionTimer
operator|!=
...
return|;
block|}
DECL|method|cancelOutstandingRequest ()
specifier|public
name|void
name|cancelOutstandingRequest
parameter_list|()
...
block|}
block|}
DECL|method|setServeSuggestions (boolean serveSuggestions)
specifier|public
name|void
name|setServeSuggestions
parameter_list|(
name|boolean
name|serveSuggestions
parameter_list|)
...
condition|)
block|{
comment|// If cancelOutstandingRequest() was called, we ignore this response
name|cancelOutstandingRequest
operator|=
literal|false
expr_stmt|;
