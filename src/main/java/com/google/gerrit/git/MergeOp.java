...
annotation|@
name|Inject
DECL|method|MergeOp (final GerritServer gs, final SchemaFactory<ReviewDb> sf, final ReplicationQueue rq, final MergedSender.Factory msf, final MergeFailSender.Factory mfsf, @CanonicalWebUrl @Nullable final Provider<String> cwu, final GerritConfig gc, final PatchSetInfoFactory psif, final IdentifiedUser.Factory iuf, @Assisted final Branch.NameKey branch)
name|MergeOp
parameter_list|(
specifier|final
name|GerritServer
...
begin_function
DECL|method|setRefLogIdent (final ChangeApproval submitAudit)
specifier|private
name|void
name|setRefLogIdent
parameter_list|(
...
condition|)
block|{
comment|// We don't support cherry-picking a merge commit.
comment|//
name|n
operator|.
name|statusCode
...
begin_function
DECL|method|toPersonIdent (final ChangeApproval audit)
specifier|private
name|PersonIdent
name|toPersonIdent
parameter_list|(
...
name|error
argument_list|(
literal|"Cannot submit patch set for Change "
operator|+
name|c
operator|.
name|getId
argument_list|()
operator|+
literal|" due to a missing dependency."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
begin_function
DECL|method|getSubmitter (Change.Id c)
specifier|private
name|ChangeApproval
name|getSubmitter
parameter_list|(
...
argument_list|()
operator|+
literal|" due to a path conflict."
argument_list|,
name|e
argument_list|)
expr_stmt|;
