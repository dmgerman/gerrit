...
block|}
block|}
DECL|method|scheduleImp (final Project.NameKey project, final String ref, final ReplicationConfig config, final URIish uri)
specifier|private
specifier|static
...
expr_stmt|;
block|}
DECL|method|posInt (final RemoteConfig rc, final RepositoryConfig cfg, final String name, final int defValue)
specifier|private
specifier|static
name|int
name|posInt
