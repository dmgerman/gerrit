...
comment|// to realize its binary, and instead produced the diff. Some
comment|// databases (PostgreSQL) won't allow us to store a nul into a
comment|// text field. Force it to be a binary; it really should have
comment|// been that in the first place.
comment|//
name|p
operator|.
name|setPatchType
...
parameter_list|)
block|{
comment|// Should be fine; someone else beat us to the insertion.
block|}
name|i
operator|.
name|remove
