...
expr_stmt|;
block|}
DECL|method|gerrit (RepositoryConfig config, ResultSet rs)
specifier|private
specifier|static
name|void
name|gerrit
...
expr_stmt|;
block|}
DECL|method|repo (RepositoryConfig config, ResultSet rs)
specifier|private
specifier|static
name|void
name|repo
