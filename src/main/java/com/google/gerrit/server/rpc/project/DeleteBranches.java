...
annotation|@
name|Inject
DECL|method|DeleteBranches (final ProjectControl.Factory projectControlFactory, final GitRepositoryManager repoManager, final ReplicationQueue replication, @Assisted Project.NameKey name, @Assisted Set<Branch.NameKey> toRemove)
name|DeleteBranches
parameter_list|(
specifier|final
name|ProjectControl
