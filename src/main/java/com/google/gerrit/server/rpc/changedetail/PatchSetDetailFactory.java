...
annotation|@
name|Inject
DECL|method|PatchSetDetailFactory (final PatchSetInfoFactory psif, final ReviewDb db, final ChangeControl.Factory changeControlFactory, @Assisted final PatchSet.Id id)
name|PatchSetDetailFactory
parameter_list|(
specifier|final
name|PatchSetInfoFactory
