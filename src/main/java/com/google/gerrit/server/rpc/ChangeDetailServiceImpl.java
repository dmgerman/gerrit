...
annotation|@
name|Inject
DECL|method|ChangeDetailServiceImpl (final SchemaFactory<ReviewDb> sf, final ChangeDetailFactory.Factory changeDetail, final PatchSetDetailFactory.Factory patchSetDetail, final PatchSetPublishDetailFactory.Factory patchSetPublishDetail)
name|ChangeDetailServiceImpl
parameter_list|(
specifier|final
name|SchemaFactory
