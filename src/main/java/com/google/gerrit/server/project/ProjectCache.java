...
annotation|@
name|Inject
DECL|method|ProjectCache (final AnonymousUser au, final SchemaFactory<ReviewDb> sf, @WildProjectName final Project.NameKey wp, final CacheManager mgr)
name|ProjectCache
parameter_list|(
specifier|final
name|AnonymousUser
...
return|;
block|}
DECL|method|get0 (final Object key)
specifier|private
name|ProjectState
name|get0
parameter_list|(
