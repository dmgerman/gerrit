...
condition|)
block|{
comment|// We know who the user is; embed their account data into the host
comment|// page to avoid an RPC during module loading.
comment|//
specifier|final
name|Document
name|peruser
...
block|{
comment|// User is anonymous (hasn't authenticated with us).
comment|//
if|if
condition|(
name|RPCServletUtils
