...
annotation|@
name|Inject
DECL|method|EncryptedContactStore (@erritServerConfig final Config cfg, @SitePath final File sitePath, final SchemaFactory<ReviewDb> sf)
name|EncryptedContactStore
parameter_list|(
annotation|@
name|GerritServerConfig
...
argument_list|(
literal|"contactstore.url not set"
argument_list|)
argument_list|)
throw|;
block|}
...
return|;
block|}
DECL|method|readPubRing (final File sitePath)
specifier|private
name|PGPPublicKeyRingCollection
name|readPubRing
parameter_list|(
