...
name|db
decl_stmt|;
DECL|method|OutgoingEmail (final GerritServer gs, final Change c, final String mc)
specifier|protected
name|OutgoingEmail
parameter_list|(
specifier|final
...
name|EmailException
argument_list|(
literal|"SMTP server rejected from "
operator|+
name|smtpFromAddress
argument_list|)
throw|;
...
name|EmailException
argument_list|(
literal|"SMTP server rejected rcpt "
operator|+
name|emailAddress
operator|+
literal|": "
...
name|EmailException
argument_list|(
literal|"SMTP server rejected message body"
argument_list|)
throw|;
block|}
name|w
