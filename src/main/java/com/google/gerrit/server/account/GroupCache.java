...
annotation|@
name|Inject
DECL|method|GroupCache ( final SchemaFactory<ReviewDb> sf, final AuthConfig authConfig, @Named(CACHE_NAME) final Cache<com.google.gwtorm.client.Key<?>, AccountGroup> rawAny)
name|GroupCache
parameter_list|(
specifier|final
name|SchemaFactory
