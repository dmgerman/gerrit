...
annotation|@
name|Inject
DECL|method|AccountResolver (final EmailExpander emailExpander, final AccountByEmailCache byEmail, final AccountCache byId, final Provider<ReviewDb> schema)
name|AccountResolver
parameter_list|(
specifier|final
name|EmailExpander
