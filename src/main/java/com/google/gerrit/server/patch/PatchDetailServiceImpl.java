...
annotation|@
name|Inject
DECL|method|PatchDetailServiceImpl (final SchemaFactory<ReviewDb> sf, final GerritServer gs, final FileTypeRegistry ftr, final DiffCache dc, final AddReviewerSender.Factory arsf, final AbandonedSender.Factory asf, final CommentSender.Factory csf, final PatchSetInfoFactory psif, final GerritConfig gc)
name|PatchDetailServiceImpl
parameter_list|(
specifier|final
name|SchemaFactory
