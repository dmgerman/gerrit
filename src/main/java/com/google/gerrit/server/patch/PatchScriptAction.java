...
name|git
decl_stmt|;
DECL|method|PatchScriptAction (final GerritServer gs, final RepositoryCache rc, final Patch.Key patchKey, final PatchSet.Id psa, final PatchSet.Id psb, final PatchScriptSettings settings)
name|PatchScriptAction
parameter_list|(
specifier|final
name|GerritServer
