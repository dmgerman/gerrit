...
name|sourceFileName
decl_stmt|;
DECL|method|DiffCacheKey (final Project.NameKey pnk, final AnyObjectId a, final AnyObjectId b, final Patch p)
specifier|public
name|DiffCacheKey
parameter_list|(
specifier|final
...
expr_stmt|;
block|}
DECL|method|DiffCacheKey (final Project.NameKey p, final AnyObjectId a, final AnyObjectId b, final String dname, final String sname)
specifier|public
name|DiffCacheKey
parameter_list|(
specifier|final
