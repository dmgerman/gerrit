...
name|edits
decl_stmt|;
DECL|method|PatchListEntry (final FileHeader hdr)
name|PatchListEntry
parameter_list|(
specifier|final
name|FileHeader
...
block|}
block|}
DECL|method|PatchListEntry (final ChangeType changeType, final PatchType patchType, final String oldName, final String newName, final FileHeader header, final List<Edit> edits)
specifier|private
name|PatchListEntry
parameter_list|(
specifier|final
