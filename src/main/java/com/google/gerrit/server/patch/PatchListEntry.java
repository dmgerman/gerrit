...
block|}
block|}
DECL|method|PatchListEntry (final ChangeType changeType, final PatchType patchType, final String oldName, final String newName, final byte[] header, final List<Edit> edits)
specifier|private
name|PatchListEntry
parameter_list|(
specifier|final
