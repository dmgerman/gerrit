...
name|NoDifferencesException
block|{
comment|// The line map is always 2 entries larger than the number of lines in
comment|// the file. Index 0 is padded out/unused. The last index is the total
comment|// length of the buffer, and acts as a sentinel to find the end of a line.
comment|//
return|return
name|getLineMap
argument_list|(
