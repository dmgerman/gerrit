...
parameter_list|)
block|{
comment|// The remote host described in the OpenID doesn't exist, so we
comment|// can't try to perform discovery against it.
comment|//
name|callback
argument_list|(
name|req
...
literal|"type.fname"
argument_list|,
literal|"http://example.com/schema/fullname"
argument_list|)
expr_stmt|;
name|auth
operator|.
...
name|put
argument_list|(
literal|"openid.sreg.optional"
argument_list|,
literal|"fullname,email"
argument_list|)
expr_stmt|;
name|auth
operator|.
name|put
argument_list|(
literal|"openid.ns.sreg"
argument_list|,
literal|"http://openid.net/extensions/sreg/1.1"
argument_list|)
expr_stmt|;
name|relyingParty
operator|.
name|getOpenIdUserManager
argument_list|()
operator|.
name|saveUser
argument_list|(
...
expr_stmt|;
block|}
DECL|method|save (UrlEncodedParameterMap b, HttpServletRequest r, String n)
specifier|private
specifier|static
name|void
name|save
...
block|}
block|}
DECL|method|initializeAccount (final HttpServletRequest req, final HttpServletResponse rsp, final OpenIdUser user, final String fullname, final String email)
specifier|private
name|void
name|initializeAccount
parameter_list|(
...
return|;
block|}
DECL|method|openAccount (final ReviewDb db, final OpenIdUser user, final String fullname, final String email)
specifier|private
name|Account
name|openAccount
parameter_list|(
...
return|;
block|}
DECL|method|linkAccount (final HttpServletRequest req, final ReviewDb db, final OpenIdUser user, final String email)
specifier|private
name|Account
name|linkAccount
parameter_list|(
...
return|return;
block|}
comment|// We're not in an OpenID transaction so try to clear out the
comment|// OpenID management cookie.
comment|//
name|relyingParty
operator|.
name|getOpenIdUserManager
