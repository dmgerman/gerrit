...
annotation|@
name|Inject
DECL|method|HostPageServlet (final Provider<GerritCall> cf, @SitePath final File path, final GerritConfig gc, @CanonicalWebUrl @Nullable final Provider<String> up, @CanonicalWebUrl @Nullable final String configuredUrl, final ServletContext servletContext)
name|HostPageServlet
parameter_list|(
specifier|final
name|Provider
