...
annotation|@
name|Inject
DECL|method|CatServlet (final Provider<GerritCall> cf, final Provider<CurrentUser> cu, final GerritServer gs, final Provider<ReviewDb> sf, final FileTypeRegistry ftr, final ChangeControl.Factory ccf)
name|CatServlet
parameter_list|(
specifier|final
name|Provider
