...
annotation|@
name|Inject
DECL|method|GerritCall (final AuthConfig ac, final EmailExpander emailExpander, final SchemaFactory<ReviewDb> sf, final AccountByEmailCache bec, final HttpServletRequest i, final HttpServletResponse o)
name|GerritCall
parameter_list|(
specifier|final
name|AuthConfig
