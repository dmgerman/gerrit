...
annotation|@
name|Inject
DECL|method|GerritConfigProvider (@erritServerConfig final Config gsc, @CanonicalWebUrl @Nullable final String cwu, final AuthConfig ac, @WildProjectName final Project.NameKey wp, final SshInfo si, final ApprovalTypes at, final ContactStore cs)
name|GerritConfigProvider
parameter_list|(
annotation|@
name|GerritServerConfig
