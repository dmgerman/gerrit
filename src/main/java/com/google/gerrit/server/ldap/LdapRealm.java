...
block|}
block|}
comment|/*    * We store the group names because LDAP doesn't support a query    * that will tell us whether a user is part of a parent group    */
DECL|method|groupsFor (DirContext ctx, String dn)
specifier|private
name|ArrayList
argument_list|<
name|String
...
try|try
block|{
comment|// add the current item's name
name|String
name|attNames
index|[]
init|=
