...
condition|)
block|{
comment|// Keep the alive period infinite, rather than expiring.
block|}
else|else
block|{
name|live
...
return|;
block|}
DECL|method|getInt (String name, String setting, int def)
specifier|private
name|int
name|getInt
parameter_list|(
...
return|;
block|}
DECL|method|getSeconds (String n, String setting, long def)
specifier|private
name|long
name|getSeconds
parameter_list|(
