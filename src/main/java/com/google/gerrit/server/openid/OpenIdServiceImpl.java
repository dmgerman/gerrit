...
annotation|@
name|Inject
DECL|method|OpenIdServiceImpl (final Provider<GerritCall> cf, final Provider<IdentifiedUser> iu, final AuthConfig ac, @CanonicalWebUrl @Nullable final Provider<String> up, final AccountByEmailCache bec, final AccountCache bic, final CacheManager cacheMgr, final SchemaFactory<ReviewDb> sf)
name|OpenIdServiceImpl
parameter_list|(
specifier|final
name|Provider
...
literal|"unchecked"
argument_list|)
DECL|method|debugRequest (final HttpServletRequest req)
specifier|private
specifier|static
name|void
name|debugRequest
...
name|isNew
decl_stmt|;
DECL|method|SignInResult (final Account a, final boolean n)
name|SignInResult
parameter_list|(
specifier|final
name|Account
...
return|;
block|}
DECL|method|linkAccount (final HttpServletRequest req, final ReviewDb db, final Identifier user, final String curEmail)
specifier|private
name|Account
name|linkAccount
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|cancelWithError (final HttpServletRequest req, final HttpServletResponse rsp, final SignInDialog.Mode mode, final String errorDetail)
specifier|private
name|void
name|cancelWithError
parameter_list|(
