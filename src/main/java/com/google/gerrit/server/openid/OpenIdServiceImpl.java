...
annotation|@
name|Inject
DECL|method|OpenIdServiceImpl (final Provider<GerritCall> cf, final AuthConfig ac, @CanonicalWebUrl @Nullable final Provider<String> up, final AccountByEmailCache bec, final CacheManager cacheMgr, final SchemaFactory<ReviewDb> sf)
name|OpenIdServiceImpl
parameter_list|(
specifier|final
name|Provider
