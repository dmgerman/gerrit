...
annotation|@
name|Inject
DECL|method|GenericFactory (final AuthConfig authConfig, final AccountCache accountCache, final Realm realm)
name|GenericFactory
parameter_list|(
specifier|final
name|AuthConfig
...
annotation|@
name|Inject
DECL|method|RequestFactory (final AuthConfig authConfig, final AccountCache accountCache, final Realm realm, final @RemotePeer Provider<SocketAddress> remotePeerProvider, final Provider<ReviewDb> dbProvider)
name|RequestFactory
parameter_list|(
specifier|final
name|AuthConfig
