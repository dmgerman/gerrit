...
name|usage
operator|=
literal|"patch to approve"
argument_list|)
DECL|field|patchIdentity
specifier|private
name|String
name|patchIdentity
decl_stmt|;
...
expr_stmt|;
block|}
DECL|method|addApproval (final PatchSetApproval.Key psaKey, final Short score, final Change c, final ApproveOption co, final Transaction txn)
specifier|private
name|void
name|addApproval
parameter_list|(
