...
expr_stmt|;
block|}
DECL|method|setRealmProperties (List<RealmProperty> p)
specifier|public
name|void
...
name|value
decl_stmt|;
DECL|method|RealmProperty ()
specifier|protected
name|RealmProperty
parameter_list|()
block|{     }
DECL|method|RealmProperty (final String n, final String v)
specifier|public
name|RealmProperty
parameter_list|(
specifier|final
