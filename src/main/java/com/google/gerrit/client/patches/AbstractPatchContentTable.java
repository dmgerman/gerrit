...
block|}
block|}
DECL|method|lineToSafeHtml (String text, boolean showWhitespaceErrors)
specifier|protected
name|SafeHtml
name|lineToSafeHtml
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|createReplyEditor (final LineCommentPanel currentPanel)
specifier|protected
name|void
...
block|}
block|}
DECL|method|createCommentEditor (final int suggestRow, final int column, final int line, final short file, final String parentUuid)
specifier|private
name|void
name|createCommentEditor
parameter_list|(
...
condition|)
block|{
comment|// Create a panel with a Reply button if we are looking at the
comment|// last comment for this line.
name|mp
operator|=
operator|new
name|LineCommentPanel
