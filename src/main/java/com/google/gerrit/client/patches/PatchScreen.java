...
argument_list|)
expr_stmt|;
comment|// If the user selected a different patch set than the default for either side,
comment|// expand the history panel
name|historyPanel
operator|.
name|setOpen
argument_list|(
...
expr_stmt|;
block|}
DECL|method|createIgnoreWhitespace (final Grid parent, final int row, final int col)
specifier|private
name|void
name|createIgnoreWhitespace
parameter_list|(
