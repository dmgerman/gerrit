...
expr_stmt|;
block|}
DECL|method|displayApprovals (final int row, ApprovalSummary summary, AccountInfoCache aic)
specifier|private
name|void
...
block|}
block|}
DECL|method|approvalFormatter (final int dataBegin, final int rows)
name|GerritCallback
argument_list|<
name|ApprovalSummarySet
argument_list|>
