...
annotation|@
name|Override
DECL|method|requestSuggestions (final Request req, final Callback callback)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|class|ProjectNameSuggestion
specifier|private
specifier|static
class|class
name|ProjectNameSuggestion
...
name|key
decl_stmt|;
DECL|method|ProjectNameSuggestion (final Project.NameKey k)
name|ProjectNameSuggestion
parameter_list|(
specifier|final
name|Project
