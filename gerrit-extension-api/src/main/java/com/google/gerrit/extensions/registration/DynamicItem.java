...
expr_stmt|;
block|}
comment|/**    * Declare a singleton {@code DynamicItem<T>} with a binder.    *<p>    * Items must be defined in a Guice module before they can be bound:    *<pre>    * {@code    *   DynamicSet.itemOf(binder(), new TypeLiteral<Thing<Foo>>() {});    * }    *</pre>    *    * @param binder a new binder created in the module.    * @param member type of entry to store.    */
